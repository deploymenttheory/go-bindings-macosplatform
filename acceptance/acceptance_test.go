...
import (
	...
	"github.com/deploymenttheory/go-bindings-macosplatform/internal/codegen/pipeline"
)
...
const (
	...
	defaultModPrefix = "github.com/deploymenttheory/go-bindings-macosplatform/bindings/frameworks"
...
func TestCrossFrameworkTypeResolution(t *testing.T) {
	...
	if !strings.Contains(string(data), `"github.com/deploymenttheory/go-bindings-macosplatform/bindings/frameworks/foundation"`) {
