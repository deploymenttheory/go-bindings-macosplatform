...
func (e GKMeshGraphTriangulationMode) String() string {
	var parts []string
	if e&GKMeshGraphTriangulationModeVertices != 0 { parts = append(parts, "GKMeshGraphTriangulationModeVertices") }
	if e&GKMeshGraphTriangulationModeCenters != 0 { parts = append(parts, "GKMeshGraphTriangulationModeCenters") }
	if e&GKMeshGraphTriangulationModeEdgeMidpoints != 0 { parts = append(parts, "GKMeshGraphTriangulationModeEdgeMidpoints") }
