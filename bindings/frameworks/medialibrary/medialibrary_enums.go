...
func (e MLMediaSourceType) String() string {
	var parts []string
	if e&MLMediaSourceTypeAudio != 0 {
		parts = append(parts, "MLMediaSourceTypeAudio")
	}
	if e&MLMediaSourceTypeImage != 0 {
		parts = append(parts, "MLMediaSourceTypeImage")
	}
	if e&MLMediaSourceTypeMovie != 0 {
		parts = append(parts, "MLMediaSourceTypeMovie")
	}
	if len(parts) == 0 {
		return "0"
	}
