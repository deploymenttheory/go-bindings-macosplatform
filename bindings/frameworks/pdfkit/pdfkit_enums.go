...
func (e PDFAreaOfInterest) String() string {
	var parts []string
	if e&KPDFPageArea != 0 { parts = append(parts, "KPDFPageArea") }
	if e&KPDFTextArea != 0 { parts = append(parts, "KPDFTextArea") }
	if e&KPDFAnnotationArea != 0 { parts = append(parts, "KPDFAnnotationArea") }
	if e&KPDFLinkArea != 0 { parts = append(parts, "KPDFLinkArea") }
	if e&KPDFControlArea != 0 { parts = append(parts, "KPDFControlArea") }
	if e&KPDFTextFieldArea != 0 { parts = append(parts, "KPDFTextFieldArea") }
	if e&KPDFIconArea != 0 { parts = append(parts, "KPDFIconArea") }
	if e&KPDFPopupArea != 0 { parts = append(parts, "KPDFPopupArea") }
	if e&KPDFImageArea != 0 { parts = append(parts, "KPDFImageArea") }
	if e&KPDFAnyArea != 0 { parts = append(parts, "KPDFAnyArea") }
