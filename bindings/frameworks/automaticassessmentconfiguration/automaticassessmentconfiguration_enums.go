...
func (e AEAutocorrectMode) String() string {
	var parts []string
	if e&AEAutocorrectModeSpelling != 0 { parts = append(parts, "AEAutocorrectModeSpelling") }
	if e&AEAutocorrectModePunctuation != 0 { parts = append(parts, "AEAutocorrectModePunctuation") }
