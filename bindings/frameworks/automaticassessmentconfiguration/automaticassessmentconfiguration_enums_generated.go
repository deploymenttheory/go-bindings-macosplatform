...
type UserAccountType int64

const (
	// No specific account type is required.
	UserAccountTypeAny UserAccountType = 0
	// Requires a standard user account.
	UserAccountTypeStandard UserAccountType = 1
	// Requires a guest user account.
	UserAccountTypeGuest UserAccountType = 2
)

// String returns the UserAccountType constant's name, or its numeric form when the
// value is not a known constant.
func (e UserAccountType) String() string {
	switch e {
	case UserAccountTypeAny:
		return "UserAccountTypeAny"
	case UserAccountTypeStandard:
		return "UserAccountTypeStandard"
	case UserAccountTypeGuest:
		return "UserAccountTypeGuest"
	default:
		return fmt.Sprintf("UserAccountType(%d)", int64(e))
	}
}
