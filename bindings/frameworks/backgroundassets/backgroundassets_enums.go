...
func (e BAAssetPackStatus) String() string {
	var parts []string
	if e&BAAssetPackStatusDownloadAvailable != 0 { parts = append(parts, "BAAssetPackStatusDownloadAvailable") }
	if e&BAAssetPackStatusUpdateAvailable != 0 { parts = append(parts, "BAAssetPackStatusUpdateAvailable") }
	if e&BAAssetPackStatusUpToDate != 0 { parts = append(parts, "BAAssetPackStatusUpToDate") }
	if e&BAAssetPackStatusOutOfDate != 0 { parts = append(parts, "BAAssetPackStatusOutOfDate") }
	if e&BAAssetPackStatusObsolete != 0 { parts = append(parts, "BAAssetPackStatusObsolete") }
	if e&BAAssetPackStatusDownloading != 0 { parts = append(parts, "BAAssetPackStatusDownloading") }
	if e&BAAssetPackStatusDownloaded != 0 { parts = append(parts, "BAAssetPackStatusDownloaded") }
...
const (
	// An error code that indicates the system can’t find an asset pack with the given identifier. Refer to the value in `-[NSError userInfo]` for the key `BAAssetPackIdentifierErrorKey` for the asset pack’s identifier.
	BAManagedErrorCodeAssetPackNotFound BAManagedErrorCode = 0
	// An error code that indicates the system can’t find a file at the specified path. Refer to the value in `-[NSError userInfo]` for the key `NSFilePathErrorKey` for the file path.
