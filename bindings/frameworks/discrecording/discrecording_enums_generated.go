...
const (
	CDTextEncodingASCII                     = 1
	CDTextEncodingISOLatin1Modified         = 5
	CDTextGenreCodeAdultContemporary        = 2
	CDTextGenreCodeAlternativeRock          = 3
	CDTextGenreCodeChildrens                = 4
	CDTextGenreCodeClassical                = 5
	CDTextGenreCodeContemporaryChristian    = 6
	CDTextGenreCodeCountry                  = 7
	CDTextGenreCodeDance                    = 8
	CDTextGenreCodeEasyListening            = 9
	CDTextGenreCodeErotic                   = 10
	CDTextGenreCodeFolk                     = 11
	CDTextGenreCodeGospel                   = 12
	CDTextGenreCodeHipHop                   = 13
	CDTextGenreCodeJazz                     = 14
	CDTextGenreCodeLatin                    = 15
	CDTextGenreCodeMusical                  = 16
	CDTextGenreCodeNewAge                   = 17
	CDTextGenreCodeOpera                    = 18
	CDTextGenreCodeOperetta                 = 19
	CDTextGenreCodePop                      = 20
	CDTextGenreCodeRap                      = 21
	CDTextGenreCodeReggae                   = 22
	CDTextGenreCodeRhythmAndBlues           = 24
	CDTextGenreCodeRock                     = 23
	CDTextGenreCodeSoundEffects             = 25
	CDTextGenreCodeSoundtrack               = 26
	CDTextGenreCodeSpokenWord               = 27
	CDTextGenreCodeUnknown                  = 1
	CDTextGenreCodeWorldMusic               = 28
	FileForkData                            = 0
	FileForkResource                        = 1
	FilesystemInclusionMaskHFSPlus          = 8
	FilesystemInclusionMaskISO9660          = 1
	FilesystemInclusionMaskJoliet           = 2
	FilesystemInclusionMaskUDF              = 4
	FlagSubchannelDataRequested             = 2
