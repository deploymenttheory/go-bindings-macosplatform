...
func (o *DRMSF) InitWithFrames(frames uint) objc.ID {
	_ret := objc.Send[objc.ID](o.Ptr(), _dRMSFSelInitWithFrames, frames)
	return _ret
}
...
func (o *DRMSF) InitWithString(string_ *foundation.NSString) objc.ID {
	_ret := objc.Send[objc.ID](o.Ptr(), _dRMSFSelInitWithString, string_.Ptr())
	return _ret
}
...
func (o *DRMSF) Minutes() uint {
	_ret := objc.Send[uint](o.Ptr(), _dRMSFSelMinutes)
	return _ret
}
...
func (o *DRMSF) Seconds() uint {
	_ret := objc.Send[uint](o.Ptr(), _dRMSFSelSeconds)
	return _ret
}
...
func (o *DRMSF) Frames() uint {
	_ret := objc.Send[uint](o.Ptr(), _dRMSFSelFrames)
	return _ret
}
...
func (o *DRMSF) Sectors() uint {
	_ret := objc.Send[uint](o.Ptr(), _dRMSFSelSectors)
	return _ret
}
