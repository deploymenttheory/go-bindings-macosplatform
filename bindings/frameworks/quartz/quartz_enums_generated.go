...
// String returns the ICReturnCodeOffset constant's name, or its numeric form when the
// value is not a known constant.
...
// String returns the IKImageBrowserDropOperation constant's name, or its numeric form when the
// value is not a known constant.
...
// String returns the QLPreviewPDFStyle constant's name, or its numeric form when the
// value is not a known constant.
