...
func NewAztecCodeDescriptorWithPayloadIsCompactLayerCountDataCodewordCount(errorCorrectedPayload []byte, isCompact bool, layerCount int, dataCodewordCount int) *AztecCodeDescriptor {
	...
	_id := objc.Send[objc.ID](_alloc, objc.RegisterName("initWithPayload:isCompact:layerCount:dataCodewordCount:"), rt.BytesToNSData(errorCorrectedPayload), isCompact, layerCount, dataCodewordCount)
...
func (acd *AztecCodeDescriptor) ErrorCorrectedPayload() []byte {
	defer runtime.KeepAlive(acd)
	_r := objc.Send[objc.ID](objref.IDOf(acd), objc.RegisterName("errorCorrectedPayload"))
...
func (acd *AztecCodeDescriptor) IsCompact() bool {
	defer runtime.KeepAlive(acd)
	_r := objc.Send[bool](objref.IDOf(acd), objc.RegisterName("isCompact"))
	return _r
}
...
func (acd *AztecCodeDescriptor) LayerCount() int {
	defer runtime.KeepAlive(acd)
	_r := objc.Send[int](objref.IDOf(acd), objc.RegisterName("layerCount"))
	return _r
}
...
func (acd *AztecCodeDescriptor) DataCodewordCount() int {
	defer runtime.KeepAlive(acd)
	_r := objc.Send[int](objref.IDOf(acd), objc.RegisterName("dataCodewordCount"))
	return _r
}
