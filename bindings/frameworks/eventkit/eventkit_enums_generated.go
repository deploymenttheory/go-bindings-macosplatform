...
// String returns the ParticipantScheduleStatus constant's name, or its numeric form when the
// value is not a known constant.
func (e ParticipantScheduleStatus) String() string {
	switch e {
	case ParticipantScheduleStatusNone:
		return "ParticipantScheduleStatusNone"
	case ParticipantScheduleStatusPending:
		return "ParticipantScheduleStatusPending"
	case ParticipantScheduleStatusSent:
		return "ParticipantScheduleStatusSent"
	case ParticipantScheduleStatusDelivered:
		return "ParticipantScheduleStatusDelivered"
	case ParticipantScheduleStatusRecipientNotRecognized:
		return "ParticipantScheduleStatusRecipientNotRecognized"
	case ParticipantScheduleStatusNoPrivileges:
		return "ParticipantScheduleStatusNoPrivileges"
	case ParticipantScheduleStatusDeliveryFailed:
		return "ParticipantScheduleStatusDeliveryFailed"
	case ParticipantScheduleStatusCannotDeliver:
		return "ParticipantScheduleStatusCannotDeliver"
	case ParticipantScheduleStatusRecipientNotAllowed:
		return "ParticipantScheduleStatusRecipientNotAllowed"
	default:
		return fmt.Sprintf("ParticipantScheduleStatus(%d)", int64(e))
	}
}
...
// String returns the ReminderPriority constant's name, or its numeric form when the
// value is not a known constant.
func (e ReminderPriority) String() string {
	switch e {
	case ReminderPriorityNone:
		return "ReminderPriorityNone"
	case ReminderPriorityHigh:
		return "ReminderPriorityHigh"
	case ReminderPriorityMedium:
		return "ReminderPriorityMedium"
	case ReminderPriorityLow:
		return "ReminderPriorityLow"
	default:
		return fmt.Sprintf("ReminderPriority(%d)", int64(e))
	}
}
