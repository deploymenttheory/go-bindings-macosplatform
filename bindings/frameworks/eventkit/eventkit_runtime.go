...
func SymbolAvailable(symbol string) bool {
	...
	return _eventkitLib != 0 && !_failedSymbols[symbol]
}

func _loadLibrary() {
	var err error
	_eventkitLib, err = purego.Dlopen("/System/Library/Frameworks/EventKit.framework/EventKit", purego.RTLD_GLOBAL|purego.RTLD_LAZY)
	if err != nil {
