...
// String returns the UNNotificationContentExtensionMediaPlayPauseButtonType constant's name, or its numeric form when the
// value is not a known constant.
...
// String returns the UNNotificationContentExtensionResponseOption constant's name, or its numeric form when the
// value is not a known constant.
