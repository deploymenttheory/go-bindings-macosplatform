...
// String returns the FrameStatus constant's name, or its numeric form when the
// value is not a known constant.
func (e FrameStatus) String() string {
	switch e {
	case FrameStatusComplete:
		return "FrameStatusComplete"
	case FrameStatusIdle:
		return "FrameStatusIdle"
	case FrameStatusBlank:
		return "FrameStatusBlank"
	case FrameStatusSuspended:
		return "FrameStatusSuspended"
	case FrameStatusStarted:
		return "FrameStatusStarted"
	case FrameStatusStopped:
		return "FrameStatusStopped"
	default:
		return fmt.Sprintf("FrameStatus(%d)", int64(e))
	}
}
...
const (
	...
	StreamErrorInsufficientStorage                    StreamErrorCode = -3822
	StreamErrorNotSupported                           StreamErrorCode = -3823
	StreamErrorMissingBackgroundMode                  StreamErrorCode = -3824
)
...
func (e StreamErrorCode) String() string {
	...
	case StreamErrorInsufficientStorage:
		return "StreamErrorInsufficientStorage"
	case StreamErrorNotSupported:
		return "StreamErrorNotSupported"
	case StreamErrorMissingBackgroundMode:
		return "StreamErrorMissingBackgroundMode"
	default:
...
// String returns the StreamOutputType constant's name, or its numeric form when the
// value is not a known constant.
func (e StreamOutputType) String() string {
	switch e {
	case StreamOutputTypeScreen:
		return "StreamOutputTypeScreen"
	case StreamOutputTypeAudio:
		return "StreamOutputTypeAudio"
	case StreamOutputTypeMicrophone:
		return "StreamOutputTypeMicrophone"
	default:
		return fmt.Sprintf("StreamOutputType(%d)", int64(e))
	}
}
