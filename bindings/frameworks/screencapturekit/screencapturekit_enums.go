...
func (e SCContentSharingPickerMode) String() string {
	var parts []string
	if e&SCContentSharingPickerModeSingleWindow != 0 { parts = append(parts, "SCContentSharingPickerModeSingleWindow") }
	if e&SCContentSharingPickerModeMultipleWindows != 0 { parts = append(parts, "SCContentSharingPickerModeMultipleWindows") }
	if e&SCContentSharingPickerModeSingleApplication != 0 { parts = append(parts, "SCContentSharingPickerModeSingleApplication") }
	if e&SCContentSharingPickerModeMultipleApplications != 0 { parts = append(parts, "SCContentSharingPickerModeMultipleApplications") }
	if e&SCContentSharingPickerModeSingleDisplay != 0 { parts = append(parts, "SCContentSharingPickerModeSingleDisplay") }
...
func (e SCFrameStatus) String() string {
	...
	default:
		return fmt.Sprintf("SCFrameStatus(%d)", int64(e))
	}
}
