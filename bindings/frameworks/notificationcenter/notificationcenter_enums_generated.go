...
const (
	...
	//
	// Deprecated: Use WidgetKit instead. Today View extensions have been deprecated.
	UpdateResultNewData UpdateResult = 0
	// The update did not result in any new data since the last update.
	//
	// Deprecated: Use WidgetKit instead. Today View extensions have been deprecated.
	UpdateResultNoData UpdateResult = 1
	// The update attempt failed.
	//
	// Deprecated: Use WidgetKit instead. Today View extensions have been deprecated.
	UpdateResultFailed UpdateResult = 2
)

// String returns the UpdateResult constant's name, or its numeric form when the
// value is not a known constant.
func (e UpdateResult) String() string {
	switch e {
	case UpdateResultNewData:
		return "UpdateResultNewData"
	case UpdateResultNoData:
		return "UpdateResultNoData"
	case UpdateResultFailed:
		return "UpdateResultFailed"
	default:
		return fmt.Sprintf("UpdateResult(%d)", int64(e))
	}
}
