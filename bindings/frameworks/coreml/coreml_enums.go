...
func (e MLModelError) String() string {
	...
	default:
		return fmt.Sprintf("MLModelError(%d)", int64(e))
	}
}
...
func (e MLUpdateProgressEvent) String() string {
	var parts []string
	if e&MLUpdateProgressEventTrainingBegin != 0 { parts = append(parts, "MLUpdateProgressEventTrainingBegin") }
	if e&MLUpdateProgressEventEpochEnd != 0 { parts = append(parts, "MLUpdateProgressEventEpochEnd") }
	if e&MLUpdateProgressEventMiniBatchEnd != 0 { parts = append(parts, "MLUpdateProgressEventMiniBatchEnd") }
