...
func (e SCNetworkConnectionPPPStatus) String() string {
	...
	default:
		return fmt.Sprintf("SCNetworkConnectionPPPStatus(%d)", int64(e))
	}
}
...
func (e SCNetworkReachabilityFlags) String() string {
	var parts []string
	if e&KSCNetworkReachabilityFlagsTransientConnection != 0 { parts = append(parts, "KSCNetworkReachabilityFlagsTransientConnection") }
	if e&KSCNetworkReachabilityFlagsReachable != 0 { parts = append(parts, "KSCNetworkReachabilityFlagsReachable") }
	if e&KSCNetworkReachabilityFlagsConnectionRequired != 0 { parts = append(parts, "KSCNetworkReachabilityFlagsConnectionRequired") }
	if e&KSCNetworkReachabilityFlagsConnectionOnTraffic != 0 { parts = append(parts, "KSCNetworkReachabilityFlagsConnectionOnTraffic") }
	if e&KSCNetworkReachabilityFlagsInterventionRequired != 0 { parts = append(parts, "KSCNetworkReachabilityFlagsInterventionRequired") }
	if e&KSCNetworkReachabilityFlagsConnectionOnDemand != 0 { parts = append(parts, "KSCNetworkReachabilityFlagsConnectionOnDemand") }
	if e&KSCNetworkReachabilityFlagsIsLocalAddress != 0 { parts = append(parts, "KSCNetworkReachabilityFlagsIsLocalAddress") }
	if e&KSCNetworkReachabilityFlagsIsDirect != 0 { parts = append(parts, "KSCNetworkReachabilityFlagsIsDirect") }
...
func (e SCPreferencesNotification) String() string {
	var parts []string
	if e&KSCPreferencesNotificationCommit != 0 { parts = append(parts, "KSCPreferencesNotificationCommit") }
	if e&KSCPreferencesNotificationApply != 0 { parts = append(parts, "KSCPreferencesNotificationApply") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
