...
func (sc *SetCommand) WithArguments(arguments map[string]obj.Object) *SetCommand {
...
func (sc *SetCommand) WithScriptingProperties(scriptingProperties map[string]obj.Object) *SetCommand {
