...
func (cc *CloseCommand) WithArguments(arguments map[string]obj.Object) *CloseCommand {
...
func (cc *CloseCommand) WithObservationInfo(observationInfo unsafe.Pointer) *CloseCommand {
	objc.Send[objc.ID](objref.IDOf(cc), objc.RegisterName("setObservationInfo:"), observationInfo)
	return cc
}

// WithScriptingProperties sets the scripting properties.
func (cc *CloseCommand) WithScriptingProperties(scriptingProperties map[string]obj.Object) *CloseCommand {
