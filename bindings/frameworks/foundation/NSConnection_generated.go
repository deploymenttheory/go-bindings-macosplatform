...
func (c *Connection) WithDelegate(delegate ConnectionDelegate) *Connection {
	_shim := newConnectionDelegateShim(delegate)
...
func (c *Connection) WithScriptingProperties(scriptingProperties map[string]obj.Object) *Connection {
