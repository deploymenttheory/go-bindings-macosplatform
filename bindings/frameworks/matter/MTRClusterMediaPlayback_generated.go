...
func NewMTRClusterMediaPlaybackWithDeviceEndpointIDQueue(device *MTRDevice, endpointID obj.Object, queue dispatch.Queue) *MTRClusterMediaPlayback {
...
func NewMTRClusterMediaPlaybackWithDeviceEndpointQueue(device *MTRDevice, endpoint uint16, queue dispatch.Queue) *MTRClusterMediaPlayback {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRClusterMediaPlayback")), objc.RegisterName("alloc"))
