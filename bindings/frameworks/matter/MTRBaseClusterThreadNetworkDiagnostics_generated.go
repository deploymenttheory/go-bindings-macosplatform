...
func NewMTRBaseClusterThreadNetworkDiagnosticsWithDeviceEndpointIDQueue(device *MTRBaseDevice, endpointID obj.Object, queue dispatch.Queue) *MTRBaseClusterThreadNetworkDiagnostics {
...
func NewMTRBaseClusterThreadNetworkDiagnosticsWithDeviceEndpointQueue(device *MTRBaseDevice, endpoint uint16, queue dispatch.Queue) *MTRBaseClusterThreadNetworkDiagnostics {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRBaseClusterThreadNetworkDiagnostics")), objc.RegisterName("alloc"))
