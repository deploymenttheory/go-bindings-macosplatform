...
func NewMTRBaseClusterDiagnosticLogsWithDeviceEndpointIDQueue(device *MTRBaseDevice, endpointID obj.Object, queue dispatch.Queue) *MTRBaseClusterDiagnosticLogs {
...
func NewMTRBaseClusterDiagnosticLogsWithDeviceEndpointQueue(device *MTRBaseDevice, endpoint uint16, queue dispatch.Queue) *MTRBaseClusterDiagnosticLogs {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRBaseClusterDiagnosticLogs")), objc.RegisterName("alloc"))
