...
func NewMTRClusterGroupKeyManagementWithDeviceEndpointIDQueue(device *MTRDevice, endpointID obj.Object, queue dispatch.Queue) *MTRClusterGroupKeyManagement {
...
func NewMTRClusterGroupKeyManagementWithDeviceEndpointQueue(device *MTRDevice, endpoint uint16, queue dispatch.Queue) *MTRClusterGroupKeyManagement {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRClusterGroupKeyManagement")), objc.RegisterName("alloc"))
