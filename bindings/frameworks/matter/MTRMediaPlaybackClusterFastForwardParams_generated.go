...
func (mmpcffp *MTRMediaPlaybackClusterFastForwardParams) Description() string {
	defer runtime.KeepAlive(mmpcffp)
...
func (mmpcffp *MTRMediaPlaybackClusterFastForwardParams) AudioAdvanceUnmuted() *foundation.Number {
	defer runtime.KeepAlive(mmpcffp)
...
func (mmpcffp *MTRMediaPlaybackClusterFastForwardParams) TimedInvokeTimeoutMs() *foundation.Number {
	defer runtime.KeepAlive(mmpcffp)
...
func (mmpcffp *MTRMediaPlaybackClusterFastForwardParams) ServerSideProcessingTimeout() *foundation.Number {
	defer runtime.KeepAlive(mmpcffp)
