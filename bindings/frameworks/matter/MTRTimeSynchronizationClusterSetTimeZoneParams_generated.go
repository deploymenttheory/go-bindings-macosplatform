...
// MTRTimeSynchronizationClusterSetTimeZoneParams is an idiomatic wrapper over the Objective-C class MTRTimeSynchronizationClusterSetTimeZoneParams.
type MTRTimeSynchronizationClusterSetTimeZoneParams struct {
	objref.Handle
}

// MTRTimeSynchronizationClusterSetTimeZoneParamsFromID adopts an existing Objective-C object as a MTRTimeSynchronizationClusterSetTimeZoneParams
...
func MTRTimeSynchronizationClusterSetTimeZoneParamsFromID(id objc.ID) *MTRTimeSynchronizationClusterSetTimeZoneParams {
	...
	x := &MTRTimeSynchronizationClusterSetTimeZoneParams{}
	x.Handle = objref.Wrap(purego.Retain(id))
	objref.Track(x)
	return x
}

// mTRTimeSynchronizationClusterSetTimeZoneParamsAdopt wraps an Objective-C object that this code just created as a
// MTRTimeSynchronizationClusterSetTimeZoneParams (nil for 0). The caller already owns the object's reference,
// so this does not add another; it only arranges for the object to be released
// once Go stops using it. Constructors use it.
func mTRTimeSynchronizationClusterSetTimeZoneParamsAdopt(id objc.ID) *MTRTimeSynchronizationClusterSetTimeZoneParams {
	if id == 0 {
		return nil
	}
	x := &MTRTimeSynchronizationClusterSetTimeZoneParams{}
...
func (mtscstzp *MTRTimeSynchronizationClusterSetTimeZoneParams) Description() string {
	defer runtime.KeepAlive(mtscstzp)
...
func NewMTRTimeSynchronizationClusterSetTimeZoneParams() *MTRTimeSynchronizationClusterSetTimeZoneParams {
	_id := objc.Send[objc.ID](objc.ID(_class("MTRTimeSynchronizationClusterSetTimeZoneParams")), objc.RegisterName("new"))
...
func (mtscstzp *MTRTimeSynchronizationClusterSetTimeZoneParams) TimedInvokeTimeoutMs() *foundation.Number {
	defer runtime.KeepAlive(mtscstzp)
...
func (mtscstzp *MTRTimeSynchronizationClusterSetTimeZoneParams) ServerSideProcessingTimeout() *foundation.Number {
	defer runtime.KeepAlive(mtscstzp)
