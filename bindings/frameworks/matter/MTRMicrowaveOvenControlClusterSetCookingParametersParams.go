...
// Apple documentation: https://developer.apple.com/documentation/matter/mtrmicrowaveovencontrolclustersetcookingparametersparams
...
func MTRMicrowaveOvenControlClusterSetCookingParametersParamsFromID(id objc.ID) *MTRMicrowaveOvenControlClusterSetCookingParametersParams {
	...
	o := &MTRMicrowaveOvenControlClusterSetCookingParametersParams{}
	o.InitPtr(id)
	pureobjc.Track(o)
	return o
}
...
func (o *MTRMicrowaveOvenControlClusterSetCookingParametersParams) SetCookMode(cookMode *foundation.NSNumber) {
	o.Ptr().Send(_mTRMicrowaveOvenControlClusterSetCookingParametersParamsSelSetCookMode, cookMode.Ptr())
}
...
func (o *MTRMicrowaveOvenControlClusterSetCookingParametersParams) SetCookTime(cookTime *foundation.NSNumber) {
	o.Ptr().Send(_mTRMicrowaveOvenControlClusterSetCookingParametersParamsSelSetCookTime, cookTime.Ptr())
}
...
func (o *MTRMicrowaveOvenControlClusterSetCookingParametersParams) SetPowerSetting(powerSetting *foundation.NSNumber) {
	o.Ptr().Send(_mTRMicrowaveOvenControlClusterSetCookingParametersParamsSelSetPowerSetting, powerSetting.Ptr())
}
...
func (o *MTRMicrowaveOvenControlClusterSetCookingParametersParams) SetStartAfterSetting(startAfterSetting *foundation.NSNumber) {
	o.Ptr().Send(_mTRMicrowaveOvenControlClusterSetCookingParametersParamsSelSetStartAfterSetting, startAfterSetting.Ptr())
}
...
func (o *MTRMicrowaveOvenControlClusterSetCookingParametersParams) SetTimedInvokeTimeoutMs(timedInvokeTimeoutMs *foundation.NSNumber) {
	o.Ptr().Send(_mTRMicrowaveOvenControlClusterSetCookingParametersParamsSelSetTimedInvokeTimeoutMs, timedInvokeTimeoutMs.Ptr())
}
