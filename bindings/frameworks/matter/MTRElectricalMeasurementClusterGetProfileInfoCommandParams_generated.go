...
func (memcgpicp *MTRElectricalMeasurementClusterGetProfileInfoCommandParams) Description() string {
	defer runtime.KeepAlive(memcgpicp)
...
func (memcgpicp *MTRElectricalMeasurementClusterGetProfileInfoCommandParams) TimedInvokeTimeoutMs() *foundation.Number {
	defer runtime.KeepAlive(memcgpicp)
...
func (memcgpicp *MTRElectricalMeasurementClusterGetProfileInfoCommandParams) ServerSideProcessingTimeout() *foundation.Number {
	defer runtime.KeepAlive(memcgpicp)
