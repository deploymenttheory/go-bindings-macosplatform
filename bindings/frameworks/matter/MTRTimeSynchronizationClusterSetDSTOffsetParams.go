...
func (o *MTRTimeSynchronizationClusterSetDSTOffsetParams) DstOffset() *foundation.NSArray[objc.ID] {
	_ret := objc.Send[*foundation.NSArray[objc.ID]](o.Ptr(), _mTRTimeSynchronizationClusterSetDSTOffsetParamsSelDstOffset)
	return _ret
}

func (o *MTRTimeSynchronizationClusterSetDSTOffsetParams) SetDstOffset(dstOffset *foundation.NSArray[objc.ID]) {
	o.Ptr().Send(_mTRTimeSynchronizationClusterSetDSTOffsetParamsSelSetDstOffset, dstOffset)
}
