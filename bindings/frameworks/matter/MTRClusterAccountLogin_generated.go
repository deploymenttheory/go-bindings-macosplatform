...
func NewMTRClusterAccountLoginWithDeviceEndpointIDQueue(device *MTRDevice, endpointID obj.Object, queue dispatch.Queue) *MTRClusterAccountLogin {
...
func NewMTRClusterAccountLoginWithDeviceEndpointQueue(device *MTRDevice, endpoint uint16, queue dispatch.Queue) *MTRClusterAccountLogin {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRClusterAccountLogin")), objc.RegisterName("alloc"))
