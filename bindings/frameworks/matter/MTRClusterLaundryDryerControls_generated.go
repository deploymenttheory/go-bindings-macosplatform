...
func NewMTRClusterLaundryDryerControlsWithDeviceEndpointIDQueue(device *MTRDevice, endpointID obj.Object, queue dispatch.Queue) *MTRClusterLaundryDryerControls {
...
func (mcldc *MTRClusterLaundryDryerControls) ReadAttributeSupportedDrynessLevelsWithParams(params *MTRReadParams) map[string]obj.Object {
	defer runtime.KeepAlive(mcldc)
...
func (mcldc *MTRClusterLaundryDryerControls) ReadAttributeSelectedDrynessLevelWithParams(params *MTRReadParams) map[string]obj.Object {
	defer runtime.KeepAlive(mcldc)
	defer runtime.KeepAlive(params)
...
func (mcldc *MTRClusterLaundryDryerControls) WriteAttributeSelectedDrynessLevelWithValueExpectedValueInterval(dataValueDictionary map[string]obj.Object, expectedValueIntervalMs obj.Object) {
	defer runtime.KeepAlive(mcldc)
	defer runtime.KeepAlive(expectedValueIntervalMs)
	objc.Send[objc.ID](objref.IDOf(mcldc), objc.RegisterName("writeAttributeSelectedDrynessLevelWithValue:expectedValueInterval:"), rt.MapToDict(dataValueDictionary, func(_k string) objc.ID { return purego.NSString(_k) }, func(_v obj.Object) objc.ID { return objref.IDOf(_v) }), objref.IDOf(expectedValueIntervalMs))
}
...
func (mcldc *MTRClusterLaundryDryerControls) WriteAttributeSelectedDrynessLevelWithValueExpectedValueIntervalParams(dataValueDictionary map[string]obj.Object, expectedValueIntervalMs obj.Object, params *MTRWriteParams) {
	defer runtime.KeepAlive(mcldc)
	defer runtime.KeepAlive(expectedValueIntervalMs)
	defer runtime.KeepAlive(params)
	objc.Send[objc.ID](objref.IDOf(mcldc), objc.RegisterName("writeAttributeSelectedDrynessLevelWithValue:expectedValueInterval:params:"), rt.MapToDict(dataValueDictionary, func(_k string) objc.ID { return purego.NSString(_k) }, func(_v obj.Object) objc.ID { return objref.IDOf(_v) }), objref.IDOf(expectedValueIntervalMs), objref.IDOf(params))
}

// ReadAttributeGeneratedCommandListWithParams reads attribute generated command list with params.
func (mcldc *MTRClusterLaundryDryerControls) ReadAttributeGeneratedCommandListWithParams(params *MTRReadParams) map[string]obj.Object {
	defer runtime.KeepAlive(mcldc)
	defer runtime.KeepAlive(params)
...
func (mcldc *MTRClusterLaundryDryerControls) ReadAttributeAcceptedCommandListWithParams(params *MTRReadParams) map[string]obj.Object {
	defer runtime.KeepAlive(mcldc)
	defer runtime.KeepAlive(params)
...
func (mcldc *MTRClusterLaundryDryerControls) ReadAttributeAttributeListWithParams(params *MTRReadParams) map[string]obj.Object {
	defer runtime.KeepAlive(mcldc)
	defer runtime.KeepAlive(params)
...
func (mcldc *MTRClusterLaundryDryerControls) ReadAttributeFeatureMapWithParams(params *MTRReadParams) map[string]obj.Object {
	defer runtime.KeepAlive(mcldc)
	defer runtime.KeepAlive(params)
...
func (mcldc *MTRClusterLaundryDryerControls) ReadAttributeClusterRevisionWithParams(params *MTRReadParams) map[string]obj.Object {
	defer runtime.KeepAlive(mcldc)
	defer runtime.KeepAlive(params)
