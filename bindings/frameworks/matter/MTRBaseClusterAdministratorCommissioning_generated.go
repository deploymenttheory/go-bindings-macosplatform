...
func NewMTRBaseClusterAdministratorCommissioningWithDeviceEndpointIDQueue(device *MTRBaseDevice, endpointID obj.Object, queue dispatch.Queue) *MTRBaseClusterAdministratorCommissioning {
...
func NewMTRBaseClusterAdministratorCommissioningWithDeviceEndpointQueue(device *MTRBaseDevice, endpoint uint16, queue dispatch.Queue) *MTRBaseClusterAdministratorCommissioning {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRBaseClusterAdministratorCommissioning")), objc.RegisterName("alloc"))
