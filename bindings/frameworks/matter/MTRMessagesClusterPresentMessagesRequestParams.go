...
func (o *MTRMessagesClusterPresentMessagesRequestParams) Responses() *foundation.NSArray[objc.ID] {
	_ret := objc.Send[objc.ID](o.Ptr(), _mTRMessagesClusterPresentMessagesRequestParamsSelResponses)
	if _ret != 0 {
		_ret.Send(objc.RegisterName("retain"))
	}
...
func (o *MTRMessagesClusterPresentMessagesRequestParams) SetResponses(responses *foundation.NSArray[objc.ID]) {
	o.Ptr().Send(_mTRMessagesClusterPresentMessagesRequestParamsSelSetResponses, responses.Ptr())
}
