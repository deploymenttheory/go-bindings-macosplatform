...
// Apple documentation: https://developer.apple.com/documentation/matter/mtrwaterheatermanagementclusterboostparams
...
func MTRWaterHeaterManagementClusterBoostParamsFromID(id objc.ID) *MTRWaterHeaterManagementClusterBoostParams {
	...
	o := &MTRWaterHeaterManagementClusterBoostParams{}
	o.InitPtr(id)
	purego.Track(o)
	return o
}
...
func (o *MTRWaterHeaterManagementClusterBoostParams) SetBoostInfo(boostInfo *MTRWaterHeaterManagementClusterWaterHeaterBoostInfoStruct) {
	o.Ptr().Send(_mTRWaterHeaterManagementClusterBoostParamsSelSetBoostInfo, boostInfo.Ptr())
}
...
func (o *MTRWaterHeaterManagementClusterBoostParams) SetTimedInvokeTimeoutMs(timedInvokeTimeoutMs *foundation.NSNumber) {
	o.Ptr().Send(_mTRWaterHeaterManagementClusterBoostParamsSelSetTimedInvokeTimeoutMs, timedInvokeTimeoutMs.Ptr())
}
