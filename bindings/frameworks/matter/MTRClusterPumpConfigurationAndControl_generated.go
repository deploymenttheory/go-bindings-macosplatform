...
func NewMTRClusterPumpConfigurationAndControlWithDeviceEndpointIDQueue(device *MTRDevice, endpointID obj.Object, queue dispatch.Queue) *MTRClusterPumpConfigurationAndControl {
...
func NewMTRClusterPumpConfigurationAndControlWithDeviceEndpointQueue(device *MTRDevice, endpoint uint16, queue dispatch.Queue) *MTRClusterPumpConfigurationAndControl {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRClusterPumpConfigurationAndControl")), objc.RegisterName("alloc"))
