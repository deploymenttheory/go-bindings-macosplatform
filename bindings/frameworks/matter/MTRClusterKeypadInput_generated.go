...
func NewMTRClusterKeypadInputWithDeviceEndpointIDQueue(device *MTRDevice, endpointID obj.Object, queue dispatch.Queue) *MTRClusterKeypadInput {
...
func NewMTRClusterKeypadInputWithDeviceEndpointQueue(device *MTRDevice, endpoint uint16, queue dispatch.Queue) *MTRClusterKeypadInput {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRClusterKeypadInput")), objc.RegisterName("alloc"))
