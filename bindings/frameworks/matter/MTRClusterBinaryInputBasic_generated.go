...
func NewMTRClusterBinaryInputBasicWithDeviceEndpointIDQueue(device *MTRDevice, endpointID obj.Object, queue dispatch.Queue) *MTRClusterBinaryInputBasic {
...
func NewMTRClusterBinaryInputBasicWithDeviceEndpointQueue(device *MTRDevice, endpoint uint16, queue dispatch.Queue) *MTRClusterBinaryInputBasic {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRClusterBinaryInputBasic")), objc.RegisterName("alloc"))
