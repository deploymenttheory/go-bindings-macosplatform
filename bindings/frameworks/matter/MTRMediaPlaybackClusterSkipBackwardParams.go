...
// Apple documentation: https://developer.apple.com/documentation/matter/mtrmediaplaybackclusterskipbackwardparams
...
func MTRMediaPlaybackClusterSkipBackwardParamsFromID(id objc.ID) *MTRMediaPlaybackClusterSkipBackwardParams {
	...
	o := &MTRMediaPlaybackClusterSkipBackwardParams{}
	o.InitPtr(id)
	purego.Track(o)
	return o
}
...
func (o *MTRMediaPlaybackClusterSkipBackwardParams) SetDeltaPositionMilliseconds(deltaPositionMilliseconds *foundation.NSNumber) {
	o.Ptr().Send(_mTRMediaPlaybackClusterSkipBackwardParamsSelSetDeltaPositionMilliseconds, deltaPositionMilliseconds.Ptr())
}
...
func (o *MTRMediaPlaybackClusterSkipBackwardParams) SetTimedInvokeTimeoutMs(timedInvokeTimeoutMs *foundation.NSNumber) {
	o.Ptr().Send(_mTRMediaPlaybackClusterSkipBackwardParamsSelSetTimedInvokeTimeoutMs, timedInvokeTimeoutMs.Ptr())
}
