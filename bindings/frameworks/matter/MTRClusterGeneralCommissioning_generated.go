...
func NewMTRClusterGeneralCommissioningWithDeviceEndpointIDQueue(device *MTRDevice, endpointID obj.Object, queue dispatch.Queue) *MTRClusterGeneralCommissioning {
...
func NewMTRClusterGeneralCommissioningWithDeviceEndpointQueue(device *MTRDevice, endpoint uint16, queue dispatch.Queue) *MTRClusterGeneralCommissioning {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRClusterGeneralCommissioning")), objc.RegisterName("alloc"))
