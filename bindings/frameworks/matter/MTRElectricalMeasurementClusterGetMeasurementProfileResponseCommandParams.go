...
func (o *MTRElectricalMeasurementClusterGetMeasurementProfileResponseCommandParams) Intervals() *foundation.NSArray[objc.ID] {
	_ret := objc.Send[*foundation.NSArray[objc.ID]](o.Ptr(), _mTRElectricalMeasurementClusterGetMeasurementProfileResponseCommandParamsSelIntervals)
	return _ret
}
...
func (o *MTRElectricalMeasurementClusterGetMeasurementProfileResponseCommandParams) SetIntervals(intervals *foundation.NSArray[objc.ID]) {
	o.Ptr().Send(_mTRElectricalMeasurementClusterGetMeasurementProfileResponseCommandParamsSelSetIntervals, intervals)
}
