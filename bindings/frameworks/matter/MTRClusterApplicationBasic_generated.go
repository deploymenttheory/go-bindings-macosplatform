...
func NewMTRClusterApplicationBasicWithDeviceEndpointIDQueue(device *MTRDevice, endpointID obj.Object, queue dispatch.Queue) *MTRClusterApplicationBasic {
...
func NewMTRClusterApplicationBasicWithDeviceEndpointQueue(device *MTRDevice, endpoint uint16, queue dispatch.Queue) *MTRClusterApplicationBasic {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRClusterApplicationBasic")), objc.RegisterName("alloc"))
