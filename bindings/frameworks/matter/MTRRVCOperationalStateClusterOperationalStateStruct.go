...
// Apple documentation: https://developer.apple.com/documentation/matter/mtrrvcoperationalstateclusteroperationalstatestruct
...
func MTRRVCOperationalStateClusterOperationalStateStructFromID(id objc.ID) *MTRRVCOperationalStateClusterOperationalStateStruct {
	...
	o := &MTRRVCOperationalStateClusterOperationalStateStruct{}
	o.InitPtr(id)
	pureobjc.Track(o)
	return o
}
...
func (o *MTRRVCOperationalStateClusterOperationalStateStruct) SetOperationalStateID(operationalStateID *foundation.NSNumber) {
	o.Ptr().Send(_mTRRVCOperationalStateClusterOperationalStateStructSelSetOperationalStateID, operationalStateID.Ptr())
}
