...
func NewMTRBaseClusterRadonConcentrationMeasurementWithDeviceEndpointIDQueue(device *MTRBaseDevice, endpointID obj.Object, queue dispatch.Queue) *MTRBaseClusterRadonConcentrationMeasurement {
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) ReadAttributeMeasuredValueWithCompletion(ctx context.Context) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("readAttributeMeasuredValueWithCompletion:"), _block)
	select {
	case _o := <-_ch:
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) SubscribeAttributeMeasuredValueWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("subscribeAttributeMeasuredValueWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) ReadAttributeMinMeasuredValueWithCompletion(ctx context.Context) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("readAttributeMinMeasuredValueWithCompletion:"), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) SubscribeAttributeMinMeasuredValueWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("subscribeAttributeMinMeasuredValueWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) ReadAttributeMaxMeasuredValueWithCompletion(ctx context.Context) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("readAttributeMaxMeasuredValueWithCompletion:"), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) SubscribeAttributeMaxMeasuredValueWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("subscribeAttributeMaxMeasuredValueWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) ReadAttributePeakMeasuredValueWithCompletion(ctx context.Context) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("readAttributePeakMeasuredValueWithCompletion:"), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) SubscribeAttributePeakMeasuredValueWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("subscribeAttributePeakMeasuredValueWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) ReadAttributePeakMeasuredValueWindowWithCompletion(ctx context.Context) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("readAttributePeakMeasuredValueWindowWithCompletion:"), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) SubscribeAttributePeakMeasuredValueWindowWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("subscribeAttributePeakMeasuredValueWindowWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) ReadAttributeAverageMeasuredValueWithCompletion(ctx context.Context) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("readAttributeAverageMeasuredValueWithCompletion:"), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) SubscribeAttributeAverageMeasuredValueWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("subscribeAttributeAverageMeasuredValueWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) ReadAttributeAverageMeasuredValueWindowWithCompletion(ctx context.Context) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("readAttributeAverageMeasuredValueWindowWithCompletion:"), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) SubscribeAttributeAverageMeasuredValueWindowWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("subscribeAttributeAverageMeasuredValueWindowWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) ReadAttributeUncertaintyWithCompletion(ctx context.Context) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("readAttributeUncertaintyWithCompletion:"), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) SubscribeAttributeUncertaintyWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("subscribeAttributeUncertaintyWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) ReadAttributeMeasurementUnitWithCompletion(ctx context.Context) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("readAttributeMeasurementUnitWithCompletion:"), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) SubscribeAttributeMeasurementUnitWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("subscribeAttributeMeasurementUnitWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) ReadAttributeMeasurementMediumWithCompletion(ctx context.Context) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("readAttributeMeasurementMediumWithCompletion:"), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) SubscribeAttributeMeasurementMediumWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("subscribeAttributeMeasurementMediumWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) ReadAttributeLevelValueWithCompletion(ctx context.Context) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("readAttributeLevelValueWithCompletion:"), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcrcm *MTRBaseClusterRadonConcentrationMeasurement) SubscribeAttributeLevelValueWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcrcm), objc.RegisterName("subscribeAttributeLevelValueWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
