...
func NewMTRBaseClusterThermostatUserInterfaceConfigurationWithDeviceEndpointIDQueue(device *MTRBaseDevice, endpointID obj.Object, queue dispatch.Queue) *MTRBaseClusterThermostatUserInterfaceConfiguration {
...
func NewMTRBaseClusterThermostatUserInterfaceConfigurationWithDeviceEndpointQueue(device *MTRBaseDevice, endpoint uint16, queue dispatch.Queue) *MTRBaseClusterThermostatUserInterfaceConfiguration {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRBaseClusterThermostatUserInterfaceConfiguration")), objc.RegisterName("alloc"))
