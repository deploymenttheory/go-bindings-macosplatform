...
func MTRGeneralCommissioningClusterArmFailSafeParamsFromID(id objc.ID) *MTRGeneralCommissioningClusterArmFailSafeParams {
	...
	x := &MTRGeneralCommissioningClusterArmFailSafeParams{}
...
func (mgccafsp *MTRGeneralCommissioningClusterArmFailSafeParams) Description() string {
	defer runtime.KeepAlive(mgccafsp)
...
func (mgccafsp *MTRGeneralCommissioningClusterArmFailSafeParams) WithExpiryLengthSeconds(expiryLengthSeconds obj.Object) *MTRGeneralCommissioningClusterArmFailSafeParams {
	defer runtime.KeepAlive(expiryLengthSeconds)
...
func (mgccafsp *MTRGeneralCommissioningClusterArmFailSafeParams) ExpiryLengthSeconds() *foundation.Number {
	defer runtime.KeepAlive(mgccafsp)
...
func (mgccafsp *MTRGeneralCommissioningClusterArmFailSafeParams) Breadcrumb() *foundation.Number {
	defer runtime.KeepAlive(mgccafsp)
...
func (mgccafsp *MTRGeneralCommissioningClusterArmFailSafeParams) TimedInvokeTimeoutMs() *foundation.Number {
	defer runtime.KeepAlive(mgccafsp)
...
func (mgccafsp *MTRGeneralCommissioningClusterArmFailSafeParams) ServerSideProcessingTimeout() *foundation.Number {
	defer runtime.KeepAlive(mgccafsp)
