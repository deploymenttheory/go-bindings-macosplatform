...
func (mgcagp *MTRGroupsClusterAddGroupParams) WithGroupName(groupName string) *MTRGroupsClusterAddGroupParams {
	objc.Send[objc.ID](objref.IDOf(mgcagp), objc.RegisterName("setGroupName:"), purego.NSString(groupName))
	return mgcagp
}
