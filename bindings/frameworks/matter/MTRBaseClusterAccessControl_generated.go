...
func NewMTRBaseClusterAccessControlWithDeviceEndpointIDQueue(device *MTRBaseDevice, endpointID obj.Object, queue dispatch.Queue) *MTRBaseClusterAccessControl {
...
func NewMTRBaseClusterAccessControlWithDeviceEndpointQueue(device *MTRBaseDevice, endpoint uint16, queue dispatch.Queue) *MTRBaseClusterAccessControl {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRBaseClusterAccessControl")), objc.RegisterName("alloc"))
