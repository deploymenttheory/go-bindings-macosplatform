...
func (o *MTRNetworkCommissioningClusterScanNetworksResponseParams) InitWithResponseValueError(responseValue *foundation.NSDictionary[*foundation.NSString, objc.ID]) (*MTRNetworkCommissioningClusterScanNetworksResponseParams, error) {
	var _nsErr uintptr
	_ret := objc.Send[objc.ID](o.Ptr(), _mTRNetworkCommissioningClusterScanNetworksResponseParamsSelInitWithResponseValueError, responseValue.Ptr(), unsafe.Pointer(&_nsErr))
	if _ret != 0 {
...
func (o *MTRNetworkCommissioningClusterScanNetworksResponseParams) WiFiScanResults() *foundation.NSArray[objc.ID] {
	_ret := objc.Send[objc.ID](o.Ptr(), _mTRNetworkCommissioningClusterScanNetworksResponseParamsSelWiFiScanResults)
	if _ret != 0 {
		_ret.Send(objc.RegisterName("retain"))
	}
...
func (o *MTRNetworkCommissioningClusterScanNetworksResponseParams) SetWiFiScanResults(wiFiScanResults *foundation.NSArray[objc.ID]) {
	o.Ptr().Send(_mTRNetworkCommissioningClusterScanNetworksResponseParamsSelSetWiFiScanResults, wiFiScanResults.Ptr())
}

func (o *MTRNetworkCommissioningClusterScanNetworksResponseParams) ThreadScanResults() *foundation.NSArray[objc.ID] {
	_ret := objc.Send[objc.ID](o.Ptr(), _mTRNetworkCommissioningClusterScanNetworksResponseParamsSelThreadScanResults)
	if _ret != 0 {
		_ret.Send(objc.RegisterName("retain"))
	}
	return foundation.NSArrayFromID[objc.ID](_ret)
...
func (o *MTRNetworkCommissioningClusterScanNetworksResponseParams) SetThreadScanResults(threadScanResults *foundation.NSArray[objc.ID]) {
	o.Ptr().Send(_mTRNetworkCommissioningClusterScanNetworksResponseParamsSelSetThreadScanResults, threadScanResults.Ptr())
}
