...
func NewMTRBaseClusterUnitLocalizationWithDeviceEndpointIDQueue(device *MTRBaseDevice, endpointID obj.Object, queue dispatch.Queue) *MTRBaseClusterUnitLocalization {
...
func NewMTRBaseClusterUnitLocalizationWithDeviceEndpointQueue(device *MTRBaseDevice, endpoint uint16, queue dispatch.Queue) *MTRBaseClusterUnitLocalization {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRBaseClusterUnitLocalization")), objc.RegisterName("alloc"))
