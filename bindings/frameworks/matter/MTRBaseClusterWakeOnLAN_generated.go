...
func NewMTRBaseClusterWakeOnLANWithDeviceEndpointIDQueue(device *MTRBaseDevice, endpointID obj.Object, queue dispatch.Queue) *MTRBaseClusterWakeOnLAN {
...
func (mbcwol *MTRBaseClusterWakeOnLAN) SubscribeAttributeMACAddressWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result string, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcwol), objc.RegisterName("subscribeAttributeMACAddressWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcwol *MTRBaseClusterWakeOnLAN) SubscribeAttributeLinkLocalAddressWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcwol), objc.RegisterName("subscribeAttributeLinkLocalAddressWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcwol *MTRBaseClusterWakeOnLAN) SubscribeAttributeGeneratedCommandListWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcwol), objc.RegisterName("subscribeAttributeGeneratedCommandListWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcwol *MTRBaseClusterWakeOnLAN) SubscribeAttributeAcceptedCommandListWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcwol), objc.RegisterName("subscribeAttributeAcceptedCommandListWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcwol *MTRBaseClusterWakeOnLAN) SubscribeAttributeAttributeListWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcwol), objc.RegisterName("subscribeAttributeAttributeListWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcwol *MTRBaseClusterWakeOnLAN) SubscribeAttributeFeatureMapWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcwol), objc.RegisterName("subscribeAttributeFeatureMapWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
...
func (mbcwol *MTRBaseClusterWakeOnLAN) SubscribeAttributeClusterRevisionWithParamsSubscriptionEstablishedReportHandler(ctx context.Context, params *MTRSubscribeParams, subscriptionEstablished func()) (result obj.Object, err error) {
	...
	objc.Send[objc.ID](objref.IDOf(mbcwol), objc.RegisterName("subscribeAttributeClusterRevisionWithParams:subscriptionEstablished:reportHandler:"), objref.IDOf(params), objc.NewBlock(func(_ objc.Block) { subscriptionEstablished() }), _block)
	select {
	case _o := <-_ch:
		return _o.val, _o.err
	case <-ctx.Done():
