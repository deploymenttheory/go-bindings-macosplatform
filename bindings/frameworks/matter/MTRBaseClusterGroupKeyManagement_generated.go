...
func NewMTRBaseClusterGroupKeyManagementWithDeviceEndpointIDQueue(device *MTRBaseDevice, endpointID obj.Object, queue dispatch.Queue) *MTRBaseClusterGroupKeyManagement {
...
func NewMTRBaseClusterGroupKeyManagementWithDeviceEndpointQueue(device *MTRBaseDevice, endpoint uint16, queue dispatch.Queue) *MTRBaseClusterGroupKeyManagement {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRBaseClusterGroupKeyManagement")), objc.RegisterName("alloc"))
