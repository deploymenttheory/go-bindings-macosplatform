...
func NewMTRBaseClusterWiFiNetworkDiagnosticsWithDeviceEndpointIDQueue(device *MTRBaseDevice, endpointID obj.Object, queue dispatch.Queue) *MTRBaseClusterWiFiNetworkDiagnostics {
...
func NewMTRBaseClusterWiFiNetworkDiagnosticsWithDeviceEndpointQueue(device *MTRBaseDevice, endpoint uint16, queue dispatch.Queue) *MTRBaseClusterWiFiNetworkDiagnostics {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRBaseClusterWiFiNetworkDiagnostics")), objc.RegisterName("alloc"))
