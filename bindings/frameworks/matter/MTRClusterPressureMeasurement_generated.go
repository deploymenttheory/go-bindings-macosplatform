...
func NewMTRClusterPressureMeasurementWithDeviceEndpointIDQueue(device *MTRDevice, endpointID obj.Object, queue dispatch.Queue) *MTRClusterPressureMeasurement {
...
func NewMTRClusterPressureMeasurementWithDeviceEndpointQueue(device *MTRDevice, endpoint uint16, queue dispatch.Queue) *MTRClusterPressureMeasurement {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRClusterPressureMeasurement")), objc.RegisterName("alloc"))
