...
func (mmpcpp *MTRMediaPlaybackClusterPreviousParams) TimedInvokeTimeoutMs() *foundation.Number {
	defer runtime.KeepAlive(mmpcpp)
...
func (mmpcpp *MTRMediaPlaybackClusterPreviousParams) ServerSideProcessingTimeout() *foundation.Number {
	defer runtime.KeepAlive(mmpcpp)
