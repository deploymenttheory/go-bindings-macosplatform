...
func NewMTRClusterEthernetNetworkDiagnosticsWithDeviceEndpointIDQueue(device *MTRDevice, endpointID obj.Object, queue dispatch.Queue) *MTRClusterEthernetNetworkDiagnostics {
...
func NewMTRClusterEthernetNetworkDiagnosticsWithDeviceEndpointQueue(device *MTRDevice, endpoint uint16, queue dispatch.Queue) *MTRClusterEthernetNetworkDiagnostics {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRClusterEthernetNetworkDiagnostics")), objc.RegisterName("alloc"))
