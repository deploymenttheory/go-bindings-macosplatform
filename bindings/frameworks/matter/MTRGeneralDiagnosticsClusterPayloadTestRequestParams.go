...
// Apple documentation: https://developer.apple.com/documentation/matter/mtrgeneraldiagnosticsclusterpayloadtestrequestparams
...
func MTRGeneralDiagnosticsClusterPayloadTestRequestParamsFromID(id objc.ID) *MTRGeneralDiagnosticsClusterPayloadTestRequestParams {
	...
	o := &MTRGeneralDiagnosticsClusterPayloadTestRequestParams{}
	o.InitPtr(id)
	pureobjc.Track(o)
	return o
}
...
func (o *MTRGeneralDiagnosticsClusterPayloadTestRequestParams) SetEnableKey(enableKey *foundation.NSData) {
	o.Ptr().Send(_mTRGeneralDiagnosticsClusterPayloadTestRequestParamsSelSetEnableKey, enableKey.Ptr())
}
...
func (o *MTRGeneralDiagnosticsClusterPayloadTestRequestParams) SetValue(value *foundation.NSNumber) {
	o.Ptr().Send(_mTRGeneralDiagnosticsClusterPayloadTestRequestParamsSelSetValue, value.Ptr())
}
...
func (o *MTRGeneralDiagnosticsClusterPayloadTestRequestParams) SetCount(count *foundation.NSNumber) {
	o.Ptr().Send(_mTRGeneralDiagnosticsClusterPayloadTestRequestParamsSelSetCount, count.Ptr())
}
...
func (o *MTRGeneralDiagnosticsClusterPayloadTestRequestParams) SetTimedInvokeTimeoutMs(timedInvokeTimeoutMs *foundation.NSNumber) {
	o.Ptr().Send(_mTRGeneralDiagnosticsClusterPayloadTestRequestParamsSelSetTimedInvokeTimeoutMs, timedInvokeTimeoutMs.Ptr())
}
