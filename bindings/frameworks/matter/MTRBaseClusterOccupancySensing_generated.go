...
func NewMTRBaseClusterOccupancySensingWithDeviceEndpointIDQueue(device *MTRBaseDevice, endpointID obj.Object, queue dispatch.Queue) *MTRBaseClusterOccupancySensing {
...
func NewMTRBaseClusterOccupancySensingWithDeviceEndpointQueue(device *MTRBaseDevice, endpoint uint16, queue dispatch.Queue) *MTRBaseClusterOccupancySensing {
	defer runtime.KeepAlive(device)
	_alloc := objc.Send[objc.ID](objc.ID(_class("MTRBaseClusterOccupancySensing")), objc.RegisterName("alloc"))
