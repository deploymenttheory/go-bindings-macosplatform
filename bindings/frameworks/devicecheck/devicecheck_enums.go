...
const (
	...
	// An error caused by a failed attempt to use the App Attest key. You receive this error if something goes wrong with generating, retrieving, or using an App Attest cryptographic key, when: - You call ``DeviceCheck/DCAppAttestService/attestKey:clientDataHash:completionHandler:`` for a key that’s already been attested. - You call ``DeviceCheck/DCAppAttestService/generateAssertion:clientDataHash:completionHandler:`` with an unattested key. - The App Attest service rejects the key.
