...
func (e EAWiFiUnconfiguredAccessoryProperties) String() string {
	var parts []string
	if e&EAWiFiUnconfiguredAccessoryPropertySupportsAirPlay != 0 {
		parts = append(parts, "EAWiFiUnconfiguredAccessoryPropertySupportsAirPlay")
	}
	if e&EAWiFiUnconfiguredAccessoryPropertySupportsAirPrint != 0 {
		parts = append(parts, "EAWiFiUnconfiguredAccessoryPropertySupportsAirPrint")
	}
	if e&EAWiFiUnconfiguredAccessoryPropertySupportsHomeKit != 0 {
		parts = append(parts, "EAWiFiUnconfiguredAccessoryPropertySupportsHomeKit")
	}
	if len(parts) == 0 {
		return "0"
	}
