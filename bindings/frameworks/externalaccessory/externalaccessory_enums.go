...
func (e EAWiFiUnconfiguredAccessoryBrowserState) String() string {
	switch e {
	case EAWiFiUnconfiguredAccessoryBrowserStateWiFiUnavailable:
		return "EAWiFiUnconfiguredAccessoryBrowserStateWiFiUnavailable"
	case EAWiFiUnconfiguredAccessoryBrowserStateStopped:
		return "EAWiFiUnconfiguredAccessoryBrowserStateStopped"
	case EAWiFiUnconfiguredAccessoryBrowserStateSearching:
		return "EAWiFiUnconfiguredAccessoryBrowserStateSearching"
	case EAWiFiUnconfiguredAccessoryBrowserStateConfiguring:
		return "EAWiFiUnconfiguredAccessoryBrowserStateConfiguring"
	default:
		return fmt.Sprintf("EAWiFiUnconfiguredAccessoryBrowserState(%d)", int64(e))
	}
}
...
func (e EAWiFiUnconfiguredAccessoryConfigurationStatus) String() string {
	switch e {
	case EAWiFiUnconfiguredAccessoryConfigurationStatusSuccess:
		return "EAWiFiUnconfiguredAccessoryConfigurationStatusSuccess"
	case EAWiFiUnconfiguredAccessoryConfigurationStatusUserCancelledConfiguration:
		return "EAWiFiUnconfiguredAccessoryConfigurationStatusUserCancelledConfiguration"
	case EAWiFiUnconfiguredAccessoryConfigurationStatusFailed:
		return "EAWiFiUnconfiguredAccessoryConfigurationStatusFailed"
	default:
		return fmt.Sprintf("EAWiFiUnconfiguredAccessoryConfigurationStatus(%d)", int64(e))
	}
}
...
func (e EAWiFiUnconfiguredAccessoryProperties) String() string {
	var parts []string
	if e&EAWiFiUnconfiguredAccessoryPropertySupportsAirPlay != 0 { parts = append(parts, "EAWiFiUnconfiguredAccessoryPropertySupportsAirPlay") }
	if e&EAWiFiUnconfiguredAccessoryPropertySupportsAirPrint != 0 { parts = append(parts, "EAWiFiUnconfiguredAccessoryPropertySupportsAirPrint") }
	if e&EAWiFiUnconfiguredAccessoryPropertySupportsHomeKit != 0 { parts = append(parts, "EAWiFiUnconfiguredAccessoryPropertySupportsHomeKit") }
