...
const (
	...
	WiFiUnconfiguredAccessoryBrowserStateWiFiUnavailable WiFiUnconfiguredAccessoryBrowserState = 0
	// The browser is not actively searching for unconfigured accessories.
	WiFiUnconfiguredAccessoryBrowserStateStopped WiFiUnconfiguredAccessoryBrowserState = 1
	// The browser is actively searching for unconfigured accessory.
	WiFiUnconfiguredAccessoryBrowserStateSearching WiFiUnconfiguredAccessoryBrowserState = 2
	// The browser is actively configuring an accessory.
	WiFiUnconfiguredAccessoryBrowserStateConfiguring WiFiUnconfiguredAccessoryBrowserState = 3
)

// String returns the WiFiUnconfiguredAccessoryBrowserState constant's name, or its numeric form when the
// value is not a known constant.
func (e WiFiUnconfiguredAccessoryBrowserState) String() string {
	switch e {
	case WiFiUnconfiguredAccessoryBrowserStateWiFiUnavailable:
		return "WiFiUnconfiguredAccessoryBrowserStateWiFiUnavailable"
	case WiFiUnconfiguredAccessoryBrowserStateStopped:
		return "WiFiUnconfiguredAccessoryBrowserStateStopped"
	case WiFiUnconfiguredAccessoryBrowserStateSearching:
		return "WiFiUnconfiguredAccessoryBrowserStateSearching"
	case WiFiUnconfiguredAccessoryBrowserStateConfiguring:
		return "WiFiUnconfiguredAccessoryBrowserStateConfiguring"
	default:
		return fmt.Sprintf("WiFiUnconfiguredAccessoryBrowserState(%d)", int64(e))
	}
}
...
const (
	...
	WiFiUnconfiguredAccessoryConfigurationStatusSuccess WiFiUnconfiguredAccessoryConfigurationStatus = 0
	// The user cancelled the configuration process.
	WiFiUnconfiguredAccessoryConfigurationStatusUserCancelledConfiguration WiFiUnconfiguredAccessoryConfigurationStatus = 1
	// The configuration failed.
	WiFiUnconfiguredAccessoryConfigurationStatusFailed WiFiUnconfiguredAccessoryConfigurationStatus = 2
)

// String returns the WiFiUnconfiguredAccessoryConfigurationStatus constant's name, or its numeric form when the
// value is not a known constant.
func (e WiFiUnconfiguredAccessoryConfigurationStatus) String() string {
	switch e {
	case WiFiUnconfiguredAccessoryConfigurationStatusSuccess:
		return "WiFiUnconfiguredAccessoryConfigurationStatusSuccess"
	case WiFiUnconfiguredAccessoryConfigurationStatusUserCancelledConfiguration:
		return "WiFiUnconfiguredAccessoryConfigurationStatusUserCancelledConfiguration"
	case WiFiUnconfiguredAccessoryConfigurationStatusFailed:
		return "WiFiUnconfiguredAccessoryConfigurationStatusFailed"
	default:
		return fmt.Sprintf("WiFiUnconfiguredAccessoryConfigurationStatus(%d)", int64(e))
	}
}
...
const (
	...
	WiFiUnconfiguredAccessoryPropertySupportsAirPlay WiFiUnconfiguredAccessoryProperties = 1
	// The accessory indicates that it supports AirPrint.
	WiFiUnconfiguredAccessoryPropertySupportsAirPrint WiFiUnconfiguredAccessoryProperties = 2
	// The accessory indicates that it supports HomeKit.
	WiFiUnconfiguredAccessoryPropertySupportsHomeKit WiFiUnconfiguredAccessoryProperties = 4
)

// String returns the WiFiUnconfiguredAccessoryProperties constant's name, or its numeric form when the
// value is not a known constant.
func (e WiFiUnconfiguredAccessoryProperties) String() string {
	var parts []string
	if e&WiFiUnconfiguredAccessoryPropertySupportsAirPlay != 0 {
		parts = append(parts, "WiFiUnconfiguredAccessoryPropertySupportsAirPlay")
	}
	if e&WiFiUnconfiguredAccessoryPropertySupportsAirPrint != 0 {
		parts = append(parts, "WiFiUnconfiguredAccessoryPropertySupportsAirPrint")
	}
	if e&WiFiUnconfiguredAccessoryPropertySupportsHomeKit != 0 {
		parts = append(parts, "WiFiUnconfiguredAccessoryPropertySupportsHomeKit")
	}
	if len(parts) == 0 {
		return "0"
	}
