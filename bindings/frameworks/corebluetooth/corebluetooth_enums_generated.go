...
const (
	// The manager’s state is unknown.
	CentralManagerStateUnknown CentralManagerState = 0
	// A state that indicates the connection with the system service was momentarily lost.
	CentralManagerStateResetting CentralManagerState = 1
	// A state that indicates this device doesn’t support the Bluetooth low energy central or client role.
	CentralManagerStateUnsupported CentralManagerState = 2
	// A state that indicates the application isn’t authorized to use the Bluetooth low energy role.
	CentralManagerStateUnauthorized CentralManagerState = 3
	// A state that indicates Bluetooth is currently powered off.
	CentralManagerStatePoweredOff CentralManagerState = 4
	// A state that indicates Bluetooth is currently powered on and available to use.
	CentralManagerStatePoweredOn CentralManagerState = 5
)

// String returns the CentralManagerState constant's name, or its numeric form when the
// value is not a known constant.
func (e CentralManagerState) String() string {
	switch e {
	case CentralManagerStateUnknown:
		return "CentralManagerStateUnknown"
	case CentralManagerStateResetting:
		return "CentralManagerStateResetting"
	case CentralManagerStateUnsupported:
		return "CentralManagerStateUnsupported"
	case CentralManagerStateUnauthorized:
		return "CentralManagerStateUnauthorized"
	case CentralManagerStatePoweredOff:
		return "CentralManagerStatePoweredOff"
	case CentralManagerStatePoweredOn:
		return "CentralManagerStatePoweredOn"
	default:
		return fmt.Sprintf("CentralManagerState(%d)", int64(e))
	}
}
...
const (
	...
	ConnectionEventPeerDisconnected ConnectionEvent = 0
	// The peer has connected to the local device.
	ConnectionEventPeerConnected ConnectionEvent = 1
)

// String returns the ConnectionEvent constant's name, or its numeric form when the
// value is not a known constant.
func (e ConnectionEvent) String() string {
	switch e {
	case ConnectionEventPeerDisconnected:
		return "ConnectionEventPeerDisconnected"
	case ConnectionEventPeerConnected:
		return "ConnectionEventPeerConnected"
	default:
		return fmt.Sprintf("ConnectionEvent(%d)", int64(e))
	}
}
...
const (
	...
	ErrorInvalidParameters             Error = 1
	ErrorInvalidHandle                 Error = 2
	ErrorNotConnected                  Error = 3
	ErrorOutOfSpace                    Error = 4
	ErrorOperationCancelled            Error = 5
	ErrorConnectionTimeout             Error = 6
	ErrorPeripheralDisconnected        Error = 7
	ErrorUUIDNotAllowed                Error = 8
	ErrorAlreadyAdvertising            Error = 9
	ErrorConnectionFailed              Error = 10
	ErrorConnectionLimitReached        Error = 11
	ErrorUnkownDevice                  Error = 12
	ErrorUnknownDevice                 Error = 12
	ErrorOperationNotSupported         Error = 13
	ErrorPeerRemovedPairingInformation Error = 14
	ErrorEncryptionTimedOut            Error = 15
	ErrorTooManyLEPairedDevices        Error = 16
)
...
func (e Error) String() string {
	...
	case ErrorPeripheralDisconnected:
		return "ErrorPeripheralDisconnected"
	case ErrorUUIDNotAllowed:
		return "ErrorUUIDNotAllowed"
	case ErrorAlreadyAdvertising:
		return "ErrorAlreadyAdvertising"
	case ErrorConnectionFailed:
		return "ErrorConnectionFailed"
	case ErrorConnectionLimitReached:
		return "ErrorConnectionLimitReached"
	case ErrorUnkownDevice:
		return "ErrorUnkownDevice"
	case ErrorOperationNotSupported:
		return "ErrorOperationNotSupported"
	case ErrorPeerRemovedPairingInformation:
		return "ErrorPeerRemovedPairingInformation"
	case ErrorEncryptionTimedOut:
		return "ErrorEncryptionTimedOut"
	case ErrorTooManyLEPairedDevices:
		return "ErrorTooManyLEPairedDevices"
	default:
...
const (
	...
	PeripheralManagerStateUnknown PeripheralManagerState = 0
	// A manager state that indicates the connection with the system service was momentarily lost.
	PeripheralManagerStateResetting PeripheralManagerState = 1
	// A manager state that indicates the platform doesn’t support the Bluetooth low energy peripheral/server role.
	PeripheralManagerStateUnsupported PeripheralManagerState = 2
	// A manager state that indicates the app isn’t authorized to use the Bluetooth low energy peripheral/server role.
	PeripheralManagerStateUnauthorized PeripheralManagerState = 3
	// A manager state that indicates Bluetooth is currently powered off.
	PeripheralManagerStatePoweredOff PeripheralManagerState = 4
	// A manager state that indicates Bluetooth is currently powered on and is available to use.
	PeripheralManagerStatePoweredOn PeripheralManagerState = 5
)

// String returns the PeripheralManagerState constant's name, or its numeric form when the
// value is not a known constant.
func (e PeripheralManagerState) String() string {
	switch e {
	case PeripheralManagerStateUnknown:
		return "PeripheralManagerStateUnknown"
	case PeripheralManagerStateResetting:
		return "PeripheralManagerStateResetting"
	case PeripheralManagerStateUnsupported:
		return "PeripheralManagerStateUnsupported"
	case PeripheralManagerStateUnauthorized:
		return "PeripheralManagerStateUnauthorized"
	case PeripheralManagerStatePoweredOff:
		return "PeripheralManagerStatePoweredOff"
	case PeripheralManagerStatePoweredOn:
		return "PeripheralManagerStatePoweredOn"
	default:
		return fmt.Sprintf("PeripheralManagerState(%d)", int64(e))
	}
}
