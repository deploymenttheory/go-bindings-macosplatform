...
func (e CBAttributePermissions) String() string {
	var parts []string
	if e&CBAttributePermissionsReadable != 0 { parts = append(parts, "CBAttributePermissionsReadable") }
	if e&CBAttributePermissionsWriteable != 0 { parts = append(parts, "CBAttributePermissionsWriteable") }
	if e&CBAttributePermissionsReadEncryptionRequired != 0 { parts = append(parts, "CBAttributePermissionsReadEncryptionRequired") }
	if e&CBAttributePermissionsWriteEncryptionRequired != 0 { parts = append(parts, "CBAttributePermissionsWriteEncryptionRequired") }
...
func (e CBCharacteristicProperties) String() string {
	var parts []string
	if e&CBCharacteristicPropertyBroadcast != 0 { parts = append(parts, "CBCharacteristicPropertyBroadcast") }
	if e&CBCharacteristicPropertyRead != 0 { parts = append(parts, "CBCharacteristicPropertyRead") }
	if e&CBCharacteristicPropertyWriteWithoutResponse != 0 { parts = append(parts, "CBCharacteristicPropertyWriteWithoutResponse") }
	if e&CBCharacteristicPropertyWrite != 0 { parts = append(parts, "CBCharacteristicPropertyWrite") }
	if e&CBCharacteristicPropertyNotify != 0 { parts = append(parts, "CBCharacteristicPropertyNotify") }
	if e&CBCharacteristicPropertyIndicate != 0 { parts = append(parts, "CBCharacteristicPropertyIndicate") }
	if e&CBCharacteristicPropertyAuthenticatedSignedWrites != 0 { parts = append(parts, "CBCharacteristicPropertyAuthenticatedSignedWrites") }
	if e&CBCharacteristicPropertyExtendedProperties != 0 { parts = append(parts, "CBCharacteristicPropertyExtendedProperties") }
	if e&CBCharacteristicPropertyNotifyEncryptionRequired != 0 { parts = append(parts, "CBCharacteristicPropertyNotifyEncryptionRequired") }
	if e&CBCharacteristicPropertyIndicateEncryptionRequired != 0 { parts = append(parts, "CBCharacteristicPropertyIndicateEncryptionRequired") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
