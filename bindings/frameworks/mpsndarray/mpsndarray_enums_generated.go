...
// String returns the MPSCustomKernelIndex constant's name, or its numeric form when the
// value is not a known constant.
...
// String returns the MPSDeviceCapsValues constant's name, or its numeric form when the
// value is not a known constant.
...
// String returns the MPSImageType constant's name, or its numeric form when the
// value is not a known constant.
