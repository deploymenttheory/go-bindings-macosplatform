...
func (e MPSNDArrayQuantizationScheme) String() string {
	var parts []string
	if e&MPSNDArrayQuantizationTypeAffine != 0 { parts = append(parts, "MPSNDArrayQuantizationTypeAffine") }
	if e&MPSNDArrayQuantizationTypeLUT != 0 { parts = append(parts, "MPSNDArrayQuantizationTypeLUT") }
