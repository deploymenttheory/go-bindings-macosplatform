...
func (o *MPSNDArrayUnaryKernel) Offsets() MPSNDArrayOffsets {
	_ret := objc.Send[MPSNDArrayOffsets](o.Ptr(), _mPSNDArrayUnaryKernelSelOffsets)
	return _ret
}
...
func (o *MPSNDArrayUnaryKernel) KernelSizes() MPSNDArraySizes {
	_ret := objc.Send[MPSNDArraySizes](o.Ptr(), _mPSNDArrayUnaryKernelSelKernelSizes)
	return _ret
}
...
func (o *MPSNDArrayUnaryKernel) Strides() MPSNDArrayOffsets {
	_ret := objc.Send[MPSNDArrayOffsets](o.Ptr(), _mPSNDArrayUnaryKernelSelStrides)
	return _ret
}
...
func (o *MPSNDArrayUnaryKernel) DilationRates() MPSNDArraySizes {
	_ret := objc.Send[MPSNDArraySizes](o.Ptr(), _mPSNDArrayUnaryKernelSelDilationRates)
	return _ret
}
