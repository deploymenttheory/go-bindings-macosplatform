...
// AccessoryManager is an idiomatic wrapper over the Objective-C class AAUSBAccessoryManager.
//
...
func NewAccessoryManager() *AccessoryManager {
	_id := objc.Send[objc.ID](objc.ID(_class("AAUSBAccessoryManager")), objc.RegisterName("new"))
