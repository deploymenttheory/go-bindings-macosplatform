...
type AccessoryMatchingCriteriaInterfaceMatchingOption int64

const (
	// Matching is successful for USB accessories where every criterion/dictionary matches at least one USB interface.
	AccessoryMatchingCriteriaInterfaceMatchingOptionMatchAll AccessoryMatchingCriteriaInterfaceMatchingOption = 0
	// Matching is successful for USB accessories where any of the criteria/dictionaries match at least one USB interface.
	AccessoryMatchingCriteriaInterfaceMatchingOptionMatchAny AccessoryMatchingCriteriaInterfaceMatchingOption = 1
)

// String returns the AccessoryMatchingCriteriaInterfaceMatchingOption constant's name, or its numeric form when the
// value is not a known constant.
func (e AccessoryMatchingCriteriaInterfaceMatchingOption) String() string {
	switch e {
	case AccessoryMatchingCriteriaInterfaceMatchingOptionMatchAll:
		return "AccessoryMatchingCriteriaInterfaceMatchingOptionMatchAll"
	case AccessoryMatchingCriteriaInterfaceMatchingOptionMatchAny:
		return "AccessoryMatchingCriteriaInterfaceMatchingOptionMatchAny"
	default:
		return fmt.Sprintf("AccessoryMatchingCriteriaInterfaceMatchingOption(%d)", int64(e))
	}
}
...
// String returns the AAErrorCode constant's name, or its numeric form when the
// value is not a known constant.
