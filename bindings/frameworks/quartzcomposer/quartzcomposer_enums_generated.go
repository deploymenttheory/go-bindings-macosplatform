...
type PlugInExecutionMode int64

const (
	KQCPlugInExecutionModeProvider  PlugInExecutionMode = 1
	KQCPlugInExecutionModeProcessor PlugInExecutionMode = 2
	KQCPlugInExecutionModeConsumer  PlugInExecutionMode = 3
)

// String returns the PlugInExecutionMode constant's name, or its numeric form when the
// value is not a known constant.
func (e PlugInExecutionMode) String() string {
	switch e {
	...
	default:
		return fmt.Sprintf("PlugInExecutionMode(%d)", int64(e))
	}
}

type PlugInTimeMode int64

const (
	KQCPlugInTimeModeNone     PlugInTimeMode = 0
	KQCPlugInTimeModeIdle     PlugInTimeMode = 1
	KQCPlugInTimeModeTimeBase PlugInTimeMode = 2
)

// String returns the PlugInTimeMode constant's name, or its numeric form when the
// value is not a known constant.
func (e PlugInTimeMode) String() string {
	switch e {
	...
	default:
		return fmt.Sprintf("PlugInTimeMode(%d)", int64(e))
	}
}
