...
func (e MPSMatrixDecompositionStatus) String() string {
	...
	default:
		return fmt.Sprintf("MPSMatrixDecompositionStatus(%d)", int64(e))
	}
}
...
func (e MPSMatrixRandomDistribution) String() string {
	var parts []string
	if e&MPSMatrixRandomDistributionDefault != 0 { parts = append(parts, "MPSMatrixRandomDistributionDefault") }
	if e&MPSMatrixRandomDistributionUniform != 0 { parts = append(parts, "MPSMatrixRandomDistributionUniform") }
	if e&MPSMatrixRandomDistributionNormal != 0 { parts = append(parts, "MPSMatrixRandomDistributionNormal") }
