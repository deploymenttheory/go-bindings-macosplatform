...
// String returns the MatrixDecompositionStatus constant's name, or its numeric form when the
// value is not a known constant.
func (e MatrixDecompositionStatus) String() string {
	switch e {
	case MatrixDecompositionStatusSuccess:
		return "MatrixDecompositionStatusSuccess"
	case MatrixDecompositionStatusFailure:
		return "MatrixDecompositionStatusFailure"
	case MatrixDecompositionStatusSingular:
		return "MatrixDecompositionStatusSingular"
	case MatrixDecompositionStatusNonPositiveDefinite:
		return "MatrixDecompositionStatusNonPositiveDefinite"
	default:
		return fmt.Sprintf("MatrixDecompositionStatus(%d)", int64(e))
	}
}
