...
const (
	...
	QLThumbnailErrorSavingToURLFailed QLThumbnailError = 1
	QLThumbnailErrorNoCachedThumbnail QLThumbnailError = 2
	QLThumbnailErrorNoCloudThumbnail QLThumbnailError = 3
	QLThumbnailErrorRequestInvalid QLThumbnailError = 4
	QLThumbnailErrorRequestCancelled QLThumbnailError = 5
)

func (e QLThumbnailError) String() string {
	switch e {
	case QLThumbnailErrorGenerationFailed:
		return "QLThumbnailErrorGenerationFailed"
	case QLThumbnailErrorSavingToURLFailed:
		return "QLThumbnailErrorSavingToURLFailed"
	case QLThumbnailErrorNoCachedThumbnail:
		return "QLThumbnailErrorNoCachedThumbnail"
	case QLThumbnailErrorNoCloudThumbnail:
		return "QLThumbnailErrorNoCloudThumbnail"
	case QLThumbnailErrorRequestInvalid:
		return "QLThumbnailErrorRequestInvalid"
	case QLThumbnailErrorRequestCancelled:
		return "QLThumbnailErrorRequestCancelled"
	default:
		return fmt.Sprintf("QLThumbnailError(%d)", int64(e))
	}
}
...
func (e QLThumbnailGenerationRequestRepresentationTypes) String() string {
	var parts []string
	if e&QLThumbnailGenerationRequestRepresentationTypeIcon != 0 { parts = append(parts, "QLThumbnailGenerationRequestRepresentationTypeIcon") }
	if e&QLThumbnailGenerationRequestRepresentationTypeLowQualityThumbnail != 0 { parts = append(parts, "QLThumbnailGenerationRequestRepresentationTypeLowQualityThumbnail") }
	if e&QLThumbnailGenerationRequestRepresentationTypeThumbnail != 0 { parts = append(parts, "QLThumbnailGenerationRequestRepresentationTypeThumbnail") }
	if e&QLThumbnailGenerationRequestRepresentationTypeAll != 0 { parts = append(parts, "QLThumbnailGenerationRequestRepresentationTypeAll") }
