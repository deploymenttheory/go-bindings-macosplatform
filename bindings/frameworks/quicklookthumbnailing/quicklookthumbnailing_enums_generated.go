...
type ThumbnailError int64

const (
	ThumbnailErrorGenerationFailed  ThumbnailError = 0
	ThumbnailErrorSavingToURLFailed ThumbnailError = 1
	ThumbnailErrorNoCachedThumbnail ThumbnailError = 2
	ThumbnailErrorNoCloudThumbnail  ThumbnailError = 3
	ThumbnailErrorRequestInvalid    ThumbnailError = 4
	ThumbnailErrorRequestCancelled  ThumbnailError = 5
)

// String returns the ThumbnailError constant's name, or its numeric form when the
// value is not a known constant.
func (e ThumbnailError) String() string {
	switch e {
	case ThumbnailErrorGenerationFailed:
		return "ThumbnailErrorGenerationFailed"
	case ThumbnailErrorSavingToURLFailed:
		return "ThumbnailErrorSavingToURLFailed"
	case ThumbnailErrorNoCachedThumbnail:
		return "ThumbnailErrorNoCachedThumbnail"
	case ThumbnailErrorNoCloudThumbnail:
		return "ThumbnailErrorNoCloudThumbnail"
	case ThumbnailErrorRequestInvalid:
		return "ThumbnailErrorRequestInvalid"
	case ThumbnailErrorRequestCancelled:
		return "ThumbnailErrorRequestCancelled"
	default:
		return fmt.Sprintf("ThumbnailError(%d)", int64(e))
	}
}
