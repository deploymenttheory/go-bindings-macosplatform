...
type NSCandidateListTouchBarItem[CandidateType pureobjc.AnyObject] struct {
	NSTouchBarItem
}
...
func NSCandidateListTouchBarItemFromID[CandidateType pureobjc.AnyObject](id objc.ID) *NSCandidateListTouchBarItem[CandidateType] {
	if id == 0 {
		return nil
	}
