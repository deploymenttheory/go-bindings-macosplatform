...
func (s *Switch) WithExclusiveGestureBehavior(exclusiveGestureBehavior ViewExclusiveGestureBehavior) *Switch {
	purego.Main(func() {
...
func (s *Switch) WithTextSelectionManager(textSelectionManager *TextSelectionManager) *Switch {
