...
func (b *Button) WithExclusiveGestureBehavior(exclusiveGestureBehavior ViewExclusiveGestureBehavior) *Button {
	purego.Main(func() {
...
func (b *Button) WithTextSelectionManager(textSelectionManager *TextSelectionManager) *Button {
