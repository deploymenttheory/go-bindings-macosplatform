...
func (b *Box) WithExclusiveGestureBehavior(exclusiveGestureBehavior ViewExclusiveGestureBehavior) *Box {
	purego.Main(func() {
...
func (b *Box) WithTextSelectionManager(textSelectionManager *TextSelectionManager) *Box {
