...
func NewTextLineFragmentWithStringAttributesRange(str string, attributes obj.Object, range_ foundation.NSRange) *TextLineFragment {
	defer runtime.KeepAlive(attributes)
	_alloc := objc.Send[objc.ID](objc.ID(_class("NSTextLineFragment")), objc.RegisterName("alloc"))
	_id := objc.Send[objc.ID](_alloc, objc.RegisterName("initWithString:attributes:range:"), purego.NSString(str), objref.IDOf(attributes), range_)
	return textLineFragmentAdopt(_id)
}
