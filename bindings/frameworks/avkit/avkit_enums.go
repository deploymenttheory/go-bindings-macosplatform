...
func (e AVLegibleMediaOptionsMenuContents) String() string {
	var parts []string
	if e&AVLegibleMediaOptionsMenuContentsLegible != 0 { parts = append(parts, "AVLegibleMediaOptionsMenuContentsLegible") }
	if e&AVLegibleMediaOptionsMenuContentsCaptionAppearance != 0 { parts = append(parts, "AVLegibleMediaOptionsMenuContentsCaptionAppearance") }
	if e&AVLegibleMediaOptionsMenuContentsAll != 0 { parts = append(parts, "AVLegibleMediaOptionsMenuContentsAll") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}

type AVLegibleMediaOptionsMenuStateChangeReason int64

const (
	AVLegibleMediaOptionsMenuStateChangeReasonNone AVLegibleMediaOptionsMenuStateChangeReason = 0
	AVLegibleMediaOptionsMenuStateChangeReasonLanguageMismatch AVLegibleMediaOptionsMenuStateChangeReason = 1
)

func (e AVLegibleMediaOptionsMenuStateChangeReason) String() string {
	switch e {
	case AVLegibleMediaOptionsMenuStateChangeReasonNone:
		return "AVLegibleMediaOptionsMenuStateChangeReasonNone"
	case AVLegibleMediaOptionsMenuStateChangeReasonLanguageMismatch:
		return "AVLegibleMediaOptionsMenuStateChangeReasonLanguageMismatch"
	default:
		return fmt.Sprintf("AVLegibleMediaOptionsMenuStateChangeReason(%d)", int64(e))
	}
}
...
func (e AVVideoFrameAnalysisType) String() string {
	var parts []string
	if e&AVVideoFrameAnalysisTypeDefault != 0 { parts = append(parts, "AVVideoFrameAnalysisTypeDefault") }
	if e&AVVideoFrameAnalysisTypeText != 0 { parts = append(parts, "AVVideoFrameAnalysisTypeText") }
	if e&AVVideoFrameAnalysisTypeSubject != 0 { parts = append(parts, "AVVideoFrameAnalysisTypeSubject") }
	if e&AVVideoFrameAnalysisTypeVisualSearch != 0 { parts = append(parts, "AVVideoFrameAnalysisTypeVisualSearch") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
