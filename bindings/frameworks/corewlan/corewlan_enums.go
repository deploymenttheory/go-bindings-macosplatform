...
func (e CWCipherKeyFlags) String() string {
	var parts []string
	if e&KCWCipherKeyFlagsUnicast != 0 { parts = append(parts, "KCWCipherKeyFlagsUnicast") }
	if e&KCWCipherKeyFlagsMulticast != 0 { parts = append(parts, "KCWCipherKeyFlagsMulticast") }
	if e&KCWCipherKeyFlagsTx != 0 { parts = append(parts, "KCWCipherKeyFlagsTx") }
	if e&KCWCipherKeyFlagsRx != 0 { parts = append(parts, "KCWCipherKeyFlagsRx") }
...
func (e CWErr) String() string {
	...
	case KCWErr:
		return "KCWErr"
	default:
		return fmt.Sprintf("CWErr(%d)", int64(e))
	}
}
