...
func (e VSAccountAccessStatus) String() string {
	switch e {
	case VSAccountAccessStatusNotDetermined:
		return "VSAccountAccessStatusNotDetermined"
	case VSAccountAccessStatusRestricted:
		return "VSAccountAccessStatusRestricted"
	case VSAccountAccessStatusDenied:
		return "VSAccountAccessStatusDenied"
	case VSAccountAccessStatusGranted:
		return "VSAccountAccessStatusGranted"
	default:
		return fmt.Sprintf("VSAccountAccessStatus(%d)", int64(e))
	}
}
...
func (e VSUserAccountQueryOptions) String() string {
	var parts []string
	if e&VSUserAccountQueryAllDevices != 0 { parts = append(parts, "VSUserAccountQueryAllDevices") }
