...
func (e GCDevicePhysicalInputElementChange) String() string {
	...
	default:
		return fmt.Sprintf("GCDevicePhysicalInputElementChange(%d)", int64(e))
	}
}
...
func (e GCExtendedGamepadSnapshotDataVersion) String() string {
	...
	default:
		return fmt.Sprintf("GCExtendedGamepadSnapshotDataVersion(%d)", int64(e))
	}
}
...
func (e GCMicroGamepadSnapshotDataVersion) String() string {
	...
	default:
		return fmt.Sprintf("GCMicroGamepadSnapshotDataVersion(%d)", int64(e))
	}
}
...
func (e GCPhysicalInputSourceDirection) String() string {
	var parts []string
	if e&GCPhysicalInputSourceDirectionUp != 0 { parts = append(parts, "GCPhysicalInputSourceDirectionUp") }
	if e&GCPhysicalInputSourceDirectionRight != 0 { parts = append(parts, "GCPhysicalInputSourceDirectionRight") }
	if e&GCPhysicalInputSourceDirectionDown != 0 { parts = append(parts, "GCPhysicalInputSourceDirectionDown") }
	if e&GCPhysicalInputSourceDirectionLeft != 0 { parts = append(parts, "GCPhysicalInputSourceDirectionLeft") }
