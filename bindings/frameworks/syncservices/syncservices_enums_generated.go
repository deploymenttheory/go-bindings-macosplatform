...
// String returns the ISyncServerDisabledReason constant's name, or its numeric form when the
// value is not a known constant.
...
// String returns the ISyncSessionDriverChangeResult constant's name, or its numeric form when the
// value is not a known constant.
...
// String returns the ISyncSessionDriverMode constant's name, or its numeric form when the
// value is not a known constant.
