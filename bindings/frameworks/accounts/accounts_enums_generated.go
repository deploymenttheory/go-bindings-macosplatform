...
type AccountCredentialRenewResult int64

const (
	// The account’s credentials have been renewed and are now associated with the account.
	AccountCredentialRenewResultRenewed AccountCredentialRenewResult = 0
	// Renewal failed because the user revoked your access to their account.
	AccountCredentialRenewResultRejected AccountCredentialRenewResult = 1
	// A non-user-initiated cancel of the prompt.
	AccountCredentialRenewResultFailed AccountCredentialRenewResult = 2
)

// String returns the AccountCredentialRenewResult constant's name, or its numeric form when the
// value is not a known constant.
func (e AccountCredentialRenewResult) String() string {
	switch e {
	case AccountCredentialRenewResultRenewed:
		return "AccountCredentialRenewResultRenewed"
	case AccountCredentialRenewResultRejected:
		return "AccountCredentialRenewResultRejected"
	case AccountCredentialRenewResultFailed:
		return "AccountCredentialRenewResultFailed"
	default:
		return fmt.Sprintf("AccountCredentialRenewResult(%d)", int64(e))
	}
}
