...
func (lf *LinkedFunctions) WithGroups(groups map[string]obj.Object) *LinkedFunctions {
	objc.Send[objc.ID](objref.IDOf(lf), objc.RegisterName("setGroups:"), rt.MapToDict(groups, func(_k string) objc.ID { return purego.NSString(_k) }, func(_v obj.Object) objc.ID { return objref.IDOf(_v) }))
	return lf
}
...
func (lf *LinkedFunctions) Groups() map[string]obj.Object {
	defer runtime.KeepAlive(lf)
