...
type ColorConversionOptions uint64

const (
	ColorConversionOptionsNone                 ColorConversionOptions = 0
	ColorConversionOptionsPrecisionDefault     ColorConversionOptions = 0
	ConverisonOptionsPrecisionSnorm8           ColorConversionOptions = 7
	ConverisonOptionsPrecisionUnorm8           ColorConversionOptions = 8
	ConverisonOptionsPrecisionSnorm16          ColorConversionOptions = 15
	ConverisonOptionsPrecisionUnorm16          ColorConversionOptions = 16
	ConverisonOptionsPrecisionFloat16          ColorConversionOptions = 11
	ConverisonOptionsPrecisionFloat32          ColorConversionOptions = 24
	ColorConversionOptionsPrecisionMask        ColorConversionOptions = 63
	ColorConversionOptionsReturnGrayscaleAsRGB ColorConversionOptions = 256
	ColorConversionOptionsVerboseLogging       ColorConversionOptions = 512
)

// String returns the ColorConversionOptions constant's name, or its numeric form when the
// value is not a known constant.
func (e ColorConversionOptions) String() string {
	var parts []string
	if e&ConverisonOptionsPrecisionSnorm8 != 0 {
		parts = append(parts, "ConverisonOptionsPrecisionSnorm8")
	}
	if e&ConverisonOptionsPrecisionUnorm8 != 0 {
		parts = append(parts, "ConverisonOptionsPrecisionUnorm8")
	}
	if e&ConverisonOptionsPrecisionSnorm16 != 0 {
		parts = append(parts, "ConverisonOptionsPrecisionSnorm16")
	}
	if e&ConverisonOptionsPrecisionUnorm16 != 0 {
		parts = append(parts, "ConverisonOptionsPrecisionUnorm16")
	}
	if e&ConverisonOptionsPrecisionFloat16 != 0 {
		parts = append(parts, "ConverisonOptionsPrecisionFloat16")
	}
	if e&ConverisonOptionsPrecisionFloat32 != 0 {
		parts = append(parts, "ConverisonOptionsPrecisionFloat32")
	}
	if e&ColorConversionOptionsPrecisionMask != 0 {
		parts = append(parts, "ColorConversionOptionsPrecisionMask")
	}
	if e&ColorConversionOptionsReturnGrayscaleAsRGB != 0 {
		parts = append(parts, "ColorConversionOptionsReturnGrayscaleAsRGB")
	}
	if e&ColorConversionOptionsVerboseLogging != 0 {
		parts = append(parts, "ColorConversionOptionsVerboseLogging")
	}
	if len(parts) == 0 {
		return "0"
	}
