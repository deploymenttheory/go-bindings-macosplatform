...
func (e MPSAccelerationStructureUsage) String() string {
	var parts []string
	if e&MPSAccelerationStructureUsageRefit != 0 { parts = append(parts, "MPSAccelerationStructureUsageRefit") }
	if e&MPSAccelerationStructureUsageFrequentRebuild != 0 { parts = append(parts, "MPSAccelerationStructureUsageFrequentRebuild") }
	if e&MPSAccelerationStructureUsagePreferGPUBuild != 0 { parts = append(parts, "MPSAccelerationStructureUsagePreferGPUBuild") }
	if e&MPSAccelerationStructureUsagePreferCPUBuild != 0 { parts = append(parts, "MPSAccelerationStructureUsagePreferCPUBuild") }
...
func (e MPSRayMaskOptions) String() string {
	var parts []string
	if e&MPSRayMaskOptionPrimitive != 0 { parts = append(parts, "MPSRayMaskOptionPrimitive") }
	if e&MPSRayMaskOptionInstance != 0 { parts = append(parts, "MPSRayMaskOptionInstance") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
