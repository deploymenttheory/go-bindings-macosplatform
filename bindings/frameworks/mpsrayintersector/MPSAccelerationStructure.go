...
func (o *MPSAccelerationStructure) RebuildWithCompletionHandler(completionHandler func(*MPSAccelerationStructure)) {
	...
	if completionHandler != nil {
		__block_completionHandler = objc.NewBlock(func(_ objc.Block, blockParam0 objc.ID) {
			...
			completionHandler(MPSAccelerationStructureFromID(blockParam0))
		})
...
func (o *MPSAccelerationStructure) BoundingBox() MPSAxisAlignedBoundingBox {
	_ret := objc.Send[MPSAxisAlignedBoundingBox](o.Ptr(), _mPSAccelerationStructureSelBoundingBox)
	return _ret
}
...
func (o *MPSAccelerationStructure) Status() MPSAccelerationStructureStatus {
	_ret := objc.Send[MPSAccelerationStructureStatus](o.Ptr(), _mPSAccelerationStructureSelStatus)
	return _ret
}
...
func (o *MPSAccelerationStructure) Usage() MPSAccelerationStructureUsage {
	_ret := objc.Send[MPSAccelerationStructureUsage](o.Ptr(), _mPSAccelerationStructureSelUsage)
	return _ret
}
