...
func (e SKTileAdjacencyMask) String() string {
	var parts []string
	if e&SKTileAdjacencyUp != 0 { parts = append(parts, "SKTileAdjacencyUp") }
	if e&SKTileAdjacencyUpperRight != 0 { parts = append(parts, "SKTileAdjacencyUpperRight") }
	if e&SKTileAdjacencyRight != 0 { parts = append(parts, "SKTileAdjacencyRight") }
	if e&SKTileAdjacencyLowerRight != 0 { parts = append(parts, "SKTileAdjacencyLowerRight") }
	if e&SKTileAdjacencyDown != 0 { parts = append(parts, "SKTileAdjacencyDown") }
	if e&SKTileAdjacencyLowerLeft != 0 { parts = append(parts, "SKTileAdjacencyLowerLeft") }
	if e&SKTileAdjacencyLeft != 0 { parts = append(parts, "SKTileAdjacencyLeft") }
	if e&SKTileAdjacencyUpperLeft != 0 { parts = append(parts, "SKTileAdjacencyUpperLeft") }
	if e&SKTileAdjacencyAll != 0 { parts = append(parts, "SKTileAdjacencyAll") }
	if e&SKTileHexFlatAdjacencyUp != 0 { parts = append(parts, "SKTileHexFlatAdjacencyUp") }
	if e&SKTileHexFlatAdjacencyUpperRight != 0 { parts = append(parts, "SKTileHexFlatAdjacencyUpperRight") }
	if e&SKTileHexFlatAdjacencyLowerRight != 0 { parts = append(parts, "SKTileHexFlatAdjacencyLowerRight") }
	if e&SKTileHexFlatAdjacencyDown != 0 { parts = append(parts, "SKTileHexFlatAdjacencyDown") }
	if e&SKTileHexFlatAdjacencyLowerLeft != 0 { parts = append(parts, "SKTileHexFlatAdjacencyLowerLeft") }
	if e&SKTileHexFlatAdjacencyUpperLeft != 0 { parts = append(parts, "SKTileHexFlatAdjacencyUpperLeft") }
	if e&SKTileHexFlatAdjacencyAll != 0 { parts = append(parts, "SKTileHexFlatAdjacencyAll") }
	if e&SKTileHexPointyAdjacencyUpperLeft != 0 { parts = append(parts, "SKTileHexPointyAdjacencyUpperLeft") }
	if e&SKTileHexPointyAdjacencyUpperRight != 0 { parts = append(parts, "SKTileHexPointyAdjacencyUpperRight") }
	if e&SKTileHexPointyAdjacencyRight != 0 { parts = append(parts, "SKTileHexPointyAdjacencyRight") }
	if e&SKTileHexPointyAdjacencyLowerRight != 0 { parts = append(parts, "SKTileHexPointyAdjacencyLowerRight") }
	if e&SKTileHexPointyAdjacencyLowerLeft != 0 { parts = append(parts, "SKTileHexPointyAdjacencyLowerLeft") }
	if e&SKTileHexPointyAdjacencyLeft != 0 { parts = append(parts, "SKTileHexPointyAdjacencyLeft") }
	if e&SKTileHexPointyAdjacencyAdd != 0 { parts = append(parts, "SKTileHexPointyAdjacencyAdd") }
	if e&SKTileAdjacencyUpEdge != 0 { parts = append(parts, "SKTileAdjacencyUpEdge") }
	if e&SKTileAdjacencyUpperRightEdge != 0 { parts = append(parts, "SKTileAdjacencyUpperRightEdge") }
	if e&SKTileAdjacencyRightEdge != 0 { parts = append(parts, "SKTileAdjacencyRightEdge") }
	if e&SKTileAdjacencyLowerRightEdge != 0 { parts = append(parts, "SKTileAdjacencyLowerRightEdge") }
	if e&SKTileAdjacencyDownEdge != 0 { parts = append(parts, "SKTileAdjacencyDownEdge") }
	if e&SKTileAdjacencyLowerLeftEdge != 0 { parts = append(parts, "SKTileAdjacencyLowerLeftEdge") }
	if e&SKTileAdjacencyLeftEdge != 0 { parts = append(parts, "SKTileAdjacencyLeftEdge") }
	if e&SKTileAdjacencyUpperLeftEdge != 0 { parts = append(parts, "SKTileAdjacencyUpperLeftEdge") }
	if e&SKTileAdjacencyUpperRightCorner != 0 { parts = append(parts, "SKTileAdjacencyUpperRightCorner") }
	if e&SKTileAdjacencyLowerRightCorner != 0 { parts = append(parts, "SKTileAdjacencyLowerRightCorner") }
	if e&SKTileAdjacencyLowerLeftCorner != 0 { parts = append(parts, "SKTileAdjacencyLowerLeftCorner") }
	if e&SKTileAdjacencyUpperLeftCorner != 0 { parts = append(parts, "SKTileAdjacencyUpperLeftCorner") }
