...
// String returns the FogMode constant's name, or its numeric form when the
// value is not a known constant.
func (e FogMode) String() string {
	...
	case FogModeExp2:
		return "FogModeExp2"
	case FogModeLinear:
		return "FogModeLinear"
	default:
		return fmt.Sprintf("FogMode(%d)", int64(e))
	}
}
...
// String returns the TextureLoaderError constant's name, or its numeric form when the
// value is not a known constant.
func (e TextureLoaderError) String() string {
	switch e {
	case TextureLoaderErrorFileOrURLNotFound:
		return "TextureLoaderErrorFileOrURLNotFound"
	case TextureLoaderErrorInvalidNSData:
		return "TextureLoaderErrorInvalidNSData"
	case TextureLoaderErrorInvalidCGImage:
		return "TextureLoaderErrorInvalidCGImage"
	case TextureLoaderErrorUnknownPathType:
		return "TextureLoaderErrorUnknownPathType"
	case TextureLoaderErrorUnknownFileType:
		return "TextureLoaderErrorUnknownFileType"
	case TextureLoaderErrorPVRAtlasUnsupported:
		return "TextureLoaderErrorPVRAtlasUnsupported"
	case TextureLoaderErrorCubeMapInvalidNumFiles:
		return "TextureLoaderErrorCubeMapInvalidNumFiles"
	case TextureLoaderErrorCompressedTextureUpload:
		return "TextureLoaderErrorCompressedTextureUpload"
	case TextureLoaderErrorUncompressedTextureUpload:
		return "TextureLoaderErrorUncompressedTextureUpload"
	case TextureLoaderErrorUnsupportedCubeMapDimensions:
		return "TextureLoaderErrorUnsupportedCubeMapDimensions"
	case TextureLoaderErrorUnsupportedBitDepth:
		return "TextureLoaderErrorUnsupportedBitDepth"
	case TextureLoaderErrorUnsupportedPVRFormat:
		return "TextureLoaderErrorUnsupportedPVRFormat"
	case TextureLoaderErrorDataPreprocessingFailure:
		return "TextureLoaderErrorDataPreprocessingFailure"
	case TextureLoaderErrorMipmapUnsupported:
		return "TextureLoaderErrorMipmapUnsupported"
	case TextureLoaderErrorUnsupportedOrientation:
		return "TextureLoaderErrorUnsupportedOrientation"
	case TextureLoaderErrorReorientationFailure:
		return "TextureLoaderErrorReorientationFailure"
	case TextureLoaderErrorAlphaPremultiplicationFailure:
		return "TextureLoaderErrorAlphaPremultiplicationFailure"
	case TextureLoaderErrorInvalidEAGLContext:
		return "TextureLoaderErrorInvalidEAGLContext"
	case TextureLoaderErrorIncompatibleFormatSRGB:
		return "TextureLoaderErrorIncompatibleFormatSRGB"
	case TextureLoaderErrorUnsupportedTextureTarget:
		return "TextureLoaderErrorUnsupportedTextureTarget"
	default:
		return fmt.Sprintf("TextureLoaderError(%d)", int64(e))
	}
}
...
// String returns the VertexAttrib constant's name, or its numeric form when the
// value is not a known constant.
func (e VertexAttrib) String() string {
	switch e {
	case VertexAttribPosition:
		return "VertexAttribPosition"
	case VertexAttribNormal:
		return "VertexAttribNormal"
	case VertexAttribColor:
		return "VertexAttribColor"
	case VertexAttribTexCoord0:
		return "VertexAttribTexCoord0"
	case VertexAttribTexCoord1:
		return "VertexAttribTexCoord1"
	default:
		return fmt.Sprintf("VertexAttrib(%d)", int64(e))
	}
}
