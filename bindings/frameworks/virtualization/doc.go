...
//   - CustomVirtioDeviceProvider: [CustomVirtioDeviceDelegateProvider]
...
//   - EFISignature: [EFISignatureSHA256Hash], [EFISignatureX509Certificate]
...
//   - GuestProvisioningOptions: [MacGuestProvisioningOptions]
