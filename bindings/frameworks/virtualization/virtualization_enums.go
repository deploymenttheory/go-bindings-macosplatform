...
func (e VZEFIVariableStoreInitializationOptions) String() string {
	var parts []string
	if e&VZEFIVariableStoreInitializationOptionAllowOverwrite != 0 { parts = append(parts, "VZEFIVariableStoreInitializationOptionAllowOverwrite") }
...
func (e VZMacAuxiliaryStorageInitializationOptions) String() string {
	var parts []string
	if e&VZMacAuxiliaryStorageInitializationOptionAllowOverwrite != 0 { parts = append(parts, "VZMacAuxiliaryStorageInitializationOptionAllowOverwrite") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
