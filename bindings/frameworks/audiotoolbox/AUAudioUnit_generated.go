...
func (au *AudioUnit) WithMIDIOutputEventListBlock(midiOutputEventListBlock func(int64, uint8, obj.Object) int) *AudioUnit {
	objc.Send[objc.ID](objref.IDOf(au), objc.RegisterName("setMIDIOutputEventListBlock:"), objc.NewBlock(func(_ objc.Block, _b0 int64, _b1 uint8, _b2 objc.ID) int {
		return midiOutputEventListBlock(_b0, _b1, obj.Wrap(_b2))
	}))
	return au
}
