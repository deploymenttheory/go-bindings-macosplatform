...
func (auvb *AudioUnitV2Bridge) WithMIDIOutputEventListBlock(midiOutputEventListBlock func(int64, uint8, obj.Object) int) *AudioUnitV2Bridge {
	objc.Send[objc.ID](objref.IDOf(auvb), objc.RegisterName("setMIDIOutputEventListBlock:"), objc.NewBlock(func(_ objc.Block, _b0 int64, _b1 uint8, _b2 objc.ID) int {
