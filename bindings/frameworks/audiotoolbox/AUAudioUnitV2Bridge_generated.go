...
func (auvb *AudioUnitV2Bridge) WithMIDIOutputEventBlock(midiOutputEventBlock func(int64, uint8, int, unsafe.Pointer) int) *AudioUnitV2Bridge {
	objc.Send[objc.ID](objref.IDOf(auvb), objc.RegisterName("setMIDIOutputEventBlock:"), objc.NewBlock(func(_ objc.Block, _b0 int64, _b1 uint8, _b2 int, _b3 unsafe.Pointer) int {
...
func (auvb *AudioUnitV2Bridge) WithMIDIOutputEventListBlock(midiOutputEventListBlock func(int64, uint8, unsafe.Pointer) int) *AudioUnitV2Bridge {
	objc.Send[objc.ID](objref.IDOf(auvb), objc.RegisterName("setMIDIOutputEventListBlock:"), objc.NewBlock(func(_ objc.Block, _b0 int64, _b1 uint8, _b2 unsafe.Pointer) int {
