...
func NewFileProviderItemVersionWithContentVersionMetadataVersion(contentVersion []byte, metadataVersion []byte) *FileProviderItemVersion {
	...
	_id := objc.Send[objc.ID](_alloc, objc.RegisterName("initWithContentVersion:metadataVersion:"), rt.BytesToNSData(contentVersion), rt.BytesToNSData(metadataVersion))
...
func (fpiv *FileProviderItemVersion) ContentVersion() []byte {
	defer runtime.KeepAlive(fpiv)
...
func (fpiv *FileProviderItemVersion) MetadataVersion() []byte {
	defer runtime.KeepAlive(fpiv)
