...
func (e OSLogEnumeratorOptions) String() string {
	var parts []string
	if e&OSLogEnumeratorReverse != 0 { parts = append(parts, "OSLogEnumeratorReverse") }
...
type Os_activity_flag_t int64

const (
	OS_ACTIVITY_FLAG_DEFAULT Os_activity_flag_t = 0
	OS_ACTIVITY_FLAG_DETACHED Os_activity_flag_t = 1
	OS_ACTIVITY_FLAG_IF_NONE_PRESENT Os_activity_flag_t = 2
)

func (e Os_activity_flag_t) String() string {
	switch e {
	...
	default:
		return fmt.Sprintf("Os_activity_flag_t(%d)", int64(e))
	}
}
...
func (e Os_signpost_type_t) String() string {
	...
	default:
		return fmt.Sprintf("Os_signpost_type_t(%d)", int64(e))
	}
}
