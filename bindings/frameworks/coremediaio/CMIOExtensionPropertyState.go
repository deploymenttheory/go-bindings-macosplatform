...
type CMIOExtensionPropertyState[ObjectType pureobjc.AnyObject] struct {
	foundation.NSObject
}
...
func CMIOExtensionPropertyStateFromID[ObjectType pureobjc.AnyObject](id objc.ID) *CMIOExtensionPropertyState[ObjectType] {
	if id == 0 {
		return nil
	}
