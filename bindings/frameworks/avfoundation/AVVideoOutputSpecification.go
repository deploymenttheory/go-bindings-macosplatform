...
func (o *AVVideoOutputSpecification) SetOutputPixelBufferAttributesForTagCollection(pixelBufferAttributes *foundation.NSDictionary[*foundation.NSString, objc.ID], tagCollection unsafe.Pointer) {
	o.Ptr().Send(_aVVideoOutputSpecificationSelSetOutputPixelBufferAttributesForTagCollection, pixelBufferAttributes, tagCollection)
}
...
func (o *AVVideoOutputSpecification) SetOutputSettingsForTagCollection(outputSettings *foundation.NSDictionary[*foundation.NSString, objc.ID], tagCollection unsafe.Pointer) {
	o.Ptr().Send(_aVVideoOutputSpecificationSelSetOutputSettingsForTagCollection, outputSettings, tagCollection)
}
...
func (o *AVVideoOutputSpecification) PreferredTagCollections() *foundation.NSArray[objc.ID] {
	_ret := objc.Send[*foundation.NSArray[objc.ID]](o.Ptr(), _aVVideoOutputSpecificationSelPreferredTagCollections)
	return _ret
}
...
func (o *AVVideoOutputSpecification) DefaultPixelBufferAttributes() *foundation.NSDictionary[*foundation.NSString, objc.ID] {
	_ret := objc.Send[*foundation.NSDictionary[*foundation.NSString, objc.ID]](o.Ptr(), _aVVideoOutputSpecificationSelDefaultPixelBufferAttributes)
	return _ret
}
...
func (o *AVVideoOutputSpecification) SetDefaultPixelBufferAttributes(defaultPixelBufferAttributes *foundation.NSDictionary[*foundation.NSString, objc.ID]) {
	o.Ptr().Send(_aVVideoOutputSpecificationSelSetDefaultPixelBufferAttributes, defaultPixelBufferAttributes)
}
...
func (o *AVVideoOutputSpecification) DefaultOutputSettings() *foundation.NSDictionary[*foundation.NSString, objc.ID] {
	_ret := objc.Send[*foundation.NSDictionary[*foundation.NSString, objc.ID]](o.Ptr(), _aVVideoOutputSpecificationSelDefaultOutputSettings)
	return _ret
}
