...
func (aig *AssetImageGenerator) CopyCGImageAtTimeActualTime(requestedTime coremedia.CMTime, actualTime *coremedia.CMTime) (result coregraphics.CGImageRef, err error) {
	defer runtime.KeepAlive(aig)
	var _nsErr uintptr
