...
func NewAssetWriterInputWithMediaTypeOutputSettings(mediaType obj.Object, outputSettings map[string]obj.Object) *AssetWriterInput {
	defer runtime.KeepAlive(mediaType)
	_alloc := objc.Send[objc.ID](objc.ID(_class("AVAssetWriterInput")), objc.RegisterName("alloc"))
	_id := objc.Send[objc.ID](_alloc, objc.RegisterName("initWithMediaType:outputSettings:"), objref.IDOf(mediaType), rt.MapToDict(outputSettings, func(_k string) objc.ID { return purego.NSString(_k) }, func(_v obj.Object) objc.ID { return objref.IDOf(_v) }))
...
func NewAssetWriterInputWithMediaTypeOutputSettingsSourceFormatHint(mediaType obj.Object, outputSettings map[string]obj.Object, sourceFormatHint obj.Object) *AssetWriterInput {
	defer runtime.KeepAlive(mediaType)
	defer runtime.KeepAlive(sourceFormatHint)
	_alloc := objc.Send[objc.ID](objc.ID(_class("AVAssetWriterInput")), objc.RegisterName("alloc"))
	_id := objc.Send[objc.ID](_alloc, objc.RegisterName("initWithMediaType:outputSettings:sourceFormatHint:"), objref.IDOf(mediaType), rt.MapToDict(outputSettings, func(_k string) objc.ID { return purego.NSString(_k) }, func(_v obj.Object) objc.ID { return objref.IDOf(_v) }), objref.IDOf(sourceFormatHint))
	return assetWriterInputAdopt(_id)
}
...
func (awi *AssetWriterInput) WithMediaDataLocation(mediaDataLocation obj.Object) *AssetWriterInput {
	defer runtime.KeepAlive(mediaDataLocation)
...
func (awi *AssetWriterInput) MediaType() *foundation.String {
	defer runtime.KeepAlive(awi)
...
func (awi *AssetWriterInput) OutputSettings() map[string]obj.Object {
	defer runtime.KeepAlive(awi)
...
func (awi *AssetWriterInput) SampleReferenceBaseURL() string {
	defer runtime.KeepAlive(awi)
...
func (awi *AssetWriterInput) MediaDataLocation() *foundation.String {
	defer runtime.KeepAlive(awi)
