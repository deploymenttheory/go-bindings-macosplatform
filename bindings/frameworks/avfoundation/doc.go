...
//   - AssetTrackPlan: [AssetVideoTrackPlan]
...
//   - CaptureOutput: [CaptureAudioDataOutput], [CaptureAudioPreviewOutput], [CaptureBroadcastVideoOutput], [CaptureFileOutput], [CaptureMetadataOutput], [CapturePhotoOutput], [CaptureStillImageOutput], [CaptureVideoDataOutput]
...
//   - MetadataObject: [MetadataBodyObject], [MetadataCatHeadObject], [MetadataCinematicVideoMetadataObject], [MetadataDogHeadObject], [MetadataFaceObject], [MetadataFocusTrackedObject], [MetadataMachineReadableCodeObject], [MetadataSalientObject]
//   - MetricEvent: [MetricContentKeyRequestEvent], [MetricDownloadSummaryEvent], [MetricErrorEvent], [MetricHLSMediaSegmentRequestEvent], [MetricHLSPlaylistRequestEvent], [MetricMediaResourceRequestEvent], [MetricPlaybackModeSwitchEvent], [MetricPlayerItemLikelyToKeepUpEvent], [MetricPlayerItemPlaybackSummaryEvent], [MetricPlayerItemRateChangeEvent], [MetricPlayerItemVariantSwitchEvent], [MetricPlayerItemVariantSwitchStartEvent]
...
//   - PlannedSegmentConfiguration: [PlannedVideoSegmentConfiguration]
//   - PlannedSegmentWritingRequest: [PlannedVideoSegmentWritingRequest]
...
//   - PlayerItemOutput: [PlayerItemLegibleOutput], [PlayerItemMetadataOutput], [PlayerItemRenderedLegibleOutput], [PlayerItemSampleBufferOutput], [PlayerItemVideoOutput]
//   - PlayerItemSampleBufferOutputConfiguration: [PlayerItemSampleBufferOutputAudioConfiguration]
