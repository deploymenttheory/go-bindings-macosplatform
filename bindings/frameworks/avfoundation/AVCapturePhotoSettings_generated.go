...
func (cps *CapturePhotoSettings) WithMaxPhotoDimensions(maxPhotoDimensions CMVideoDimensions) *CapturePhotoSettings {
...
func (cps *CapturePhotoSettings) MaxPhotoDimensions() CMVideoDimensions {
	defer runtime.KeepAlive(cps)
	_r := objc.Send[CMVideoDimensions](objref.IDOf(cps), objc.RegisterName("maxPhotoDimensions"))
	return _r
}
