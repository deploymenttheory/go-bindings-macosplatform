...
func (e Error) String() string {
	...
	case ErrorUserFallback:
		return "ErrorUserFallback"
	case ErrorSystemCancel:
		return "ErrorSystemCancel"
	case ErrorPasscodeNotSet:
		return "ErrorPasscodeNotSet"
	case ErrorTouchIDNotAvailable:
		return "ErrorTouchIDNotAvailable"
	case ErrorTouchIDNotEnrolled:
		return "ErrorTouchIDNotEnrolled"
	case ErrorTouchIDLockout:
		return "ErrorTouchIDLockout"
	case ErrorAppCancel:
		return "ErrorAppCancel"
	case ErrorInvalidContext:
		return "ErrorInvalidContext"
	case ErrorNotInteractive:
		return "ErrorNotInteractive"
	case ErrorWatchNotAvailable:
		return "ErrorWatchNotAvailable"
	case ErrorBiometryNotPaired:
		return "ErrorBiometryNotPaired"
	case ErrorBiometryDisconnected:
		return "ErrorBiometryDisconnected"
	case ErrorInvalidDimensions:
		return "ErrorInvalidDimensions"
	default:
