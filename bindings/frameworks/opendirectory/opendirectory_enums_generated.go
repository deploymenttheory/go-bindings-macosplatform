...
const (
	PacketEncryptionAllow    = 1
	PacketEncryptionDisabled = 0
	PacketEncryptionRequired = 2
	PacketEncryptionSSL      = 3
	PacketSigningAllow       = 1
	PacketSigningDisabled    = 0
	PacketSigningRequired    = 2
)
