...
func (cpag *CNNPoolingAverageGradient) WithLabel(label string) *CNNPoolingAverageGradient {
	objc.Send[objc.ID](objref.IDOf(cpag), objc.RegisterName("setLabel:"), purego.NSString(label))
	return cpag
}
