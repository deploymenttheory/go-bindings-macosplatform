...
func (nrcs *NNReduceColumnSum) WithClipRectSource(clipRectSource metal.MTLRegion) *NNReduceColumnSum {
	objc.Send[objc.ID](objref.IDOf(nrcs), objc.RegisterName("setClipRectSource:"), clipRectSource)
	return nrcs
}
...
func (nrcs *NNReduceColumnSum) WithOffset(offset mpscore.MPSOffset) *NNReduceColumnSum {
	objc.Send[objc.ID](objref.IDOf(nrcs), objc.RegisterName("setOffset:"), offset)
	return nrcs
}
...
func (nrcs *NNReduceColumnSum) WithClipRect(clipRect metal.MTLRegion) *NNReduceColumnSum {
	objc.Send[objc.ID](objref.IDOf(nrcs), objc.RegisterName("setClipRect:"), clipRect)
	return nrcs
}
...
func (nrcs *NNReduceColumnSum) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *NNReduceColumnSum {
	objc.Send[objc.ID](objref.IDOf(nrcs), objc.RegisterName("setDestinationFeatureChannelOffset:"), destinationFeatureChannelOffset)
	return nrcs
}
...
func (nrcs *NNReduceColumnSum) WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *NNReduceColumnSum {
	objc.Send[objc.ID](objref.IDOf(nrcs), objc.RegisterName("setSourceFeatureChannelOffset:"), sourceFeatureChannelOffset)
	return nrcs
}
...
func (nrcs *NNReduceColumnSum) WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *NNReduceColumnSum {
	objc.Send[objc.ID](objref.IDOf(nrcs), objc.RegisterName("setSourceFeatureChannelMaxCount:"), sourceFeatureChannelMaxCount)
	return nrcs
}

// WithLabel sets the string that identifies the kernel.
func (nrcs *NNReduceColumnSum) WithLabel(label string) *NNReduceColumnSum {
	objc.Send[objc.ID](objref.IDOf(nrcs), objc.RegisterName("setLabel:"), purego.NSString(label))
	return nrcs
}
