...
// Apple documentation: https://developer.apple.com/documentation/metalperformanceshaders/mpstemporaryndarray
...
func MPSTemporaryNDArrayDefaultAllocator() mpscore.MPSNDArrayAllocator {
	_ret := objc.Send[mpscore.MPSNDArrayAllocator](objc.ID(_clsMPSTemporaryNDArray), _mPSTemporaryNDArraySelDefaultAllocator)
	return _ret
}
