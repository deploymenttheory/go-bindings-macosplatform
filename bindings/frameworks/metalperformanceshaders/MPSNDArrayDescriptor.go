...
// Apple documentation: https://developer.apple.com/documentation/metalperformanceshaders/mpsndarraydescriptor
...
func (o *MPSNDArrayDescriptor) SliceRangeForDimension(dimensionIndex uint) mpscore.MPSDimensionSlice {
	_ret := objc.Send[mpscore.MPSDimensionSlice](o.Ptr(), _mPSNDArrayDescriptorSelSliceRangeForDimension, dimensionIndex)
	return _ret
}
...
func (o *MPSNDArrayDescriptor) SliceDimensionWithSubrange(dimensionIndex uint, subRange mpscore.MPSDimensionSlice) {
...
func (o *MPSNDArrayDescriptor) DataType() mpscore.MPSDataType {
	_ret := objc.Send[mpscore.MPSDataType](o.Ptr(), _mPSNDArrayDescriptorSelDataType)
	return _ret
}

func (o *MPSNDArrayDescriptor) SetDataType(dataType mpscore.MPSDataType) {
