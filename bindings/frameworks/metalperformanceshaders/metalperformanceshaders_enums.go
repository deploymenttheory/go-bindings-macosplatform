...
func (e MPSDeviceOptions) String() string {
	var parts []string
	if e&MPSDeviceOptionsLowPower != 0 { parts = append(parts, "MPSDeviceOptionsLowPower") }
	if e&MPSDeviceOptionsSkipRemovable != 0 { parts = append(parts, "MPSDeviceOptionsSkipRemovable") }
