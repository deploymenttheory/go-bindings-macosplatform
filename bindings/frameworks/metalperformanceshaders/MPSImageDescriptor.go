...
func (o *MPSImageDescriptor) CopyWithZone(zone unsafe.Pointer) *MPSImageDescriptor {
	_ret := objc.Send[objc.ID](o.Ptr(), _mPSImageDescriptorSelCopyWithZone, zone)
	return MPSImageDescriptorFromID(_ret)
}
...
func (o *MPSImageDescriptor) ChannelFormat() mpscore.MPSImageFeatureChannelFormat {
	_ret := objc.Send[mpscore.MPSImageFeatureChannelFormat](o.Ptr(), _mPSImageDescriptorSelChannelFormat)
	return _ret
}

func (o *MPSImageDescriptor) SetChannelFormat(channelFormat mpscore.MPSImageFeatureChannelFormat) {
