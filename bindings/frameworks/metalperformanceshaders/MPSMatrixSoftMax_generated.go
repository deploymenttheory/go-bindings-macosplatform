...
func (msm *MatrixSoftMax) WithLabel(label string) *MatrixSoftMax {
	objc.Send[objc.ID](objref.IDOf(msm), objc.RegisterName("setLabel:"), purego.NSString(label))
	return msm
}
...
var _ KernelProvider = (*MatrixSoftMax)(nil)
