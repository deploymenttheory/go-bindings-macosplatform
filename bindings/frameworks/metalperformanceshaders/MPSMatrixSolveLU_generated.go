...
func (msl *MatrixSolveLU) WithLabel(label string) *MatrixSolveLU {
	objc.Send[objc.ID](objref.IDOf(msl), objc.RegisterName("setLabel:"), purego.NSString(label))
	return msl
}

var _ MatrixBinaryKernelProvider = (*MatrixSolveLU)(nil)

var _ KernelProvider = (*MatrixSolveLU)(nil)
