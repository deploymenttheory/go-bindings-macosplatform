...
func (mrm *MatrixRandomMTGP32) WithLabel(label string) *MatrixRandomMTGP32 {
	objc.Send[objc.ID](objref.IDOf(mrm), objc.RegisterName("setLabel:"), purego.NSString(label))
	return mrm
}
