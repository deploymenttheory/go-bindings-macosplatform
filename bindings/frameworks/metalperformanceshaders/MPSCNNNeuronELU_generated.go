...
// CNNNeuronELU is an idiomatic wrapper over the Objective-C class MPSCNNNeuronELU.
//
...
// CNNNeuronELUFromID adopts an existing Objective-C object as a CNNNeuronELU
...
// cNNNeuronELUAdopt wraps an Objective-C object that this code just created as a
// CNNNeuronELU (nil for 0). The caller already owns the object's reference,
// so this does not add another; it only arranges for the object to be released
// once Go stops using it. Constructors use it.
func cNNNeuronELUAdopt(id objc.ID) *CNNNeuronELU {
	if id == 0 {
		return nil
	}
	x := &CNNNeuronELU{}
...
// NewCNNNeuronELU creates a new CNNNeuronELU.
func NewCNNNeuronELU() *CNNNeuronELU {
	_id := objc.Send[objc.ID](objc.ID(_class("MPSCNNNeuronELU")), objc.RegisterName("new"))
	return cNNNeuronELUAdopt(_id)
}

// WithOffset sets the position of the destination image’s clip rectangle origin, relative to the source image.
func (cne *CNNNeuronELU) WithOffset(offset mpscore.MPSOffset) *CNNNeuronELU {
...
func (cne *CNNNeuronELU) WithClipRect(clipRect metal.MTLRegion) *CNNNeuronELU {
...
func (cne *CNNNeuronELU) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNNeuronELU {
...
func (cne *CNNNeuronELU) WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *CNNNeuronELU {
...
func (cne *CNNNeuronELU) WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *CNNNeuronELU {
...
func (cne *CNNNeuronELU) WithLabel(label string) *CNNNeuronELU {
	objc.Send[objc.ID](objref.IDOf(cne), objc.RegisterName("setLabel:"), purego.NSString(label))
	return cne
}

var _ CNNNeuronProvider = (*CNNNeuronELU)(nil)

var _ CNNKernelProvider = (*CNNNeuronELU)(nil)

var _ KernelProvider = (*CNNNeuronELU)(nil)
