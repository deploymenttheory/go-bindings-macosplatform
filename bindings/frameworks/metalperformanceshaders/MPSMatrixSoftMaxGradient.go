...
func (o *MPSMatrixSoftMaxGradient) CopyWithZoneDevice(zone unsafe.Pointer, device metal.MTLDevice) *MPSMatrixSoftMaxGradient {
	_ret := objc.Send[objc.ID](o.Ptr(), _mPSMatrixSoftMaxGradientSelCopyWithZoneDevice, zone, device)
	return MPSMatrixSoftMaxGradientFromID(_ret)
}
