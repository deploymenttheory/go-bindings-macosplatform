...
func (mdl *MatrixDecompositionLU) WithLabel(label string) *MatrixDecompositionLU {
	objc.Send[objc.ID](objref.IDOf(mdl), objc.RegisterName("setLabel:"), purego.NSString(label))
	return mdl
}
