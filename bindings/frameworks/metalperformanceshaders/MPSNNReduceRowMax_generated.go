...
func (nrrm *NNReduceRowMax) WithClipRectSource(clipRectSource metal.MTLRegion) *NNReduceRowMax {
...
func (nrrm *NNReduceRowMax) WithOffset(offset mpscore.MPSOffset) *NNReduceRowMax {
...
func (nrrm *NNReduceRowMax) WithClipRect(clipRect metal.MTLRegion) *NNReduceRowMax {
...
func (nrrm *NNReduceRowMax) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *NNReduceRowMax {
...
func (nrrm *NNReduceRowMax) WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *NNReduceRowMax {
...
func (nrrm *NNReduceRowMax) WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *NNReduceRowMax {
...
func (nrrm *NNReduceRowMax) WithLabel(label string) *NNReduceRowMax {
