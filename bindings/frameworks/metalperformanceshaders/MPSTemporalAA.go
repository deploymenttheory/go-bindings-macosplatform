...
// Apple documentation: https://developer.apple.com/documentation/metalperformanceshaders/mpstemporalaa
...
func (o *MPSTemporalAA) CopyWithZoneDevice(zone unsafe.Pointer, device metal.MTLDevice) *MPSTemporalAA {
	_ret := objc.Send[objc.ID](o.Ptr(), _mPSTemporalAASelCopyWithZoneDevice, zone, device)
	return MPSTemporalAAFromID(_ret)
}
