...
func (csmg *CNNSoftMaxGradient) WithLabel(label string) *CNNSoftMaxGradient {
	objc.Send[objc.ID](objref.IDOf(csmg), objc.RegisterName("setLabel:"), purego.NSString(label))
	return csmg
}
...
var _ KernelProvider = (*CNNSoftMaxGradient)(nil)
