...
// Apple documentation: https://developer.apple.com/documentation/metalperformanceshaders/mpsmatrixrandomphilox
...
func (o *MPSMatrixRandomPhilox) InitWithDeviceDestinationDataTypeSeedDistributionDescriptor(device metal.MTLDevice, destinationDataType mpscore.MPSDataType, seed uint, distributionDescriptor *mpsmatrix.MPSMatrixRandomDistributionDescriptor) *MPSMatrixRandomPhilox {
