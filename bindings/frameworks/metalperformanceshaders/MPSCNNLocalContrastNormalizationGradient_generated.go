...
func (clcng *CNNLocalContrastNormalizationGradient) WithLabel(label string) *CNNLocalContrastNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(clcng), objc.RegisterName("setLabel:"), purego.NSString(label))
	return clcng
}
...
var _ KernelProvider = (*CNNLocalContrastNormalizationGradient)(nil)
