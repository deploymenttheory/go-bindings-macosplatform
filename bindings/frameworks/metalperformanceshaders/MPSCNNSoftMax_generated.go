...
func (csm *CNNSoftMax) WithOffset(offset mpscore.MPSOffset) *CNNSoftMax {
	objc.Send[objc.ID](objref.IDOf(csm), objc.RegisterName("setOffset:"), offset)
	return csm
}
...
func (csm *CNNSoftMax) WithClipRect(clipRect metal.MTLRegion) *CNNSoftMax {
	objc.Send[objc.ID](objref.IDOf(csm), objc.RegisterName("setClipRect:"), clipRect)
	return csm
}
...
func (csm *CNNSoftMax) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNSoftMax {
	objc.Send[objc.ID](objref.IDOf(csm), objc.RegisterName("setDestinationFeatureChannelOffset:"), destinationFeatureChannelOffset)
	return csm
}
...
func (csm *CNNSoftMax) WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *CNNSoftMax {
	objc.Send[objc.ID](objref.IDOf(csm), objc.RegisterName("setSourceFeatureChannelOffset:"), sourceFeatureChannelOffset)
	return csm
}
...
func (csm *CNNSoftMax) WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *CNNSoftMax {
	objc.Send[objc.ID](objref.IDOf(csm), objc.RegisterName("setSourceFeatureChannelMaxCount:"), sourceFeatureChannelMaxCount)
	return csm
}

// WithLabel sets the string that identifies the kernel.
func (csm *CNNSoftMax) WithLabel(label string) *CNNSoftMax {
	objc.Send[objc.ID](objref.IDOf(csm), objc.RegisterName("setLabel:"), purego.NSString(label))
	return csm
}

var _ CNNKernelProvider = (*CNNSoftMax)(nil)

var _ KernelProvider = (*CNNSoftMax)(nil)
