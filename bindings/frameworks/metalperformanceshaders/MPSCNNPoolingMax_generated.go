...
func (cpm *CNNPoolingMax) WithLabel(label string) *CNNPoolingMax {
	objc.Send[objc.ID](objref.IDOf(cpm), objc.RegisterName("setLabel:"), purego.NSString(label))
	return cpm
}
...
var _ KernelProvider = (*CNNPoolingMax)(nil)
