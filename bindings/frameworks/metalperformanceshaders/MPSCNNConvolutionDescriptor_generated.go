...
func (ccd *CNNConvolutionDescriptor) SetBatchNormalizationParametersForInferenceWithMeanVarianceGammaBetaEpsilon(epsilon float32) (mean float32, variance float32, gamma float32, beta float32) {
	defer runtime.KeepAlive(ccd)
	var _out0 float32
	var _out1 float32
	var _out2 float32
