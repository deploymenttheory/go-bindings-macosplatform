...
func (cplng *CNNPoolingL2NormGradient) WithLabel(label string) *CNNPoolingL2NormGradient {
	objc.Send[objc.ID](objref.IDOf(cplng), objc.RegisterName("setLabel:"), purego.NSString(label))
	return cplng
}
...
var _ KernelProvider = (*CNNPoolingL2NormGradient)(nil)
