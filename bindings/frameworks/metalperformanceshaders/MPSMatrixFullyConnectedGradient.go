...
// Apple documentation: https://developer.apple.com/documentation/metalperformanceshaders/mpsmatrixfullyconnectedgradient
...
func (o *MPSMatrixFullyConnectedGradient) CopyWithZoneDevice(zone unsafe.Pointer, device metal.MTLDevice) *MPSMatrixFullyConnectedGradient {
	_ret := objc.Send[objc.ID](o.Ptr(), _mPSMatrixFullyConnectedGradientSelCopyWithZoneDevice, zone, device)
	return MPSMatrixFullyConnectedGradientFromID(_ret)
}
