...
// NNGramMatrixCalculationGradient is an idiomatic wrapper over the Objective-C class MPSNNGramMatrixCalculationGradient.
//
...
// NNGramMatrixCalculationGradientFromID adopts an existing Objective-C object as a NNGramMatrixCalculationGradient
// (nil for 0), retaining it and registering a release finalizer.
func NNGramMatrixCalculationGradientFromID(id objc.ID) *NNGramMatrixCalculationGradient {
	if id == 0 {
		return nil
	}
	x := &NNGramMatrixCalculationGradient{}
	x.Handle = objref.Wrap(purego.Retain(id))
	objref.Track(x)
	return x
}

// nNGramMatrixCalculationGradientAdopt wraps an Objective-C object that this code just created as a
// NNGramMatrixCalculationGradient (nil for 0). The caller already owns the object's reference,
// so this does not add another; it only arranges for the object to be released
// once Go stops using it. Constructors use it.
func nNGramMatrixCalculationGradientAdopt(id objc.ID) *NNGramMatrixCalculationGradient {
	if id == 0 {
		return nil
	}
	x := &NNGramMatrixCalculationGradient{}
...
// NewNNGramMatrixCalculationGradient creates a new NNGramMatrixCalculationGradient.
func NewNNGramMatrixCalculationGradient() *NNGramMatrixCalculationGradient {
	_id := objc.Send[objc.ID](objc.ID(_class("MPSNNGramMatrixCalculationGradient")), objc.RegisterName("new"))
	return nNGramMatrixCalculationGradientAdopt(_id)
}

// WithAlpha sets scaling factor for the output. Default: 1.0f. NOTE: the value for alpha is automatically adjusted by the
func (ngmcg *NNGramMatrixCalculationGradient) WithAlpha(alpha float32) *NNGramMatrixCalculationGradient {
	objc.Send[objc.ID](objref.IDOf(ngmcg), objc.RegisterName("setAlpha:"), alpha)
	return ngmcg
}
...
func (ngmcg *NNGramMatrixCalculationGradient) WithKernelOffsetX(kernelOffsetX int) *NNGramMatrixCalculationGradient {
	objc.Send[objc.ID](objref.IDOf(ngmcg), objc.RegisterName("setKernelOffsetX:"), kernelOffsetX)
	return ngmcg
}
...
func (ngmcg *NNGramMatrixCalculationGradient) WithKernelOffsetY(kernelOffsetY int) *NNGramMatrixCalculationGradient {
	objc.Send[objc.ID](objref.IDOf(ngmcg), objc.RegisterName("setKernelOffsetY:"), kernelOffsetY)
	return ngmcg
}
...
func (ngmcg *NNGramMatrixCalculationGradient) WithPrimaryOffset(primaryOffset mpscore.MPSOffset) *NNGramMatrixCalculationGradient {
	objc.Send[objc.ID](objref.IDOf(ngmcg), objc.RegisterName("setPrimaryOffset:"), primaryOffset)
	return ngmcg
}
...
func (ngmcg *NNGramMatrixCalculationGradient) WithSecondaryOffset(secondaryOffset mpscore.MPSOffset) *NNGramMatrixCalculationGradient {
	objc.Send[objc.ID](objref.IDOf(ngmcg), objc.RegisterName("setSecondaryOffset:"), secondaryOffset)
	return ngmcg
}
...
func (ngmcg *NNGramMatrixCalculationGradient) WithClipRect(clipRect metal.MTLRegion) *NNGramMatrixCalculationGradient {
	objc.Send[objc.ID](objref.IDOf(ngmcg), objc.RegisterName("setClipRect:"), clipRect)
	return ngmcg
}
...
func (ngmcg *NNGramMatrixCalculationGradient) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *NNGramMatrixCalculationGradient {
	objc.Send[objc.ID](objref.IDOf(ngmcg), objc.RegisterName("setDestinationFeatureChannelOffset:"), destinationFeatureChannelOffset)
	return ngmcg
}
...
func (ngmcg *NNGramMatrixCalculationGradient) WithPrimarySourceFeatureChannelOffset(primarySourceFeatureChannelOffset int) *NNGramMatrixCalculationGradient {
	objc.Send[objc.ID](objref.IDOf(ngmcg), objc.RegisterName("setPrimarySourceFeatureChannelOffset:"), primarySourceFeatureChannelOffset)
	return ngmcg
}
...
func (ngmcg *NNGramMatrixCalculationGradient) WithSecondarySourceFeatureChannelOffset(secondarySourceFeatureChannelOffset int) *NNGramMatrixCalculationGradient {
	objc.Send[objc.ID](objref.IDOf(ngmcg), objc.RegisterName("setSecondarySourceFeatureChannelOffset:"), secondarySourceFeatureChannelOffset)
	return ngmcg
}
...
func (ngmcg *NNGramMatrixCalculationGradient) WithPrimarySourceFeatureChannelMaxCount(primarySourceFeatureChannelMaxCount int) *NNGramMatrixCalculationGradient {
	objc.Send[objc.ID](objref.IDOf(ngmcg), objc.RegisterName("setPrimarySourceFeatureChannelMaxCount:"), primarySourceFeatureChannelMaxCount)
	return ngmcg
}
...
func (ngmcg *NNGramMatrixCalculationGradient) WithSecondarySourceFeatureChannelMaxCount(secondarySourceFeatureChannelMaxCount int) *NNGramMatrixCalculationGradient {
	objc.Send[objc.ID](objref.IDOf(ngmcg), objc.RegisterName("setSecondarySourceFeatureChannelMaxCount:"), secondarySourceFeatureChannelMaxCount)
	return ngmcg
}
...
func (ngmcg *NNGramMatrixCalculationGradient) WithPrimaryStrideInPixelsX(primaryStrideInPixelsX int) *NNGramMatrixCalculationGradient {
	objc.Send[objc.ID](objref.IDOf(ngmcg), objc.RegisterName("setPrimaryStrideInPixelsX:"), primaryStrideInPixelsX)
	return ngmcg
}
...
func (ngmcg *NNGramMatrixCalculationGradient) WithPrimaryStrideInPixelsY(primaryStrideInPixelsY int) *NNGramMatrixCalculationGradient {
	objc.Send[objc.ID](objref.IDOf(ngmcg), objc.RegisterName("setPrimaryStrideInPixelsY:"), primaryStrideInPixelsY)
	return ngmcg
}
...
func (ngmcg *NNGramMatrixCalculationGradient) WithSecondaryStrideInPixelsX(secondaryStrideInPixelsX int) *NNGramMatrixCalculationGradient {
	objc.Send[objc.ID](objref.IDOf(ngmcg), objc.RegisterName("setSecondaryStrideInPixelsX:"), secondaryStrideInPixelsX)
	return ngmcg
}
...
func (ngmcg *NNGramMatrixCalculationGradient) WithSecondaryStrideInPixelsY(secondaryStrideInPixelsY int) *NNGramMatrixCalculationGradient {
	objc.Send[objc.ID](objref.IDOf(ngmcg), objc.RegisterName("setSecondaryStrideInPixelsY:"), secondaryStrideInPixelsY)
	return ngmcg
}

// WithLabel sets the string that identifies the kernel.
func (ngmcg *NNGramMatrixCalculationGradient) WithLabel(label string) *NNGramMatrixCalculationGradient {
	objc.Send[objc.ID](objref.IDOf(ngmcg), objc.RegisterName("setLabel:"), purego.NSString(label))
	return ngmcg
}
...
var _ CNNGradientKernelProvider = (*NNGramMatrixCalculationGradient)(nil)

var _ CNNBinaryKernelProvider = (*NNGramMatrixCalculationGradient)(nil)

var _ KernelProvider = (*NNGramMatrixCalculationGradient)(nil)
