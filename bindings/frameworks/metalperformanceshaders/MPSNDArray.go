...
// Apple documentation: https://developer.apple.com/documentation/metalperformanceshaders/mpsndarray
...
func MPSNDArrayDefaultAllocator() mpscore.MPSNDArrayAllocator {
	_ret := objc.Send[mpscore.MPSNDArrayAllocator](objc.ID(_clsMPSNDArray), _mPSNDArraySelDefaultAllocator)
	return _ret
}
...
func (o *MPSNDArray) ExportDataWithCommandBufferToBufferDestinationDataTypeOffsetRowStrides(cmdBuf metal.MTLCommandBuffer, buffer metal.MTLBuffer, destinationDataType mpscore.MPSDataType, offset uint, rowStrides *int64) {
...
func (o *MPSNDArray) ImportDataWithCommandBufferFromBufferSourceDataTypeOffsetRowStrides(cmdBuf metal.MTLCommandBuffer, buffer metal.MTLBuffer, sourceDataType mpscore.MPSDataType, offset uint, rowStrides *int64) {
...
func (o *MPSNDArray) ExportDataWithCommandBufferToImagesOffset(cmdBuf metal.MTLCommandBuffer, images unsafe.Pointer, offset mpscore.MPSImageCoordinate) {
...
func (o *MPSNDArray) ImportDataWithCommandBufferFromImagesOffset(cmdBuf metal.MTLCommandBuffer, images unsafe.Pointer, offset mpscore.MPSImageCoordinate) {
...
func (o *MPSNDArray) DataType() mpscore.MPSDataType {
	_ret := objc.Send[mpscore.MPSDataType](o.Ptr(), _mPSNDArraySelDataType)
	return _ret
}
