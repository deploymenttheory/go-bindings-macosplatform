...
func (ck *CNNKernel) WithLabel(label string) *CNNKernel {
	objc.Send[objc.ID](objref.IDOf(ck), objc.RegisterName("setLabel:"), purego.NSString(label))
	return ck
}
...
var _ KernelProvider = (*CNNKernel)(nil)
