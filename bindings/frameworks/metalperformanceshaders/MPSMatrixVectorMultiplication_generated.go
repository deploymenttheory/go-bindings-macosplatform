...
func (mvm *MatrixVectorMultiplication) WithLabel(label string) *MatrixVectorMultiplication {
	objc.Send[objc.ID](objref.IDOf(mvm), objc.RegisterName("setLabel:"), purego.NSString(label))
	return mvm
}
