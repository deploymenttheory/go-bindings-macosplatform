...
func MPSVectorDescriptorVectorBytesForLengthDataType(length uint, dataType mpscore.MPSDataType) uint {
...
func (o *MPSVectorDescriptor) DataType() mpscore.MPSDataType {
	_ret := objc.Send[mpscore.MPSDataType](o.Ptr(), _mPSVectorDescriptorSelDataType)
	return _ret
}

func (o *MPSVectorDescriptor) SetDataType(dataType mpscore.MPSDataType) {
