...
func (ircm *ImageReduceColumnMin) WithLabel(label string) *ImageReduceColumnMin {
	objc.Send[objc.ID](objref.IDOf(ircm), objc.RegisterName("setLabel:"), purego.NSString(label))
	return ircm
}
