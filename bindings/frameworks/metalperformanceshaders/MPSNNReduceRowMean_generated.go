...
func (nrrm *NNReduceRowMean) WithClipRectSource(clipRectSource metal.MTLRegion) *NNReduceRowMean {
...
func (nrrm *NNReduceRowMean) WithOffset(offset mpscore.MPSOffset) *NNReduceRowMean {
...
func (nrrm *NNReduceRowMean) WithClipRect(clipRect metal.MTLRegion) *NNReduceRowMean {
...
func (nrrm *NNReduceRowMean) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *NNReduceRowMean {
...
func (nrrm *NNReduceRowMean) WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *NNReduceRowMean {
...
func (nrrm *NNReduceRowMean) WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *NNReduceRowMean {
...
func (nrrm *NNReduceRowMean) WithLabel(label string) *NNReduceRowMean {
