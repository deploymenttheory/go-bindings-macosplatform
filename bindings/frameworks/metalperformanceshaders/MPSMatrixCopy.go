...
// Apple documentation: https://developer.apple.com/documentation/metalperformanceshaders/mpsmatrixcopy
...
func (o *MPSMatrixCopy) EncodeToCommandBufferCopyDescriptor(commandBuffer metal.MTLCommandBuffer, copyDescriptor *mpsmatrix.MPSMatrixCopyDescriptor) {
