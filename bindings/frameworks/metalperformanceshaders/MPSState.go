...
//
// Apple documentation: https://developer.apple.com/documentation/metalperformanceshaders/mpsstate
...
func (o *MPSState) TextureInfoAtIndex(index uint) mpscore.MPSStateTextureInfo {
	_ret := objc.Send[mpscore.MPSStateTextureInfo](o.Ptr(), _mPSStateSelTextureInfoAtIndex, index)
	return _ret
}

// @abstract Return YES if the resource at index is a buffer @discussion Does not force allocation of the MTLResource
func (o *MPSState) ResourceTypeAtIndex(index uint) mpscore.MPSStateResourceType {
	_ret := objc.Send[mpscore.MPSStateResourceType](o.Ptr(), _mPSStateSelResourceTypeAtIndex, index)
	return _ret
}
