...
func CNNInstanceNormalizationGradientFromID(id objc.ID) *CNNInstanceNormalizationGradient {
	...
	x := &CNNInstanceNormalizationGradient{}
...
func (cing *CNNInstanceNormalizationGradient) WithKernelOffsetX(kernelOffsetX int) *CNNInstanceNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(cing), objc.RegisterName("setKernelOffsetX:"), kernelOffsetX)
	return cing
}
...
func (cing *CNNInstanceNormalizationGradient) WithKernelOffsetY(kernelOffsetY int) *CNNInstanceNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(cing), objc.RegisterName("setKernelOffsetY:"), kernelOffsetY)
	return cing
}
...
func (cing *CNNInstanceNormalizationGradient) WithPrimaryOffset(primaryOffset mpscore.MPSOffset) *CNNInstanceNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(cing), objc.RegisterName("setPrimaryOffset:"), primaryOffset)
	return cing
}
...
func (cing *CNNInstanceNormalizationGradient) WithSecondaryOffset(secondaryOffset mpscore.MPSOffset) *CNNInstanceNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(cing), objc.RegisterName("setSecondaryOffset:"), secondaryOffset)
	return cing
}
...
func (cing *CNNInstanceNormalizationGradient) WithClipRect(clipRect metal.MTLRegion) *CNNInstanceNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(cing), objc.RegisterName("setClipRect:"), clipRect)
	return cing
}
...
func (cing *CNNInstanceNormalizationGradient) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNInstanceNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(cing), objc.RegisterName("setDestinationFeatureChannelOffset:"), destinationFeatureChannelOffset)
	return cing
}
...
func (cing *CNNInstanceNormalizationGradient) WithPrimarySourceFeatureChannelOffset(primarySourceFeatureChannelOffset int) *CNNInstanceNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(cing), objc.RegisterName("setPrimarySourceFeatureChannelOffset:"), primarySourceFeatureChannelOffset)
	return cing
}
...
func (cing *CNNInstanceNormalizationGradient) WithSecondarySourceFeatureChannelOffset(secondarySourceFeatureChannelOffset int) *CNNInstanceNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(cing), objc.RegisterName("setSecondarySourceFeatureChannelOffset:"), secondarySourceFeatureChannelOffset)
	return cing
}
...
func (cing *CNNInstanceNormalizationGradient) WithPrimarySourceFeatureChannelMaxCount(primarySourceFeatureChannelMaxCount int) *CNNInstanceNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(cing), objc.RegisterName("setPrimarySourceFeatureChannelMaxCount:"), primarySourceFeatureChannelMaxCount)
	return cing
}
...
func (cing *CNNInstanceNormalizationGradient) WithSecondarySourceFeatureChannelMaxCount(secondarySourceFeatureChannelMaxCount int) *CNNInstanceNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(cing), objc.RegisterName("setSecondarySourceFeatureChannelMaxCount:"), secondarySourceFeatureChannelMaxCount)
	return cing
}
...
func (cing *CNNInstanceNormalizationGradient) WithPrimaryStrideInPixelsX(primaryStrideInPixelsX int) *CNNInstanceNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(cing), objc.RegisterName("setPrimaryStrideInPixelsX:"), primaryStrideInPixelsX)
	return cing
}
...
func (cing *CNNInstanceNormalizationGradient) WithPrimaryStrideInPixelsY(primaryStrideInPixelsY int) *CNNInstanceNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(cing), objc.RegisterName("setPrimaryStrideInPixelsY:"), primaryStrideInPixelsY)
	return cing
}
...
func (cing *CNNInstanceNormalizationGradient) WithSecondaryStrideInPixelsX(secondaryStrideInPixelsX int) *CNNInstanceNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(cing), objc.RegisterName("setSecondaryStrideInPixelsX:"), secondaryStrideInPixelsX)
	return cing
}
...
func (cing *CNNInstanceNormalizationGradient) WithSecondaryStrideInPixelsY(secondaryStrideInPixelsY int) *CNNInstanceNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(cing), objc.RegisterName("setSecondaryStrideInPixelsY:"), secondaryStrideInPixelsY)
	return cing
}

// WithLabel sets the string that identifies the kernel.
func (cing *CNNInstanceNormalizationGradient) WithLabel(label string) *CNNInstanceNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(cing), objc.RegisterName("setLabel:"), purego.NSString(label))
	return cing
}

var _ CNNGradientKernelProvider = (*CNNInstanceNormalizationGradient)(nil)

var _ CNNBinaryKernelProvider = (*CNNInstanceNormalizationGradient)(nil)

var _ KernelProvider = (*CNNInstanceNormalizationGradient)(nil)
