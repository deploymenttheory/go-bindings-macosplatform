...
func (csn *CNNSpatialNormalization) WithLabel(label string) *CNNSpatialNormalization {
	objc.Send[objc.ID](objref.IDOf(csn), objc.RegisterName("setLabel:"), purego.NSString(label))
	return csn
}
