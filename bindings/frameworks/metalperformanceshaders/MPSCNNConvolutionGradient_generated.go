...
func (ccg *CNNConvolutionGradient) WithLabel(label string) *CNNConvolutionGradient {
	objc.Send[objc.ID](objref.IDOf(ccg), objc.RegisterName("setLabel:"), purego.NSString(label))
	return ccg
}
