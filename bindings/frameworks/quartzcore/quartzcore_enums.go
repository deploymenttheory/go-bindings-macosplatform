...
func (e CAAutoresizingMask) String() string {
	var parts []string
	if e&KCALayerMinXMargin != 0 { parts = append(parts, "KCALayerMinXMargin") }
	if e&KCALayerWidthSizable != 0 { parts = append(parts, "KCALayerWidthSizable") }
	if e&KCALayerMaxXMargin != 0 { parts = append(parts, "KCALayerMaxXMargin") }
	if e&KCALayerMinYMargin != 0 { parts = append(parts, "KCALayerMinYMargin") }
	if e&KCALayerHeightSizable != 0 { parts = append(parts, "KCALayerHeightSizable") }
	if e&KCALayerMaxYMargin != 0 { parts = append(parts, "KCALayerMaxYMargin") }
...
func (e CACornerMask) String() string {
	var parts []string
	if e&KCALayerMinXMinYCorner != 0 { parts = append(parts, "KCALayerMinXMinYCorner") }
	if e&KCALayerMaxXMinYCorner != 0 { parts = append(parts, "KCALayerMaxXMinYCorner") }
	if e&KCALayerMinXMaxYCorner != 0 { parts = append(parts, "KCALayerMinXMaxYCorner") }
	if e&KCALayerMaxXMaxYCorner != 0 { parts = append(parts, "KCALayerMaxXMaxYCorner") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
func (e CAEdgeAntialiasingMask) String() string {
	var parts []string
	if e&KCALayerLeftEdge != 0 { parts = append(parts, "KCALayerLeftEdge") }
	if e&KCALayerRightEdge != 0 { parts = append(parts, "KCALayerRightEdge") }
	if e&KCALayerBottomEdge != 0 { parts = append(parts, "KCALayerBottomEdge") }
	if e&KCALayerTopEdge != 0 { parts = append(parts, "KCALayerTopEdge") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
