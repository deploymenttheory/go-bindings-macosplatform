...
// WithTimingMode sets the timing mode used to execute an action.
...
// WithTimingFunction sets a block SceneKit calls to determine the action’s animation timing.
