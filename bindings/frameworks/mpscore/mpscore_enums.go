...
func (e MPSAliasingStrategy) String() string {
	var parts []string
	if e&MPSAliasingStrategyShallAlias != 0 { parts = append(parts, "MPSAliasingStrategyShallAlias") }
	if e&MPSAliasingStrategyShallNotAlias != 0 { parts = append(parts, "MPSAliasingStrategyShallNotAlias") }
	if e&MPSAliasingStrategyAliasingReserved != 0 { parts = append(parts, "MPSAliasingStrategyAliasingReserved") }
	if e&MPSAliasingStrategyPreferTemporaryMemory != 0 { parts = append(parts, "MPSAliasingStrategyPreferTemporaryMemory") }
	if e&MPSAliasingStrategyPreferNonTemporaryMemory != 0 { parts = append(parts, "MPSAliasingStrategyPreferNonTemporaryMemory") }
...
func (e MPSKernelOptions) String() string {
	var parts []string
	if e&MPSKernelOptionsSkipAPIValidation != 0 { parts = append(parts, "MPSKernelOptionsSkipAPIValidation") }
	if e&MPSKernelOptionsAllowReducedPrecision != 0 { parts = append(parts, "MPSKernelOptionsAllowReducedPrecision") }
	if e&MPSKernelOptionsDisableInternalTiling != 0 { parts = append(parts, "MPSKernelOptionsDisableInternalTiling") }
	if e&MPSKernelOptionsInsertDebugGroups != 0 { parts = append(parts, "MPSKernelOptionsInsertDebugGroups") }
	if e&MPSKernelOptionsVerbose != 0 { parts = append(parts, "MPSKernelOptionsVerbose") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
