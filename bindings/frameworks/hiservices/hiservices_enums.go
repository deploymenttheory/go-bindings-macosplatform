...
func (e AXMenuItemModifiers) String() string {
	var parts []string
	if e&KAXMenuItemModifierShift != 0 {
		parts = append(parts, "KAXMenuItemModifierShift")
	}
	if e&KAXMenuItemModifierOption != 0 {
		parts = append(parts, "KAXMenuItemModifierOption")
	}
	if e&KAXMenuItemModifierControl != 0 {
		parts = append(parts, "KAXMenuItemModifierControl")
	}
	if e&KAXMenuItemModifierNoCommand != 0 {
		parts = append(parts, "KAXMenuItemModifierNoCommand")
	}
	if len(parts) == 0 {
		return "0"
	}
