...
func (e PHPickerCapabilities) String() string {
	var parts []string
	if e&PHPickerCapabilitiesSearch != 0 { parts = append(parts, "PHPickerCapabilitiesSearch") }
	if e&PHPickerCapabilitiesStagingArea != 0 { parts = append(parts, "PHPickerCapabilitiesStagingArea") }
	if e&PHPickerCapabilitiesCollectionNavigation != 0 { parts = append(parts, "PHPickerCapabilitiesCollectionNavigation") }
	if e&PHPickerCapabilitiesSelectionActions != 0 { parts = append(parts, "PHPickerCapabilitiesSelectionActions") }
	if e&PHPickerCapabilitiesSensitivityAnalysisIntervention != 0 { parts = append(parts, "PHPickerCapabilitiesSensitivityAnalysisIntervention") }
