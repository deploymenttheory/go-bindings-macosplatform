...
func (e OSALanguageFeatures) String() string {
	var parts []string
	if e&OSASupportsCompiling != 0 { parts = append(parts, "OSASupportsCompiling") }
	if e&OSASupportsGetSource != 0 { parts = append(parts, "OSASupportsGetSource") }
	if e&OSASupportsAECoercion != 0 { parts = append(parts, "OSASupportsAECoercion") }
	if e&OSASupportsAESending != 0 { parts = append(parts, "OSASupportsAESending") }
	if e&OSASupportsRecording != 0 { parts = append(parts, "OSASupportsRecording") }
	if e&OSASupportsConvenience != 0 { parts = append(parts, "OSASupportsConvenience") }
	if e&OSASupportsDialects != 0 { parts = append(parts, "OSASupportsDialects") }
	if e&OSASupportsEventHandling != 0 { parts = append(parts, "OSASupportsEventHandling") }
...
func (e OSAStorageOptions) String() string {
	var parts []string
	if e&OSAPreventGetSource != 0 { parts = append(parts, "OSAPreventGetSource") }
	if e&OSACompileIntoContext != 0 { parts = append(parts, "OSACompileIntoContext") }
	if e&OSADontSetScriptLocation != 0 { parts = append(parts, "OSADontSetScriptLocation") }
	if e&OSAStayOpenApplet != 0 { parts = append(parts, "OSAStayOpenApplet") }
	if e&OSAShowStartupScreen != 0 { parts = append(parts, "OSAShowStartupScreen") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
