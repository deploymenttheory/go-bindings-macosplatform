...
func (e CMAttitudeReferenceFrame) String() string {
	var parts []string
	if e&CMAttitudeReferenceFrameXArbitraryZVertical != 0 { parts = append(parts, "CMAttitudeReferenceFrameXArbitraryZVertical") }
	if e&CMAttitudeReferenceFrameXArbitraryCorrectedZVertical != 0 { parts = append(parts, "CMAttitudeReferenceFrameXArbitraryCorrectedZVertical") }
	if e&CMAttitudeReferenceFrameXMagneticNorthZVertical != 0 { parts = append(parts, "CMAttitudeReferenceFrameXMagneticNorthZVertical") }
	if e&CMAttitudeReferenceFrameXTrueNorthZVertical != 0 { parts = append(parts, "CMAttitudeReferenceFrameXTrueNorthZVertical") }
...
const (
	CMErrorNULL CMError = 100
	CMErrorDeviceRequiresMovement CMError = 101
	CMErrorTrueNorthNotAvailable CMError = 102
	CMErrorUnknown CMError = 103
	CMErrorMotionActivityNotAvailable CMError = 104
	CMErrorMotionActivityNotAuthorized CMError = 105
	CMErrorMotionActivityNotEntitled CMError = 106
	CMErrorInvalidParameter CMError = 107
	CMErrorInvalidAction CMError = 108
	CMErrorNotAvailable CMError = 109
	CMErrorNotEntitled CMError = 110
	CMErrorNotAuthorized CMError = 111
	CMErrorNilData CMError = 112
	CMErrorSize CMError = 113
)

func (e CMError) String() string {
	switch e {
	case CMErrorNULL:
		return "CMErrorNULL"
	case CMErrorDeviceRequiresMovement:
		return "CMErrorDeviceRequiresMovement"
	case CMErrorTrueNorthNotAvailable:
		return "CMErrorTrueNorthNotAvailable"
	case CMErrorUnknown:
		return "CMErrorUnknown"
	case CMErrorMotionActivityNotAvailable:
		return "CMErrorMotionActivityNotAvailable"
	case CMErrorMotionActivityNotAuthorized:
		return "CMErrorMotionActivityNotAuthorized"
	case CMErrorMotionActivityNotEntitled:
		return "CMErrorMotionActivityNotEntitled"
	case CMErrorInvalidParameter:
		return "CMErrorInvalidParameter"
	case CMErrorInvalidAction:
		return "CMErrorInvalidAction"
	case CMErrorNotAvailable:
		return "CMErrorNotAvailable"
	case CMErrorNotEntitled:
		return "CMErrorNotEntitled"
	case CMErrorNotAuthorized:
		return "CMErrorNotAuthorized"
	case CMErrorNilData:
		return "CMErrorNilData"
	case CMErrorSize:
		return "CMErrorSize"
	default:
		return fmt.Sprintf("CMError(%d)", int64(e))
	}
}
...
func (e CMMagneticFieldCalibrationAccuracy) String() string {
	...
	case CMMagneticFieldCalibrationAccuracyUncalibrated:
		return "CMMagneticFieldCalibrationAccuracyUncalibrated"
	case CMMagneticFieldCalibrationAccuracyLow:
		return "CMMagneticFieldCalibrationAccuracyLow"
	case CMMagneticFieldCalibrationAccuracyMedium:
		return "CMMagneticFieldCalibrationAccuracyMedium"
	case CMMagneticFieldCalibrationAccuracyHigh:
		return "CMMagneticFieldCalibrationAccuracyHigh"
	default:
		return fmt.Sprintf("CMMagneticFieldCalibrationAccuracy(%d)", int64(e))
	}
}
...
const (
	...
	CMWaterSubmersionDepthStateNotSubmerged CMWaterSubmersionDepthState = 100
	CMWaterSubmersionDepthStateSubmergedShallow CMWaterSubmersionDepthState = 200
	CMWaterSubmersionDepthStateSubmergedDeep CMWaterSubmersionDepthState = 300
	CMWaterSubmersionDepthStateApproachingMaxDepth CMWaterSubmersionDepthState = 400
	CMWaterSubmersionDepthStatePastMaxDepth CMWaterSubmersionDepthState = 500
	CMWaterSubmersionDepthStateSensorDepthError CMWaterSubmersionDepthState = 600
)

func (e CMWaterSubmersionDepthState) String() string {
	switch e {
	case CMWaterSubmersionDepthStateUnknown:
		return "CMWaterSubmersionDepthStateUnknown"
	case CMWaterSubmersionDepthStateNotSubmerged:
		return "CMWaterSubmersionDepthStateNotSubmerged"
	case CMWaterSubmersionDepthStateSubmergedShallow:
		return "CMWaterSubmersionDepthStateSubmergedShallow"
	case CMWaterSubmersionDepthStateSubmergedDeep:
		return "CMWaterSubmersionDepthStateSubmergedDeep"
	case CMWaterSubmersionDepthStateApproachingMaxDepth:
		return "CMWaterSubmersionDepthStateApproachingMaxDepth"
	case CMWaterSubmersionDepthStatePastMaxDepth:
		return "CMWaterSubmersionDepthStatePastMaxDepth"
	case CMWaterSubmersionDepthStateSensorDepthError:
		return "CMWaterSubmersionDepthStateSensorDepthError"
	default:
		return fmt.Sprintf("CMWaterSubmersionDepthState(%d)", int64(e))
	}
}
...
const (
	...
	CMWaterSubmersionStateNotSubmerged CMWaterSubmersionState = 1
	CMWaterSubmersionStateSubmerged CMWaterSubmersionState = 2
)

func (e CMWaterSubmersionState) String() string {
	switch e {
	case CMWaterSubmersionStateUnknown:
		return "CMWaterSubmersionStateUnknown"
	case CMWaterSubmersionStateNotSubmerged:
		return "CMWaterSubmersionStateNotSubmerged"
	case CMWaterSubmersionStateSubmerged:
		return "CMWaterSubmersionStateSubmerged"
	default:
		return fmt.Sprintf("CMWaterSubmersionState(%d)", int64(e))
	}
}
