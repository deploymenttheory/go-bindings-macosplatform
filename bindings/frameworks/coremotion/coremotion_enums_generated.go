...
// String returns the AttitudeReferenceFrame constant's name, or its numeric form when the
// value is not a known constant.
func (e AttitudeReferenceFrame) String() string {
	var parts []string
	if e&AttitudeReferenceFrameXArbitraryZVertical != 0 {
		parts = append(parts, "AttitudeReferenceFrameXArbitraryZVertical")
	}
	if e&AttitudeReferenceFrameXArbitraryCorrectedZVertical != 0 {
		parts = append(parts, "AttitudeReferenceFrameXArbitraryCorrectedZVertical")
	}
	if e&AttitudeReferenceFrameXMagneticNorthZVertical != 0 {
		parts = append(parts, "AttitudeReferenceFrameXMagneticNorthZVertical")
	}
	if e&AttitudeReferenceFrameXTrueNorthZVertical != 0 {
		parts = append(parts, "AttitudeReferenceFrameXTrueNorthZVertical")
	}
	if len(parts) == 0 {
		return "0"
	}
...
func (e Error) String() string {
	...
	case ErrorNULL:
		return "ErrorNULL"
	case ErrorDeviceRequiresMovement:
		return "ErrorDeviceRequiresMovement"
	case ErrorTrueNorthNotAvailable:
		return "ErrorTrueNorthNotAvailable"
	case ErrorUnknown:
		return "ErrorUnknown"
	case ErrorMotionActivityNotAvailable:
		return "ErrorMotionActivityNotAvailable"
	case ErrorMotionActivityNotAuthorized:
		return "ErrorMotionActivityNotAuthorized"
	case ErrorMotionActivityNotEntitled:
		return "ErrorMotionActivityNotEntitled"
...
// String returns the WaterSubmersionDepthState constant's name, or its numeric form when the
// value is not a known constant.
func (e WaterSubmersionDepthState) String() string {
	switch e {
	case WaterSubmersionDepthStateUnknown:
		return "WaterSubmersionDepthStateUnknown"
	case WaterSubmersionDepthStateNotSubmerged:
		return "WaterSubmersionDepthStateNotSubmerged"
	case WaterSubmersionDepthStateSubmergedShallow:
		return "WaterSubmersionDepthStateSubmergedShallow"
	case WaterSubmersionDepthStateSubmergedDeep:
		return "WaterSubmersionDepthStateSubmergedDeep"
	case WaterSubmersionDepthStateApproachingMaxDepth:
		return "WaterSubmersionDepthStateApproachingMaxDepth"
	case WaterSubmersionDepthStatePastMaxDepth:
		return "WaterSubmersionDepthStatePastMaxDepth"
	case WaterSubmersionDepthStateSensorDepthError:
		return "WaterSubmersionDepthStateSensorDepthError"
	default:
		return fmt.Sprintf("WaterSubmersionDepthState(%d)", int64(e))
	}
}
...
// String returns the WaterSubmersionState constant's name, or its numeric form when the
// value is not a known constant.
func (e WaterSubmersionState) String() string {
	switch e {
	case WaterSubmersionStateUnknown:
		return "WaterSubmersionStateUnknown"
	case WaterSubmersionStateNotSubmerged:
		return "WaterSubmersionStateNotSubmerged"
	case WaterSubmersionStateSubmerged:
		return "WaterSubmersionStateSubmerged"
	default:
		return fmt.Sprintf("WaterSubmersionState(%d)", int64(e))
	}
}
