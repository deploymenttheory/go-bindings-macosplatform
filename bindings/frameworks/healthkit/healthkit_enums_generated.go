...
type CategoryValueMenopausalState int64

const (
	// A value that indicates the person is in menopause at the sample date.
	CategoryValueMenopausalStateMenopause CategoryValueMenopausalState = 1
	// A value that indicates the person is in perimenopause at the sample date.
	CategoryValueMenopausalStatePerimenopause CategoryValueMenopausalState = 2
	// A value that indicates no menopausal state applies at the sample date.
	CategoryValueMenopausalStateNone CategoryValueMenopausalState = 3
)

// String returns the CategoryValueMenopausalState constant's name, or its numeric form when the
// value is not a known constant.
func (e CategoryValueMenopausalState) String() string {
	switch e {
	case CategoryValueMenopausalStateMenopause:
		return "CategoryValueMenopausalStateMenopause"
	case CategoryValueMenopausalStatePerimenopause:
		return "CategoryValueMenopausalStatePerimenopause"
	case CategoryValueMenopausalStateNone:
		return "CategoryValueMenopausalStateNone"
	default:
		return fmt.Sprintf("CategoryValueMenopausalState(%d)", int64(e))
	}
}
