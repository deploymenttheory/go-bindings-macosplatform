...
type SafariSettingsError int64

const (
	// The process does not have the permission to call this API.
	SafariSettingsErrorNotAllowed SafariSettingsError = 0
	// The system was unable to perform the requested operation.
	SafariSettingsErrorFailed SafariSettingsError = 1
)

// String returns the SafariSettingsError constant's name, or its numeric form when the
// value is not a known constant.
func (e SafariSettingsError) String() string {
	switch e {
	case SafariSettingsErrorNotAllowed:
		return "SafariSettingsErrorNotAllowed"
	case SafariSettingsErrorFailed:
		return "SafariSettingsErrorFailed"
	default:
		return fmt.Sprintf("SafariSettingsError(%d)", int64(e))
	}
}
