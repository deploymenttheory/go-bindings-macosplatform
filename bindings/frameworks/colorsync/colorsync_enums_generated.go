...
// String returns the ColorSyncDataDepth constant's name, or its numeric form when the
...
// String returns the ColorSyncAlphaInfo constant's name, or its numeric form when the
// value is not a known constant.
