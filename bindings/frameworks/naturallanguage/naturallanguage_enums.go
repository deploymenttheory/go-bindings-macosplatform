...
func (e NLTaggerOptions) String() string {
	var parts []string
	if e&NLTaggerOmitWords != 0 { parts = append(parts, "NLTaggerOmitWords") }
	if e&NLTaggerOmitPunctuation != 0 { parts = append(parts, "NLTaggerOmitPunctuation") }
	if e&NLTaggerOmitWhitespace != 0 { parts = append(parts, "NLTaggerOmitWhitespace") }
	if e&NLTaggerOmitOther != 0 { parts = append(parts, "NLTaggerOmitOther") }
	if e&NLTaggerJoinNames != 0 { parts = append(parts, "NLTaggerJoinNames") }
	if e&NLTaggerJoinContractions != 0 { parts = append(parts, "NLTaggerJoinContractions") }
...
type NLTokenizerAttributes uint64
...
func (e NLTokenizerAttributes) String() string {
	var parts []string
	if e&NLTokenizerAttributeNumeric != 0 { parts = append(parts, "NLTokenizerAttributeNumeric") }
	if e&NLTokenizerAttributeSymbolic != 0 { parts = append(parts, "NLTokenizerAttributeSymbolic") }
	if e&NLTokenizerAttributeEmoji != 0 { parts = append(parts, "NLTokenizerAttributeEmoji") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
