...
func (e NLTokenizerAttributes) String() string {
	var parts []string
	if e&NLTokenizerAttributeNumeric != 0 {
		parts = append(parts, "NLTokenizerAttributeNumeric")
	}
	if e&NLTokenizerAttributeSymbolic != 0 {
		parts = append(parts, "NLTokenizerAttributeSymbolic")
	}
	if e&NLTokenizerAttributeEmoji != 0 {
		parts = append(parts, "NLTokenizerAttributeEmoji")
	}
	if len(parts) == 0 {
		return "0"
	}
