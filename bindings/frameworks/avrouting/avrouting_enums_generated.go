...
type CustomRoutingEventReason int64
...
const (
	...
	CustomRoutingEventReasonDeactivate CustomRoutingEventReason = 1
	// A value that indicates to reactivate a route a user authorized previously.
	CustomRoutingEventReasonReactivate CustomRoutingEventReason = 2
)

// String returns the CustomRoutingEventReason constant's name, or its numeric form when the
// value is not a known constant.
func (e CustomRoutingEventReason) String() string {
	switch e {
	case CustomRoutingEventReasonActivate:
		return "CustomRoutingEventReasonActivate"
	case CustomRoutingEventReasonDeactivate:
		return "CustomRoutingEventReasonDeactivate"
	case CustomRoutingEventReasonReactivate:
		return "CustomRoutingEventReasonReactivate"
	default:
		return fmt.Sprintf("CustomRoutingEventReason(%d)", int64(e))
	}
}
