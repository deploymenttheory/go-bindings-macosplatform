...
type PHFetchResultChangeDetails[ObjectType pureobjc.AnyObject] struct {
	foundation.NSObject
}
...
func PHFetchResultChangeDetailsFromID[ObjectType pureobjc.AnyObject](id objc.ID) *PHFetchResultChangeDetails[ObjectType] {
	if id == 0 {
		return nil
	}
