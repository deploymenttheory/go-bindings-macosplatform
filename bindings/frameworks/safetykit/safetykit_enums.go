...
type SAEmergencyResponseManagerVoiceCallStatus int64

const (
	SAEmergencyResponseManagerVoiceCallStatusDialing      SAEmergencyResponseManagerVoiceCallStatus = 0
	SAEmergencyResponseManagerVoiceCallStatusActive       SAEmergencyResponseManagerVoiceCallStatus = 1
	SAEmergencyResponseManagerVoiceCallStatusDisconnected SAEmergencyResponseManagerVoiceCallStatus = 2
	SAEmergencyResponseManagerVoiceCallStatusFailed       SAEmergencyResponseManagerVoiceCallStatus = 3
)

func (e SAEmergencyResponseManagerVoiceCallStatus) String() string {
	switch e {
	case SAEmergencyResponseManagerVoiceCallStatusDialing:
		return "SAEmergencyResponseManagerVoiceCallStatusDialing"
	case SAEmergencyResponseManagerVoiceCallStatusActive:
		return "SAEmergencyResponseManagerVoiceCallStatusActive"
	case SAEmergencyResponseManagerVoiceCallStatusDisconnected:
		return "SAEmergencyResponseManagerVoiceCallStatusDisconnected"
	case SAEmergencyResponseManagerVoiceCallStatusFailed:
		return "SAEmergencyResponseManagerVoiceCallStatusFailed"
	default:
		return fmt.Sprintf("SAEmergencyResponseManagerVoiceCallStatus(%d)", int64(e))
	}
}
