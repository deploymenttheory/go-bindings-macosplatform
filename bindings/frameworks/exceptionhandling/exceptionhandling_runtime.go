...
func SymbolAvailable(symbol string) bool {
	...
	return _exceptionhandlingLib != 0 && !_failedSymbols[symbol]
}

func _loadLibrary() {
	var err error
	_exceptionhandlingLib, err = purego.Dlopen("/System/Library/Frameworks/ExceptionHandling.framework/ExceptionHandling", purego.RTLD_GLOBAL|purego.RTLD_LAZY)
	if err != nil {
