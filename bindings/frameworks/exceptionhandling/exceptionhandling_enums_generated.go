...
const (
	HandleOtherExceptionMask          = 512
	HandleTopLevelExceptionMask       = 128
	HandleUncaughtExceptionMask       = 2
	HandleUncaughtRuntimeErrorMask    = 32
	HandleUncaughtSystemExceptionMask = 8
	HangOnOtherExceptionMask          = 16
	HangOnTopLevelExceptionMask       = 8
	HangOnUncaughtExceptionMask       = 1
	HangOnUncaughtRuntimeErrorMask    = 4
	HangOnUncaughtSystemExceptionMask = 2
	LogOtherExceptionMask             = 256
	LogTopLevelExceptionMask          = 64
	LogUncaughtExceptionMask          = 1
	LogUncaughtRuntimeErrorMask       = 16
	LogUncaughtSystemExceptionMask    = 4
)
