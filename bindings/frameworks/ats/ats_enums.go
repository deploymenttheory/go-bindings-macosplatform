...
type ATSFontNotifyAction int64
...
func (e ATSFontNotifyAction) String() string {
	...
	default:
		return fmt.Sprintf("ATSFontNotifyAction(%d)", int64(e))
	}
}

type ATSFontNotifyOption int64
...
func (e ATSFontNotifyOption) String() string {
	...
	default:
		return fmt.Sprintf("ATSFontNotifyOption(%d)", int64(e))
	}
}

type ATSFontQueryMessageID int64
...
func (e ATSFontQueryMessageID) String() string {
	...
	default:
		return fmt.Sprintf("ATSFontQueryMessageID(%d)", int64(e))
	}
}
...
const (
	KATSGlyphInfoAppleReserved   = 536608744
	KATSGlyphInfoByteSizeMask    = 7
	KATSGlyphInfoHasImposedWidth = 16
	KATSGlyphInfoIsAttachment    = 2147483648
	KATSGlyphInfoIsLTHanger      = 1073741824
	KATSGlyphInfoIsRBHanger      = 536870912
	KATSGlyphInfoIsWhiteSpace    = 262144
	KATSGlyphInfoTerminatorGlyph = 524288
)
...
const (
	KATSLineAppleReserved                 = 4242538496
	KATSLineApplyAntiAliasing             = 2048
	KATSLineBreakToNearestCharacter       = 33554432
	KATSLineDisableAllBaselineAdjustments = 524288
	KATSLineDisableAllGlyphMorphing       = 131072
	KATSLineDisableAllJustification       = 65536
	KATSLineDisableAllKerningAdjustments  = 262144
	KATSLineDisableAllLayoutOperations    = 2031616
	KATSLineDisableAllTrackingAdjustments = 1048576
	KATSLineDisableAutoAdjustDisplayPos   = 16384
	KATSLineDisableNegativeJustification  = 8192
	KATSLineFillOutToWidth                = 256
	KATSLineFractDisable                  = 64
	KATSLineHasNoHangers                  = 2
	KATSLineHasNoOpticalAlignment         = 4
	KATSLineIgnoreFontLeading             = 1024
	KATSLineImposeNoAngleForEnds          = 128
	KATSLineIsDisplayOnly                 = 1
	KATSLineKeepSpacesOutOfMargin         = 8
	KATSLineLastNoJustification           = 32
	KATSLineNoAntiAliasing                = 4096
	KATSLineNoLayoutOptions               = 0
	KATSLineNoSpecialJustification        = 16
	KATSLineTabAdjustEnabled              = 512
	KATSLineUseDeviceMetrics              = 16777216
	KATSLineUseQDRendering                = 32768
)
...
const (
	...
	KATSOptionFlagsIncludeDisabledMask     = 128
	KATSOptionFlagsIterateByPrecedenceMask = 32
...
const (
	KATSStyleAppleReserved     = 4294967288
	KATSStyleApplyAntiAliasing = 2
	KATSStyleApplyHints        = 0
	KATSStyleNoAntiAliasing    = 4
	KATSStyleNoHinting         = 1
	KATSStyleNoOptions         = 0
)
...
const (
	KATSULayoutOperationAppleReserved        = 4294967232
...
const (
	KATSNoTracking      = -2147483648
	KATSUseGlyphAdvance = 2147483647
	KATSUseLineHeight   = 2147483647
)
...
const (
	KFontNoLanguage = 4294967295
	KFontNoName     = 4294967295
	KFontNoPlatform = 4294967295
	KFontNoScript   = 4294967295
)
