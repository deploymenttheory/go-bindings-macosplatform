...
// String returns the ATSFontNotifyAction constant's name, or its numeric form when the
// value is not a known constant.
...
// String returns the ATSFontNotifyOption constant's name, or its numeric form when the
// value is not a known constant.
...
// String returns the ATSFontQueryMessageID constant's name, or its numeric form when the
// value is not a known constant.
