...
const (
	...
	MediaTypeAny MediaType = 18446744073709551615
)
...
func (e MediaType) String() string {
	var parts []string
	if e&MediaTypeMusic != 0 {
		parts = append(parts, "MediaTypeMusic")
	}
	if e&MediaTypePodcast != 0 {
		parts = append(parts, "MediaTypePodcast")
	}
	if e&MediaTypeAudioBook != 0 {
		parts = append(parts, "MediaTypeAudioBook")
	}
	if e&MediaTypeAudioITunesU != 0 {
		parts = append(parts, "MediaTypeAudioITunesU")
	}
	if e&MediaTypeAnyAudio != 0 {
		parts = append(parts, "MediaTypeAnyAudio")
	}
	if e&MediaTypeMovie != 0 {
		parts = append(parts, "MediaTypeMovie")
	}
	if e&MediaTypeTVShow != 0 {
		parts = append(parts, "MediaTypeTVShow")
	}
	if e&MediaTypeVideoPodcast != 0 {
		parts = append(parts, "MediaTypeVideoPodcast")
	}
	if e&MediaTypeMusicVideo != 0 {
		parts = append(parts, "MediaTypeMusicVideo")
	}
	if e&MediaTypeVideoITunesU != 0 {
		parts = append(parts, "MediaTypeVideoITunesU")
	}
	if e&MediaTypeHomeVideo != 0 {
		parts = append(parts, "MediaTypeHomeVideo")
	}
	if e&MediaTypeAnyVideo != 0 {
		parts = append(parts, "MediaTypeAnyVideo")
	}
	if e&MediaTypeAny != 0 {
		parts = append(parts, "MediaTypeAny")
	}
	if len(parts) == 0 {
		return "0"
	}
...
type NowPlayingInfoMediaType uint64
...
// String returns the NowPlayingInfoMediaType constant's name, or its numeric form when the
// value is not a known constant.
func (e NowPlayingInfoMediaType) String() string {
	switch e {
	case NowPlayingInfoMediaTypeNone:
		return "NowPlayingInfoMediaTypeNone"
	case NowPlayingInfoMediaTypeAudio:
		return "NowPlayingInfoMediaTypeAudio"
	case NowPlayingInfoMediaTypeVideo:
		return "NowPlayingInfoMediaTypeVideo"
	default:
		return fmt.Sprintf("NowPlayingInfoMediaType(%d)", int64(e))
	}
}

// Constants indicating the status of a command.
type RemoteCommandHandlerStatus int64
...
// String returns the RemoteCommandHandlerStatus constant's name, or its numeric form when the
// value is not a known constant.
func (e RemoteCommandHandlerStatus) String() string {
	switch e {
	case RemoteCommandHandlerStatusSuccess:
		return "RemoteCommandHandlerStatusSuccess"
	case RemoteCommandHandlerStatusNoSuchContent:
		return "RemoteCommandHandlerStatusNoSuchContent"
	case RemoteCommandHandlerStatusNoActionableNowPlayingItem:
		return "RemoteCommandHandlerStatusNoActionableNowPlayingItem"
	case RemoteCommandHandlerStatusDeviceNotFound:
		return "RemoteCommandHandlerStatusDeviceNotFound"
	case RemoteCommandHandlerStatusCommandFailed:
		return "RemoteCommandHandlerStatusCommandFailed"
	default:
		return fmt.Sprintf("RemoteCommandHandlerStatus(%d)", int64(e))
	}
}
