...
const (
	MPMediaTypeMusic MPMediaType = 1
	MPMediaTypePodcast MPMediaType = 2
	MPMediaTypeAudioBook MPMediaType = 4
	MPMediaTypeAudioITunesU MPMediaType = 8
	MPMediaTypeAnyAudio MPMediaType = 255
	MPMediaTypeMovie MPMediaType = 256
	MPMediaTypeTVShow MPMediaType = 512
	MPMediaTypeVideoPodcast MPMediaType = 1024
	MPMediaTypeMusicVideo MPMediaType = 2048
	MPMediaTypeVideoITunesU MPMediaType = 4096
	MPMediaTypeHomeVideo MPMediaType = 8192
	MPMediaTypeAnyVideo MPMediaType = 65280
	MPMediaTypeAny MPMediaType = 18446744073709551615
)

func (e MPMediaType) String() string {
	var parts []string
	if e&MPMediaTypeMusic != 0 { parts = append(parts, "MPMediaTypeMusic") }
	if e&MPMediaTypePodcast != 0 { parts = append(parts, "MPMediaTypePodcast") }
	if e&MPMediaTypeAudioBook != 0 { parts = append(parts, "MPMediaTypeAudioBook") }
	if e&MPMediaTypeAudioITunesU != 0 { parts = append(parts, "MPMediaTypeAudioITunesU") }
	if e&MPMediaTypeAnyAudio != 0 { parts = append(parts, "MPMediaTypeAnyAudio") }
	if e&MPMediaTypeMovie != 0 { parts = append(parts, "MPMediaTypeMovie") }
	if e&MPMediaTypeTVShow != 0 { parts = append(parts, "MPMediaTypeTVShow") }
	if e&MPMediaTypeVideoPodcast != 0 { parts = append(parts, "MPMediaTypeVideoPodcast") }
	if e&MPMediaTypeMusicVideo != 0 { parts = append(parts, "MPMediaTypeMusicVideo") }
	if e&MPMediaTypeVideoITunesU != 0 { parts = append(parts, "MPMediaTypeVideoITunesU") }
	if e&MPMediaTypeHomeVideo != 0 { parts = append(parts, "MPMediaTypeHomeVideo") }
	if e&MPMediaTypeAnyVideo != 0 { parts = append(parts, "MPMediaTypeAnyVideo") }
	if e&MPMediaTypeAny != 0 { parts = append(parts, "MPMediaTypeAny") }
...
const (
	...
	MPNowPlayingInfoMediaTypeAudio MPNowPlayingInfoMediaType = 1
	MPNowPlayingInfoMediaTypeVideo MPNowPlayingInfoMediaType = 2
)

func (e MPNowPlayingInfoMediaType) String() string {
	switch e {
	case MPNowPlayingInfoMediaTypeNone:
		return "MPNowPlayingInfoMediaTypeNone"
	case MPNowPlayingInfoMediaTypeAudio:
		return "MPNowPlayingInfoMediaTypeAudio"
	case MPNowPlayingInfoMediaTypeVideo:
		return "MPNowPlayingInfoMediaTypeVideo"
	default:
		return fmt.Sprintf("MPNowPlayingInfoMediaType(%d)", int64(e))
	}
}
