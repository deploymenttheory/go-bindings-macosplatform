...
func SymbolAvailable(symbol string) bool {
	...
	return _storekitLib != 0 && !_failedSymbols[symbol]
}

func _loadLibrary() {
	var err error
	_storekitLib, err = purego.Dlopen("/System/Library/Frameworks/StoreKit.framework/StoreKit", purego.RTLD_GLOBAL|purego.RTLD_LAZY)
	if err != nil {
