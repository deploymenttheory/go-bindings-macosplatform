...
func (e SKCloudServiceCapability) String() string {
	var parts []string
	if e&SKCloudServiceCapabilityMusicCatalogPlayback != 0 { parts = append(parts, "SKCloudServiceCapabilityMusicCatalogPlayback") }
	if e&SKCloudServiceCapabilityMusicCatalogSubscriptionEligible != 0 { parts = append(parts, "SKCloudServiceCapabilityMusicCatalogSubscriptionEligible") }
	if e&SKCloudServiceCapabilityAddToCloudMusicLibrary != 0 { parts = append(parts, "SKCloudServiceCapabilityAddToCloudMusicLibrary") }
...
type SKPaymentTransactionState int64

const (
	SKPaymentTransactionStatePurchasing SKPaymentTransactionState = 0
	SKPaymentTransactionStatePurchased SKPaymentTransactionState = 1
	SKPaymentTransactionStateFailed SKPaymentTransactionState = 2
	SKPaymentTransactionStateRestored SKPaymentTransactionState = 3
	SKPaymentTransactionStateDeferred SKPaymentTransactionState = 4
)

func (e SKPaymentTransactionState) String() string {
	switch e {
	...
	default:
		return fmt.Sprintf("SKPaymentTransactionState(%d)", int64(e))
	}
}
