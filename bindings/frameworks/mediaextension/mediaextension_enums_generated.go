...
// Bitmask — values may be combined with |.
type DecodeFrameStatus uint64

const (
	DecodeFrameNoStatus DecodeFrameStatus = 0
	...
	DecodeFrameFrameDropped DecodeFrameStatus = 1
)

// String returns the DecodeFrameStatus constant's name, or its numeric form when the
// value is not a known constant.
func (e DecodeFrameStatus) String() string {
	var parts []string
	if e&DecodeFrameFrameDropped != 0 {
		parts = append(parts, "DecodeFrameFrameDropped")
	}
	if len(parts) == 0 {
		return "0"
	}
...
const (
	ErrorUnsupportedFeature   Error = -19320
	ErrorAllocationFailure    Error = -19321
	ErrorInvalidParameter     Error = -19322
	ErrorParsingFailure       Error = -19323
	ErrorInternalFailure      Error = -19324
	ErrorPropertyNotSupported Error = -19325
	ErrorNoSuchEdit           Error = -19326
	ErrorNoSamples            Error = -19327
	ErrorLocationNotAvailable Error = -19328
	ErrorEndOfStream          Error = -19329
	ErrorPermissionDenied     Error = -19330
	ErrorReferenceMissing     Error = -19331
)
...
func (e Error) String() string {
	...
	case ErrorAllocationFailure:
		return "ErrorAllocationFailure"
	case ErrorInvalidParameter:
		return "ErrorInvalidParameter"
	case ErrorParsingFailure:
		return "ErrorParsingFailure"
	case ErrorInternalFailure:
		return "ErrorInternalFailure"
	case ErrorPropertyNotSupported:
		return "ErrorPropertyNotSupported"
	case ErrorNoSuchEdit:
		return "ErrorNoSuchEdit"
	case ErrorNoSamples:
		return "ErrorNoSamples"
	case ErrorLocationNotAvailable:
		return "ErrorLocationNotAvailable"
	case ErrorEndOfStream:
		return "ErrorEndOfStream"
	case ErrorPermissionDenied:
		return "ErrorPermissionDenied"
	case ErrorReferenceMissing:
		return "ErrorReferenceMissing"
	default:
...
// Bitmask — values may be combined with |.
type FormatReaderParseAdditionalFragmentsStatus uint64

const (
	// Indicates that the format reader file size increased.
	FormatReaderParseAdditionalFragmentsStatusSizeIncreased FormatReaderParseAdditionalFragmentsStatus = 1
	// Indicates that the format reader received one or more fragments.
	FormatReaderParseAdditionalFragmentsStatusFragmentAdded FormatReaderParseAdditionalFragmentsStatus = 2
	// Indicates that the format reader can’t receive any more fragments.
	FormatReaderParseAdditionalFragmentsStatusFragmentsComplete FormatReaderParseAdditionalFragmentsStatus = 4
)

// String returns the FormatReaderParseAdditionalFragmentsStatus constant's name, or its numeric form when the
// value is not a known constant.
func (e FormatReaderParseAdditionalFragmentsStatus) String() string {
	var parts []string
	if e&FormatReaderParseAdditionalFragmentsStatusSizeIncreased != 0 {
		parts = append(parts, "FormatReaderParseAdditionalFragmentsStatusSizeIncreased")
	}
	if e&FormatReaderParseAdditionalFragmentsStatusFragmentAdded != 0 {
		parts = append(parts, "FormatReaderParseAdditionalFragmentsStatusFragmentAdded")
	}
	if e&FormatReaderParseAdditionalFragmentsStatusFragmentsComplete != 0 {
		parts = append(parts, "FormatReaderParseAdditionalFragmentsStatusFragmentsComplete")
	}
	if len(parts) == 0 {
		return "0"
	}
