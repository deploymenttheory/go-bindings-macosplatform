...
func (e FSAccessMask) String() string {
	var parts []string
	if e&FSAccessReadData != 0 { parts = append(parts, "FSAccessReadData") }
	if e&FSAccessListDirectory != 0 { parts = append(parts, "FSAccessListDirectory") }
	if e&FSAccessWriteData != 0 { parts = append(parts, "FSAccessWriteData") }
	if e&FSAccessAddFile != 0 { parts = append(parts, "FSAccessAddFile") }
	if e&FSAccessExecute != 0 { parts = append(parts, "FSAccessExecute") }
	if e&FSAccessSearch != 0 { parts = append(parts, "FSAccessSearch") }
	if e&FSAccessDelete != 0 { parts = append(parts, "FSAccessDelete") }
	if e&FSAccessAppendData != 0 { parts = append(parts, "FSAccessAppendData") }
	if e&FSAccessAddSubdirectory != 0 { parts = append(parts, "FSAccessAddSubdirectory") }
	if e&FSAccessDeleteChild != 0 { parts = append(parts, "FSAccessDeleteChild") }
	if e&FSAccessReadAttributes != 0 { parts = append(parts, "FSAccessReadAttributes") }
	if e&FSAccessWriteAttributes != 0 { parts = append(parts, "FSAccessWriteAttributes") }
	if e&FSAccessReadXattr != 0 { parts = append(parts, "FSAccessReadXattr") }
	if e&FSAccessWriteXattr != 0 { parts = append(parts, "FSAccessWriteXattr") }
	if e&FSAccessReadSecurity != 0 { parts = append(parts, "FSAccessReadSecurity") }
	if e&FSAccessWriteSecurity != 0 { parts = append(parts, "FSAccessWriteSecurity") }
	if e&FSAccessTakeOwnership != 0 { parts = append(parts, "FSAccessTakeOwnership") }
...
func (e FSBlockmapFlags) String() string {
	var parts []string
	if e&FSBlockmapFlagsRead != 0 { parts = append(parts, "FSBlockmapFlagsRead") }
	if e&FSBlockmapFlagsWrite != 0 { parts = append(parts, "FSBlockmapFlagsWrite") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
func (e FSCompleteIOFlags) String() string {
	var parts []string
	if e&FSCompleteIOFlagsRead != 0 { parts = append(parts, "FSCompleteIOFlagsRead") }
	if e&FSCompleteIOFlagsWrite != 0 { parts = append(parts, "FSCompleteIOFlagsWrite") }
	if e&FSCompleteIOFlagsAsync != 0 { parts = append(parts, "FSCompleteIOFlagsAsync") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
func (e FSDeactivateOptions) String() string {
	var parts []string
	if e&FSDeactivateOptionsForce != 0 { parts = append(parts, "FSDeactivateOptionsForce") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
func (e FSItemAttribute) String() string {
	var parts []string
	if e&FSItemAttributeType != 0 { parts = append(parts, "FSItemAttributeType") }
	if e&FSItemAttributeMode != 0 { parts = append(parts, "FSItemAttributeMode") }
	if e&FSItemAttributeLinkCount != 0 { parts = append(parts, "FSItemAttributeLinkCount") }
	if e&FSItemAttributeUID != 0 { parts = append(parts, "FSItemAttributeUID") }
	if e&FSItemAttributeGID != 0 { parts = append(parts, "FSItemAttributeGID") }
	if e&FSItemAttributeFlags != 0 { parts = append(parts, "FSItemAttributeFlags") }
	if e&FSItemAttributeSize != 0 { parts = append(parts, "FSItemAttributeSize") }
	if e&FSItemAttributeAllocSize != 0 { parts = append(parts, "FSItemAttributeAllocSize") }
	if e&FSItemAttributeFileID != 0 { parts = append(parts, "FSItemAttributeFileID") }
	if e&FSItemAttributeParentID != 0 { parts = append(parts, "FSItemAttributeParentID") }
	if e&FSItemAttributeAccessTime != 0 { parts = append(parts, "FSItemAttributeAccessTime") }
	if e&FSItemAttributeModifyTime != 0 { parts = append(parts, "FSItemAttributeModifyTime") }
	if e&FSItemAttributeChangeTime != 0 { parts = append(parts, "FSItemAttributeChangeTime") }
	if e&FSItemAttributeBirthTime != 0 { parts = append(parts, "FSItemAttributeBirthTime") }
	if e&FSItemAttributeBackupTime != 0 { parts = append(parts, "FSItemAttributeBackupTime") }
	if e&FSItemAttributeAddedTime != 0 { parts = append(parts, "FSItemAttributeAddedTime") }
	if e&FSItemAttributeSupportsLimitedXAttrs != 0 { parts = append(parts, "FSItemAttributeSupportsLimitedXAttrs") }
	if e&FSItemAttributeInhibitKernelOffloadedIO != 0 { parts = append(parts, "FSItemAttributeInhibitKernelOffloadedIO") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
func (e FSItemDeactivationOptions) String() string {
	var parts []string
	if e&FSItemDeactivationAlways != 0 { parts = append(parts, "FSItemDeactivationAlways") }
	if e&FSItemDeactivationForRemovedItems != 0 { parts = append(parts, "FSItemDeactivationForRemovedItems") }
	if e&FSItemDeactivationForPreallocatedItems != 0 { parts = append(parts, "FSItemDeactivationForPreallocatedItems") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
func (e FSMountOptions) String() string {
	var parts []string
	if e&FSMountOptionsReadOnly != 0 { parts = append(parts, "FSMountOptionsReadOnly") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
func (e FSPreallocateFlags) String() string {
	var parts []string
	if e&FSPreallocateFlagsContiguous != 0 { parts = append(parts, "FSPreallocateFlagsContiguous") }
	if e&FSPreallocateFlagsAll != 0 { parts = append(parts, "FSPreallocateFlagsAll") }
	if e&FSPreallocateFlagsPersist != 0 { parts = append(parts, "FSPreallocateFlagsPersist") }
	if e&FSPreallocateFlagsFromEOF != 0 { parts = append(parts, "FSPreallocateFlagsFromEOF") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
func (e FSVolumeOpenModes) String() string {
	var parts []string
	if e&FSVolumeOpenModesRead != 0 { parts = append(parts, "FSVolumeOpenModesRead") }
	if e&FSVolumeOpenModesWrite != 0 { parts = append(parts, "FSVolumeOpenModesWrite") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
