...
type AccessibilityContainerType uint64

const (
	// An option that indicates the element has no container.
	AccessibilityContainerTypeNone AccessibilityContainerType = 0
	// A website accessibility landmark that contains the element.
	AccessibilityContainerTypeLandmark AccessibilityContainerType = 1
	// A table that contains the element.
	AccessibilityContainerTypeTable AccessibilityContainerType = 2
	// A list contains the element.
	AccessibilityContainerTypeList AccessibilityContainerType = 4
	// An HTML fieldset element that contains the element.
	AccessibilityContainerTypeFieldset AccessibilityContainerType = 8
	// A dialog that contains the element.
	AccessibilityContainerTypeDialog AccessibilityContainerType = 16
	// A tree that contains the element.
	AccessibilityContainerTypeTree AccessibilityContainerType = 32
	// A frame that contains the element.
	AccessibilityContainerTypeFrame AccessibilityContainerType = 64
	// An HTML article element that contains the alert.
	AccessibilityContainerTypeArticle AccessibilityContainerType = 128
	// A semantic group that contains the element.
	AccessibilityContainerTypeSemanticGroup AccessibilityContainerType = 256
	// A scroll area that contains the element.
	AccessibilityContainerTypeScrollArea AccessibilityContainerType = 512
	// An alert that contains the element.
	AccessibilityContainerTypeAlert AccessibilityContainerType = 1024
	// A description list that contains the element.
	AccessibilityContainerTypeDescriptionList AccessibilityContainerType = 2048
)

// String returns the AccessibilityContainerType constant's name, or its numeric form when the
// value is not a known constant.
func (e AccessibilityContainerType) String() string {
	var parts []string
	if e&AccessibilityContainerTypeLandmark != 0 {
		parts = append(parts, "AccessibilityContainerTypeLandmark")
	}
	if e&AccessibilityContainerTypeTable != 0 {
		parts = append(parts, "AccessibilityContainerTypeTable")
	}
	if e&AccessibilityContainerTypeList != 0 {
		parts = append(parts, "AccessibilityContainerTypeList")
	}
	if e&AccessibilityContainerTypeFieldset != 0 {
		parts = append(parts, "AccessibilityContainerTypeFieldset")
	}
	if e&AccessibilityContainerTypeDialog != 0 {
		parts = append(parts, "AccessibilityContainerTypeDialog")
	}
	if e&AccessibilityContainerTypeTree != 0 {
		parts = append(parts, "AccessibilityContainerTypeTree")
	}
	if e&AccessibilityContainerTypeFrame != 0 {
		parts = append(parts, "AccessibilityContainerTypeFrame")
	}
	if e&AccessibilityContainerTypeArticle != 0 {
		parts = append(parts, "AccessibilityContainerTypeArticle")
	}
	if e&AccessibilityContainerTypeSemanticGroup != 0 {
		parts = append(parts, "AccessibilityContainerTypeSemanticGroup")
	}
	if e&AccessibilityContainerTypeScrollArea != 0 {
		parts = append(parts, "AccessibilityContainerTypeScrollArea")
	}
	if e&AccessibilityContainerTypeAlert != 0 {
		parts = append(parts, "AccessibilityContainerTypeAlert")
	}
	if e&AccessibilityContainerTypeDescriptionList != 0 {
		parts = append(parts, "AccessibilityContainerTypeDescriptionList")
	}
	if len(parts) == 0 {
		return "0"
	}
...
const (
	...
	AccessibilityPressedStateUndefined AccessibilityPressedState = 0
	// A state that indicates the element isn’t pressed.
	AccessibilityPressedStateFalse AccessibilityPressedState = 1
	// A state that indicates the element is pressed.
	AccessibilityPressedStateTrue AccessibilityPressedState = 2
	// A state that indicates the element is in a mixed state.
	AccessibilityPressedStateMixed AccessibilityPressedState = 3
)

// String returns the AccessibilityPressedState constant's name, or its numeric form when the
// value is not a known constant.
func (e AccessibilityPressedState) String() string {
	switch e {
	case AccessibilityPressedStateUndefined:
		return "AccessibilityPressedStateUndefined"
	case AccessibilityPressedStateFalse:
		return "AccessibilityPressedStateFalse"
	case AccessibilityPressedStateTrue:
		return "AccessibilityPressedStateTrue"
	case AccessibilityPressedStateMixed:
		return "AccessibilityPressedStateMixed"
	default:
		return fmt.Sprintf("AccessibilityPressedState(%d)", int64(e))
	}
}

// The types of touch gestures that operate on input text.
type GestureType int64

const (
	// A gesture for touch interactions with the magnifying glass tool.
	GestureTypeLoupe GestureType = 0
	// A gesture for a single tap performed with one finger.
	GestureTypeOneFingerTap GestureType = 1
	// A gesture for a double tap followed by holding the second tap.
	GestureTypeDoubleTapAndHold GestureType = 2
	// A gesture for two rapid consecutive taps.
	GestureTypeDoubleTap GestureType = 3
	// A gesture for a double tap with a single finger.
	GestureTypeOneFingerDoubleTap GestureType = 8
	// A gesture for three rapid consecutive taps with one finger.
	GestureTypeOneFingerTripleTap GestureType = 9
	// A gesture for a single simultaneous tap with two fingers.
	GestureTypeTwoFingerSingleTap GestureType = 10
	// A gesture to select a range of text with two fingers.
	GestureTypeTwoFingerRangedSelectGesture GestureType = 11
	// A gesture for dragging to adjust input method phrase boundaries.
	GestureTypeIMPhraseBoundaryDrag GestureType = 14
	// A gesture that represents a deep press using 3D Touch or Force Touch.
	GestureTypeForceTouch GestureType = 15
)

// String returns the GestureType constant's name, or its numeric form when the
// value is not a known constant.
func (e GestureType) String() string {
	switch e {
	case GestureTypeLoupe:
		return "GestureTypeLoupe"
	case GestureTypeOneFingerTap:
		return "GestureTypeOneFingerTap"
	case GestureTypeDoubleTapAndHold:
		return "GestureTypeDoubleTapAndHold"
	case GestureTypeDoubleTap:
		return "GestureTypeDoubleTap"
	case GestureTypeOneFingerDoubleTap:
		return "GestureTypeOneFingerDoubleTap"
	case GestureTypeOneFingerTripleTap:
		return "GestureTypeOneFingerTripleTap"
	case GestureTypeTwoFingerSingleTap:
		return "GestureTypeTwoFingerSingleTap"
	case GestureTypeTwoFingerRangedSelectGesture:
		return "GestureTypeTwoFingerRangedSelectGesture"
	case GestureTypeIMPhraseBoundaryDrag:
		return "GestureTypeIMPhraseBoundaryDrag"
	case GestureTypeForceTouch:
		return "GestureTypeForceTouch"
	default:
		return fmt.Sprintf("GestureType(%d)", int64(e))
	}
}

// Flags that indicate different states or characteristics of a text selection.
// Bitmask — values may be combined with |.
type SelectionFlags uint64

const (
	// An option that indicates no active flags.
	SelectionFlagsNone SelectionFlags = 0
	// A flag that indicates whether a word resides near the person’s tap gesture.
	WordIsNearTap SelectionFlags = 1
	// A flag that indicates whether a text selection is reversed or flipped in direction from its original direction.
	SelectionFlipped SelectionFlags = 2
	// A flag that indicates whether a text selection crosses or modifies phrase boundaries in an active selection.
	PhraseBoundaryChanged SelectionFlags = 4
)

// String returns the SelectionFlags constant's name, or its numeric form when the
// value is not a known constant.
func (e SelectionFlags) String() string {
	var parts []string
	if e&WordIsNearTap != 0 {
		parts = append(parts, "WordIsNearTap")
	}
	if e&SelectionFlipped != 0 {
		parts = append(parts, "SelectionFlipped")
	}
	if e&PhraseBoundaryChanged != 0 {
		parts = append(parts, "PhraseBoundaryChanged")
	}
	if len(parts) == 0 {
		return "0"
	}
...
type SelectionTouchPhase int64

const (
	// A phase that indicates when a new touch interaction for text selection begins.
	SelectionTouchPhaseStarted SelectionTouchPhase = 0
	// A phase that indicates that a touch actively adjusts the text selection boundaries.
	SelectionTouchPhaseMoved SelectionTouchPhase = 1
	// A phase that indicates when the touch interaction for text selection completes without specifying movement direction.
	SelectionTouchPhaseEnded SelectionTouchPhase = 2
	// A phase that indicates when the touch interaction ends after moving in a forward direction.
	SelectionTouchPhaseEndedMovingForward SelectionTouchPhase = 3
	// A phase that indicates when the touch interaction ends after moving in a backward direction.
	SelectionTouchPhaseEndedMovingBackward SelectionTouchPhase = 4
	// A phase that indicates when the touch interaction ends without any movement of the selection boundaries.
	SelectionTouchPhaseEndedNotMoving SelectionTouchPhase = 5
)

// String returns the SelectionTouchPhase constant's name, or its numeric form when the
// value is not a known constant.
func (e SelectionTouchPhase) String() string {
	switch e {
	case SelectionTouchPhaseStarted:
		return "SelectionTouchPhaseStarted"
	case SelectionTouchPhaseMoved:
		return "SelectionTouchPhaseMoved"
	case SelectionTouchPhaseEnded:
		return "SelectionTouchPhaseEnded"
	case SelectionTouchPhaseEndedMovingForward:
		return "SelectionTouchPhaseEndedMovingForward"
	case SelectionTouchPhaseEndedMovingBackward:
		return "SelectionTouchPhaseEndedMovingBackward"
	case SelectionTouchPhaseEndedNotMoving:
		return "SelectionTouchPhaseEndedNotMoving"
	default:
		return fmt.Sprintf("SelectionTouchPhase(%d)", int64(e))
	}
}
