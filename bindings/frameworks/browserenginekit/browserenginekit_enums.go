...
func (e BEAccessibilityContainerType) String() string {
	var parts []string
	if e&BEAccessibilityContainerTypeLandmark != 0 { parts = append(parts, "BEAccessibilityContainerTypeLandmark") }
	if e&BEAccessibilityContainerTypeTable != 0 { parts = append(parts, "BEAccessibilityContainerTypeTable") }
	if e&BEAccessibilityContainerTypeList != 0 { parts = append(parts, "BEAccessibilityContainerTypeList") }
	if e&BEAccessibilityContainerTypeFieldset != 0 { parts = append(parts, "BEAccessibilityContainerTypeFieldset") }
	if e&BEAccessibilityContainerTypeDialog != 0 { parts = append(parts, "BEAccessibilityContainerTypeDialog") }
	if e&BEAccessibilityContainerTypeTree != 0 { parts = append(parts, "BEAccessibilityContainerTypeTree") }
	if e&BEAccessibilityContainerTypeFrame != 0 { parts = append(parts, "BEAccessibilityContainerTypeFrame") }
	if e&BEAccessibilityContainerTypeArticle != 0 { parts = append(parts, "BEAccessibilityContainerTypeArticle") }
	if e&BEAccessibilityContainerTypeSemanticGroup != 0 { parts = append(parts, "BEAccessibilityContainerTypeSemanticGroup") }
	if e&BEAccessibilityContainerTypeScrollArea != 0 { parts = append(parts, "BEAccessibilityContainerTypeScrollArea") }
	if e&BEAccessibilityContainerTypeAlert != 0 { parts = append(parts, "BEAccessibilityContainerTypeAlert") }
	if e&BEAccessibilityContainerTypeDescriptionList != 0 { parts = append(parts, "BEAccessibilityContainerTypeDescriptionList") }
...
func (e BESelectionFlags) String() string {
	var parts []string
	if e&BEWordIsNearTap != 0 { parts = append(parts, "BEWordIsNearTap") }
	if e&BESelectionFlipped != 0 { parts = append(parts, "BESelectionFlipped") }
	if e&BEPhraseBoundaryChanged != 0 { parts = append(parts, "BEPhraseBoundaryChanged") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
