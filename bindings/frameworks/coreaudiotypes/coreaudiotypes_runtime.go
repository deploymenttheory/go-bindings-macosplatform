...
func SymbolAvailable(symbol string) bool {
	...
	return _coreaudiotypesLib != 0 && !_failedSymbols[symbol]
}

func _loadLibrary() {
	var err error
	_coreaudiotypesLib, err = purego.Dlopen("/System/Library/Frameworks/CoreAudioTypes.framework/CoreAudioTypes", purego.RTLD_GLOBAL|purego.RTLD_LAZY)
	if err != nil {
