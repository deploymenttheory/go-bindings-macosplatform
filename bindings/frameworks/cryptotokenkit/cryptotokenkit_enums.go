...
func (e TKSmartCardPINCompletion) String() string {
	var parts []string
	if e&TKSmartCardPINCompletionMaxLength != 0 { parts = append(parts, "TKSmartCardPINCompletionMaxLength") }
	if e&TKSmartCardPINCompletionKey != 0 { parts = append(parts, "TKSmartCardPINCompletionKey") }
	if e&TKSmartCardPINCompletionTimeout != 0 { parts = append(parts, "TKSmartCardPINCompletionTimeout") }
...
func (e TKSmartCardPINConfirmation) String() string {
	var parts []string
	if e&TKSmartCardPINConfirmationNew != 0 { parts = append(parts, "TKSmartCardPINConfirmationNew") }
	if e&TKSmartCardPINConfirmationCurrent != 0 { parts = append(parts, "TKSmartCardPINConfirmationCurrent") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
func (e TKSmartCardProtocol) String() string {
	var parts []string
	if e&TKSmartCardProtocolT0 != 0 { parts = append(parts, "TKSmartCardProtocolT0") }
	if e&TKSmartCardProtocolT1 != 0 { parts = append(parts, "TKSmartCardProtocolT1") }
	if e&TKSmartCardProtocolT15 != 0 { parts = append(parts, "TKSmartCardProtocolT15") }
	if e&TKSmartCardProtocolAny != 0 { parts = append(parts, "TKSmartCardProtocolAny") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
func (e TKTokenOperation) String() string {
	...
	default:
		return fmt.Sprintf("TKTokenOperation(%d)", int64(e))
	}
}
