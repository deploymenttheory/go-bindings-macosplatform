...
func (e DDDeviceSupports) String() string {
	var parts []string
	if e&DDDeviceSupportsBluetoothPairingLE != 0 { parts = append(parts, "DDDeviceSupportsBluetoothPairingLE") }
	if e&DDDeviceSupportsBluetoothTransportBridging != 0 { parts = append(parts, "DDDeviceSupportsBluetoothTransportBridging") }
	if e&DDDeviceSupportsBluetoothHID != 0 { parts = append(parts, "DDDeviceSupportsBluetoothHID") }
