...
func (e IOSurfaceMemoryLedgerFlags) String() string {
	var parts []string
	if e&KIOSurfaceMemoryLedgerFlagNoFootprint != 0 {
		parts = append(parts, "KIOSurfaceMemoryLedgerFlagNoFootprint")
	}
	if len(parts) == 0 {
		return "0"
	}
...
func (e IOSurfacePurgeabilityState) String() string {
	var parts []string
	if e&KIOSurfacePurgeableVolatile != 0 {
		parts = append(parts, "KIOSurfacePurgeableVolatile")
	}
	if e&KIOSurfacePurgeableEmpty != 0 {
		parts = append(parts, "KIOSurfacePurgeableEmpty")
	}
	if e&KIOSurfacePurgeableKeepCurrent != 0 {
		parts = append(parts, "KIOSurfacePurgeableKeepCurrent")
	}
	if len(parts) == 0 {
		return "0"
	}
