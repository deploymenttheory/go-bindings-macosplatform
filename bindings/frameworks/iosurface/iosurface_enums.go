...
func (e IOSurfaceLockOptions) String() string {
	var parts []string
	if e&KIOSurfaceLockReadOnly != 0 { parts = append(parts, "KIOSurfaceLockReadOnly") }
	if e&KIOSurfaceLockAvoidSync != 0 { parts = append(parts, "KIOSurfaceLockAvoidSync") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}

type IOSurfaceMemoryLedgerFlags int64
...
func (e IOSurfaceMemoryLedgerFlags) String() string {
	var parts []string
	if e&KIOSurfaceMemoryLedgerFlagNoFootprint != 0 { parts = append(parts, "KIOSurfaceMemoryLedgerFlagNoFootprint") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
func (e IOSurfaceMemoryLedgerTags) String() string {
	...
	default:
		return fmt.Sprintf("IOSurfaceMemoryLedgerTags(%d)", int64(e))
	}
}

type IOSurfacePurgeabilityState int64
...
func (e IOSurfacePurgeabilityState) String() string {
	var parts []string
	if e&KIOSurfacePurgeableVolatile != 0 { parts = append(parts, "KIOSurfacePurgeableVolatile") }
	if e&KIOSurfacePurgeableEmpty != 0 { parts = append(parts, "KIOSurfacePurgeableEmpty") }
	if e&KIOSurfacePurgeableKeepCurrent != 0 { parts = append(parts, "KIOSurfacePurgeableKeepCurrent") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
