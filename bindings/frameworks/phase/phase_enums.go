...
func (e PHASEAutomaticHeadTrackingFlags) String() string {
	var parts []string
	if e&PHASEAutomaticHeadTrackingFlagOrientation != 0 { parts = append(parts, "PHASEAutomaticHeadTrackingFlagOrientation") }
	if e&PHASEAutomaticHeadTrackingFlagPosition != 0 { parts = append(parts, "PHASEAutomaticHeadTrackingFlagPosition") }
...
func (e PHASEPushStreamBufferOptions) String() string {
	var parts []string
	if e&PHASEPushStreamBufferDefault != 0 { parts = append(parts, "PHASEPushStreamBufferDefault") }
	if e&PHASEPushStreamBufferLoops != 0 { parts = append(parts, "PHASEPushStreamBufferLoops") }
	if e&PHASEPushStreamBufferInterrupts != 0 { parts = append(parts, "PHASEPushStreamBufferInterrupts") }
	if e&PHASEPushStreamBufferInterruptsAtLoop != 0 { parts = append(parts, "PHASEPushStreamBufferInterruptsAtLoop") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
func (e PHASESpatialPipelineFlags) String() string {
	var parts []string
	if e&PHASESpatialPipelineFlagDirectPathTransmission != 0 { parts = append(parts, "PHASESpatialPipelineFlagDirectPathTransmission") }
	if e&PHASESpatialPipelineFlagEarlyReflections != 0 { parts = append(parts, "PHASESpatialPipelineFlagEarlyReflections") }
	if e&PHASESpatialPipelineFlagLateReverb != 0 { parts = append(parts, "PHASESpatialPipelineFlagLateReverb") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
