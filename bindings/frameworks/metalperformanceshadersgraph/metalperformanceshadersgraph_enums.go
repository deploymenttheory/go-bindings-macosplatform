...
func (e MPSGraphReducedPrecisionFastMath) String() string {
	var parts []string
	if e&MPSGraphReducedPrecisionFastMathAllowFP16Conv2DWinogradTransformIntermediate != 0 { parts = append(parts, "MPSGraphReducedPrecisionFastMathAllowFP16Conv2DWinogradTransformIntermediate") }
	if e&MPSGraphReducedPrecisionFastMathAllowConvertingOperandsFromFP32ToFP19 != 0 { parts = append(parts, "MPSGraphReducedPrecisionFastMathAllowConvertingOperandsFromFP32ToFP19") }
	if e&MPSGraphReducedPrecisionFastMathAllowFP16Intermediates != 0 { parts = append(parts, "MPSGraphReducedPrecisionFastMathAllowFP16Intermediates") }
