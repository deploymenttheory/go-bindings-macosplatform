...
func (e MKAddressFilterOption) String() string {
	var parts []string
	if e&MKAddressFilterOptionCountry != 0 { parts = append(parts, "MKAddressFilterOptionCountry") }
	if e&MKAddressFilterOptionAdministrativeArea != 0 { parts = append(parts, "MKAddressFilterOptionAdministrativeArea") }
	if e&MKAddressFilterOptionSubAdministrativeArea != 0 { parts = append(parts, "MKAddressFilterOptionSubAdministrativeArea") }
	if e&MKAddressFilterOptionLocality != 0 { parts = append(parts, "MKAddressFilterOptionLocality") }
	if e&MKAddressFilterOptionSubLocality != 0 { parts = append(parts, "MKAddressFilterOptionSubLocality") }
	if e&MKAddressFilterOptionPostalCode != 0 { parts = append(parts, "MKAddressFilterOptionPostalCode") }
...
func (e MKDirectionsTransportType) String() string {
	var parts []string
	if e&MKDirectionsTransportTypeAutomobile != 0 { parts = append(parts, "MKDirectionsTransportTypeAutomobile") }
	if e&MKDirectionsTransportTypeWalking != 0 { parts = append(parts, "MKDirectionsTransportTypeWalking") }
	if e&MKDirectionsTransportTypeTransit != 0 { parts = append(parts, "MKDirectionsTransportTypeTransit") }
	if e&MKDirectionsTransportTypeCycling != 0 { parts = append(parts, "MKDirectionsTransportTypeCycling") }
	if e&MKDirectionsTransportTypeAny != 0 { parts = append(parts, "MKDirectionsTransportTypeAny") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
func (e MKLocalSearchCompleterResultType) String() string {
	var parts []string
	if e&MKLocalSearchCompleterResultTypeAddress != 0 { parts = append(parts, "MKLocalSearchCompleterResultTypeAddress") }
	if e&MKLocalSearchCompleterResultTypePointOfInterest != 0 { parts = append(parts, "MKLocalSearchCompleterResultTypePointOfInterest") }
	if e&MKLocalSearchCompleterResultTypeQuery != 0 { parts = append(parts, "MKLocalSearchCompleterResultTypeQuery") }
	if e&MKLocalSearchCompleterResultTypePhysicalFeature != 0 { parts = append(parts, "MKLocalSearchCompleterResultTypePhysicalFeature") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
func (e MKLocalSearchResultType) String() string {
	var parts []string
	if e&MKLocalSearchResultTypeAddress != 0 { parts = append(parts, "MKLocalSearchResultTypeAddress") }
	if e&MKLocalSearchResultTypePointOfInterest != 0 { parts = append(parts, "MKLocalSearchResultTypePointOfInterest") }
	if e&MKLocalSearchResultTypePhysicalFeature != 0 { parts = append(parts, "MKLocalSearchResultTypePhysicalFeature") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
