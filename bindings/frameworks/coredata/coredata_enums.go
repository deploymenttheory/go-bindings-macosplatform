...
func (e NSFetchRequestResultType) String() string {
	var parts []string
	if e&NSManagedObjectIDResultType != 0 { parts = append(parts, "NSManagedObjectIDResultType") }
	if e&NSDictionaryResultType != 0 { parts = append(parts, "NSDictionaryResultType") }
	if e&NSCountResultType != 0 { parts = append(parts, "NSCountResultType") }
...
func (e NSPersistentCloudKitContainerSchemaInitializationOptions) String() string {
	var parts []string
	if e&NSPersistentCloudKitContainerSchemaInitializationOptionsDryRun != 0 { parts = append(parts, "NSPersistentCloudKitContainerSchemaInitializationOptionsDryRun") }
	if e&NSPersistentCloudKitContainerSchemaInitializationOptionsPrintSchema != 0 { parts = append(parts, "NSPersistentCloudKitContainerSchemaInitializationOptionsPrintSchema") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
func (e NSSnapshotEventType) String() string {
	var parts []string
	if e&NSSnapshotEventUndoInsertion != 0 { parts = append(parts, "NSSnapshotEventUndoInsertion") }
	if e&NSSnapshotEventUndoDeletion != 0 { parts = append(parts, "NSSnapshotEventUndoDeletion") }
	if e&NSSnapshotEventUndoUpdate != 0 { parts = append(parts, "NSSnapshotEventUndoUpdate") }
	if e&NSSnapshotEventRollback != 0 { parts = append(parts, "NSSnapshotEventRollback") }
	if e&NSSnapshotEventRefresh != 0 { parts = append(parts, "NSSnapshotEventRefresh") }
	if e&NSSnapshotEventMergePolicy != 0 { parts = append(parts, "NSSnapshotEventMergePolicy") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
