...
func (e CSSearchQuerySourceOptions) String() string {
	var parts []string
	if e&CSSearchQuerySourceOptionAllowMail != 0 { parts = append(parts, "CSSearchQuerySourceOptionAllowMail") }
...
func (e CSSearchableItemUpdateListenerOptions) String() string {
	var parts []string
	if e&CSSearchableItemUpdateListenerOptionSummarization != 0 { parts = append(parts, "CSSearchableItemUpdateListenerOptionSummarization") }
	if e&CSSearchableItemUpdateListenerOptionPriority != 0 { parts = append(parts, "CSSearchableItemUpdateListenerOptionPriority") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
