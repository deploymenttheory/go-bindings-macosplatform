...
type MXHistogramBucket[UnitType pureobjc.AnyObject] struct {
	foundation.NSObject
}
...
func MXHistogramBucketFromID[UnitType pureobjc.AnyObject](id objc.ID) *MXHistogramBucket[UnitType] {
	if id == 0 {
		return nil
	}
