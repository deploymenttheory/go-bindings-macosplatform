...
func (e Ar_authorization_type_t) String() string {
	var parts []string
	if e&Ar_authorization_type_hand_tracking != 0 { parts = append(parts, "Ar_authorization_type_hand_tracking") }
	if e&Ar_authorization_type_world_sensing != 0 { parts = append(parts, "Ar_authorization_type_world_sensing") }
	if e&Ar_authorization_type_camera_access != 0 { parts = append(parts, "Ar_authorization_type_camera_access") }
...
func (e Ar_session_error_code_t) String() string {
	switch e {
...
func (e Ar_world_tracking_error_code_t) String() string {
	switch e {
	...
	default:
		return fmt.Sprintf("Ar_world_tracking_error_code_t(%d)", int64(e))
	}
}
...
func (e Cp_layer_renderer_configuration_error_code) String() string {
	switch e {
	...
	default:
		return fmt.Sprintf("Cp_layer_renderer_configuration_error_code(%d)", int64(e))
	}
}
...
func (e Cp_supported_color_formats_options) String() string {
	var parts []string
	if e&Cp_supported_color_formats_options_progressive_immersion_enabled != 0 { parts = append(parts, "Cp_supported_color_formats_options_progressive_immersion_enabled") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
func (e Cp_supported_layouts_options) String() string {
	var parts []string
	if e&Cp_supported_layouts_options_foveation_enabled != 0 { parts = append(parts, "Cp_supported_layouts_options_foveation_enabled") }
	if e&Cp_supported_layouts_options_progressive_immersion_enabled != 0 { parts = append(parts, "Cp_supported_layouts_options_progressive_immersion_enabled") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
