...
func (e AUGenericViewDisplayFlags) String() string {
	var parts []string
	if e&AUViewTitleDisplayFlag != 0 { parts = append(parts, "AUViewTitleDisplayFlag") }
	if e&AUViewPropertiesDisplayFlag != 0 { parts = append(parts, "AUViewPropertiesDisplayFlag") }
	if e&AUViewParametersDisplayFlag != 0 { parts = append(parts, "AUViewParametersDisplayFlag") }
