...
func (o *MPSNNLossGradientNode) LossType() MPSCNNLossType {
	_ret := objc.Send[MPSCNNLossType](o.Ptr(), _mPSNNLossGradientNodeSelLossType)
	return _ret
}

func (o *MPSNNLossGradientNode) ReductionType() MPSCNNReductionType {
	_ret := objc.Send[MPSCNNReductionType](o.Ptr(), _mPSNNLossGradientNodeSelReductionType)
	return _ret
}
...
func (o *MPSNNLossGradientNode) PropertyCallBack() MPSNNLossCallback {
	_ret := objc.Send[MPSNNLossCallback](o.Ptr(), _mPSNNLossGradientNodeSelPropertyCallBack)
	return _ret
}
