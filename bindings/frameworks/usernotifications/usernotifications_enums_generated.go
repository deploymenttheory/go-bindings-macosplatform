...
type AlertStyle int64

const (
	// No alert.
	AlertStyleNone AlertStyle = 0
	// Banner alerts.
	AlertStyleBanner AlertStyle = 1
	// Modal alerts.
	AlertStyleAlert AlertStyle = 2
)
...
func (e AlertStyle) String() string {
	switch e {
	case AlertStyleNone:
		return "AlertStyleNone"
	case AlertStyleBanner:
		return "AlertStyleBanner"
	case AlertStyleAlert:
		return "AlertStyleAlert"
	default:
...
// Bitmask — values may be combined with |.
type NotificationPresentationOptions uint64

const (
	// Apply the notification’s badge value to the app’s icon.
	NotificationPresentationOptionBadge NotificationPresentationOptions = 1
	// Play the sound associated with the notification.
	NotificationPresentationOptionSound NotificationPresentationOptions = 2
	// Display the alert using the content provided by the notification.
	//
	// Deprecated: since macOS 11.0.
	NotificationPresentationOptionAlert NotificationPresentationOptions = 4
	// Show the notification in Notification Center.
	NotificationPresentationOptionList NotificationPresentationOptions = 8
	// Present the notification as a banner.
	NotificationPresentationOptionBanner NotificationPresentationOptions = 16
)

// String returns the NotificationPresentationOptions constant's name, or its numeric form when the
// value is not a known constant.
func (e NotificationPresentationOptions) String() string {
	var parts []string
	if e&NotificationPresentationOptionBadge != 0 {
		parts = append(parts, "NotificationPresentationOptionBadge")
	}
	if e&NotificationPresentationOptionSound != 0 {
		parts = append(parts, "NotificationPresentationOptionSound")
	}
	if e&NotificationPresentationOptionAlert != 0 {
		parts = append(parts, "NotificationPresentationOptionAlert")
	}
	if e&NotificationPresentationOptionList != 0 {
		parts = append(parts, "NotificationPresentationOptionList")
	}
	if e&NotificationPresentationOptionBanner != 0 {
		parts = append(parts, "NotificationPresentationOptionBanner")
	}
	if len(parts) == 0 {
		return "0"
	}
