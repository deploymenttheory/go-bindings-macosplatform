...
func (e UNAlertStyle) String() string {
	...
	default:
		return fmt.Sprintf("UNAlertStyle(%d)", int64(e))
	}
}
...
func (e UNAuthorizationOptions) String() string {
	var parts []string
	if e&UNAuthorizationOptionBadge != 0 { parts = append(parts, "UNAuthorizationOptionBadge") }
	if e&UNAuthorizationOptionSound != 0 { parts = append(parts, "UNAuthorizationOptionSound") }
	if e&UNAuthorizationOptionAlert != 0 { parts = append(parts, "UNAuthorizationOptionAlert") }
	if e&UNAuthorizationOptionCarPlay != 0 { parts = append(parts, "UNAuthorizationOptionCarPlay") }
	if e&UNAuthorizationOptionCriticalAlert != 0 { parts = append(parts, "UNAuthorizationOptionCriticalAlert") }
	if e&UNAuthorizationOptionProvidesAppNotificationSettings != 0 { parts = append(parts, "UNAuthorizationOptionProvidesAppNotificationSettings") }
	if e&UNAuthorizationOptionProvisional != 0 { parts = append(parts, "UNAuthorizationOptionProvisional") }
	if e&UNAuthorizationOptionTimeSensitive != 0 { parts = append(parts, "UNAuthorizationOptionTimeSensitive") }
...
func (e UNNotificationActionOptions) String() string {
	var parts []string
	if e&UNNotificationActionOptionAuthenticationRequired != 0 { parts = append(parts, "UNNotificationActionOptionAuthenticationRequired") }
	if e&UNNotificationActionOptionDestructive != 0 { parts = append(parts, "UNNotificationActionOptionDestructive") }
	if e&UNNotificationActionOptionForeground != 0 { parts = append(parts, "UNNotificationActionOptionForeground") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
func (e UNNotificationCategoryOptions) String() string {
	var parts []string
	if e&UNNotificationCategoryOptionCustomDismissAction != 0 { parts = append(parts, "UNNotificationCategoryOptionCustomDismissAction") }
	if e&UNNotificationCategoryOptionHiddenPreviewsShowTitle != 0 { parts = append(parts, "UNNotificationCategoryOptionHiddenPreviewsShowTitle") }
	if e&UNNotificationCategoryOptionHiddenPreviewsShowSubtitle != 0 { parts = append(parts, "UNNotificationCategoryOptionHiddenPreviewsShowSubtitle") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
...
type UNNotificationPresentationOptions uint64
...
func (e UNNotificationPresentationOptions) String() string {
	var parts []string
	if e&UNNotificationPresentationOptionBadge != 0 { parts = append(parts, "UNNotificationPresentationOptionBadge") }
	if e&UNNotificationPresentationOptionSound != 0 { parts = append(parts, "UNNotificationPresentationOptionSound") }
	if e&UNNotificationPresentationOptionAlert != 0 { parts = append(parts, "UNNotificationPresentationOptionAlert") }
	if e&UNNotificationPresentationOptionList != 0 { parts = append(parts, "UNNotificationPresentationOptionList") }
	if e&UNNotificationPresentationOptionBanner != 0 { parts = append(parts, "UNNotificationPresentationOptionBanner") }
	if len(parts) == 0 { return "0" }
	return strings.Join(parts, "|")
}
