...
func SymbolAvailable(symbol string) bool {
	...
	return _mediatoolboxLib != 0 && !_failedSymbols[symbol]
}

func _loadLibrary() {
	var err error
	_mediatoolboxLib, err = purego.Dlopen("/System/Library/Frameworks/MediaToolbox.framework/MediaToolbox", purego.RTLD_GLOBAL|purego.RTLD_LAZY)
	if err != nil {
