...
func (e MPMediaType) String() string {
	var parts []string
	if e&MPMediaTypeMusic != 0 {
		parts = append(parts, "MPMediaTypeMusic")
	}
	if e&MPMediaTypePodcast != 0 {
		parts = append(parts, "MPMediaTypePodcast")
	}
	if e&MPMediaTypeAudioBook != 0 {
		parts = append(parts, "MPMediaTypeAudioBook")
	}
	if e&MPMediaTypeAudioITunesU != 0 {
		parts = append(parts, "MPMediaTypeAudioITunesU")
	}
	if e&MPMediaTypeAnyAudio != 0 {
		parts = append(parts, "MPMediaTypeAnyAudio")
	}
	if e&MPMediaTypeMovie != 0 {
		parts = append(parts, "MPMediaTypeMovie")
	}
	if e&MPMediaTypeTVShow != 0 {
		parts = append(parts, "MPMediaTypeTVShow")
	}
	if e&MPMediaTypeVideoPodcast != 0 {
		parts = append(parts, "MPMediaTypeVideoPodcast")
	}
	if e&MPMediaTypeMusicVideo != 0 {
		parts = append(parts, "MPMediaTypeMusicVideo")
	}
	if e&MPMediaTypeVideoITunesU != 0 {
		parts = append(parts, "MPMediaTypeVideoITunesU")
	}
	if e&MPMediaTypeHomeVideo != 0 {
		parts = append(parts, "MPMediaTypeHomeVideo")
	}
	if e&MPMediaTypeAnyVideo != 0 {
		parts = append(parts, "MPMediaTypeAnyVideo")
	}
	if e&MPMediaTypeAny != 0 {
		parts = append(parts, "MPMediaTypeAny")
	}
	if len(parts) == 0 {
		return "0"
	}
