...
func (e GCPhysicalInputSourceDirection) String() string {
	var parts []string
	if e&GCPhysicalInputSourceDirectionUp != 0 {
		parts = append(parts, "GCPhysicalInputSourceDirectionUp")
	}
	if e&GCPhysicalInputSourceDirectionRight != 0 {
		parts = append(parts, "GCPhysicalInputSourceDirectionRight")
	}
	if e&GCPhysicalInputSourceDirectionDown != 0 {
		parts = append(parts, "GCPhysicalInputSourceDirectionDown")
	}
	if e&GCPhysicalInputSourceDirectionLeft != 0 {
		parts = append(parts, "GCPhysicalInputSourceDirectionLeft")
	}
	if len(parts) == 0 {
		return "0"
	}
