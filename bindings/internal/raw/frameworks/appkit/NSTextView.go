...
var (
	...
	_nSTextViewSelRegisterTextAttachmentViewProviderReusePolicyForTextAttachmentViewProviderType = objc.RegisterName("registerTextAttachmentViewProviderReusePolicy:forTextAttachmentViewProviderType:")
	_nSTextViewSelTextViewportLayoutControllerConfigureRenderingSurfaceForTextLayoutFragment     = objc.RegisterName("textViewportLayoutController:configureRenderingSurfaceForTextLayoutFragment:")
	_nSTextViewSelViewportBoundsForTextViewportLayoutController                                  = objc.RegisterName("viewportBoundsForTextViewportLayoutController:")
	_nSTextViewSelTextViewportLayoutControllerWillLayout                                         = objc.RegisterName("textViewportLayoutControllerWillLayout:")
	_nSTextViewSelTextViewportLayoutControllerDidLayout                                          = objc.RegisterName("textViewportLayoutControllerDidLayout:")
	_nSTextViewSelTextViewportLayoutControllerReceivedSetNeedsLayout                             = objc.RegisterName("textViewportLayoutControllerReceivedSetNeedsLayout:")
...
func (o *NSTextView) RegisterTextAttachmentViewProviderReusePolicyForTextAttachmentViewProviderType(policy NSTextAttachmentViewProviderReusePolicy, viewProviderType objc.Class) {
	purego.Main(func() {
		o.Ptr().Send(_nSTextViewSelRegisterTextAttachmentViewProviderReusePolicyForTextAttachmentViewProviderType, policy, viewProviderType)
	})
}
...
func (o *NSTextView) TextViewportLayoutControllerConfigureRenderingSurfaceForTextLayoutFragment(textViewportLayoutController *NSTextViewportLayoutController, textLayoutFragment *NSTextLayoutFragment) {
	purego.Main(func() {
		o.Ptr().Send(_nSTextViewSelTextViewportLayoutControllerConfigureRenderingSurfaceForTextLayoutFragment, textViewportLayoutController.Ptr(), textLayoutFragment.Ptr())
	})
}
...
func (o *NSTextView) ViewportBoundsForTextViewportLayoutController(textViewportLayoutController *NSTextViewportLayoutController) corefoundation.CGRect {
	var _mainthread0 corefoundation.CGRect
	purego.Main(func() {
		_mainthread0 = func() corefoundation.CGRect {
			_ret := objc.Send[corefoundation.CGRect](o.Ptr(), _nSTextViewSelViewportBoundsForTextViewportLayoutController, textViewportLayoutController.Ptr())
			return _ret
		}()
	})
	return _mainthread0
...
func (o *NSTextView) TextViewportLayoutControllerWillLayout(textViewportLayoutController *NSTextViewportLayoutController) {
	purego.Main(func() {
		o.Ptr().Send(_nSTextViewSelTextViewportLayoutControllerWillLayout, textViewportLayoutController.Ptr())
	})
}
...
func (o *NSTextView) TextViewportLayoutControllerDidLayout(textViewportLayoutController *NSTextViewportLayoutController) {
	purego.Main(func() {
		o.Ptr().Send(_nSTextViewSelTextViewportLayoutControllerDidLayout, textViewportLayoutController.Ptr())
	})
}
...
func (o *NSTextView) TextViewportLayoutControllerReceivedSetNeedsLayout(textViewportLayoutController *NSTextViewportLayoutController) {
	purego.Main(func() {
		o.Ptr().Send(_nSTextViewSelTextViewportLayoutControllerReceivedSetNeedsLayout, textViewportLayoutController.Ptr())
	})
}
