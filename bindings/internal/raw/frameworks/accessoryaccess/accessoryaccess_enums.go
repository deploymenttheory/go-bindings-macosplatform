...
type AAErrorCode int64

const (
	AAErrorCodeInternal                           AAErrorCode = 1
	AAErrorCodeAccessoryListenerAlreadyRegistered AAErrorCode = 2
	AAErrorCodeAccessoryNotAccessible             AAErrorCode = 3
	AAErrorCodeInvalidAccessoryState              AAErrorCode = 4
)

func (e AAErrorCode) String() string {
	switch e {
	case AAErrorCodeInternal:
		return "AAErrorCodeInternal"
	case AAErrorCodeAccessoryListenerAlreadyRegistered:
		return "AAErrorCodeAccessoryListenerAlreadyRegistered"
	case AAErrorCodeAccessoryNotAccessible:
		return "AAErrorCodeAccessoryNotAccessible"
	case AAErrorCodeInvalidAccessoryState:
		return "AAErrorCodeInvalidAccessoryState"
	default:
		return fmt.Sprintf("AAErrorCode(%d)", int64(e))
	}
}

type AAUSBAccessoryMatchingCriteriaInterfaceMatchingOption int64

const (
	// Matching is successful for USB accessories where every criterion/dictionary matches at least one USB interface.
	AAUSBAccessoryMatchingCriteriaInterfaceMatchingOptionMatchAll AAUSBAccessoryMatchingCriteriaInterfaceMatchingOption = 0
	// Matching is successful for USB accessories where any of the criteria/dictionaries match at least one USB interface.
	AAUSBAccessoryMatchingCriteriaInterfaceMatchingOptionMatchAny AAUSBAccessoryMatchingCriteriaInterfaceMatchingOption = 1
)

func (e AAUSBAccessoryMatchingCriteriaInterfaceMatchingOption) String() string {
	switch e {
	case AAUSBAccessoryMatchingCriteriaInterfaceMatchingOptionMatchAll:
		return "AAUSBAccessoryMatchingCriteriaInterfaceMatchingOptionMatchAll"
	case AAUSBAccessoryMatchingCriteriaInterfaceMatchingOptionMatchAny:
		return "AAUSBAccessoryMatchingCriteriaInterfaceMatchingOptionMatchAny"
	default:
		return fmt.Sprintf("AAUSBAccessoryMatchingCriteriaInterfaceMatchingOption(%d)", int64(e))
	}
}
