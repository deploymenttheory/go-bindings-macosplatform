...
func (e IKImageBrowserDropOperation) String() string {
	switch e {
	case IKImageBrowserDropOn:
		return "IKImageBrowserDropOn"
	case IKImageBrowserDropBefore:
		return "IKImageBrowserDropBefore"
	default:
		return fmt.Sprintf("IKImageBrowserDropOperation(%d)", int64(e))
	}
}
...
func (e QLPreviewPDFStyle) String() string {
	switch e {
	case KQLPreviewPDFStandardStyle:
		return "KQLPreviewPDFStandardStyle"
	case KQLPreviewPDFPagesWithThumbnailsOnRightStyle:
		return "KQLPreviewPDFPagesWithThumbnailsOnRightStyle"
	case KQLPreviewPDFPagesWithThumbnailsOnLeftStyle:
		return "KQLPreviewPDFPagesWithThumbnailsOnLeftStyle"
	default:
		return fmt.Sprintf("QLPreviewPDFStyle(%d)", int64(e))
	}
}
