...
func (e NSFileProviderCreateItemOptions) String() string {
	var parts []string
	if e&NSFileProviderCreateItemMayAlreadyExist != 0 {
		parts = append(parts, "NSFileProviderCreateItemMayAlreadyExist")
	}
	if e&NSFileProviderCreateItemDeletionConflicted != 0 {
		parts = append(parts, "NSFileProviderCreateItemDeletionConflicted")
	}
	if len(parts) == 0 {
		return "0"
	}
...
func (e NSFileProviderDeleteItemOptions) String() string {
	var parts []string
	if e&NSFileProviderDeleteItemRecursive != 0 {
		parts = append(parts, "NSFileProviderDeleteItemRecursive")
	}
	if len(parts) == 0 {
		return "0"
	}
...
func (e NSFileProviderFetchContentsOptions) String() string {
	var parts []string
	if e&NSFileProviderFetchContentsOptionsStrictVersioning != 0 {
		parts = append(parts, "NSFileProviderFetchContentsOptionsStrictVersioning")
	}
	if len(parts) == 0 {
		return "0"
	}
...
func (e NSFileProviderFileSystemFlags) String() string {
	var parts []string
	if e&NSFileProviderFileSystemUserExecutable != 0 {
		parts = append(parts, "NSFileProviderFileSystemUserExecutable")
	}
	if e&NSFileProviderFileSystemUserReadable != 0 {
		parts = append(parts, "NSFileProviderFileSystemUserReadable")
	}
	if e&NSFileProviderFileSystemUserWritable != 0 {
		parts = append(parts, "NSFileProviderFileSystemUserWritable")
	}
	if e&NSFileProviderFileSystemHidden != 0 {
		parts = append(parts, "NSFileProviderFileSystemHidden")
	}
	if e&NSFileProviderFileSystemPathExtensionHidden != 0 {
		parts = append(parts, "NSFileProviderFileSystemPathExtensionHidden")
	}
	if len(parts) == 0 {
		return "0"
	}
...
func (e NSFileProviderItemCapabilities) String() string {
	var parts []string
	if e&NSFileProviderItemCapabilitiesAllowsReading != 0 {
		parts = append(parts, "NSFileProviderItemCapabilitiesAllowsReading")
	}
	if e&NSFileProviderItemCapabilitiesAllowsWriting != 0 {
		parts = append(parts, "NSFileProviderItemCapabilitiesAllowsWriting")
	}
	if e&NSFileProviderItemCapabilitiesAllowsReparenting != 0 {
		parts = append(parts, "NSFileProviderItemCapabilitiesAllowsReparenting")
	}
	if e&NSFileProviderItemCapabilitiesAllowsRenaming != 0 {
		parts = append(parts, "NSFileProviderItemCapabilitiesAllowsRenaming")
	}
	if e&NSFileProviderItemCapabilitiesAllowsTrashing != 0 {
		parts = append(parts, "NSFileProviderItemCapabilitiesAllowsTrashing")
	}
	if e&NSFileProviderItemCapabilitiesAllowsDeleting != 0 {
		parts = append(parts, "NSFileProviderItemCapabilitiesAllowsDeleting")
	}
	if e&NSFileProviderItemCapabilitiesAllowsEvicting != 0 {
		parts = append(parts, "NSFileProviderItemCapabilitiesAllowsEvicting")
	}
	if e&NSFileProviderItemCapabilitiesAllowsExcludingFromSync != 0 {
		parts = append(parts, "NSFileProviderItemCapabilitiesAllowsExcludingFromSync")
	}
	if e&NSFileProviderItemCapabilitiesAllowsAddingSubItems != 0 {
		parts = append(parts, "NSFileProviderItemCapabilitiesAllowsAddingSubItems")
	}
	if e&NSFileProviderItemCapabilitiesAllowsContentEnumerating != 0 {
		parts = append(parts, "NSFileProviderItemCapabilitiesAllowsContentEnumerating")
	}
	if e&NSFileProviderItemCapabilitiesAllowsAll != 0 {
		parts = append(parts, "NSFileProviderItemCapabilitiesAllowsAll")
	}
	if len(parts) == 0 {
		return "0"
	}
...
func (e NSFileProviderItemFields) String() string {
	var parts []string
	if e&NSFileProviderItemContents != 0 {
		parts = append(parts, "NSFileProviderItemContents")
	}
	if e&NSFileProviderItemFilename != 0 {
		parts = append(parts, "NSFileProviderItemFilename")
	}
	if e&NSFileProviderItemParentItemIdentifier != 0 {
		parts = append(parts, "NSFileProviderItemParentItemIdentifier")
	}
	if e&NSFileProviderItemLastUsedDate != 0 {
		parts = append(parts, "NSFileProviderItemLastUsedDate")
	}
	if e&NSFileProviderItemTagData != 0 {
		parts = append(parts, "NSFileProviderItemTagData")
	}
	if e&NSFileProviderItemFavoriteRank != 0 {
		parts = append(parts, "NSFileProviderItemFavoriteRank")
	}
	if e&NSFileProviderItemCreationDate != 0 {
		parts = append(parts, "NSFileProviderItemCreationDate")
	}
	if e&NSFileProviderItemContentModificationDate != 0 {
		parts = append(parts, "NSFileProviderItemContentModificationDate")
	}
	if e&NSFileProviderItemFileSystemFlags != 0 {
		parts = append(parts, "NSFileProviderItemFileSystemFlags")
	}
	if e&NSFileProviderItemExtendedAttributes != 0 {
		parts = append(parts, "NSFileProviderItemExtendedAttributes")
	}
	if e&NSFileProviderItemTypeAndCreator != 0 {
		parts = append(parts, "NSFileProviderItemTypeAndCreator")
	}
	if len(parts) == 0 {
		return "0"
	}
...
func (e NSFileProviderMaterializationFlags) String() string {
	var parts []string
	if e&NSFileProviderMaterializationFlagsKnownSparseRanges != 0 {
		parts = append(parts, "NSFileProviderMaterializationFlagsKnownSparseRanges")
	}
	if len(parts) == 0 {
		return "0"
	}
...
func (e NSFileProviderModifyItemOptions) String() string {
	var parts []string
	if e&NSFileProviderModifyItemMayAlreadyExist != 0 {
		parts = append(parts, "NSFileProviderModifyItemMayAlreadyExist")
	}
	if e&NSFileProviderModifyItemFailOnConflict != 0 {
		parts = append(parts, "NSFileProviderModifyItemFailOnConflict")
	}
	if e&NSFileProviderModifyItemIsImmediateUploadRequestByPresentingApplication != 0 {
		parts = append(parts, "NSFileProviderModifyItemIsImmediateUploadRequestByPresentingApplication")
	}
	if len(parts) == 0 {
		return "0"
	}
...
type NSFileProviderNamespacePolicy int64

const (
	// Inherit the namespace policy of the parent folder.
	NSFileProviderNamespacePolicyInherited NSFileProviderNamespacePolicy = 0
	...
	NSFileProviderNamespacePolicyMaterializeLazily NSFileProviderNamespacePolicy = 1
	...
	NSFileProviderNamespacePolicyMaterializeEagerly NSFileProviderNamespacePolicy = 2
)

func (e NSFileProviderNamespacePolicy) String() string {
	switch e {
	case NSFileProviderNamespacePolicyInherited:
		return "NSFileProviderNamespacePolicyInherited"
	case NSFileProviderNamespacePolicyMaterializeLazily:
		return "NSFileProviderNamespacePolicyMaterializeLazily"
	case NSFileProviderNamespacePolicyMaterializeEagerly:
		return "NSFileProviderNamespacePolicyMaterializeEagerly"
	default:
		return fmt.Sprintf("NSFileProviderNamespacePolicy(%d)", int64(e))
	}
}
...
func (e NSFileProviderVolumeUnsupportedReason) String() string {
	var parts []string
	if e&NSFileProviderVolumeUnsupportedReasonUnknown != 0 {
		parts = append(parts, "NSFileProviderVolumeUnsupportedReasonUnknown")
	}
	if e&NSFileProviderVolumeUnsupportedReasonNonAPFS != 0 {
		parts = append(parts, "NSFileProviderVolumeUnsupportedReasonNonAPFS")
	}
	if e&NSFileProviderVolumeUnsupportedReasonNonEncrypted != 0 {
		parts = append(parts, "NSFileProviderVolumeUnsupportedReasonNonEncrypted")
	}
	if e&NSFileProviderVolumeUnsupportedReasonReadOnly != 0 {
		parts = append(parts, "NSFileProviderVolumeUnsupportedReasonReadOnly")
	}
	if e&NSFileProviderVolumeUnsupportedReasonNetwork != 0 {
		parts = append(parts, "NSFileProviderVolumeUnsupportedReasonNetwork")
	}
	if e&NSFileProviderVolumeUnsupportedReasonQuarantined != 0 {
		parts = append(parts, "NSFileProviderVolumeUnsupportedReasonQuarantined")
	}
	if len(parts) == 0 {
		return "0"
	}
