...
func (e ODFrameworkErrors) String() string {
	...
	case KODErrorCredentialsContactPrimary:
		return "KODErrorCredentialsContactPrimary"
	...
	default:
		return fmt.Sprintf("ODFrameworkErrors(%d)", int64(e))
	}
}
...
const (
	KODMatchAny                   = 1
	KODMatchBeginsWith            = 8194
	KODMatchContains              = 8196
	KODMatchEndsWith              = 8195
	KODMatchEqualTo               = 8193
	KODMatchGreaterThan           = 8198
	KODMatchInsensitiveBeginsWith = 8450
	KODMatchInsensitiveContains   = 8452
	KODMatchInsensitiveEndsWith   = 8451
	KODMatchInsensitiveEqualTo    = 8449
	KODMatchLessThan              = 8199
)

const (
	KODNodeTypeAuthentication = 8705
	KODNodeTypeConfigure      = 8706
	KODNodeTypeContacts       = 8708
	KODNodeTypeLocalNodes     = 8704
	KODNodeTypeNetwork        = 8709
)
