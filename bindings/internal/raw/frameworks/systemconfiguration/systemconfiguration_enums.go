...
func (e SCPreferencesNotification) String() string {
	var parts []string
	if e&KSCPreferencesNotificationCommit != 0 {
		parts = append(parts, "KSCPreferencesNotificationCommit")
	}
	if e&KSCPreferencesNotificationApply != 0 {
		parts = append(parts, "KSCPreferencesNotificationApply")
	}
	if len(parts) == 0 {
		return "0"
	}
