...
func (e UNNotificationPresentationOptions) String() string {
	var parts []string
	if e&UNNotificationPresentationOptionBadge != 0 {
		parts = append(parts, "UNNotificationPresentationOptionBadge")
	}
	if e&UNNotificationPresentationOptionSound != 0 {
		parts = append(parts, "UNNotificationPresentationOptionSound")
	}
	if e&UNNotificationPresentationOptionAlert != 0 {
		parts = append(parts, "UNNotificationPresentationOptionAlert")
	}
	if e&UNNotificationPresentationOptionList != 0 {
		parts = append(parts, "UNNotificationPresentationOptionList")
	}
	if e&UNNotificationPresentationOptionBanner != 0 {
		parts = append(parts, "UNNotificationPresentationOptionBanner")
	}
	if len(parts) == 0 {
		return "0"
	}
