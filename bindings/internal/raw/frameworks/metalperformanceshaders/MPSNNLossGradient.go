...
// Apple documentation: https://developer.apple.com/documentation/metalperformanceshaders/mpsnnlossgradient
...
func (o *MPSNNLossGradient) LossType() mpsneuralnetwork.MPSCNNLossType {
	_ret := objc.Send[mpsneuralnetwork.MPSCNNLossType](o.Ptr(), _mPSNNLossGradientSelLossType)
	return _ret
}

func (o *MPSNNLossGradient) ReductionType() mpsneuralnetwork.MPSCNNReductionType {
	_ret := objc.Send[mpsneuralnetwork.MPSCNNReductionType](o.Ptr(), _mPSNNLossGradientSelReductionType)
	return _ret
}
