...
func (o *MPSCNNConvolutionWeightsAndBiasesState) InitWithDeviceCnnConvolutionDescriptor(device metal.MTLDevice, descriptor *mpsneuralnetwork.MPSCNNConvolutionDescriptor) *MPSCNNConvolutionWeightsAndBiasesState {
...
func MPSCNNConvolutionWeightsAndBiasesStateTemporaryCNNConvolutionWeightsAndBiasesStateWithCommandBufferCnnConvolutionDescriptor(commandBuffer metal.MTLCommandBuffer, descriptor *mpsneuralnetwork.MPSCNNConvolutionDescriptor) *MPSCNNConvolutionWeightsAndBiasesState {
...
func (o *MPSCNNConvolutionWeightsAndBiasesState) InitWithWeightsWeightsOffsetBiasesBiasesOffsetCnnConvolutionDescriptor(weights metal.MTLBuffer, weightsOffset uint, biases metal.MTLBuffer, biasesOffset uint, descriptor *mpsneuralnetwork.MPSCNNConvolutionDescriptor) *MPSCNNConvolutionWeightsAndBiasesState {
