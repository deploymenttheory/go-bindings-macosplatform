...
func (o *MPSInstanceAccelerationStructure) TransformType() mpsrayintersector.MPSTransformType {
	_ret := objc.Send[mpsrayintersector.MPSTransformType](o.Ptr(), _mPSInstanceAccelerationStructureSelTransformType)
	return _ret
}

func (o *MPSInstanceAccelerationStructure) SetTransformType(transformType mpsrayintersector.MPSTransformType) {
