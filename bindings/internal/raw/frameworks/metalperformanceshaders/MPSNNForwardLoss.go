...
// Apple documentation: https://developer.apple.com/documentation/metalperformanceshaders/mpsnnforwardloss
...
func (o *MPSNNForwardLoss) LossType() mpsneuralnetwork.MPSCNNLossType {
	_ret := objc.Send[mpsneuralnetwork.MPSCNNLossType](o.Ptr(), _mPSNNForwardLossSelLossType)
	return _ret
}

func (o *MPSNNForwardLoss) ReductionType() mpsneuralnetwork.MPSCNNReductionType {
	_ret := objc.Send[mpsneuralnetwork.MPSCNNReductionType](o.Ptr(), _mPSNNForwardLossSelReductionType)
	return _ret
}
