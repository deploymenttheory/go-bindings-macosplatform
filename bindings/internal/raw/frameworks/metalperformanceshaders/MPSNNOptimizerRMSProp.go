...
//
// Apple documentation: https://developer.apple.com/documentation/metalperformanceshaders/mpsnnoptimizerrmsprop
...
func (o *MPSNNOptimizerRMSProp) InitWithDeviceDecayEpsilonOptimizerDescriptor(device metal.MTLDevice, decay float64, epsilon float32, optimizerDescriptor *mpsneuralnetwork.MPSNNOptimizerDescriptor) *MPSNNOptimizerRMSProp {
