...
//
// Apple documentation: https://developer.apple.com/documentation/metalperformanceshaders/mpsmatrixbatchnormalizationgradient
...
func (o *MPSMatrixBatchNormalizationGradient) SetNeuronTypeParameterAParameterBParameterC(neuronType mpsneuralnetwork.MPSCNNNeuronType, parameterA float32, parameterB float32, parameterC float32) {
...
func (o *MPSMatrixBatchNormalizationGradient) NeuronType() mpsneuralnetwork.MPSCNNNeuronType {
	_ret := objc.Send[mpsneuralnetwork.MPSCNNNeuronType](o.Ptr(), _mPSMatrixBatchNormalizationGradientSelNeuronType)
	return _ret
}
...
func (o *MPSMatrixBatchNormalizationGradient) CopyWithZoneDevice(zone unsafe.Pointer, device metal.MTLDevice) *MPSMatrixBatchNormalizationGradient {
	_ret := objc.Send[objc.ID](o.Ptr(), _mPSMatrixBatchNormalizationGradientSelCopyWithZoneDevice, zone, device)
	return MPSMatrixBatchNormalizationGradientFromID(_ret)
}
