...
func (o *MPSMatrixNeuronGradient) SetNeuronTypeParameterAParameterBParameterC(neuronType mpsneuralnetwork.MPSCNNNeuronType, parameterA float32, parameterB float32, parameterC float32) {
...
func (o *MPSMatrixNeuronGradient) NeuronType() mpsneuralnetwork.MPSCNNNeuronType {
	_ret := objc.Send[mpsneuralnetwork.MPSCNNNeuronType](o.Ptr(), _mPSMatrixNeuronGradientSelNeuronType)
	return _ret
}
...
func (o *MPSMatrixNeuronGradient) CopyWithZoneDevice(zone unsafe.Pointer, device metal.MTLDevice) *MPSMatrixNeuronGradient {
	_ret := objc.Send[objc.ID](o.Ptr(), _mPSMatrixNeuronGradientSelCopyWithZoneDevice, zone, device)
	return MPSMatrixNeuronGradientFromID(_ret)
}
