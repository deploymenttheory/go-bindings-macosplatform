...
func (o *MPSImageScale) ScaleTransform() *MPSScaleTransform {
	_ret := objc.Send[*MPSScaleTransform](o.Ptr(), _mPSImageScaleSelScaleTransform)
	return _ret
}

func (o *MPSImageScale) SetScaleTransform(scaleTransform *MPSScaleTransform) {
