...
func MPSNNScaleNodeNodeWithSourceOutputSize(sourceNode *mpsneuralnetwork.MPSNNImageNode, size metal.MTLSize) *MPSNNScaleNode {
...
func MPSNNScaleNodeNodeWithSourceTransformProviderOutputSize(sourceNode *mpsneuralnetwork.MPSNNImageNode, transformProvider mpsneuralnetwork.MPSImageTransformProvider, size metal.MTLSize) *MPSNNScaleNode {
...
func (o *MPSNNScaleNode) InitWithSourceOutputSize(sourceNode *mpsneuralnetwork.MPSNNImageNode, size metal.MTLSize) *MPSNNScaleNode {
...
func (o *MPSNNScaleNode) InitWithSourceTransformProviderOutputSize(sourceNode *mpsneuralnetwork.MPSNNImageNode, transformProvider mpsneuralnetwork.MPSImageTransformProvider, size metal.MTLSize) *MPSNNScaleNode {
