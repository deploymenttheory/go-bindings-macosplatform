...
// Apple documentation: https://developer.apple.com/documentation/metalperformanceshaders/mpspolygonaccelerationstructure
...
func (o *MPSPolygonAccelerationStructure) PolygonType() mpsrayintersector.MPSPolygonType {
	_ret := objc.Send[mpsrayintersector.MPSPolygonType](o.Ptr(), _mPSPolygonAccelerationStructureSelPolygonType)
	return _ret
}

func (o *MPSPolygonAccelerationStructure) SetPolygonType(polygonType mpsrayintersector.MPSPolygonType) {
