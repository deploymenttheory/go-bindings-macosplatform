...
var (
	...
	_mPSRNNImageInferenceLayerSelCopyWithZoneDevice                                                                                        = objc.RegisterName("copyWithZone:device:")
...
func (o *MPSRNNImageInferenceLayer) InitWithDeviceRnnDescriptor(device metal.MTLDevice, rnnDescriptor *mpsneuralnetwork.MPSRNNDescriptor) *MPSRNNImageInferenceLayer {
...
func (o *MPSRNNImageInferenceLayer) CopyWithZoneDevice(zone unsafe.Pointer, device metal.MTLDevice) *MPSRNNImageInferenceLayer {
	_ret := objc.Send[objc.ID](o.Ptr(), _mPSRNNImageInferenceLayerSelCopyWithZoneDevice, zone, device)
	return MPSRNNImageInferenceLayerFromID(_ret)
}
...
func (o *MPSRNNImageInferenceLayer) BidirectionalCombineMode() mpsneuralnetwork.MPSRNNBidirectionalCombineMode {
	_ret := objc.Send[mpsneuralnetwork.MPSRNNBidirectionalCombineMode](o.Ptr(), _mPSRNNImageInferenceLayerSelBidirectionalCombineMode)
	return _ret
}

func (o *MPSRNNImageInferenceLayer) SetBidirectionalCombineMode(bidirectionalCombineMode mpsneuralnetwork.MPSRNNBidirectionalCombineMode) {
