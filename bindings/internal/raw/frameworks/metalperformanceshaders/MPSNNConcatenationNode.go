...
func MPSNNConcatenationNodeNodeWithSources(sourceNodes *foundation.NSArray[*mpsneuralnetwork.MPSNNImageNode]) *MPSNNConcatenationNode {
	_ret := objc.Send[objc.ID](objc.ID(_clsMPSNNConcatenationNode), _mPSNNConcatenationNodeSelNodeWithSources, sourceNodes.Ptr())
	if _ret != 0 {
...
func (o *MPSNNConcatenationNode) InitWithSources(sourceNodes *foundation.NSArray[*mpsneuralnetwork.MPSNNImageNode]) *MPSNNConcatenationNode {
	_ret := objc.Send[objc.ID](o.Ptr(), _mPSNNConcatenationNodeSelInitWithSources, sourceNodes.Ptr())
	if _ret != 0 {
		_ret.Send(objc.RegisterName("retain"))
	}
	return MPSNNConcatenationNodeFromID(_ret)
