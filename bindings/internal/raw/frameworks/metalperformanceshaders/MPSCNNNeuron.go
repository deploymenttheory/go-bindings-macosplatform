...
//
// Apple documentation: https://developer.apple.com/documentation/metalperformanceshaders/mpscnnneuron
...
func (o *MPSCNNNeuron) InitWithDeviceNeuronDescriptor(device metal.MTLDevice, neuronDescriptor *mpsneuralnetwork.MPSNNNeuronDescriptor) *MPSCNNNeuron {
...
func (o *MPSCNNNeuron) NeuronType() mpsneuralnetwork.MPSCNNNeuronType {
	_ret := objc.Send[mpsneuralnetwork.MPSCNNNeuronType](o.Ptr(), _mPSCNNNeuronSelNeuronType)
	return _ret
}
