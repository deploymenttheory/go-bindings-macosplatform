...
var (
	...
	_mPSRNNMatrixTrainingLayerSelCopyWithZoneDevice                                                                                                                                                                                                            = objc.RegisterName("copyWithZone:device:")
...
func (o *MPSRNNMatrixTrainingLayer) CopyWithZoneDevice(zone unsafe.Pointer, device metal.MTLDevice) *MPSRNNMatrixTrainingLayer {
	_ret := objc.Send[objc.ID](o.Ptr(), _mPSRNNMatrixTrainingLayerSelCopyWithZoneDevice, zone, device)
	return MPSRNNMatrixTrainingLayerFromID(_ret)
}
