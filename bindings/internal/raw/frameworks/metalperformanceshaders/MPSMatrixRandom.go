...
// Apple documentation: https://developer.apple.com/documentation/metalperformanceshaders/mpsmatrixrandom
...
func (o *MPSMatrixRandom) DistributionType() mpsmatrix.MPSMatrixRandomDistribution {
	_ret := objc.Send[mpsmatrix.MPSMatrixRandomDistribution](o.Ptr(), _mPSMatrixRandomSelDistributionType)
	return _ret
}
