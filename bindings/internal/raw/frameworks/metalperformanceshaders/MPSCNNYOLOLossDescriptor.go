...
func (o *MPSCNNYOLOLossDescriptor) SetConfidenceLossDescriptor(confidenceLossDescriptor *mpsneuralnetwork.MPSCNNLossDescriptor) {
...
func (o *MPSCNNYOLOLossDescriptor) SetClassesLossDescriptor(classesLossDescriptor *mpsneuralnetwork.MPSCNNLossDescriptor) {
...
func (o *MPSCNNYOLOLossDescriptor) ReductionType() mpsneuralnetwork.MPSCNNReductionType {
	_ret := objc.Send[mpsneuralnetwork.MPSCNNReductionType](o.Ptr(), _mPSCNNYOLOLossDescriptorSelReductionType)
	return _ret
}

func (o *MPSCNNYOLOLossDescriptor) SetReductionType(reductionType mpsneuralnetwork.MPSCNNReductionType) {
