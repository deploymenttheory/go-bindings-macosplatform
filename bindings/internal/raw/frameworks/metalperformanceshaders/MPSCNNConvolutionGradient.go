...
func (o *MPSCNNConvolutionGradient) ReloadWeightsAndBiasesWithCommandBufferState(commandBuffer metal.MTLCommandBuffer, state *mpsneuralnetwork.MPSCNNConvolutionWeightsAndBiasesState) {
...
func (o *MPSCNNConvolutionGradient) DataSource() mpsneuralnetwork.MPSCNNConvolutionDataSource {
	_ret := objc.Send[mpsneuralnetwork.MPSCNNConvolutionDataSource](o.Ptr(), _mPSCNNConvolutionGradientSelDataSource)
	return _ret
}
...
func (o *MPSCNNConvolutionGradient) GradientOption() mpsneuralnetwork.MPSCNNConvolutionGradientOption {
	_ret := objc.Send[mpsneuralnetwork.MPSCNNConvolutionGradientOption](o.Ptr(), _mPSCNNConvolutionGradientSelGradientOption)
	return _ret
}

func (o *MPSCNNConvolutionGradient) SetGradientOption(gradientOption mpsneuralnetwork.MPSCNNConvolutionGradientOption) {
