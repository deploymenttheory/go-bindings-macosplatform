...
func (o *MPSImageFindKeypoints) InitWithDeviceInfo(device metal.MTLDevice, info *mpsimage.MPSImageKeypointRangeInfo) *MPSImageFindKeypoints {
...
func (o *MPSImageFindKeypoints) KeypointRangeInfo() mpsimage.MPSImageKeypointRangeInfo {
	_ret := objc.Send[mpsimage.MPSImageKeypointRangeInfo](o.Ptr(), _mPSImageFindKeypointsSelKeypointRangeInfo)
	return _ret
}
