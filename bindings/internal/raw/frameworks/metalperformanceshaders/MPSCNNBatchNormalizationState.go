...
func (o *MPSCNNBatchNormalizationState) BatchNormalization() *mpsneuralnetwork.MPSCNNBatchNormalization {
	_ret := objc.Send[objc.ID](o.Ptr(), _mPSCNNBatchNormalizationStateSelBatchNormalization)
	if _ret != 0 {
		_ret.Send(objc.RegisterName("retain"))
	}
	return mpsneuralnetwork.MPSCNNBatchNormalizationFromID(_ret)
}
