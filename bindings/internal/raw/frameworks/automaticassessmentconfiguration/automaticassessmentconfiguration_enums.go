...
type AEUserAccountType int64

const (
	// No specific account type is required.
	AEUserAccountTypeAny AEUserAccountType = 0
	// Requires a standard user account.
	AEUserAccountTypeStandard AEUserAccountType = 1
	// Requires a guest user account.
	AEUserAccountTypeGuest AEUserAccountType = 2
)

func (e AEUserAccountType) String() string {
	switch e {
	case AEUserAccountTypeAny:
		return "AEUserAccountTypeAny"
	case AEUserAccountTypeStandard:
		return "AEUserAccountTypeStandard"
	case AEUserAccountTypeGuest:
		return "AEUserAccountTypeGuest"
	default:
		return fmt.Sprintf("AEUserAccountType(%d)", int64(e))
	}
}
