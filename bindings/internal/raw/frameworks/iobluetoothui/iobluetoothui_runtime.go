...
func SymbolAvailable(symbol string) bool {
	...
	return _iobluetoothuiLib != 0 && !_failedSymbols[symbol]
}

func _loadLibrary() {
	var err error
	_iobluetoothuiLib, err = purego.Dlopen("/System/Library/Frameworks/IOBluetoothUI.framework/IOBluetoothUI", purego.RTLD_GLOBAL|purego.RTLD_LAZY)
	if err != nil {
