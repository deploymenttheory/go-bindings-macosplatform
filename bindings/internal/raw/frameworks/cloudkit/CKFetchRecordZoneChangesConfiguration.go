...
func CKFetchRecordZoneChangesConfigurationFromID(id objc.ID) *CKFetchRecordZoneChangesConfiguration {
	...
	o := &CKFetchRecordZoneChangesConfiguration{}
	o.InitPtr(id)
	purego.Track(o)
	return o
}
...
func (o *CKFetchRecordZoneChangesConfiguration) SetResultsLimit(resultsLimit uint) {
	o.Ptr().Send(_cKFetchRecordZoneChangesConfigurationSelSetResultsLimit, resultsLimit)
}
...
func (o *CKFetchRecordZoneChangesConfiguration) DesiredKeys() *foundation.NSArray[*foundation.NSString] {
	_ret := objc.Send[objc.ID](o.Ptr(), _cKFetchRecordZoneChangesConfigurationSelDesiredKeys)
	if _ret != 0 {
		_ret.Send(objc.RegisterName("retain"))
	}
...
func (o *CKFetchRecordZoneChangesConfiguration) SetDesiredKeys(desiredKeys *foundation.NSArray[*foundation.NSString]) {
	o.Ptr().Send(_cKFetchRecordZoneChangesConfigurationSelSetDesiredKeys, desiredKeys.Ptr())
}
