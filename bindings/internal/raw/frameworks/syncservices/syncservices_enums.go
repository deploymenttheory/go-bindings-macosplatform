...
func (e ISyncServerDisabledReason) String() string {
	switch e {
	case ISyncServerDisabledReasonNone:
		return "ISyncServerDisabledReasonNone"
	case ISyncServerDisabledReasonByPreference:
		return "ISyncServerDisabledReasonByPreference"
	case ISyncServerDisabledReasonSharedNetworkHome:
		return "ISyncServerDisabledReasonSharedNetworkHome"
	case ISyncServerDisabledReasonUnresponsive:
		return "ISyncServerDisabledReasonUnresponsive"
	case ISyncServerDisabledReasonUnknown:
		return "ISyncServerDisabledReasonUnknown"
	default:
		return fmt.Sprintf("ISyncServerDisabledReason(%d)", int64(e))
	}
}

type ISyncSessionDriverChangeResult int64
...
func (e ISyncSessionDriverChangeResult) String() string {
	switch e {
	case ISyncSessionDriverChangeRefused:
		return "ISyncSessionDriverChangeRefused"
	case ISyncSessionDriverChangeAccepted:
		return "ISyncSessionDriverChangeAccepted"
	case ISyncSessionDriverChangeIgnored:
		return "ISyncSessionDriverChangeIgnored"
	case ISyncSessionDriverChangeError:
		return "ISyncSessionDriverChangeError"
	default:
		return fmt.Sprintf("ISyncSessionDriverChangeResult(%d)", int64(e))
	}
}

type ISyncSessionDriverMode int64
...
func (e ISyncSessionDriverMode) String() string {
	switch e {
	case ISyncSessionDriverModeFast:
		return "ISyncSessionDriverModeFast"
	case ISyncSessionDriverModeSlow:
		return "ISyncSessionDriverModeSlow"
	case ISyncSessionDriverModeRefresh:
...
// Deprecated: since macOS 10.7.
type __ISyncChangeType int64

const (
	ISyncChangeTypeNone   __ISyncChangeType = 0
	ISyncChangeTypeAdd    __ISyncChangeType = 1
	ISyncChangeTypeModify __ISyncChangeType = 2
	ISyncChangeTypeDelete __ISyncChangeType = 3
)

func (e __ISyncChangeType) String() string {
	switch e {
	...
	default:
		return fmt.Sprintf("__ISyncChangeType(%d)", int64(e))
	}
}

// Deprecated: since macOS 10.7.
type __ISyncStatus int64

const (
	ISyncStatusRunning   __ISyncStatus = 1
	ISyncStatusSuccess   __ISyncStatus = 2
	ISyncStatusWarnings  __ISyncStatus = 3
	ISyncStatusErrors    __ISyncStatus = 4
	ISyncStatusCancelled __ISyncStatus = 5
	ISyncStatusFailed    __ISyncStatus = 6
	ISyncStatusNever     __ISyncStatus = 7
)

func (e __ISyncStatus) String() string {
	switch e {
	...
	default:
		return fmt.Sprintf("__ISyncStatus(%d)", int64(e))
	}
}
