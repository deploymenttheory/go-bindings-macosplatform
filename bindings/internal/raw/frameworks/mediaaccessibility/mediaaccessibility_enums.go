...
const (
	...
	KMACaptionAppearanceDomainVideoConferencing MACaptionAppearanceDomain = 2
)
...
func (e MACaptionAppearanceDomain) String() string {
	...
	case KMACaptionAppearanceDomainVideoConferencing:
		return "KMACaptionAppearanceDomainVideoConferencing"
	default:
