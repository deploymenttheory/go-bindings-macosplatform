...
func VTTemporalNoiseFilterConfigurationMaximumDimensions() CMVideoDimensions {
	_ret := objc.Send[CMVideoDimensions](objc.ID(_clsVTTemporalNoiseFilterConfiguration), _vTTemporalNoiseFilterConfigurationSelMaximumDimensions)
	return _ret
}
...
func VTTemporalNoiseFilterConfigurationMinimumDimensions() CMVideoDimensions {
	_ret := objc.Send[CMVideoDimensions](objc.ID(_clsVTTemporalNoiseFilterConfiguration), _vTTemporalNoiseFilterConfigurationSelMinimumDimensions)
	return _ret
}
