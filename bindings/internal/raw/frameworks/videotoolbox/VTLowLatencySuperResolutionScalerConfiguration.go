...
func VTLowLatencySuperResolutionScalerConfigurationMaximumDimensions() CMVideoDimensions {
	_ret := objc.Send[CMVideoDimensions](objc.ID(_clsVTLowLatencySuperResolutionScalerConfiguration), _vTLowLatencySuperResolutionScalerConfigurationSelMaximumDimensions)
	return _ret
}

// Minimum dimensions for a source frame for the processor.
func VTLowLatencySuperResolutionScalerConfigurationMinimumDimensions() CMVideoDimensions {
	_ret := objc.Send[CMVideoDimensions](objc.ID(_clsVTLowLatencySuperResolutionScalerConfiguration), _vTLowLatencySuperResolutionScalerConfigurationSelMinimumDimensions)
	return _ret
}
