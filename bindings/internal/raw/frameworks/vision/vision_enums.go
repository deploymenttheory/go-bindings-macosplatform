...
const (
	...
	VNErrorResourceUnavailable      VNErrorCode = 23
	VNErrorResourceCorrupted        VNErrorCode = 24
)
...
func (e VNErrorCode) String() string {
	...
	case VNErrorResourceUnavailable:
		return "VNErrorResourceUnavailable"
	case VNErrorResourceCorrupted:
		return "VNErrorResourceCorrupted"
	default:
