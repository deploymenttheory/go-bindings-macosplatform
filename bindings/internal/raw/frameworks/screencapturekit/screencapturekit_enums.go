...
const (
	...
	SCStreamErrorInsufficientStorage                    SCStreamErrorCode = -3822
	SCStreamErrorNotSupported                           SCStreamErrorCode = -3823
	SCStreamErrorMissingBackgroundMode                  SCStreamErrorCode = -3824
)
...
func (e SCStreamErrorCode) String() string {
	...
	case SCStreamErrorInsufficientStorage:
		return "SCStreamErrorInsufficientStorage"
	case SCStreamErrorNotSupported:
		return "SCStreamErrorNotSupported"
	case SCStreamErrorMissingBackgroundMode:
		return "SCStreamErrorMissingBackgroundMode"
	default:
