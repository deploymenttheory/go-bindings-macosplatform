...
func (e MEDecodeFrameStatus) String() string {
	var parts []string
	if e&MEDecodeFrameFrameDropped != 0 {
		parts = append(parts, "MEDecodeFrameFrameDropped")
	}
	if len(parts) == 0 {
		return "0"
	}
...
func (e MEFormatReaderParseAdditionalFragmentsStatus) String() string {
	var parts []string
	if e&MEFormatReaderParseAdditionalFragmentsStatusSizeIncreased != 0 {
		parts = append(parts, "MEFormatReaderParseAdditionalFragmentsStatusSizeIncreased")
	}
	if e&MEFormatReaderParseAdditionalFragmentsStatusFragmentAdded != 0 {
		parts = append(parts, "MEFormatReaderParseAdditionalFragmentsStatusFragmentAdded")
	}
	if e&MEFormatReaderParseAdditionalFragmentsStatusFragmentsComplete != 0 {
		parts = append(parts, "MEFormatReaderParseAdditionalFragmentsStatusFragmentsComplete")
	}
	if len(parts) == 0 {
		return "0"
	}
