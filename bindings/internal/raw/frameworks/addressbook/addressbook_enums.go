...
type _ABPropertyType int32

const (
	KABErrorInProperty             _ABPropertyType = 0
	KABStringProperty              _ABPropertyType = 1
	KABIntegerProperty             _ABPropertyType = 2
	KABRealProperty                _ABPropertyType = 3
	KABDateProperty                _ABPropertyType = 4
	KABArrayProperty               _ABPropertyType = 5
	KABDictionaryProperty          _ABPropertyType = 6
	KABDataProperty                _ABPropertyType = 7
	KABDateComponentsProperty      _ABPropertyType = 8
	KABMultiStringProperty         _ABPropertyType = 257
	KABMultiIntegerProperty        _ABPropertyType = 258
	KABMultiRealProperty           _ABPropertyType = 259
	KABMultiDateProperty           _ABPropertyType = 260
	KABMultiArrayProperty          _ABPropertyType = 261
	KABMultiDictionaryProperty     _ABPropertyType = 262
	KABMultiDataProperty           _ABPropertyType = 263
	KABMultiDateComponentsProperty _ABPropertyType = 264
)

func (e _ABPropertyType) String() string {
	switch e {
	...
	default:
		return fmt.Sprintf("_ABPropertyType(%d)", int64(e))
	}
}

type _ABSearchComparison int32

const (
	KABEqual                                  _ABSearchComparison = 0
	KABNotEqual                               _ABSearchComparison = 1
	KABLessThan                               _ABSearchComparison = 2
	KABLessThanOrEqual                        _ABSearchComparison = 3
	KABGreaterThan                            _ABSearchComparison = 4
	KABGreaterThanOrEqual                     _ABSearchComparison = 5
	KABEqualCaseInsensitive                   _ABSearchComparison = 6
	KABContainsSubString                      _ABSearchComparison = 7
	KABContainsSubStringCaseInsensitive       _ABSearchComparison = 8
	KABPrefixMatch                            _ABSearchComparison = 9
	KABPrefixMatchCaseInsensitive             _ABSearchComparison = 10
	KABBitsInBitFieldMatch                    _ABSearchComparison = 11
	KABDoesNotContainSubString                _ABSearchComparison = 12
	KABDoesNotContainSubStringCaseInsensitive _ABSearchComparison = 13
	KABNotEqualCaseInsensitive                _ABSearchComparison = 14
	KABSuffixMatch                            _ABSearchComparison = 15
	KABSuffixMatchCaseInsensitive             _ABSearchComparison = 16
	KABWithinIntervalAroundToday              _ABSearchComparison = 17
	KABWithinIntervalAroundTodayYearless      _ABSearchComparison = 18
	KABNotWithinIntervalAroundToday           _ABSearchComparison = 19
	KABNotWithinIntervalAroundTodayYearless   _ABSearchComparison = 20
	KABWithinIntervalFromToday                _ABSearchComparison = 21
	KABWithinIntervalFromTodayYearless        _ABSearchComparison = 22
	KABNotWithinIntervalFromToday             _ABSearchComparison = 23
	KABNotWithinIntervalFromTodayYearless     _ABSearchComparison = 24
)

func (e _ABSearchComparison) String() string {
	switch e {
	case KABEqual:
		return "KABEqual"
	case KABNotEqual:
	...
	default:
		return fmt.Sprintf("_ABSearchComparison(%d)", int64(e))
	}
}

type _ABSearchConjunction int32

const (
	KABSearchAnd _ABSearchConjunction = 0
	KABSearchOr  _ABSearchConjunction = 1
)

func (e _ABSearchConjunction) String() string {
	switch e {
	case KABSearchAnd:
		return "KABSearchAnd"
	case KABSearchOr:
		return "KABSearchOr"
	default:
		return fmt.Sprintf("_ABSearchConjunction(%d)", int64(e))
	}
}
