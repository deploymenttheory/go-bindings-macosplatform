...
func SKNodeNodeWithFileNamedSecurelyWithClassesAndError(filename *foundation.NSString, classes *foundation.NSSet[objc.Class]) (*SKNode, error) {
	...
	purego.Main(func() {
		_mainthread0, _mainthread1 = func() (*SKNode, error) {
...
func (o *SKNode) ValueForAttributeNamed(key *foundation.NSString) *SKAttributeValue {
	var _mainthread0 *SKAttributeValue
	purego.Main(func() {
		_mainthread0 = func() *SKAttributeValue {
...
func (o *SKNode) ObjectForKeyedSubscript(name *foundation.NSString) *foundation.NSArray[*SKNode] {
	var _mainthread0 *foundation.NSArray[*SKNode]
	purego.Main(func() {
		_mainthread0 = func() *foundation.NSArray[*SKNode] {
...
func (o *SKNode) PhysicsBody() *SKPhysicsBody {
	var _mainthread0 *SKPhysicsBody
	purego.Main(func() {
		_mainthread0 = func() *SKPhysicsBody {
...
func (o *SKNode) UserData() *foundation.NSMutableDictionary[objc.ID, objc.ID] {
	var _mainthread0 *foundation.NSMutableDictionary[objc.ID, objc.ID]
	purego.Main(func() {
		_mainthread0 = func() *foundation.NSMutableDictionary[objc.ID, objc.ID] {
...
func (o *SKNode) ReachConstraints() *SKReachConstraints {
	var _mainthread0 *SKReachConstraints
	purego.Main(func() {
		_mainthread0 = func() *SKReachConstraints {
...
func (o *SKNode) Constraints() *foundation.NSArray[*SKConstraint] {
	var _mainthread0 *foundation.NSArray[*SKConstraint]
	purego.Main(func() {
		_mainthread0 = func() *foundation.NSArray[*SKConstraint] {
...
func (o *SKNode) AttributeValues() *foundation.NSDictionary[*foundation.NSString, *SKAttributeValue] {
	var _mainthread0 *foundation.NSDictionary[*foundation.NSString, *SKAttributeValue]
	purego.Main(func() {
		_mainthread0 = func() *foundation.NSDictionary[*foundation.NSString, *SKAttributeValue] {
