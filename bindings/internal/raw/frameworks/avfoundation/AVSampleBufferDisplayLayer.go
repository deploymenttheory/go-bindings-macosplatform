...
func (o *AVSampleBufferDisplayLayer) Status() AVQueuedSampleBufferRenderingStatus {
	var _mainthread0 AVQueuedSampleBufferRenderingStatus
	purego.Main(func() {
		_mainthread0 = func() AVQueuedSampleBufferRenderingStatus {
...
func (o *AVSampleBufferDisplayLayer) SampleBufferRenderer() *AVSampleBufferVideoRenderer {
	var _mainthread0 *AVSampleBufferVideoRenderer
	purego.Main(func() {
		_mainthread0 = func() *AVSampleBufferVideoRenderer {
