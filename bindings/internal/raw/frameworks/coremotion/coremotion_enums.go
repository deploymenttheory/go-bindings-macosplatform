...
func (e CMAttitudeReferenceFrame) String() string {
	var parts []string
	if e&CMAttitudeReferenceFrameXArbitraryZVertical != 0 {
		parts = append(parts, "CMAttitudeReferenceFrameXArbitraryZVertical")
	}
	if e&CMAttitudeReferenceFrameXArbitraryCorrectedZVertical != 0 {
		parts = append(parts, "CMAttitudeReferenceFrameXArbitraryCorrectedZVertical")
	}
	if e&CMAttitudeReferenceFrameXMagneticNorthZVertical != 0 {
		parts = append(parts, "CMAttitudeReferenceFrameXMagneticNorthZVertical")
	}
	if e&CMAttitudeReferenceFrameXTrueNorthZVertical != 0 {
		parts = append(parts, "CMAttitudeReferenceFrameXTrueNorthZVertical")
	}
	if len(parts) == 0 {
		return "0"
	}
