...
type IOUSBHostObjectDataOptions uint64

const (
	IOUSBHostObjectDataOptionsNone             IOUSBHostObjectDataOptions = 0
	IOUSBHostObjectDataOptionsKernelUserShared IOUSBHostObjectDataOptions = 1
)

func (e IOUSBHostObjectDataOptions) String() string {
	var parts []string
	if e&IOUSBHostObjectDataOptionsKernelUserShared != 0 {
		parts = append(parts, "IOUSBHostObjectDataOptionsKernelUserShared")
	}
	if len(parts) == 0 {
		return "0"
	}
