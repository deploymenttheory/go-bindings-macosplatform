...
type SFSafariSettingsError int64

const (
	// The process does not have the permission to call this API.
	SFSafariSettingsErrorNotAllowed SFSafariSettingsError = 0
	// The system was unable to perform the requested operation.
	SFSafariSettingsErrorFailed SFSafariSettingsError = 1
)

func (e SFSafariSettingsError) String() string {
	switch e {
	case SFSafariSettingsErrorNotAllowed:
		return "SFSafariSettingsErrorNotAllowed"
	case SFSafariSettingsErrorFailed:
		return "SFSafariSettingsErrorFailed"
	default:
		return fmt.Sprintf("SFSafariSettingsError(%d)", int64(e))
	}
}
