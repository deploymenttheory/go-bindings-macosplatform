...
func SymbolAvailable(symbol string) bool {
	...
	return _matterLib != 0 && !_failedSymbols[symbol]
}

func _loadLibrary() {
	var err error
	_matterLib, err = purego.Dlopen("/System/Library/Frameworks/Matter.framework/Matter", purego.RTLD_GLOBAL|purego.RTLD_LAZY)
	if err != nil {
