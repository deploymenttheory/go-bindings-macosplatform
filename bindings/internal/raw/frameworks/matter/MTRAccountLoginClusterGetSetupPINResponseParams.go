...
// Apple documentation: https://developer.apple.com/documentation/matter/mtraccountloginclustergetsetuppinresponseparams
...
func MTRAccountLoginClusterGetSetupPINResponseParamsFromID(id objc.ID) *MTRAccountLoginClusterGetSetupPINResponseParams {
	...
	o := &MTRAccountLoginClusterGetSetupPINResponseParams{}
	o.InitPtr(id)
	purego.Track(o)
	return o
}
...
func (o *MTRAccountLoginClusterGetSetupPINResponseParams) InitWithResponseValueError(responseValue *foundation.NSDictionary[*foundation.NSString, objc.ID]) (*MTRAccountLoginClusterGetSetupPINResponseParams, error) {
	var _nsErr uintptr
	_ret := objc.Send[objc.ID](o.Ptr(), _mTRAccountLoginClusterGetSetupPINResponseParamsSelInitWithResponseValueError, responseValue.Ptr(), unsafe.Pointer(&_nsErr))
	if _ret != 0 {
	...
	return MTRAccountLoginClusterGetSetupPINResponseParamsFromID(_ret), nil
}
...
func (o *MTRAccountLoginClusterGetSetupPINResponseParams) SetSetupPIN(setupPIN *foundation.NSString) {
	o.Ptr().Send(_mTRAccountLoginClusterGetSetupPINResponseParamsSelSetSetupPIN, setupPIN.Ptr())
}
