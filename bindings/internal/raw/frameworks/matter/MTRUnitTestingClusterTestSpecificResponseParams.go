...
// Apple documentation: https://developer.apple.com/documentation/matter/mtrunittestingclustertestspecificresponseparams
...
func MTRUnitTestingClusterTestSpecificResponseParamsFromID(id objc.ID) *MTRUnitTestingClusterTestSpecificResponseParams {
	...
	o := &MTRUnitTestingClusterTestSpecificResponseParams{}
	o.InitPtr(id)
	purego.Track(o)
	return o
}
...
func (o *MTRUnitTestingClusterTestSpecificResponseParams) InitWithResponseValueError(responseValue *foundation.NSDictionary[*foundation.NSString, objc.ID]) (*MTRUnitTestingClusterTestSpecificResponseParams, error) {
	var _nsErr uintptr
	_ret := objc.Send[objc.ID](o.Ptr(), _mTRUnitTestingClusterTestSpecificResponseParamsSelInitWithResponseValueError, responseValue.Ptr(), unsafe.Pointer(&_nsErr))
	if _ret != 0 {
	...
	return MTRUnitTestingClusterTestSpecificResponseParamsFromID(_ret), nil
}
...
func (o *MTRUnitTestingClusterTestSpecificResponseParams) SetReturnValue(returnValue *foundation.NSNumber) {
	o.Ptr().Send(_mTRUnitTestingClusterTestSpecificResponseParamsSelSetReturnValue, returnValue.Ptr())
}
