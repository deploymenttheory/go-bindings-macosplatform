...
// Apple documentation: https://developer.apple.com/documentation/matter/mtrenergyevsemodeclusterchangetomodeparams
...
func MTREnergyEVSEModeClusterChangeToModeParamsFromID(id objc.ID) *MTREnergyEVSEModeClusterChangeToModeParams {
	...
	o := &MTREnergyEVSEModeClusterChangeToModeParams{}
	o.InitPtr(id)
	purego.Track(o)
	return o
}
...
func (o *MTREnergyEVSEModeClusterChangeToModeParams) SetNewMode(newMode *foundation.NSNumber) {
	o.Ptr().Send(_mTREnergyEVSEModeClusterChangeToModeParamsSelSetNewMode, newMode.Ptr())
}
...
func (o *MTREnergyEVSEModeClusterChangeToModeParams) SetTimedInvokeTimeoutMs(timedInvokeTimeoutMs *foundation.NSNumber) {
	o.Ptr().Send(_mTREnergyEVSEModeClusterChangeToModeParamsSelSetTimedInvokeTimeoutMs, timedInvokeTimeoutMs.Ptr())
}
