...
// Apple documentation: https://developer.apple.com/documentation/matter/mtrunittestingclustertimedinvokerequestparams
...
func MTRUnitTestingClusterTimedInvokeRequestParamsFromID(id objc.ID) *MTRUnitTestingClusterTimedInvokeRequestParams {
	...
	o := &MTRUnitTestingClusterTimedInvokeRequestParams{}
	o.InitPtr(id)
	purego.Track(o)
	return o
}
...
func (o *MTRUnitTestingClusterTimedInvokeRequestParams) SetTimedInvokeTimeoutMs(timedInvokeTimeoutMs *foundation.NSNumber) {
	o.Ptr().Send(_mTRUnitTestingClusterTimedInvokeRequestParamsSelSetTimedInvokeTimeoutMs, timedInvokeTimeoutMs.Ptr())
}
