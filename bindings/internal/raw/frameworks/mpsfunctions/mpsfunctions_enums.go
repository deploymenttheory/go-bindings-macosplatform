...
const (
	MPSFColorConversionOptionsNone                 MPSFColorConversionOptions = 0
	MPSFColorConversionOptionsPrecisionDefault     MPSFColorConversionOptions = 0
	MPSFConverisonOptionsPrecisionSnorm8           MPSFColorConversionOptions = 7
	MPSFConverisonOptionsPrecisionUnorm8           MPSFColorConversionOptions = 8
	MPSFConverisonOptionsPrecisionSnorm16          MPSFColorConversionOptions = 15
	MPSFConverisonOptionsPrecisionUnorm16          MPSFColorConversionOptions = 16
	MPSFConverisonOptionsPrecisionFloat16          MPSFColorConversionOptions = 11
	MPSFConverisonOptionsPrecisionFloat32          MPSFColorConversionOptions = 24
	MPSFColorConversionOptionsPrecisionMask        MPSFColorConversionOptions = 63
	MPSFColorConversionOptionsReturnGrayscaleAsRGB MPSFColorConversionOptions = 256
	MPSFColorConversionOptionsVerboseLogging       MPSFColorConversionOptions = 512
)

func (e MPSFColorConversionOptions) String() string {
	var parts []string
	if e&MPSFConverisonOptionsPrecisionSnorm8 != 0 {
		parts = append(parts, "MPSFConverisonOptionsPrecisionSnorm8")
	}
	if e&MPSFConverisonOptionsPrecisionUnorm8 != 0 {
		parts = append(parts, "MPSFConverisonOptionsPrecisionUnorm8")
	}
	if e&MPSFConverisonOptionsPrecisionSnorm16 != 0 {
		parts = append(parts, "MPSFConverisonOptionsPrecisionSnorm16")
	}
	if e&MPSFConverisonOptionsPrecisionUnorm16 != 0 {
		parts = append(parts, "MPSFConverisonOptionsPrecisionUnorm16")
	}
	if e&MPSFConverisonOptionsPrecisionFloat16 != 0 {
		parts = append(parts, "MPSFConverisonOptionsPrecisionFloat16")
	}
	if e&MPSFConverisonOptionsPrecisionFloat32 != 0 {
		parts = append(parts, "MPSFConverisonOptionsPrecisionFloat32")
	}
	if e&MPSFColorConversionOptionsPrecisionMask != 0 {
		parts = append(parts, "MPSFColorConversionOptionsPrecisionMask")
	}
	if e&MPSFColorConversionOptionsReturnGrayscaleAsRGB != 0 {
		parts = append(parts, "MPSFColorConversionOptionsReturnGrayscaleAsRGB")
	}
	if e&MPSFColorConversionOptionsVerboseLogging != 0 {
		parts = append(parts, "MPSFColorConversionOptionsVerboseLogging")
	}
	if len(parts) == 0 {
		return "0"
	}
