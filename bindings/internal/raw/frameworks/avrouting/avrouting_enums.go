...
const (
	...
	AVCustomRoutingEventReasonActivate AVCustomRoutingEventReason = 0
	// A value that indicates that a user deselects a route in the picker.
	AVCustomRoutingEventReasonDeactivate AVCustomRoutingEventReason = 1
	// A value that indicates to reactivate a route a user authorized previously.
	AVCustomRoutingEventReasonReactivate AVCustomRoutingEventReason = 2
)

func (e AVCustomRoutingEventReason) String() string {
	switch e {
	case AVCustomRoutingEventReasonActivate:
		return "AVCustomRoutingEventReasonActivate"
	case AVCustomRoutingEventReasonDeactivate:
		return "AVCustomRoutingEventReasonDeactivate"
	case AVCustomRoutingEventReasonReactivate:
		return "AVCustomRoutingEventReasonReactivate"
	default:
		return fmt.Sprintf("AVCustomRoutingEventReason(%d)", int64(e))
	}
}
