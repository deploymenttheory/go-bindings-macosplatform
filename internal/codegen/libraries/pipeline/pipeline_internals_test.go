...
func TestLoadAllParentFWSkipAndDedup(t *testing.T) {
	...
	var found *macosplatformmetadata.FrameworkMeta
...
func TestLoadAllWinnerSelectionLowerScore(t *testing.T) {
	...
	zebraFM.Classes["NSWidget"] = macosplatformmetadata.Class{
		Methods: []macosplatformmetadata.Method{
			{Selector: "a", Return: macosplatformmetadata.ReturnType{ObjCType: "void"}},
			{Selector: "b", Return: macosplatformmetadata.ReturnType{ObjCType: "void"}},
			{Selector: "c", Return: macosplatformmetadata.ReturnType{ObjCType: "void"}},
		},
	}
	...
	alphaFM.Classes["NSWidget"] = macosplatformmetadata.Class{
		Methods: []macosplatformmetadata.Method{
			{Selector: "draw", Return: macosplatformmetadata.ReturnType{ObjCType: "void"}},
		},
	}
...
func TestTopoSortCycleFallback(t *testing.T) {
	fmA := &macosplatformmetadata.FrameworkMeta{
		...
		Classes:   map[string]macosplatformmetadata.Class{"ClassA": {Super: "ClassB"}},
	}
	fmB := &macosplatformmetadata.FrameworkMeta{
		Framework: "FrameworkB",
		Classes:   map[string]macosplatformmetadata.Class{"ClassB": {Super: "ClassA"}},
	}
	reg := &Registry{
...
func TestComputeBlockedImportsMethodArgs(t *testing.T) {
	fmAlpha := &macosplatformmetadata.FrameworkMeta{
		Framework: "Alpha",
		Classes: map[string]macosplatformmetadata.Class{
			"AlphaObj": {Methods: []macosplatformmetadata.Method{{Selector: "run", Return: macosplatformmetadata.ReturnType{}}}},
		},
		Protocols: map[string]macosplatformmetadata.Protocol{},
	}
	fmBeta := &macosplatformmetadata.FrameworkMeta{
		Framework: "Beta",
...
func TestComputeBlockedImportsCycleMultiEdge(t *testing.T) {
	...
	fmAlpha := &macosplatformmetadata.FrameworkMeta{
		Framework: "Alpha",
		Classes: map[string]macosplatformmetadata.Class{
			"AlphaObj": {Methods: []macosplatformmetadata.Method{{
				Selector: "get",
				Return:   macosplatformmetadata.ReturnType{ObjCType: "BetaObj *"}, // weight[Alpha][Beta]++
			}}},
			"AlphaObj2": {Methods: []macosplatformmetadata.Method{{
				Selector: "create",
				Return:   macosplatformmetadata.ReturnType{ObjCType: "GammaObj *"}, // weight[Alpha][Gamma]++
			}}},
		},
		Protocols: map[string]macosplatformmetadata.Protocol{},
	}
	...
	fmGamma := &macosplatformmetadata.FrameworkMeta{
		Framework: "Gamma",
		Classes:   map[string]macosplatformmetadata.Class{"GammaObj": {}},
		Protocols: map[string]macosplatformmetadata.Protocol{},
	}
	reg := &Registry{
		Frameworks: []*macosplatformmetadata.FrameworkMeta{fmAlpha, fmBeta, fmGamma},
...
func TestComputeBlockedImportsUppercaseTypedefChain(t *testing.T) {
	...
	fmB := &macosplatformmetadata.FrameworkMeta{
		Framework: "FrameworkB",
		Classes: map[string]macosplatformmetadata.Class{
			"BType": {Methods: []macosplatformmetadata.Method{{
				Selector: "toC",
				Return:   macosplatformmetadata.ReturnType{ObjCType: "CType *"}, // FrameworkB → FrameworkC
			}}},
		},
		Protocols: map[string]macosplatformmetadata.Protocol{},
	}
	fmC := &macosplatformmetadata.FrameworkMeta{
		...
		Classes: map[string]macosplatformmetadata.Class{
			"CType": {Methods: []macosplatformmetadata.Method{{
				Selector: "doThing",
				...
				Params: []macosplatformmetadata.Param{{Name: "x", ObjCType: "AliasForBType"}},
			}}},
		},
		Protocols: map[string]macosplatformmetadata.Protocol{},
	}
