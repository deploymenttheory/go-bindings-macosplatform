...
func isAsyncCompletion(m macosplatformmetadata.Method) bool {
...
func isBoolNSError(m macosplatformmetadata.Method) bool {
	return m.IsNSError && strings.TrimSpace(m.Return.ObjCType) == "BOOL"
}

func isNSErrorOut(m macosplatformmetadata.Method) bool {
	return m.IsNSError && strings.TrimSpace(m.Return.ObjCType) != "BOOL"
}

func isCollectionReturn(m macosplatformmetadata.Method) bool {
	return containsCollection(m.Return.ObjCType)
}

func isCollectionParam(m macosplatformmetadata.Method) bool {
...
func isBlockEnumeration(m macosplatformmetadata.Method) bool {
