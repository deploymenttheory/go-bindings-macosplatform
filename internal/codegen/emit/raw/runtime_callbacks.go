...
func CollectMethodSigsFromFrameworks(frameworks []*meta.FrameworkMeta, m *typemap.Mapper) []MethodSigModel {
	seen := make(map[string]MethodSigModel)

	add := func(method meta.Method) {
...
// are excluded.
func isMethodIMPSafe(method meta.Method, m *typemap.Mapper) bool {
...
func methodSigFromMethod(method meta.Method, m *typemap.Mapper) (MethodSigModel, bool) {
	ctx := typemap.Context{}
...
// EmitRuntimeCallbacksGo writes callbacks_generated.go for the internal/callbacks package.
