...
func TestIsMethodIMPSafeClassMethodExcluded(t *testing.T) {
	m := methodTrampolineMapper()
	method := meta.Method{Selector: "shared", IsClassMethod: true, Return: meta.ReturnType{ObjCType: "void"}}
	if isMethodIMPSafe(method, m) {
...
func TestIsMethodIMPSafeInitExcluded(t *testing.T) {
	m := methodTrampolineMapper()
	method := meta.Method{Selector: "init", IsInit: true, Return: meta.ReturnType{ObjCType: "instancetype"}}
	if isMethodIMPSafe(method, m) {
...
func TestIsMethodIMPSafeInitSelectorExcluded(t *testing.T) {
	m := methodTrampolineMapper()
	method := meta.Method{Selector: "initWithFrame:", Return: meta.ReturnType{ObjCType: "instancetype"}}
	if isMethodIMPSafe(method, m) {
...
func TestIsMethodIMPSafeNSErrorExcluded(t *testing.T) {
	m := methodTrampolineMapper()
	method := meta.Method{Selector: "doThing", IsNSError: true, Return: meta.ReturnType{ObjCType: "void"}}
	if isMethodIMPSafe(method, m) {
...
func TestIsMethodIMPSafeVariadicExcluded(t *testing.T) {
	m := methodTrampolineMapper()
	method := meta.Method{Selector: "logFormat:", IsVariadic: true, Return: meta.ReturnType{ObjCType: "void"}}
	if isMethodIMPSafe(method, m) {
...
func TestIsMethodIMPSafeStructReturnTreatedAsPointer(t *testing.T) {
	...
	method := meta.Method{Selector: "frame", Return: meta.ReturnType{ObjCType: "CGRect"}}
	if !isMethodIMPSafe(method, m) {
...
func TestMethodSigFromMethodVoid(t *testing.T) {
	m := methodTrampolineMapper()
	method := meta.Method{Selector: "doThing", Return: meta.ReturnType{ObjCType: "void"}}
	...
	fm2 := &meta.FrameworkMeta{
		...
		Classes: map[string]meta.Class{
			"NSBar": {Methods: []meta.Method{
				{Selector: "doOther", Return: meta.ReturnType{ObjCType: "void"}},
			}},
		},
	}
	sigs := CollectMethodSigsFromFrameworks([]*meta.FrameworkMeta{fm1, fm2}, m)
	...
	frameworks := []*meta.FrameworkMeta{
		{
			...
			Protocols: map[string]meta.Protocol{
				"NSFooDelegate": {Methods: []meta.Method{
					{Selector: "handleEvent", Return: meta.ReturnType{ObjCType: "void"}},
				}},
			},
		},
	}
