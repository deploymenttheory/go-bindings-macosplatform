...
func CollectBlockSignaturesFromFrameworks(frameworks []*meta.FrameworkMeta, m *typemap.Mapper) []BlockSignatureModel {
	...
	resolveBlockObjCType := func(arg meta.Param, typedefs map[string]string) string {
		if arg.IsBlock {
			return arg.ObjCType
		}
		if typedefs == nil {
	...
	addArgs := func(args []meta.Param, typedefs map[string]string) {
