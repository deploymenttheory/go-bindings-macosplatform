...
func writeClassBuf(name string, cls meta.Class, framework *meta.FrameworkMeta, m *typemap.Mapper, all map[string]meta.Class) (string, error) {
...
func writeClassBufKnown(name string, cls meta.Class, framework *meta.FrameworkMeta, m *typemap.Mapper, all map[string]meta.Class, known map[string]bool) (string, error) {
	var buf bytes.Buffer
...
func TestWriteClassEmbedsSameFwSuper(t *testing.T) {
	...
	cls := meta.Class{Super: "NSObject"}
	all := map[string]meta.Class{
		"NSObject":    {},
		"NSMySubclass": cls,
	}
...
func TestWriteClassUnknownSuperBecomesRoot(t *testing.T) {
	m := classTestMapper()
	framework := &meta.FrameworkMeta{Framework: "Foundation", Classes: map[string]meta.Class{}}
	cls := meta.Class{Super: "SomeUnknownBase"}
...
// the [T objc.Object] type parameter.
func TestWriteClassGenericDeclaresTypeParam(t *testing.T) {
	...
	all := map[string]meta.Class{"NSObject": {}, "NSArray": cls}
...
func TestWriteClassRuntimeTrackInConstructor(t *testing.T) {
	...
	if !strings.Contains(out, "objc.Track(") {
...
func TestWriteClassMethodEmitted(t *testing.T) {
	...
	all := map[string]meta.Class{"NSObject": {}, "NSMyClass": cls}
...
func TestWriteClassClassMethodEmitted(t *testing.T) {
	...
	out, err := writeClassBuf("NSMyMgr", cls, framework, m, map[string]meta.Class{"NSMyMgr": cls})
	if err != nil {
		t.Fatal(err)
	}
...
func TestWriteClassSkipsNilSentinelVariadic(t *testing.T) {
	...
	out, err := writeClassBuf("NSFormatter", cls, framework, m, map[string]meta.Class{"NSFormatter": cls})
	if err != nil {
		t.Fatal(err)
	}
		...
		Methods: []meta.Method{
			{
				...
				IsVariadic: true,
				IsClassMethod: true,
				Params:       []meta.Param{{Name: "format", ObjCType: "NSString * _Nonnull"}},
				Return:     meta.ReturnType{ObjCType: "NSString *"},
			},
		},
	}
	out, err := writeClassBuf("NSString", cls, framework, m, map[string]meta.Class{"NSString": cls})
	if err != nil {
		t.Fatal(err)
	}
...
func TestWriteClassAvailabilityComment(t *testing.T) {
	...
	framework := &meta.FrameworkMeta{Framework: "Foundation", Classes: map[string]meta.Class{}}
	cls := meta.Class{
		Availability: meta.Availability{MacOSIntroduced: "11.0"},
	}
	out, err := writeClassBuf("NSMyClass", cls, framework, m, map[string]meta.Class{"NSMyClass": cls})
	if err != nil {
		t.Fatal(err)
...
func TestWriteClassDeprecatedComment(t *testing.T) {
	...
	framework := &meta.FrameworkMeta{Framework: "Foundation", Classes: map[string]meta.Class{}}
	cls := meta.Class{
		Availability: meta.Availability{MacOSDeprecated: "14.0", ReplacedBy: "NewClass"},
	}
	out, err := writeClassBuf("OldClass", cls, framework, m, map[string]meta.Class{"OldClass": cls})
	if err != nil {
		t.Fatal(err)
	}
...
func TestWriteClassNSErrorMethodReturnsTwoValues(t *testing.T) {
	...
	out, err := writeClassBuf("NSTask", cls, framework, m, map[string]meta.Class{"NSTask": cls})
	if err != nil {
		t.Fatal(err)
	}
...
func TestWriteClassRuntimeObjectConformance(t *testing.T) {
	...
	if !strings.Contains(out, "var _ objc.Object = (*NSObject)(nil)") {
...
func TestClassifySuperUnknownOwner(t *testing.T) {
	m := classTestMapper()
	framework := &meta.FrameworkMeta{Framework: "Foundation"}
	cls := meta.Class{Super: "SomeAlienClass"}
...
func TestNSStringOverloadInstance(t *testing.T) {
	...
	all := map[string]meta.Class{"NSBundle": cls, "NSString": {}}
	...
	if !strings.Contains(out, "objc.GoStringToNSString(key)") {
...
func TestNSStringOverloadDisabledByDefault(t *testing.T) {
	...
	framework := &meta.FrameworkMeta{
		Framework: "Foundation",
		Classes:   map[string]meta.Class{"NSBundle": {}, "NSString": {}},
	}
	cls := meta.Class{
		Methods: []meta.Method{
			{
...
func TestWriteClassMethodWithBlockArg(t *testing.T) {
	...
	out, err := writeClassBufKnown("NSFoo", cls, framework, m, map[string]meta.Class{"NSFoo": cls}, known)
	if err != nil {
		t.Fatal(err)
	}
...
func TestBlockArgCtorError(t *testing.T) {
	...
	if got != "objc.NSErrorToError(_p0)" {
		t.Errorf("blockArgCtor(error) = %q", got)
	}
}

func TestBlockArgCtorObjcObject(t *testing.T) {
	got := blockArgCtor("objc.Object", "_p0")
	if got != "objc.WrapObject(_p0)" {
		t.Errorf("blockArgCtor(objc.Object) = %q", got)
	}
}
...
func TestBlockArgCtorPointerWithPkg(t *testing.T) {
	...
	if got != "objc.WrapTyped(_p0, foundation.NewNSString)" {
		t.Errorf("blockArgCtor(*pkg.Type) = %q", got)
	}
}

func TestBlockArgCtorPointerGeneric(t *testing.T) {
	got := blockArgCtor("*NSArray[objc.Object]", "_p0")
...
func TestBlockArgCtorPointerLocal(t *testing.T) {
	...
	if got != "objc.WrapTyped(_p0, NewNSView)" {
...
func TestBlockArgCtorTypedClass(t *testing.T) {
	...
	if got != "objc.WrapTyped(_p0, NewNSView)" {
		t.Errorf("blockArgCtorTyped(*Class) = %q; want objc.WrapTyped", got)
	}
}
...
func TestBuildBlockWrapperNSError(t *testing.T) {
	...
	if !strings.Contains(got, "objc.NSErrorToError") {
		t.Errorf("NSError wrapper should use objc.NSErrorToError; got %q", got)
	}
}
...
func TestBuildBlockWrapperBareID(t *testing.T) {
	...
	if !strings.Contains(got, "objc.WrapObject") {
		t.Errorf("bare id wrapper should use objc.WrapObject; got %q", got)
	}
}
...
func TestWriteClassDesignatedInitConstructor(t *testing.T) {
	...
	all := map[string]meta.Class{"NSFoo": cls}
		...
		Methods: []meta.Method{
			{
				...
				IsInit:          true,
				IsDesignatedInit: true,
				Params:            []meta.Param{{Name: "objs", ObjCType: "id"}},
				Return:          meta.ReturnType{IsInstancetype: true},
			},
		},
	}
	all := map[string]meta.Class{"NSArray": cls}
	out, err := writeClassBuf("NSArray", cls, framework, m, all)
	if err != nil {
		t.Fatal(err)
	}
...
func TestWriteClassNSStringClassOverload(t *testing.T) {
	...
	framework := &meta.FrameworkMeta{
		Framework: "Foundation",
		Classes:   map[string]meta.Class{"NSString": {}},
	}
	cls := meta.Class{
		Methods: []meta.Method{
			{
				...
				IsClassMethod: true,
				Params:          []meta.Param{{Name: "aString", ObjCType: "NSString *"}},
				Return:        meta.ReturnType{ObjCType: "instancetype"},
			},
		},
	}
	all := map[string]meta.Class{"NSString": cls}
...
func TestGoCGoArgExprObjcObject(t *testing.T) {
	m := goCGoMapper()
	var pre, ka []string
	got := goCGoArgExpr("objc.Object", "arg", m, &pre, &ka)
	if !strings.Contains(got, "_objcPtr_arg") {
		t.Errorf("objc.Object should use _objcPtr_; got %q", got)
	}
	if len(pre) < 2 {
		t.Errorf("objc.Object should add preambles; got %d", len(pre))
	}
	if len(ka) != 1 || ka[0] != "arg" {
		t.Errorf("objc.Object should add to keepAlives; got %v", ka)
	}
}
...
// TestWriteClassIDReturn verifies a method returning bare id emits objc.WrapObject path.
func TestWriteClassIDReturn(t *testing.T) {
	...
	out, err := writeClassBufKnown("NSObject", cls, framework, m, map[string]meta.Class{"NSObject": cls}, map[string]bool{"NSObject": true})
	if err != nil {
		t.Fatal(err)
	}
...
func TestWriteClassNullableStringReturn(t *testing.T) {
	...
	cls := meta.Class{
		Methods: []meta.Method{
			{Selector: "cStringUTF8", Return: meta.ReturnType{ObjCType: "const char *", IsNullable: true}},
		},
	}
	out, err := writeClassBufKnown("NSObject", cls, framework, m, map[string]meta.Class{"NSObject": cls}, map[string]bool{"NSObject": true})
	if err != nil {
...
// TestWriteClassNSErrorIDReturn verifies NSError+id return emits (objc.Object, error).
