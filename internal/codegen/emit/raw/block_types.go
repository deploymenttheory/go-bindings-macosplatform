...
func EmitBlocks(w io.Writer, framework *meta.FrameworkMeta, m *typemap.Mapper, knownClasses map[string]bool) error {
...
func buildBlockTypeModel(name string, bt meta.BlockType, ctx typemap.Context, m *typemap.Mapper) (blockTypeModel, error) {
