...
type functionModel struct {
	...
	// The complex return-path dispatch (void / objc.Object / value struct / primitive)
...
type classInterfaceModel struct {
	...
	EmbedLine   string // Embedded type: "objc.Object", "pkg.Superabled", or "Superable"
...
type classInterfacesFileModel struct {
	...
	UsesObjc   bool     // true when any method or embed references objc.*
...
type protocolImplGoFileModel struct {
	...
	IMPSigs             []string // sorted unique IMP sig names
	NeedsObjc           bool     // true when return type is objc.Object (no proxy)
	...
	ReturnType          string   // "*NSCacheDelegateIDProtocol" or "objc.Object"
