...
func newEnumFM(enums map[string]meta.Enum) *meta.FrameworkMeta {
...
func TestEnumsEmpty(t *testing.T) {
	...
	framework := newEnumFM(map[string]meta.Enum{})
...
func TestEnumsSortOrder(t *testing.T) {
	...
	framework := newEnumFM(map[string]meta.Enum{
		"ZebraEnum": {
			GoType:  "int64",
			Members: []meta.EnumMember{{Name: "ZebraVal", Value: "0"}},
		},
		"AlphaEnum": {
			GoType:  "int64",
			Members: []meta.EnumMember{{Name: "AlphaVal", Value: "1"}},
		},
		"MidEnum": {
			GoType:  "int64",
			Members: []meta.EnumMember{{Name: "MidVal", Value: "2"}},
		},
	})
	if err := EmitEnums(&buf, framework); err != nil {
		t.Fatalf("unexpected error: %v", err)
...
func TestEnumsNamedAndAnonMixed(t *testing.T) {
	...
	framework := newEnumFM(map[string]meta.Enum{
		"NSBinarySearchingOptions": {
			GoType:  "uint64",
			Members: []meta.EnumMember{{Name: "NSBinarySearchingFirstEqual", Value: "256"}},
		},
		"__anon_global": {
			GoType:  "uint64",
			IsAnon:  true,
			Members: []meta.EnumMember{{Name: "NSIntegerMax", Value: "9223372036854775807"}},
		},
	})
	if err := EmitEnums(&buf, framework); err != nil {
		t.Fatalf("unexpected error: %v", err)
...
func TestEnumsNoAvailabilityNoComment(t *testing.T) {
	...
	framework := newEnumFM(map[string]meta.Enum{
		"NSLineBreakMode": {
			GoType:  "int64",
			Members: []meta.EnumMember{{Name: "NSLineBreakByWordWrapping", Value: "0"}},
		},
	})
	if err := EmitEnums(&buf, framework); err != nil {
		t.Fatalf("unexpected error: %v", err)
...
func TestEnumsClosingBrace(t *testing.T) {
	...
	framework := newEnumFM(map[string]meta.Enum{
		"NSEdgeInsets": {
			GoType:  "float64",
			Members: []meta.EnumMember{{Name: "NSEdgeInsetsZero", Value: "0"}},
		},
	})
	if err := EmitEnums(&buf, framework); err != nil {
		t.Fatalf("unexpected error: %v", err)
...
func TestEnumsNilMapProducesNoOutput(t *testing.T) {
	var buf bytes.Buffer
	framework := &meta.FrameworkMeta{Framework: "TestFW", Enums: nil}
	if err := EmitEnums(&buf, framework); err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if buf.Len() != 0 {
...
func TestEnumsNeedImportsNonBitmask(t *testing.T) {
	...
	framework := newEnumFM(map[string]meta.Enum{
		"Simple": {GoType: "int64", Members: []meta.EnumMember{{Name: "A", Value: "1"}}},
	})
...
func TestEnumsNeedImportsBitmask(t *testing.T) {
	...
	framework := newEnumFM(map[string]meta.Enum{
		"Options": {
			GoType:    "uint64",
			IsBitmask: true,
			Members:   []meta.EnumMember{{Name: "OptionA", Value: "1"}, {Name: "OptionB", Value: "2"}},
		},
	})
...
func TestAnonEnumsCoveredByNamedEmpty(t *testing.T) {
	enums := map[string]meta.Enum{
		"_anon_empty_": {Members: []meta.EnumMember{}},
	}
	skip := anonEnumsCoveredByNamed(enums)
