...
func writeEnum(w io.Writer, name string, e meta.Enum) error {
	if e.IsAnon {
...
func buildEnumModel(name string, e meta.Enum) enumModel {
...
func writeAnonEnum(w io.Writer, e meta.Enum) error {
	if len(e.Members) == 0 {
		return nil
	}
...
func anonEnumsCoveredByNamed(enums map[string]meta.Enum) map[string]bool {
...
func EnumsNeedImports(framework *meta.FrameworkMeta) (needsFmt, needsStrings bool) {
...
func availabilityComment(av meta.Availability) string {
...
func deprecationComment(av meta.Availability) string {
...
func writeContextComments(w io.Writer, doc, sdkFile string, sdkLine int, av meta.Availability, prefix string) {
	if doc != "" {
...
func renderCommentBlock(doc, sdkFile string, sdkLine int, av meta.Availability, prefix string) string {
