...
func TestBridgeReturnCTypeVoid(t *testing.T) {
	m := bridgeTestMapper()
	ctx := bridgeCtx("Foundation")
	method := macosplatformmetadata.Method{Return: macosplatformmetadata.ReturnType{ObjCType: "void"}}
	got := bridgeReturnCType(method, ctx, m)
	if got != "void" {
...
func TestBridgeReturnCTypeEmpty(t *testing.T) {
	m := bridgeTestMapper()
	ctx := bridgeCtx("Foundation")
	method := macosplatformmetadata.Method{Return: macosplatformmetadata.ReturnType{}}
	got := bridgeReturnCType(method, ctx, m)
	if got != "void" {
...
func TestBridgeReturnCTypeObject(t *testing.T) {
	m := bridgeTestMapper()
	ctx := bridgeCtx("Foundation")
	method := macosplatformmetadata.Method{Return: macosplatformmetadata.ReturnType{ObjCType: "NSString *"}}
	got := bridgeReturnCType(method, ctx, m)
...
func TestBridgeParamListInstanceMethod(t *testing.T) {
	m := bridgeTestMapper()
	ctx := bridgeCtx("Foundation")
	params := bridgeParamList(false, []macosplatformmetadata.Param{}, false, ctx, m)
...
func TestBridgeParamListClassMethod(t *testing.T) {
	m := bridgeTestMapper()
	ctx := bridgeCtx("Foundation")
	params := bridgeParamList(true, []macosplatformmetadata.Param{}, false, ctx, m)
...
func TestBridgeParamListNSError(t *testing.T) {
	m := bridgeTestMapper()
	ctx := bridgeCtx("Foundation")
	params := bridgeParamList(false, []macosplatformmetadata.Param{}, true, ctx, m)
...
func TestBuildObjCCallNoArg(t *testing.T) {
	m := bridgeTestMapper()
	ctx := bridgeCtx("Foundation")
	method := macosplatformmetadata.Method{Selector: "count", Params: []macosplatformmetadata.Param{}}
...
func TestResolveClassBridgeNamesCollisionResolved(t *testing.T) {
	...
	methods := []macosplatformmetadata.Method{
		{Selector: "open", IsClassMethod: false, Return: macosplatformmetadata.ReturnType{ObjCType: "void"}},
		{Selector: "open:", IsClassMethod: false, Return: macosplatformmetadata.ReturnType{ObjCType: "void"}},
	}
...
func TestBridgeHeaderClassMethod(t *testing.T) {
	...
	framework := &macosplatformmetadata.FrameworkMeta{
		...
		Classes: map[string]macosplatformmetadata.Class{
			"NSObject": {
				Methods: []macosplatformmetadata.Method{
					{Selector: "alloc", IsClassMethod: true, Return: macosplatformmetadata.ReturnType{IsInstancetype: true}},
				},
			},
		},
	}
		...
		Classes: map[string]macosplatformmetadata.Class{
			"NSString": {
				Methods: []macosplatformmetadata.Method{
					...
					{Selector: "initWithObjects:", IsVariadic: true, Return: macosplatformmetadata.ReturnType{IsInstancetype: true}},
					// format-string — should be bridged
					{Selector: "initWithFormat:", IsVariadic: true, Params: []macosplatformmetadata.Param{{Name: "format", ObjCType: "NSString * _Nonnull"}}, Return: macosplatformmetadata.ReturnType{IsInstancetype: true}},
				},
			},
		},
	}
...
func TestBridgeHeaderFreeFunction(t *testing.T) {
	...
	framework := &macosplatformmetadata.FrameworkMeta{
		...
		Functions: []macosplatformmetadata.Function{
			{Name: "NSStringFromClass", Return: macosplatformmetadata.ReturnType{ObjCType: "NSString *"}, Params: []macosplatformmetadata.Param{{Name: "aClass", ObjCType: "Class"}}},
		},
	}
	var buf bytes.Buffer
	if err := EmitBridgeHeader(&buf, framework, m, map[string]bool{}); err != nil {
...
func TestBridgeHeaderForeignExtensions(t *testing.T) {
	...
	framework := &macosplatformmetadata.FrameworkMeta{
		...
		ForeignExtensions: map[string][]macosplatformmetadata.Method{
			"NSObject": {
				{Selector: "myExtension", Return: macosplatformmetadata.ReturnType{ObjCType: "void"}},
			},
		},
	}
	var buf bytes.Buffer
...
func TestBridgeImplVoidMethod(t *testing.T) {
	...
	framework := &macosplatformmetadata.FrameworkMeta{
		...
		Classes: map[string]macosplatformmetadata.Class{
			"NSObject": {
				Methods: []macosplatformmetadata.Method{
					{Selector: "doSomething", IsClassMethod: true, Return: macosplatformmetadata.ReturnType{ObjCType: "void"}},
				},
			},
		},
	}
...
func TestBridgeImplFreeFunction(t *testing.T) {
	...
	framework := &macosplatformmetadata.FrameworkMeta{
		...
		Classes:   map[string]macosplatformmetadata.Class{},
		Functions: []macosplatformmetadata.Function{
			{Name: "NSLog", Return: macosplatformmetadata.ReturnType{ObjCType: "void"}, Params: []macosplatformmetadata.Param{{Name: "format", ObjCType: "NSString *"}}},
		},
	}
	var buf bytes.Buffer
	if err := EmitBridgeImpl(&buf, framework, m, map[string]bool{}, "foundation_bridge.h"); err != nil {
...
func TestFreeFuncParamListEmpty(t *testing.T) {
	m := bridgeTestMapper()
	ctx := bridgeCtx("Foundation")
	result := freeFuncParamList([]macosplatformmetadata.Param{}, ctx, m)
...
func TestBridgeImplForeignExtensions(t *testing.T) {
	...
	framework := &macosplatformmetadata.FrameworkMeta{
		...
		ForeignExtensions: map[string][]macosplatformmetadata.Method{
			"NSObject": {
				{Selector: "myExt", Return: macosplatformmetadata.ReturnType{ObjCType: "void"}},
			},
		},
	}
	var buf bytes.Buffer
...
func TestHasByValueUnknownTypeBlock(t *testing.T) {
	fn := macosplatformmetadata.Function{Name: "test", Return: macosplatformmetadata.ReturnType{ObjCType: "void"}, Params: []macosplatformmetadata.Param{{Name: "cb", ObjCType: "void (^)(void)"}}}
...
func TestHasByValueUnknownTypeNullabilityAnnotation(t *testing.T) {
	fn := macosplatformmetadata.Function{Name: "test", Return: macosplatformmetadata.ReturnType{ObjCType: "void"}, Params: []macosplatformmetadata.Param{{Name: "p", ObjCType: "NSString * _Nonnull"}}}
	if hasByValueUnknownType(fn) {
...
func TestHasByValueUnknownTypeVoid(t *testing.T) {
	fn := macosplatformmetadata.Function{Name: "test", Return: macosplatformmetadata.ReturnType{ObjCType: "void"}}
	if hasByValueUnknownType(fn) {
...
func TestHasByValueUnknownTypePointer(t *testing.T) {
	fn := macosplatformmetadata.Function{Name: "test", Return: macosplatformmetadata.ReturnType{ObjCType: "NSObject *"}}
	if hasByValueUnknownType(fn) {
...
func TestHasByValueUnknownTypeSuffixT(t *testing.T) {
	fn := macosplatformmetadata.Function{Name: "test", Return: macosplatformmetadata.ReturnType{ObjCType: "vmnet_return_t"}}
	if hasByValueUnknownType(fn) {
...
func TestHasByValueUnknownTypeRefContaining(t *testing.T) {
	fn := macosplatformmetadata.Function{Name: "test", Return: macosplatformmetadata.ReturnType{ObjCType: "CGColorRef"}}
	if hasByValueUnknownType(fn) {
...
func TestHasByValueUnknownTypeSIMD(t *testing.T) {
	fn := macosplatformmetadata.Function{Name: "test", Return: macosplatformmetadata.ReturnType{ObjCType: "DenseMatrix_Float"}}
	if !hasByValueUnknownType(fn) {
...
func TestHasByValueUnknownTypeBOOL(t *testing.T) {
	fn := macosplatformmetadata.Function{Name: "test", Return: macosplatformmetadata.ReturnType{ObjCType: "BOOL"}}
	if hasByValueUnknownType(fn) {
...
func TestHasByValueUnknownTypeID(t *testing.T) {
	fn := macosplatformmetadata.Function{Name: "test", Return: macosplatformmetadata.ReturnType{ObjCType: "id"}}
	if hasByValueUnknownType(fn) {
...
func TestHasByValueUnknownTypeScalar(t *testing.T) {
	fn := macosplatformmetadata.Function{Name: "test", Return: macosplatformmetadata.ReturnType{ObjCType: "NSUInteger"}}
	if hasByValueUnknownType(fn) {
...
func TestBridgeHeaderProtocolProxy(t *testing.T) {
	...
	framework := &macosplatformmetadata.FrameworkMeta{
		...
		Protocols: map[string]macosplatformmetadata.Protocol{
			"NSCopying": {
				Methods: []macosplatformmetadata.Method{
					{Selector: "copyWithZone:", Return: macosplatformmetadata.ReturnType{ObjCType: "id"}},
				},
			},
		},
	}
...
func TestBridgeHeaderProtocolProxyClassMethodSkipped(t *testing.T) {
	...
	framework := &macosplatformmetadata.FrameworkMeta{
		...
		Protocols: map[string]macosplatformmetadata.Protocol{
			"NSFactory": {
				Methods: []macosplatformmetadata.Method{
					{Selector: "create", IsClassMethod: true, Return: macosplatformmetadata.ReturnType{ObjCType: "id"}},
				},
			},
		},
	}
...
func TestWriteFunctionImplStructReturn(t *testing.T) {
	...
	fn := macosplatformmetadata.Function{
		Name:   "GetViewport",
		Return: macosplatformmetadata.ReturnType{ObjCType: "MTLViewport"},
	}
