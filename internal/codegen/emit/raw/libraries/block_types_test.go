...
func newBlockFM(framework string, blocks map[string]macosplatformmetadata.BlockType) *macosplatformmetadata.FrameworkMeta {
...
func TestBlockSortOrder(t *testing.T) {
	...
	framework := newBlockFM("Foundation", map[string]macosplatformmetadata.BlockType{
		"ZebraBlock": {Return: macosplatformmetadata.ReturnType{}},
		"AlphaBlock": {Return: macosplatformmetadata.ReturnType{}},
		"MidBlock":   {Return: macosplatformmetadata.ReturnType{}},
	})
	m := testMapper()
	var buf bytes.Buffer
	if err := EmitBlocks(&buf, framework, m, map[string]bool{}); err != nil {
...
func TestBlockCommentContainsName(t *testing.T) {
	...
	framework := newBlockFM("Foundation", map[string]macosplatformmetadata.BlockType{
		"HandlerBlock": {Return: macosplatformmetadata.ReturnType{}},
	})
	m := testMapper()
	var buf bytes.Buffer
	if err := EmitBlocks(&buf, framework, m, map[string]bool{}); err != nil {
