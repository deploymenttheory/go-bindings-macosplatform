...
func hasVAListArg(fn macosplatformmetadata.Function) bool {
...
func buildBridgeTryBody(objcCall string, ret macosplatformmetadata.ReturnType, hasNSError bool, retC string, ctx typemap.Context, m *typemap.Mapper) string {
...
func hasDesignatedInitWithArgs(cls macosplatformmetadata.Class) bool {
...
func buildClassBridgeNames(framework, className string, methods []macosplatformmetadata.Method) map[string]string {
...
func bridgeFuncDecl(cFunc string, method macosplatformmetadata.Method, ctx typemap.Context, m *typemap.Mapper) string {
	retC := bridgeReturnCType(method, ctx, m)
...
func bridgeFuncDeclFromFunction(cFunc string, fn macosplatformmetadata.Function, ctx typemap.Context, m *typemap.Mapper) string {
	retC := m.CType(fn.Return.ObjCType, ctx, nil)
	if fn.Return.ObjCType == "" || fn.Return.ObjCType == "void" {
		retC = "void"
	}
...
func freeFuncParamList(args []macosplatformmetadata.Param, ctx typemap.Context, m *typemap.Mapper) string {
...
func bridgeReturnCType(method macosplatformmetadata.Method, ctx typemap.Context, m *typemap.Mapper) string {
	ret := method.Return
...
func bridgeParamList(isClassMethod bool, args []macosplatformmetadata.Param, hasNSError bool, ctx typemap.Context, m *typemap.Mapper) string {
	resolved := buildParamNames(args)
	var parts []string
	if !isClassMethod {
...
func buildFreeFuncCall(fn macosplatformmetadata.Function, ctx typemap.Context, m *typemap.Mapper) string {
...
func buildObjCCall(target string, method macosplatformmetadata.Method, ctx typemap.Context, m *typemap.Mapper) string {
