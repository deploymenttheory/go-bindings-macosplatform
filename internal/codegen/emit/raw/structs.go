...
func EmitStructs(w io.Writer, framework *meta.FrameworkMeta, m *typemap.Mapper, knownClasses map[string]bool) (typemap.ImportSet, error) {
...
func buildStructModel(name string, s meta.Struct, framework string, m *typemap.Mapper, knownClasses map[string]bool, usedImports typemap.ImportSet) structModel {
...
func buildCFOpaqueSet(framework *meta.FrameworkMeta) map[string]bool {
