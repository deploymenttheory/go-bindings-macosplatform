...
func TestResolveStructTypeClassMethodReplacesT(t *testing.T) {
	...
	if got != "NSArray[objc.Object]" {
		t.Errorf("class method should replace [T] with [objc.Object]; got %q", got)
	}
}
...
func TestObjectConstructExprGenericRuntimeObject(t *testing.T) {
	m := &typemap.Mapper{}
	got := objectConstructExpr("NSArray[objc.Object]", "_ptr", nil, m)
	if got != "NewNSArray(_ptr)" {
		t.Errorf("generic [objc.Object]: want NewNSArray(_ptr), got %q", got)
	}
}
...
func TestIsCrossFrameworkTypeFalse(t *testing.T) {
	for _, s := range []string{"NSString", "NSArray[T]", "objc.Object"} {
...
func TestBuildValueChainUnknownClass(t *testing.T) {
	chain := buildValueChain("NSUnknown", "", "Foundation", map[string]meta.Class{}, nil, nil)
...
func TestGoCallArgsInstanceMethod(t *testing.T) {
	args := []meta.Param{{Name: "x", ObjCType: "NSUInteger"}}
...
func TestGoCallArgsNSError(t *testing.T) {
	result := goCallArgs(false, []meta.Param{}, true)
...
func TestGoCallArgsEmpty(t *testing.T) {
	result := goCallArgs(true, []meta.Param{}, false)
	if result != "" {
...
func TestClassesCreatesFiles(t *testing.T) {
	...
	all := map[string]meta.Class{"NSObject": {}}
...
func TestClassesObjectReturnMethod(t *testing.T) {
	...
	out := string(content)
	// The method should use objc.WrapTyped with the NewNSString constructor.
	if !strings.Contains(out, "objc.WrapTyped(_ptr, NewNSString)") {
		t.Errorf("object return should use objc.WrapTyped with NewNSString; got:\n%s", out)
	}
}
...
func TestWriteObjectReturnWithErrorSameFramework(t *testing.T) {
	...
	out := buf.String()
	if !strings.Contains(out, "objc.WrapTyped(_ptr, NewNSString)") {
		t.Errorf("same-fw should use objc.WrapTyped with NewNSString; got %q", out)
	}
}
...
func TestWriteClassMethodTypeNameCollisionSkip(t *testing.T) {
	...
	framework := &meta.FrameworkMeta{
		...
		Enums: map[string]meta.Enum{
			...
			"NSObjectVersion": {Members: []meta.EnumMember{{Name: "v1", Value: "1"}}},
		},
	}
	cls := meta.Class{
		Methods: []meta.Method{
...
// writeClassMethod should then append "[objc.Object]" to produce the correct return.
func TestWriteClassMethodGenericInstancetypeSubstitution(t *testing.T) {
	...
	// instead of "*NSArray[objc.Object]". writeClassMethod must fix this up.
	m := &typemap.Mapper{
	...
	out := buf.String()
	// The class method should produce [objc.Object] return type, not bare *NSArray.
	if !strings.Contains(out, "*NSArray[objc.Object]") {
		t.Errorf("generic class method should have *NSArray[objc.Object] return; got:\n%s", out)
	}
}
...
func TestWriteClassNSCodingMethods(t *testing.T) {
	...
	all := map[string]meta.Class{"NSObject": {}, "NSString": cls}
...
func TestWriteClassNSCodingMethodsSkippedForNonConforming(t *testing.T) {
	...
	all := map[string]meta.Class{"NSObject": {}, "NSDate": cls}
