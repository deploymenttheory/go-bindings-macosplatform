...
func EmitSubclassFactories(outDir string, framework *meta.FrameworkMeta, m *typemap.Mapper, superIndex map[string]bool, allClasses map[string]meta.Class) error {
...
// overrideMethod is a pruned view of meta.Method for the subclass factory generator.
...
func collectOverridableMethods(cls meta.Class, m *typemap.Mapper, allClasses map[string]meta.Class) []overrideMethod {
