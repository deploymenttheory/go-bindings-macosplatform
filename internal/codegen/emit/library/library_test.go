...
func libTestFM(fw string, classes map[string]meta.Class) *meta.FrameworkMeta {
...
func TestClassHasValidateMethod(t *testing.T) {
	cls := meta.Class{
		Methods: []meta.Method{
			{Selector: "validateWithError:", Return: meta.ReturnType{ObjCType: "BOOL"}},
		},
	}
...
func TestClassHasValidateMethodUnavailableExcluded(t *testing.T) {
	cls := meta.Class{
		Methods: []meta.Method{
			{Selector: "validateWithError:", Availability: meta.Availability{IsUnavailable: true}},
		},
	}
	if classHasValidateMethod(cls) {
...
func TestClassHasInstanceSetter(t *testing.T) {
	cls := meta.Class{
		Methods: []meta.Method{
			{Selector: "setCount:", Return: meta.ReturnType{ObjCType: "void"}},
		},
	}
...
func TestClassHasInstanceSetterClassMethodExcluded(t *testing.T) {
	cls := meta.Class{
		Methods: []meta.Method{
			{Selector: "setCount:", IsClassMethod: true, Return: meta.ReturnType{ObjCType: "void"}},
		},
	}
	if classHasInstanceSetter(cls, "count") {
...
func TestLibraryAddRawPrefixClass(t *testing.T) {
	framework := libTestFM("AppKit", map[string]meta.Class{"NSView": {}})
...
func TestLibraryAddRawPrefixCrossFramework(t *testing.T) {
	framework := libTestFM("AppKit", map[string]meta.Class{})
...
func TestAsyncEmpty(t *testing.T) {
	m := libTestMapper()
	framework := libTestFM("Foundation", map[string]meta.Class{})
	var buf bytes.Buffer
...
func TestSlicesBasic(t *testing.T) {
	m := libTestMapper()
	framework := libTestFM("Virtualization", map[string]meta.Class{
		"VZConfiguration": {
			Methods: []meta.Method{
				{Selector: "storages", Return: meta.ReturnType{ObjCType: "NSArray<VZDiskImage *> *"}},
				{Selector: "setStorages:", Params: []meta.Param{{Name: "v", ObjCType: "NSArray<VZDiskImage *> *"}}, Return: meta.ReturnType{ObjCType: "void"}},
			},
...
func TestSpecsBasic(t *testing.T) {
	...
	framework := libTestFM("Virtualization", map[string]meta.Class{
		"VZMachineConfiguration": {
			Methods: []meta.Method{
				{Selector: "setCpuCount:", Params: []meta.Param{{Name: "v", ObjCType: "NSUInteger"}}, Return: meta.ReturnType{ObjCType: "void"}},
				{Selector: "setMemorySize:", Params: []meta.Param{{Name: "v", ObjCType: "uint64_t"}}, Return: meta.ReturnType{ObjCType: "void"}},
				{Selector: "setBootLoader:", Params: []meta.Param{{Name: "v", ObjCType: "NSUInteger"}}, Return: meta.ReturnType{ObjCType: "void"}},
			},
			Properties: []meta.Property{
...
func TestSpecsWithValidateMethod(t *testing.T) {
	...
	framework := libTestFM("Virtualization", map[string]meta.Class{
		"VZFooConfiguration": {
			Methods: []meta.Method{
				{Selector: "setA:", Params: []meta.Param{{Name: "v", ObjCType: "NSUInteger"}}, Return: meta.ReturnType{ObjCType: "void"}},
				{Selector: "setB:", Params: []meta.Param{{Name: "v", ObjCType: "NSUInteger"}}, Return: meta.ReturnType{ObjCType: "void"}},
				{Selector: "setC:", Params: []meta.Param{{Name: "v", ObjCType: "NSUInteger"}}, Return: meta.ReturnType{ObjCType: "void"}},
				{Selector: "validateWithError:", IsNSError: true, Return: meta.ReturnType{ObjCType: "BOOL"}},
			},
			Properties: []meta.Property{
				{Name: "a", ObjCType: "NSUInteger"},
				{Name: "b", ObjCType: "NSUInteger"},
...
func TestResolveOpinionatedArgTypeObjcObject(t *testing.T) {
	m := libTestMapper()
	framework := libTestFM("Foundation", map[string]meta.Class{"NSString": {}})
...
func TestAddRawPrefixSliceType(t *testing.T) {
	framework := libTestFM("Virtualization", map[string]meta.Class{"VZFoo": {}})
...
func TestAddRawPrefixProtocolType(t *testing.T) {
	framework := &meta.FrameworkMeta{
		...
		Protocols: map[string]meta.Protocol{"NSTextFieldDelegate": {}},
		Enums:     map[string]meta.Enum{},
		Structs:   map[string]meta.Struct{},
		Typedefs:  map[string]string{},
	}
...
func TestAddRawPrefixEnumType(t *testing.T) {
	framework := &meta.FrameworkMeta{
		...
		Classes:   map[string]meta.Class{},
		Protocols: map[string]meta.Protocol{},
		Enums:     map[string]meta.Enum{"NSControlSize": {}},
		Structs:   map[string]meta.Struct{},
		Typedefs:  map[string]string{},
	}
...
func TestAddRawPrefixStructType(t *testing.T) {
	framework := &meta.FrameworkMeta{
		...
		Protocols: map[string]meta.Protocol{},
		Enums:     map[string]meta.Enum{},
		Structs:   map[string]meta.Struct{"CGRect": {}},
		Typedefs:  map[string]string{},
	}
...
func TestAddRawPrefixCompoundInterface(t *testing.T) {
	framework := &meta.FrameworkMeta{
		Framework: "AppKit",
		Classes:   map[string]meta.Class{},
		Protocols: map[string]meta.Protocol{"NSFoo": {}, "NSBar": {}},
		Enums:     map[string]meta.Enum{},
		Structs:   map[string]meta.Struct{},
		Typedefs:  map[string]string{},
	}
...
func TestSpecsBoolField(t *testing.T) {
	...
	framework := libTestFM("Virtualization", map[string]meta.Class{
		"VZFooConfiguration": {
			Methods: []meta.Method{
				{Selector: "setEnabled:", Params: []meta.Param{{Name: "v", ObjCType: "BOOL"}}, Return: meta.ReturnType{ObjCType: "void"}},
				{Selector: "setA:", Params: []meta.Param{{Name: "v", ObjCType: "NSUInteger"}}, Return: meta.ReturnType{ObjCType: "void"}},
				{Selector: "setB:", Params: []meta.Param{{Name: "v", ObjCType: "NSUInteger"}}, Return: meta.ReturnType{ObjCType: "void"}},
			},
			Properties: []meta.Property{
...
func TestSpecsValueStructField(t *testing.T) {
	...
	framework := &meta.FrameworkMeta{
		...
		Classes: map[string]meta.Class{
			"CGFooConfiguration": {
				Methods: []meta.Method{
					{Selector: "setFrame:", Params: []meta.Param{{Name: "v", ObjCType: "CGRect"}}, Return: meta.ReturnType{ObjCType: "void"}},
					{Selector: "setA:", Params: []meta.Param{{Name: "v", ObjCType: "NSUInteger"}}, Return: meta.ReturnType{ObjCType: "void"}},
					{Selector: "setB:", Params: []meta.Param{{Name: "v", ObjCType: "NSUInteger"}}, Return: meta.ReturnType{ObjCType: "void"}},
				},
				Properties: []meta.Property{
...
func TestSpecsSliceField(t *testing.T) {
	...
	framework := &meta.FrameworkMeta{
		...
		Classes: map[string]meta.Class{
			...
			"VZFooConfiguration": {
				Methods: []meta.Method{
					{Selector: "setStorages:", Params: []meta.Param{{Name: "v", ObjCType: "NSArray<VZStorage *> *"}}, Return: meta.ReturnType{ObjCType: "void"}},
					{Selector: "setA:", Params: []meta.Param{{Name: "v", ObjCType: "NSUInteger"}}, Return: meta.ReturnType{ObjCType: "void"}},
					{Selector: "setB:", Params: []meta.Param{{Name: "v", ObjCType: "NSUInteger"}}, Return: meta.ReturnType{ObjCType: "void"}},
				},
				Properties: []meta.Property{
...
func TestSlicesAudioDevices(t *testing.T) {
	...
	framework := &meta.FrameworkMeta{
		...
		Classes: map[string]meta.Class{
			...
			"VZMachineConfig": {
				Methods: []meta.Method{
					{Selector: "setAudioDevices:", Params: []meta.Param{{Name: "v", ObjCType: "NSArray *"}}, Return: meta.ReturnType{ObjCType: "void"}},
				},
				Properties: []meta.Property{
