...
func completionHandlerIndex(args []meta.Param) int {
...
func classHasValidateMethod(cls meta.Class) bool {
...
func classHasInstanceSetter(cls meta.Class, propName string) bool {
	if len(propName) == 0 {
		return false
	}
...
func classGetterIsClassMethod(cls meta.Class, getterSel string) bool {
	for _, m := range cls.Methods {
