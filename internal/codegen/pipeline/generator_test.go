...
func makeReg(frameworks []*meta.FrameworkMeta, owner map[string]string) *Registry {
	...
	fmA := &meta.FrameworkMeta{
		...
		Classes: map[string]meta.Class{
			"AClass": {
				Methods: []meta.Method{{
					Selector: "getB",
					Return:   meta.ReturnType{ObjCType: "BClass *"},
				}},
			},
		},
	}
	...
	fmB := &meta.FrameworkMeta{
		...
		Classes: map[string]meta.Class{
			"BClass": {
				Methods: []meta.Method{{
					Selector: "getA",
					Return:   meta.ReturnType{ObjCType: "AClass *"},
				}},
			},
		},
	}
...
func TestComputeBlockedImportsMinWeight(t *testing.T) {
	...
	fmA := &meta.FrameworkMeta{
		...
		Classes: map[string]meta.Class{
			"AClass": {
				Methods: []meta.Method{
					{Selector: "getB1", Return: meta.ReturnType{ObjCType: "BClass *"}},
					{Selector: "getB2", Return: meta.ReturnType{ObjCType: "BClass *"}},
				},
			},
		},
	}
...
func TestComputeBlockedImportsForeignExtensions(t *testing.T) {
	...
	fmA := &meta.FrameworkMeta{
		Framework: "FrameworkA",
		Classes:   map[string]meta.Class{"AClass": {}},
...
func TestComputeBlockedImportsEnumCycle(t *testing.T) {
	...
	fmA := &meta.FrameworkMeta{
		...
		Classes: map[string]meta.Class{
			"AClass": {
				Methods: []meta.Method{
					{Selector: "m1", Return: meta.ReturnType{ObjCType: "EnumB"}},
					{Selector: "m2", Return: meta.ReturnType{ObjCType: "EnumB"}},
					{Selector: "m3", Return: meta.ReturnType{ObjCType: "EnumB"}},
					{Selector: "m4", Return: meta.ReturnType{ObjCType: "EnumB"}},
				},
			},
		},
	}
...
func TestComputeBlockedImportsProtocolEmbedPriority(t *testing.T) {
	...
	fmA := &meta.FrameworkMeta{
		...
		Classes: map[string]meta.Class{
			"AClass": {
				Methods: []meta.Method{
					{Selector: "m1", Return: meta.ReturnType{ObjCType: "BClass *"}},
					{Selector: "m2", Return: meta.ReturnType{ObjCType: "BClass *"}},
					{Selector: "m3", Return: meta.ReturnType{ObjCType: "BClass *"}},
					{Selector: "m4", Return: meta.ReturnType{ObjCType: "BClass *"}},
					{Selector: "m5", Return: meta.ReturnType{ObjCType: "BClass *"}},
				},
			},
		},
	}
	fmB := &meta.FrameworkMeta{
		Framework: "FrameworkB",
		Classes:   map[string]meta.Class{"BClass": {}},
		Protocols: map[string]meta.Protocol{
			"PB1": {InheritedProtocols: []string{"ProtoA"}},
			"PB2": {InheritedProtocols: []string{"ProtoA"}},
			"PB3": {InheritedProtocols: []string{"ProtoA"}},
...
func voidInstanceMethod(selector string) meta.Method {
	return meta.Method{
		Selector:      selector,
		IsClassMethod: false,
...
func TestTopoSortNoDeps(t *testing.T) {
	...
	fmA := &meta.FrameworkMeta{Framework: "Alpha", Classes: map[string]meta.Class{"AClass": {}}}
	fmB := &meta.FrameworkMeta{Framework: "Beta", Classes: map[string]meta.Class{"BClass": {}}}
	fmC := &meta.FrameworkMeta{Framework: "Gamma", Classes: map[string]meta.Class{"CClass": {}}}
	reg := &Registry{
...
func TestTopoSortIncludesAll(t *testing.T) {
	...
	frameworks := make([]*meta.FrameworkMeta, 0, 5)
	owner := map[string]string{}
	kc := map[string]bool{}
	for _, name := range []string{"Alpha", "Beta", "Gamma", "Delta", "Epsilon"} {
		cls := name + "Root"
		frameworks = append(frameworks, &meta.FrameworkMeta{
			Framework: name,
			Classes:   map[string]meta.Class{cls: {}},
		})
		owner[cls] = name
		kc[cls] = true
	}
