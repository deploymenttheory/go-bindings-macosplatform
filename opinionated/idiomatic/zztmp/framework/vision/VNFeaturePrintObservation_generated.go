...
func (x *FeaturePrintObservation) ComputeDistanceToFeaturePrintObservation(featurePrint *FeaturePrintObservation) (float32, error) {
	var _out0 float32
	var _nsErr uintptr
...
type FeaturePrintObservationable interface {
	obj.Object
	ComputeDistanceToFeaturePrintObservation(featurePrint *FeaturePrintObservation) (float32, error)
