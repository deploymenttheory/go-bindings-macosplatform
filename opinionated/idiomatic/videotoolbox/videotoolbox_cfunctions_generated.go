...
// VTCopySupportedPropertyDictionaryForEncoder calls [raw.VTCopySupportedPropertyDictionaryForEncoder] (C function VTCopySupportedPropertyDictionaryForEncoder).
func VTCopySupportedPropertyDictionaryForEncoder(width int32, height int32, codecType uint, encoderSpecification unsafe.Pointer, encoderIDOut unsafe.Pointer, supportedPropertiesOut unsafe.Pointer) int {
	return raw.VTCopySupportedPropertyDictionaryForEncoder(width, height, codecType, encoderSpecification, encoderIDOut, supportedPropertiesOut)
}
...
// VTCopyVideoEncoderList calls [raw.VTCopyVideoEncoderList] (C function VTCopyVideoEncoderList).
func VTCopyVideoEncoderList(options unsafe.Pointer, listOfVideoEncodersOut unsafe.Pointer) int {
	return raw.VTCopyVideoEncoderList(options, listOfVideoEncodersOut)
}
