...
func (x *QueryCursor) ID() objc.ID { return x.inner.Ptr() }

// QueryCursorFromID adopts an existing toll-free-bridged object id as a QueryCursor (nil for 0).
func QueryCursorFromID(id objc.ID) *QueryCursor {
	if id == 0 {
		return nil
	}
	return &QueryCursor{inner: raw.CKQueryCursorFromID(id)}
}
