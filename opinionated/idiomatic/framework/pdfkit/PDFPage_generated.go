...
func (x *Page) ID() objc.ID { return x.inner.Ptr() }

// PageFromID adopts an existing toll-free-bridged object id as a Page (nil for 0).
func PageFromID(id objc.ID) *Page {
	if id == 0 {
		return nil
	}
	return &Page{inner: raw.PDFPageFromID(id)}
}
