...
func (atw *AnnotationTextWidget) WithWidgetFieldType(widgetFieldType unsafe.Pointer) *AnnotationTextWidget {
	objc.Send[objc.ID](objref.IDOf(atw), objc.RegisterName("setWidgetFieldType:"), widgetFieldType)
	return atw
}
