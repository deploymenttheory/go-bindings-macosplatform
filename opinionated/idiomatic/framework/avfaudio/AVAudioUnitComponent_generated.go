...
func (auc *AudioUnitComponent) ComponentURL() string {
	defer runtime.KeepAlive(auc)
...
func (auc *AudioUnitComponent) IconURL() string {
	defer runtime.KeepAlive(auc)
...
func (auc *AudioUnitComponent) ConfigurationDictionary() map[string]obj.Object {
	defer runtime.KeepAlive(auc)
