...
func RenderPassAttachmentDescriptorFromID(id objc.ID) *RenderPassAttachmentDescriptor {
	...
	x := &RenderPassAttachmentDescriptor{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func renderPassAttachmentDescriptorAdopt(id objc.ID) *RenderPassAttachmentDescriptor {
	...
	x := &RenderPassAttachmentDescriptor{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
...
func NewRenderPassAttachmentDescriptor() *RenderPassAttachmentDescriptor {
	_id := objc.Send[objc.ID](objc.ID(_class("MTLRenderPassAttachmentDescriptor")), objc.RegisterName("new"))
	return renderPassAttachmentDescriptorAdopt(_id)
}
