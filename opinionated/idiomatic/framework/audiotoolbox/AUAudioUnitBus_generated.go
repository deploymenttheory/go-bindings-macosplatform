...
func (aub *AudioUnitBus) WithShouldAllocateBuffer(shouldAllocateBuffer bool) *AudioUnitBus {
	objc.Send[objc.ID](objref.IDOf(aub), objc.RegisterName("setShouldAllocateBuffer:"), shouldAllocateBuffer)
	return aub
}

// WithEnabled sets determines whether the bus is active.
func (aub *AudioUnitBus) WithEnabled(enabled bool) *AudioUnitBus {
	objc.Send[objc.ID](objref.IDOf(aub), objc.RegisterName("setEnabled:"), enabled)
	return aub
}

// WithName sets a name for the bus.
func (aub *AudioUnitBus) WithName(name string) *AudioUnitBus {
	objc.Send[objc.ID](objref.IDOf(aub), objc.RegisterName("setName:"), purego.NSString(name))
	return aub
}
...
func (aub *AudioUnitBus) WithContextPresentationLatency(contextPresentationLatency float64) *AudioUnitBus {
	objc.Send[objc.ID](objref.IDOf(aub), objc.RegisterName("setContextPresentationLatency:"), contextPresentationLatency)
	return aub
}
...
func (aub *AudioUnitBus) WithSupportedChannelCounts(items ...obj.Object) *AudioUnitBus {
	...
	objc.Send[objc.ID](objref.IDOf(aub), objc.RegisterName("setSupportedChannelCounts:"), _arr)
	return aub
}
...
func (aub *AudioUnitBus) WithMaximumChannelCount(maximumChannelCount uint32) *AudioUnitBus {
	objc.Send[objc.ID](objref.IDOf(aub), objc.RegisterName("setMaximumChannelCount:"), maximumChannelCount)
	return aub
}
