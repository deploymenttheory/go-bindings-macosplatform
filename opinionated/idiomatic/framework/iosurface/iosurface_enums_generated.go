...
// String returns the IOSurfaceMemoryLedgerFlags constant's name, or its numeric form when the
// value is not a known constant.
...
// String returns the IOSurfaceMemoryLedgerTags constant's name, or its numeric form when the
// value is not a known constant.
...
// String returns the IOSurfacePurgeabilityState constant's name, or its numeric form when the
// value is not a known constant.
