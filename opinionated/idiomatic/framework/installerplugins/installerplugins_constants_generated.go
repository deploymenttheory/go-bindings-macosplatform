...
// InstallerState_Choice_Identifier returns the string constant InstallerState_Choice_Identifier as an objc.ID, for use as a dictionary key or selector argument.
func InstallerState_Choice_Identifier() objc.ID {
	return purego.CFConstant(raw.InstallerState_Choice_Identifier())
}
...
// InstallerState_Choice_Installed returns the string constant InstallerState_Choice_Installed as an objc.ID, for use as a dictionary key or selector argument.
func InstallerState_Choice_Installed() objc.ID {
	return purego.CFConstant(raw.InstallerState_Choice_Installed())
}
...
// InstallerState_Choice_CustomLocation returns the string constant InstallerState_Choice_CustomLocation as an objc.ID, for use as a dictionary key or selector argument.
func InstallerState_Choice_CustomLocation() objc.ID {
	return purego.CFConstant(raw.InstallerState_Choice_CustomLocation())
}
