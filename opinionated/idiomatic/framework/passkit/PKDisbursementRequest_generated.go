...
func (dr *DisbursementRequest) WithApplicationData(applicationData obj.Object) *DisbursementRequest {
	objc.Send[objc.ID](objref.IDOf(dr), objc.RegisterName("setApplicationData:"), objref.IDOf(applicationData))
	return dr
}
