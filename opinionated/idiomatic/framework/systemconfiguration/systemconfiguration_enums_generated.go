...
// String returns the SCNetworkConnectionPPPStatus constant's name, or its numeric form when the
// value is not a known constant.
...
// String returns the SCPreferencesNotification constant's name, or its numeric form when the
// value is not a known constant.
