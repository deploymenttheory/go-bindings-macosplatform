...
func NEPacketTunnelFlowFromID(id objc.ID) *NEPacketTunnelFlow {
	...
	x := &NEPacketTunnelFlow{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func nEPacketTunnelFlowAdopt(id objc.ID) *NEPacketTunnelFlow {
	...
	x := &NEPacketTunnelFlow{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
...
func (x *NEPacketTunnelFlow) ReadPacketObjects(ctx context.Context) (obj.Object, error) {
	type _result struct {
		val obj.Object
		err error
	}
