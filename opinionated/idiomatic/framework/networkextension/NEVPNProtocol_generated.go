...
// NEVPNProtocolFromID adopts an existing toll-free-bridged object id as a NEVPNProtocol (nil for 0).
...
type NEVPNProtocolable interface {
	...
	WithProxySettings(proxySettings *raw.NEProxySettings) *NEVPNProtocol
