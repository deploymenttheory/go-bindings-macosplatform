...
func (uh *URLHandle) WithScriptingProperties(scriptingProperties map[string]obj.Object) *URLHandle {
	objc.Send[objc.ID](objref.IDOf(uh), objc.RegisterName("setScriptingProperties:"), rt.MapToDict(scriptingProperties, func(_k string) objc.ID { return purego.NSString(_k) }, func(_v obj.Object) objc.ID { return objref.IDOf(_v) }))
	return uh
}
...
func (uh *URLHandle) ResourceData() []byte {
	defer runtime.KeepAlive(uh)
...
func (uh *URLHandle) AvailableResourceData() []byte {
	defer runtime.KeepAlive(uh)
...
func (uh *URLHandle) DidLoadBytesLoadComplete(newBytes []byte, yorn bool) {
	defer runtime.KeepAlive(uh)
	objc.Send[objc.ID](objref.IDOf(uh), objc.RegisterName("didLoadBytes:loadComplete:"), rt.BytesToNSData(newBytes), yorn)
}
...
func (uh *URLHandle) WriteData(data []byte) bool {
	defer runtime.KeepAlive(uh)
	_r := objc.Send[bool](objref.IDOf(uh), objc.RegisterName("writeData:"), rt.BytesToNSData(data))
	return _r
}

// LoadInForeground returns loads the receiver’s data synchronously.
func (uh *URLHandle) LoadInForeground() []byte {
	defer runtime.KeepAlive(uh)
