...
// String returns the AXMenuItemModifiers constant's name, or its numeric form when the
// value is not a known constant.
...
// String returns the AXPriority constant's name, or its numeric form when the
// value is not a known constant.
...
// String returns the AXUnderlineStyle constant's name, or its numeric form when the
// value is not a known constant.
...
// String returns the PasteboardStandardLocation constant's name, or its numeric form when the
// value is not a known constant.
