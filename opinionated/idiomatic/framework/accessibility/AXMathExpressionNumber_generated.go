...
func (x *MathExpressionNumber) ID() objc.ID { return x.inner.Ptr() }

// MathExpressionNumberFromID adopts an existing toll-free-bridged object id as a MathExpressionNumber (nil for 0).
func MathExpressionNumberFromID(id objc.ID) *MathExpressionNumber {
	if id == 0 {
		return nil
	}
	return &MathExpressionNumber{inner: raw.AXMathExpressionNumberFromID(id)}
}
