...
// ChangeShuffleModeCommandEventFromID adopts an existing object pointer as a ChangeShuffleModeCommandEvent (nil for 0).
...
func (x *ChangeShuffleModeCommandEvent) asRemoteCommandEvent() *raw.MPRemoteCommandEvent {
