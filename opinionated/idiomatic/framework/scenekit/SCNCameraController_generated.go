...
func (x *CameraController) ID() objc.ID { return x.inner.Ptr() }

// CameraControllerFromID adopts an existing toll-free-bridged object id as a CameraController (nil for 0).
func CameraControllerFromID(id objc.ID) *CameraController {
	if id == 0 {
		return nil
	}
	return &CameraController{inner: raw.SCNCameraControllerFromID(id)}
}
