...
func (x *IOBluetoothSDPServiceAttribute) ID() objc.ID { return x.inner.Ptr() }

// IOBluetoothSDPServiceAttributeFromID adopts an existing toll-free-bridged object id as a IOBluetoothSDPServiceAttribute (nil for 0).
