...
type ImageBrowserCellState int64
...
// String returns the ImageBrowserCellState constant's name, or its numeric form when the
// value is not a known constant.
func (e ImageBrowserCellState) String() string {
	switch e {
	case ImageStateNoImage:
		return "ImageStateNoImage"
	case ImageStateInvalid:
		return "ImageStateInvalid"
	case ImageStateReady:
		return "ImageStateReady"
	default:
		return fmt.Sprintf("ImageBrowserCellState(%d)", int64(e))
	}
}

type ImageBrowserDropOperation int64
...
// String returns the ImageBrowserDropOperation constant's name, or its numeric form when the
// value is not a known constant.
func (e ImageBrowserDropOperation) String() string {
	switch e {
	case ImageBrowserDropOn:
		return "ImageBrowserDropOn"
	case ImageBrowserDropBefore:
		return "ImageBrowserDropBefore"
	default:
		return fmt.Sprintf("ImageBrowserDropOperation(%d)", int64(e))
	}
}
