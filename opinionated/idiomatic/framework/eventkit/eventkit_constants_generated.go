...
// Error domain for NSError values stemming from the EventKit Framework API. This error domain is used as the domain for all NSError instances stemming from the EventKit Framework.
