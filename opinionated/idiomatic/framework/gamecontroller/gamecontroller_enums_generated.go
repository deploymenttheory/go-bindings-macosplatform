...
// String returns the DevicePhysicalInputElementChange constant's name, or its numeric form when the
// value is not a known constant.
func (e DevicePhysicalInputElementChange) String() string {
	switch e {
	case DevicePhysicalInputElementUnknownChange:
		return "DevicePhysicalInputElementUnknownChange"
	case DevicePhysicalInputElementNoChange:
		return "DevicePhysicalInputElementNoChange"
	case DevicePhysicalInputElementChanged:
		return "DevicePhysicalInputElementChanged"
	default:
		return fmt.Sprintf("DevicePhysicalInputElementChange(%d)", int64(e))
	}
}
...
// String returns the ExtendedGamepadSnapshotDataVersion constant's name, or its numeric form when the
// value is not a known constant.
func (e ExtendedGamepadSnapshotDataVersion) String() string {
	switch e {
	case ExtendedGamepadSnapshotDataVersion1:
		return "ExtendedGamepadSnapshotDataVersion1"
	case ExtendedGamepadSnapshotDataVersion2:
		return "ExtendedGamepadSnapshotDataVersion2"
	default:
		return fmt.Sprintf("ExtendedGamepadSnapshotDataVersion(%d)", int64(e))
	}
}
...
// String returns the MicroGamepadSnapshotDataVersion constant's name, or its numeric form when the
// value is not a known constant.
func (e MicroGamepadSnapshotDataVersion) String() string {
	switch e {
	case MicroGamepadSnapshotDataVersion1:
		return "MicroGamepadSnapshotDataVersion1"
	default:
		return fmt.Sprintf("MicroGamepadSnapshotDataVersion(%d)", int64(e))
	}
}
...
// String returns the PhysicalInputSourceDirection constant's name, or its numeric form when the
// value is not a known constant.
func (e PhysicalInputSourceDirection) String() string {
	var parts []string
	if e&PhysicalInputSourceDirectionUp != 0 {
		parts = append(parts, "PhysicalInputSourceDirectionUp")
	}
	if e&PhysicalInputSourceDirectionRight != 0 {
		parts = append(parts, "PhysicalInputSourceDirectionRight")
	}
	if e&PhysicalInputSourceDirectionDown != 0 {
		parts = append(parts, "PhysicalInputSourceDirectionDown")
	}
	if e&PhysicalInputSourceDirectionLeft != 0 {
		parts = append(parts, "PhysicalInputSourceDirectionLeft")
	}
	if len(parts) == 0 {
		return "0"
	}
