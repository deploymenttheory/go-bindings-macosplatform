...
func (wtcc *WritingToolsCoordinatorContext) AttributedString() *foundation.AttributedString {
	defer runtime.KeepAlive(wtcc)
...
func (wtcc *WritingToolsCoordinatorContext) Identifier() *foundation.UUID {
	defer runtime.KeepAlive(wtcc)
