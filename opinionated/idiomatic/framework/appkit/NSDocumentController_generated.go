...
func DocumentControllerFromID(id objc.ID) *DocumentController {
	...
	x := &DocumentController{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func documentControllerAdopt(id objc.ID) *DocumentController {
	...
	x := &DocumentController{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
...
//
// WithAutosavingDelay sets autosavingDelay and returns the receiver so calls can be chained.
...
func (x *DocumentController) BeginOpenPanel(ctx context.Context) (obj.Object, error) {
	type _result struct {
		val obj.Object
		err error
	}
...
func (x *DocumentController) OpenDocumentWithContentsOfURLDisplayError(url string, displayDocument bool) (obj.Object, error) {
	var _nsErr uintptr
...
type DocumentControllerable interface {
	...
	OpenDocumentWithContentsOfURLDisplayError(url string, displayDocument bool) (obj.Object, error)
