...
func (x *ObjectController) ID() objc.ID { return x.inner.Ptr() }

// ObjectControllerFromID adopts an existing toll-free-bridged object id as a ObjectController (nil for 0).
