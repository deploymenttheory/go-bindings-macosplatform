...
func (pi *PrintInfo) WithPaperName(paperName obj.Object) *PrintInfo {
	defer runtime.KeepAlive(paperName)
...
func (pi *PrintInfo) WithJobDisposition(jobDisposition obj.Object) *PrintInfo {
	defer runtime.KeepAlive(jobDisposition)
...
func (pi *PrintInfo) TakeSettingsFromPDFInfo(inPDFInfo *PDFInfo) {
	defer runtime.KeepAlive(pi)
	defer runtime.KeepAlive(inPDFInfo)
...
func (pi *PrintInfo) PaperName() *foundation.String {
	defer runtime.KeepAlive(pi)
...
func (pi *PrintInfo) JobDisposition() *foundation.String {
	defer runtime.KeepAlive(pi)
