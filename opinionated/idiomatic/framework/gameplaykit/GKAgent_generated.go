...
func (x *Agent) ID() objc.ID { return x.inner.Ptr() }

// AgentFromID adopts an existing toll-free-bridged object id as a Agent (nil for 0).
func AgentFromID(id objc.ID) *Agent {
	if id == 0 {
		return nil
	}
	return &Agent{inner: raw.GKAgentFromID(id)}
}
