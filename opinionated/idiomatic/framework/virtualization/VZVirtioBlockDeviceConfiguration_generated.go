...
func (x *VirtioBlockDeviceConfiguration) ID() objc.ID { return x.inner.Ptr() }

// VirtioBlockDeviceConfigurationFromID adopts an existing toll-free-bridged object id as a VirtioBlockDeviceConfiguration (nil for 0).
