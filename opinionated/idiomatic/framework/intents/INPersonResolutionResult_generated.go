...
func PersonResolutionResultFromID(id objc.ID) *PersonResolutionResult {
	...
	x := &PersonResolutionResult{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func personResolutionResultAdopt(id objc.ID) *PersonResolutionResult {
	...
	x := &PersonResolutionResult{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}

// Description returns the object's -description text.
func (x *PersonResolutionResult) Description() string {
	return rt.Description(objref.IDOf(x))
}

// IsEqual reports Objective-C equality (isEqual:) with another object.
func (x *PersonResolutionResult) IsEqual(other obj.Object) bool {
	return rt.IsEqual(objref.IDOf(x), objref.IDOf(other))
}

// IsKind reports whether the object is an instance of the named class or a subclass.
func (x *PersonResolutionResult) IsKind(className string) bool {
...
func NewPersonResolutionResult() *PersonResolutionResult {
	_id := objc.Send[objc.ID](objc.ID(_class("INPersonResolutionResult")), objc.RegisterName("new"))
	return personResolutionResultAdopt(_id)
}
