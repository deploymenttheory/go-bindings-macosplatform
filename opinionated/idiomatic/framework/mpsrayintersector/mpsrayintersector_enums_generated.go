...
// String returns the IntersectionType constant's name, or its numeric form when the
// value is not a known constant.
func (e IntersectionType) String() string {
	switch e {
	case IntersectionTypeNearest:
		return "IntersectionTypeNearest"
	case IntersectionTypeAny:
		return "IntersectionTypeAny"
	default:
		return fmt.Sprintf("IntersectionType(%d)", int64(e))
	}
}
