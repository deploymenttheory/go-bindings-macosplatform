...
// PolygonType the type of polygon. Defaults to MPSPolygonTypeTriangle. Changes to this property require rebuilding the acceleration structure.
...
// SetPolygonType wraps the corresponding Objective-C method.
