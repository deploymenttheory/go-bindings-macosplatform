...
func (tas *TriangleAccelerationStructure) WithPolygonType(polygonType PolygonType) *TriangleAccelerationStructure {
	objc.Send[objc.ID](objref.IDOf(tas), objc.RegisterName("setPolygonType:"), polygonType)
	return tas
}
...
func (tas *TriangleAccelerationStructure) WithPolygonBuffers(items ...*PolygonBuffer) *TriangleAccelerationStructure {
...
func (tas *TriangleAccelerationStructure) WithUsage(usage AccelerationStructureUsage) *TriangleAccelerationStructure {
	objc.Send[objc.ID](objref.IDOf(tas), objc.RegisterName("setUsage:"), usage)
	return tas
}
