...
func (x *CNNFullyConnectedGradientNode) asCNNConvolutionGradientNode() *mpsneuralnetwork.MPSCNNConvolutionGradientNode {
	return &x.inner.MPSCNNConvolutionGradientNode
}

func (x *CNNFullyConnectedGradientNode) asNNGradientFilterNode() *mpsneuralnetwork.MPSNNGradientFilterNode {
	return &x.inner.MPSCNNConvolutionGradientNode.MPSNNGradientFilterNode
}

func (x *CNNFullyConnectedGradientNode) asNNFilterNode() *mpsneuralnetwork.MPSNNFilterNode {
