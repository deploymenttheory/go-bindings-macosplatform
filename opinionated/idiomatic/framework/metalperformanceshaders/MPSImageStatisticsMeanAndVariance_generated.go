...
func (ismav *ImageStatisticsMeanAndVariance) WithLabel(label string) *ImageStatisticsMeanAndVariance {
	objc.Send[objc.ID](objref.IDOf(ismav), objc.RegisterName("setLabel:"), purego.NSString(label))
	return ismav
}
