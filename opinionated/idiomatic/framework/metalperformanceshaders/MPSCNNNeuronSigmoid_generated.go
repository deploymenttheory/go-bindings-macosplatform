...
func CNNNeuronSigmoidFromID(id objc.ID) *CNNNeuronSigmoid {
	...
	x := &CNNNeuronSigmoid{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func cNNNeuronSigmoidAdopt(id objc.ID) *CNNNeuronSigmoid {
	...
	x := &CNNNeuronSigmoid{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}

// Description returns the object's -description text.
func (x *CNNNeuronSigmoid) Description() string {
	return rt.Description(objref.IDOf(x))
}

// IsEqual reports Objective-C equality (isEqual:) with another object.
func (x *CNNNeuronSigmoid) IsEqual(other obj.Object) bool {
	return rt.IsEqual(objref.IDOf(x), objref.IDOf(other))
}

// IsKind reports whether the object is an instance of the named class or a subclass.
func (x *CNNNeuronSigmoid) IsKind(className string) bool {
