...
// CNNNeuronSigmoid is an idiomatic wrapper over the Objective-C class MPSCNNNeuronSigmoid.
//
...
// CNNNeuronSigmoidFromID adopts an existing Objective-C object as a CNNNeuronSigmoid
...
// cNNNeuronSigmoidAdopt wraps an Objective-C object that this code just created as a
// CNNNeuronSigmoid (nil for 0). The caller already owns the object's reference,
// so this does not add another; it only arranges for the object to be released
// once Go stops using it. Constructors use it.
func cNNNeuronSigmoidAdopt(id objc.ID) *CNNNeuronSigmoid {
	if id == 0 {
		return nil
	}
	x := &CNNNeuronSigmoid{}
...
// NewCNNNeuronSigmoid creates a new CNNNeuronSigmoid.
func NewCNNNeuronSigmoid() *CNNNeuronSigmoid {
	_id := objc.Send[objc.ID](objc.ID(_class("MPSCNNNeuronSigmoid")), objc.RegisterName("new"))
	return cNNNeuronSigmoidAdopt(_id)
}

// WithOffset sets the position of the destination image’s clip rectangle origin, relative to the source image.
func (cns *CNNNeuronSigmoid) WithOffset(offset mpscore.MPSOffset) *CNNNeuronSigmoid {
	objc.Send[objc.ID](objref.IDOf(cns), objc.RegisterName("setOffset:"), offset)
	return cns
}
...
func (cns *CNNNeuronSigmoid) WithClipRect(clipRect metal.MTLRegion) *CNNNeuronSigmoid {
	objc.Send[objc.ID](objref.IDOf(cns), objc.RegisterName("setClipRect:"), clipRect)
	return cns
}
...
func (cns *CNNNeuronSigmoid) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNNeuronSigmoid {
	objc.Send[objc.ID](objref.IDOf(cns), objc.RegisterName("setDestinationFeatureChannelOffset:"), destinationFeatureChannelOffset)
	return cns
}
...
func (cns *CNNNeuronSigmoid) WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *CNNNeuronSigmoid {
	objc.Send[objc.ID](objref.IDOf(cns), objc.RegisterName("setSourceFeatureChannelOffset:"), sourceFeatureChannelOffset)
	return cns
}
...
func (cns *CNNNeuronSigmoid) WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *CNNNeuronSigmoid {
	objc.Send[objc.ID](objref.IDOf(cns), objc.RegisterName("setSourceFeatureChannelMaxCount:"), sourceFeatureChannelMaxCount)
	return cns
}

// WithLabel sets the string that identifies the kernel.
func (cns *CNNNeuronSigmoid) WithLabel(label string) *CNNNeuronSigmoid {
	objc.Send[objc.ID](objref.IDOf(cns), objc.RegisterName("setLabel:"), purego.NSString(label))
	return cns
}

var _ CNNNeuronProvider = (*CNNNeuronSigmoid)(nil)

var _ CNNKernelProvider = (*CNNNeuronSigmoid)(nil)

var _ KernelProvider = (*CNNNeuronSigmoid)(nil)
