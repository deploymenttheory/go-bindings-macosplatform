...
func (x *CNNNeuronSigmoid) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNNeuronSigmoid {
...
func (x *CNNNeuronSigmoid) WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *CNNNeuronSigmoid {
...
func (x *CNNNeuronSigmoid) WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *CNNNeuronSigmoid {
...
type CNNNeuronSigmoidable interface {
	...
	WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNNeuronSigmoid
	WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *CNNNeuronSigmoid
	WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *CNNNeuronSigmoid
