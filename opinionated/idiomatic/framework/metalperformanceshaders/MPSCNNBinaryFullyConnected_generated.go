...
func (cbfc *CNNBinaryFullyConnected) WithOffset(offset mpscore.MPSOffset) *CNNBinaryFullyConnected {
	objc.Send[objc.ID](objref.IDOf(cbfc), objc.RegisterName("setOffset:"), offset)
	return cbfc
}
...
func (cbfc *CNNBinaryFullyConnected) WithClipRect(clipRect metal.MTLRegion) *CNNBinaryFullyConnected {
	objc.Send[objc.ID](objref.IDOf(cbfc), objc.RegisterName("setClipRect:"), clipRect)
	return cbfc
}
...
func (cbfc *CNNBinaryFullyConnected) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNBinaryFullyConnected {
	objc.Send[objc.ID](objref.IDOf(cbfc), objc.RegisterName("setDestinationFeatureChannelOffset:"), destinationFeatureChannelOffset)
	return cbfc
}
...
func (cbfc *CNNBinaryFullyConnected) WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *CNNBinaryFullyConnected {
	objc.Send[objc.ID](objref.IDOf(cbfc), objc.RegisterName("setSourceFeatureChannelOffset:"), sourceFeatureChannelOffset)
	return cbfc
}
...
func (cbfc *CNNBinaryFullyConnected) WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *CNNBinaryFullyConnected {
	objc.Send[objc.ID](objref.IDOf(cbfc), objc.RegisterName("setSourceFeatureChannelMaxCount:"), sourceFeatureChannelMaxCount)
	return cbfc
}

// WithLabel sets the string that identifies the kernel.
func (cbfc *CNNBinaryFullyConnected) WithLabel(label string) *CNNBinaryFullyConnected {
	objc.Send[objc.ID](objref.IDOf(cbfc), objc.RegisterName("setLabel:"), purego.NSString(label))
	return cbfc
}
