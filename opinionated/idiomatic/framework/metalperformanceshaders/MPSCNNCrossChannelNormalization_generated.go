...
func (cccn *CNNCrossChannelNormalization) WithLabel(label string) *CNNCrossChannelNormalization {
	objc.Send[objc.ID](objref.IDOf(cccn), objc.RegisterName("setLabel:"), purego.NSString(label))
	return cccn
}
