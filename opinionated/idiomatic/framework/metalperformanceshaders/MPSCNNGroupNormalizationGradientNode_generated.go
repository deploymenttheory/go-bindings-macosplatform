...
func (x *CNNGroupNormalizationGradientNode) asNNGradientFilterNode() *mpsneuralnetwork.MPSNNGradientFilterNode {
	return &x.inner.MPSNNGradientFilterNode
}

func (x *CNNGroupNormalizationGradientNode) asNNFilterNode() *mpsneuralnetwork.MPSNNFilterNode {
