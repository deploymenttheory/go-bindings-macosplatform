...
// CNNNeuronLinear is an idiomatic wrapper over the Objective-C class MPSCNNNeuronLinear.
//
...
// CNNNeuronLinearFromID adopts an existing Objective-C object as a CNNNeuronLinear
...
// cNNNeuronLinearAdopt wraps an Objective-C object that this code just created as a
// CNNNeuronLinear (nil for 0). The caller already owns the object's reference,
// so this does not add another; it only arranges for the object to be released
// once Go stops using it. Constructors use it.
func cNNNeuronLinearAdopt(id objc.ID) *CNNNeuronLinear {
	if id == 0 {
		return nil
	}
	x := &CNNNeuronLinear{}
...
// NewCNNNeuronLinear creates a new CNNNeuronLinear.
func NewCNNNeuronLinear() *CNNNeuronLinear {
	_id := objc.Send[objc.ID](objc.ID(_class("MPSCNNNeuronLinear")), objc.RegisterName("new"))
	return cNNNeuronLinearAdopt(_id)
}

// WithOffset sets the position of the destination image’s clip rectangle origin, relative to the source image.
func (cnl *CNNNeuronLinear) WithOffset(offset mpscore.MPSOffset) *CNNNeuronLinear {
...
func (cnl *CNNNeuronLinear) WithClipRect(clipRect metal.MTLRegion) *CNNNeuronLinear {
...
func (cnl *CNNNeuronLinear) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNNeuronLinear {
...
func (cnl *CNNNeuronLinear) WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *CNNNeuronLinear {
...
func (cnl *CNNNeuronLinear) WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *CNNNeuronLinear {
...
func (cnl *CNNNeuronLinear) WithLabel(label string) *CNNNeuronLinear {
	objc.Send[objc.ID](objref.IDOf(cnl), objc.RegisterName("setLabel:"), purego.NSString(label))
	return cnl
}

var _ CNNNeuronProvider = (*CNNNeuronLinear)(nil)

var _ CNNKernelProvider = (*CNNNeuronLinear)(nil)

var _ KernelProvider = (*CNNNeuronLinear)(nil)
