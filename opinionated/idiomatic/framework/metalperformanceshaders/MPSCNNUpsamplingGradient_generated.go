...
func (x *CNNUpsamplingGradient) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNUpsamplingGradient {
...
func (x *CNNUpsamplingGradient) WithPrimarySourceFeatureChannelOffset(primarySourceFeatureChannelOffset int) *CNNUpsamplingGradient {
...
func (x *CNNUpsamplingGradient) WithSecondarySourceFeatureChannelOffset(secondarySourceFeatureChannelOffset int) *CNNUpsamplingGradient {
...
func (x *CNNUpsamplingGradient) WithPrimarySourceFeatureChannelMaxCount(primarySourceFeatureChannelMaxCount int) *CNNUpsamplingGradient {
...
func (x *CNNUpsamplingGradient) WithSecondarySourceFeatureChannelMaxCount(secondarySourceFeatureChannelMaxCount int) *CNNUpsamplingGradient {
...
func (x *CNNUpsamplingGradient) WithPrimaryStrideInPixelsX(primaryStrideInPixelsX int) *CNNUpsamplingGradient {
...
func (x *CNNUpsamplingGradient) WithPrimaryStrideInPixelsY(primaryStrideInPixelsY int) *CNNUpsamplingGradient {
...
func (x *CNNUpsamplingGradient) WithSecondaryStrideInPixelsX(secondaryStrideInPixelsX int) *CNNUpsamplingGradient {
...
func (x *CNNUpsamplingGradient) WithSecondaryStrideInPixelsY(secondaryStrideInPixelsY int) *CNNUpsamplingGradient {
...
// ScaleFactorX the downsampling scale factor for the x dimension. The default value is 1.
func (x *CNNUpsamplingGradient) ScaleFactorX() float64 {
	_r := objc.Send[float64](objref.IDOf(x), objc.RegisterName("scaleFactorX"))
	return _r
}

// ScaleFactorY the downsampling scale factor for the y dimension. The default value is 1.
...
type CNNUpsamplingGradientable interface {
	...
	WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNUpsamplingGradient
	WithPrimarySourceFeatureChannelOffset(primarySourceFeatureChannelOffset int) *CNNUpsamplingGradient
	WithSecondarySourceFeatureChannelOffset(secondarySourceFeatureChannelOffset int) *CNNUpsamplingGradient
	WithPrimarySourceFeatureChannelMaxCount(primarySourceFeatureChannelMaxCount int) *CNNUpsamplingGradient
	WithSecondarySourceFeatureChannelMaxCount(secondarySourceFeatureChannelMaxCount int) *CNNUpsamplingGradient
	WithPrimaryStrideInPixelsX(primaryStrideInPixelsX int) *CNNUpsamplingGradient
	WithPrimaryStrideInPixelsY(primaryStrideInPixelsY int) *CNNUpsamplingGradient
	WithSecondaryStrideInPixelsX(secondaryStrideInPixelsX int) *CNNUpsamplingGradient
	WithSecondaryStrideInPixelsY(secondaryStrideInPixelsY int) *CNNUpsamplingGradient
...
func (x *CNNUpsamplingGradient) isCNNUpsamplingGradient() {}
