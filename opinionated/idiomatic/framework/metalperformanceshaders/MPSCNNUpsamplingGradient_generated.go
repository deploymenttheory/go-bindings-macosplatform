...
func CNNUpsamplingGradientFromID(id objc.ID) *CNNUpsamplingGradient {
	...
	x := &CNNUpsamplingGradient{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func cNNUpsamplingGradientAdopt(id objc.ID) *CNNUpsamplingGradient {
	...
	x := &CNNUpsamplingGradient{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}

// Description returns the object's -description text.
func (x *CNNUpsamplingGradient) Description() string {
	return rt.Description(objref.IDOf(x))
}

// IsEqual reports Objective-C equality (isEqual:) with another object.
func (x *CNNUpsamplingGradient) IsEqual(other obj.Object) bool {
	return rt.IsEqual(objref.IDOf(x), objref.IDOf(other))
}

// IsKind reports whether the object is an instance of the named class or a subclass.
func (x *CNNUpsamplingGradient) IsKind(className string) bool {
	return rt.IsKind(objref.IDOf(x), className)
}

// NewCNNUpsamplingGradient creates a new CNNUpsamplingGradient.
func NewCNNUpsamplingGradient() *CNNUpsamplingGradient {
	_id := objc.Send[objc.ID](objc.ID(_class("MPSCNNUpsamplingGradient")), objc.RegisterName("new"))
	return cNNUpsamplingGradientAdopt(_id)
}
