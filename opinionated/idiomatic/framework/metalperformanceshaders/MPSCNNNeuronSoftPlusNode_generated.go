...
func (x *CNNNeuronSoftPlusNode) asCNNNeuronNode() *mpsneuralnetwork.MPSCNNNeuronNode {
	return &x.inner.MPSCNNNeuronNode
}

func (x *CNNNeuronSoftPlusNode) asNNFilterNode() *mpsneuralnetwork.MPSNNFilterNode {
