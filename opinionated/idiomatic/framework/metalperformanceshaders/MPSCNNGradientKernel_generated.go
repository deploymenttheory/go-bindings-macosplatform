...
func CNNGradientKernelFromID(id objc.ID) *CNNGradientKernel {
	...
	x := &CNNGradientKernel{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func cNNGradientKernelAdopt(id objc.ID) *CNNGradientKernel {
	...
	x := &CNNGradientKernel{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}

// Description returns the object's -description text.
func (x *CNNGradientKernel) Description() string {
	return rt.Description(objref.IDOf(x))
}

// IsEqual reports Objective-C equality (isEqual:) with another object.
func (x *CNNGradientKernel) IsEqual(other obj.Object) bool {
	return rt.IsEqual(objref.IDOf(x), objref.IDOf(other))
}

// IsKind reports whether the object is an instance of the named class or a subclass.
func (x *CNNGradientKernel) IsKind(className string) bool {
	return rt.IsKind(objref.IDOf(x), className)
}

// NewCNNGradientKernel creates a new CNNGradientKernel.
func NewCNNGradientKernel() *CNNGradientKernel {
	_id := objc.Send[objc.ID](objc.ID(_class("MPSCNNGradientKernel")), objc.RegisterName("new"))
	return cNNGradientKernelAdopt(_id)
}
