...
func (x *Image) SubImageWithFeatureChannelRange(range_ foundation.NSRange) obj.Object {
...
func (x *Image) Parent() obj.Object {
...
type Imageable interface {
	...
	SubImageWithFeatureChannelRange(range_ foundation.NSRange) obj.Object
	ResourceSize() int
	Width() int
	Height() int
	FeatureChannels() int
