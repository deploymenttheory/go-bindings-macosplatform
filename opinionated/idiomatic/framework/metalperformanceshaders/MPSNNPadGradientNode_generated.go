...
func (x *NNPadGradientNode) asNNGradientFilterNode() *mpsneuralnetwork.MPSNNGradientFilterNode {
	return &x.inner.MPSNNGradientFilterNode
}

func (x *NNPadGradientNode) asNNFilterNode() *mpsneuralnetwork.MPSNNFilterNode {
