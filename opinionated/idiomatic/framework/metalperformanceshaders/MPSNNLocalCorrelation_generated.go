...
func (nlc *NNLocalCorrelation) WithLabel(label string) *NNLocalCorrelation {
	objc.Send[objc.ID](objref.IDOf(nlc), objc.RegisterName("setLabel:"), purego.NSString(label))
	return nlc
}
