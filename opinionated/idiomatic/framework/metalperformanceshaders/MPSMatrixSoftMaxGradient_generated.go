...
func (msmg *MatrixSoftMaxGradient) WithLabel(label string) *MatrixSoftMaxGradient {
	objc.Send[objc.ID](objref.IDOf(msmg), objc.RegisterName("setLabel:"), purego.NSString(label))
	return msmg
}
