...
func (x *NNReductionFeatureChannelsArgumentMaxNode) asNNUnaryReductionNode() *mpsneuralnetwork.MPSNNUnaryReductionNode {
	return &x.inner.MPSNNUnaryReductionNode
}

func (x *NNReductionFeatureChannelsArgumentMaxNode) asNNFilterNode() *mpsneuralnetwork.MPSNNFilterNode {
