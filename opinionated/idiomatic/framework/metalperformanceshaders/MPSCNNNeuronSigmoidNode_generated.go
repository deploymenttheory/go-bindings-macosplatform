...
func (x *CNNNeuronSigmoidNode) asCNNNeuronNode() *mpsneuralnetwork.MPSCNNNeuronNode {
	return &x.inner.MPSCNNNeuronNode
}

func (x *CNNNeuronSigmoidNode) asNNFilterNode() *mpsneuralnetwork.MPSNNFilterNode {
