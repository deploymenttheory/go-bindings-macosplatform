...
func (x *CNNNeuronReLU) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNNeuronReLU {
...
func (x *CNNNeuronReLU) WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *CNNNeuronReLU {
...
func (x *CNNNeuronReLU) WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *CNNNeuronReLU {
...
type CNNNeuronReLUable interface {
	...
	WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNNeuronReLU
	WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *CNNNeuronReLU
	WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *CNNNeuronReLU
