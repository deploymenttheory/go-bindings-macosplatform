...
func NNReduceColumnMinFromID(id objc.ID) *NNReduceColumnMin {
	...
	x := &NNReduceColumnMin{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func nNReduceColumnMinAdopt(id objc.ID) *NNReduceColumnMin {
	...
	x := &NNReduceColumnMin{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}

// Description returns the object's -description text.
func (x *NNReduceColumnMin) Description() string {
	return rt.Description(objref.IDOf(x))
}

// IsEqual reports Objective-C equality (isEqual:) with another object.
func (x *NNReduceColumnMin) IsEqual(other obj.Object) bool {
	return rt.IsEqual(objref.IDOf(x), objref.IDOf(other))
}

// IsKind reports whether the object is an instance of the named class or a subclass.
func (x *NNReduceColumnMin) IsKind(className string) bool {
...
func (x *NNReduceColumnMin) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *NNReduceColumnMin {
...
func (x *NNReduceColumnMin) WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *NNReduceColumnMin {
...
func (x *NNReduceColumnMin) WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *NNReduceColumnMin {
...
type NNReduceColumnMinable interface {
	obj.Object
	WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *NNReduceColumnMin
	WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *NNReduceColumnMin
	WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *NNReduceColumnMin
