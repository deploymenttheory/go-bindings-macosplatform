...
// ImageNormalizedHistogramFromID adopts an existing toll-free-bridged object id as a ImageNormalizedHistogram (nil for 0).
...
func (x *ImageNormalizedHistogram) HistogramInfo() mpsimage.MPSImageHistogramInfo {
