...
func (x *NNConcatenationGradientNode) asNNGradientFilterNode() *mpsneuralnetwork.MPSNNGradientFilterNode {
	return &x.inner.MPSNNGradientFilterNode
}

func (x *NNConcatenationGradientNode) asNNFilterNode() *mpsneuralnetwork.MPSNNFilterNode {
