...
func (cnprl *CNNNeuronPReLU) WithLabel(label string) *CNNNeuronPReLU {
	objc.Send[objc.ID](objref.IDOf(cnprl), objc.RegisterName("setLabel:"), purego.NSString(label))
	return cnprl
}
...
var _ KernelProvider = (*CNNNeuronPReLU)(nil)
