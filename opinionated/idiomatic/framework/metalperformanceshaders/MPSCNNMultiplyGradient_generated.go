...
func (cmg *CNNMultiplyGradient) WithLabel(label string) *CNNMultiplyGradient {
	objc.Send[objc.ID](objref.IDOf(cmg), objc.RegisterName("setLabel:"), purego.NSString(label))
	return cmg
}
...
var _ KernelProvider = (*CNNMultiplyGradient)(nil)
