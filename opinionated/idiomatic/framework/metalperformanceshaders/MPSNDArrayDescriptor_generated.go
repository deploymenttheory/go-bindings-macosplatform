...
func (x *NDArrayDescriptor) SliceRangeForDimension(dimensionIndex int) mpscore.MPSDimensionSlice {
	_r := objc.Send[mpscore.MPSDimensionSlice](objref.IDOf(x), objc.RegisterName("sliceRangeForDimension:"), dimensionIndex)
	return _r
}

// SliceDimensionWithSubrange the slice dimensions for each dimension
func (x *NDArrayDescriptor) SliceDimensionWithSubrange(dimensionIndex int, subRange mpscore.MPSDimensionSlice) {
	objc.Send[objc.ID](objref.IDOf(x), objc.RegisterName("sliceDimension:withSubrange:"), dimensionIndex, subRange)
}
...
type NDArrayDescriptorable interface {
	...
	SliceRangeForDimension(dimensionIndex int) mpscore.MPSDimensionSlice
	SliceDimensionWithSubrange(dimensionIndex int, subRange mpscore.MPSDimensionSlice)
