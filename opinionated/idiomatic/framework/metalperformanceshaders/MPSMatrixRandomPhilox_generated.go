...
func (mrp *MatrixRandomPhilox) WithLabel(label string) *MatrixRandomPhilox {
	objc.Send[objc.ID](objref.IDOf(mrp), objc.RegisterName("setLabel:"), purego.NSString(label))
	return mrp
}
