...
// NNReduceColumnMax is an idiomatic wrapper over the Objective-C class MPSNNReduceColumnMax.
//
...
// NNReduceColumnMaxFromID adopts an existing Objective-C object as a NNReduceColumnMax
...
// nNReduceColumnMaxAdopt wraps an Objective-C object that this code just created as a
// NNReduceColumnMax (nil for 0). The caller already owns the object's reference,
// so this does not add another; it only arranges for the object to be released
// once Go stops using it. Constructors use it.
func nNReduceColumnMaxAdopt(id objc.ID) *NNReduceColumnMax {
	if id == 0 {
		return nil
	}
	x := &NNReduceColumnMax{}
...
// NewNNReduceColumnMax creates a new NNReduceColumnMax.
func NewNNReduceColumnMax() *NNReduceColumnMax {
	_id := objc.Send[objc.ID](objc.ID(_class("MPSNNReduceColumnMax")), objc.RegisterName("new"))
	return nNReduceColumnMaxAdopt(_id)
}
...
func (nrcm *NNReduceColumnMax) WithClipRectSource(clipRectSource metal.MTLRegion) *NNReduceColumnMax {
...
func (nrcm *NNReduceColumnMax) WithOffset(offset mpscore.MPSOffset) *NNReduceColumnMax {
...
func (nrcm *NNReduceColumnMax) WithClipRect(clipRect metal.MTLRegion) *NNReduceColumnMax {
...
func (nrcm *NNReduceColumnMax) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *NNReduceColumnMax {
...
func (nrcm *NNReduceColumnMax) WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *NNReduceColumnMax {
...
func (nrcm *NNReduceColumnMax) WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *NNReduceColumnMax {
...
func (nrcm *NNReduceColumnMax) WithLabel(label string) *NNReduceColumnMax {
	objc.Send[objc.ID](objref.IDOf(nrcm), objc.RegisterName("setLabel:"), purego.NSString(label))
	return nrcm
}

var _ NNReduceUnaryProvider = (*NNReduceColumnMax)(nil)

var _ CNNKernelProvider = (*NNReduceColumnMax)(nil)

var _ KernelProvider = (*NNReduceColumnMax)(nil)
