...
func (cung *CNNUpsamplingNearestGradient) WithLabel(label string) *CNNUpsamplingNearestGradient {
	objc.Send[objc.ID](objref.IDOf(cung), objc.RegisterName("setLabel:"), purego.NSString(label))
	return cung
}
...
var _ KernelProvider = (*CNNUpsamplingNearestGradient)(nil)
