...
func (x *NNArithmeticGradientNode) WithPaddingPolicy(paddingPolicy mpsneuralnetwork.MPSNNPadding) *NNArithmeticGradientNode {
...
type NNArithmeticGradientNodeable interface {
	...
	WithPaddingPolicy(paddingPolicy mpsneuralnetwork.MPSNNPadding) *NNArithmeticGradientNode
