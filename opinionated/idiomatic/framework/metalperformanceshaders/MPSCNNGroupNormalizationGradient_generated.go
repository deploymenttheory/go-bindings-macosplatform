...
func (cgng *CNNGroupNormalizationGradient) WithLabel(label string) *CNNGroupNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(cgng), objc.RegisterName("setLabel:"), purego.NSString(label))
	return cgng
}
...
var _ KernelProvider = (*CNNGroupNormalizationGradient)(nil)
