...
// CNNBatchNormalizationStatisticsGradient is an idiomatic wrapper over the Objective-C class MPSCNNBatchNormalizationStatisticsGradient.
//
...
// CNNBatchNormalizationStatisticsGradientFromID adopts an existing Objective-C object as a CNNBatchNormalizationStatisticsGradient
// (nil for 0), retaining it and registering a release finalizer.
func CNNBatchNormalizationStatisticsGradientFromID(id objc.ID) *CNNBatchNormalizationStatisticsGradient {
	if id == 0 {
		return nil
	}
	x := &CNNBatchNormalizationStatisticsGradient{}
	x.Handle = objref.Wrap(purego.Retain(id))
	objref.Track(x)
	return x
}

// cNNBatchNormalizationStatisticsGradientAdopt wraps an Objective-C object that this code just created as a
// CNNBatchNormalizationStatisticsGradient (nil for 0). The caller already owns the object's reference,
// so this does not add another; it only arranges for the object to be released
// once Go stops using it. Constructors use it.
func cNNBatchNormalizationStatisticsGradientAdopt(id objc.ID) *CNNBatchNormalizationStatisticsGradient {
	if id == 0 {
		return nil
	}
	x := &CNNBatchNormalizationStatisticsGradient{}
...
// NewCNNBatchNormalizationStatisticsGradient creates a new CNNBatchNormalizationStatisticsGradient.
func NewCNNBatchNormalizationStatisticsGradient() *CNNBatchNormalizationStatisticsGradient {
	_id := objc.Send[objc.ID](objc.ID(_class("MPSCNNBatchNormalizationStatisticsGradient")), objc.RegisterName("new"))
	return cNNBatchNormalizationStatisticsGradientAdopt(_id)
}
...
func (cbnsg *CNNBatchNormalizationStatisticsGradient) WithKernelOffsetX(kernelOffsetX int) *CNNBatchNormalizationStatisticsGradient {
	objc.Send[objc.ID](objref.IDOf(cbnsg), objc.RegisterName("setKernelOffsetX:"), kernelOffsetX)
	return cbnsg
}
...
func (cbnsg *CNNBatchNormalizationStatisticsGradient) WithKernelOffsetY(kernelOffsetY int) *CNNBatchNormalizationStatisticsGradient {
	objc.Send[objc.ID](objref.IDOf(cbnsg), objc.RegisterName("setKernelOffsetY:"), kernelOffsetY)
	return cbnsg
}
...
func (cbnsg *CNNBatchNormalizationStatisticsGradient) WithPrimaryOffset(primaryOffset mpscore.MPSOffset) *CNNBatchNormalizationStatisticsGradient {
	objc.Send[objc.ID](objref.IDOf(cbnsg), objc.RegisterName("setPrimaryOffset:"), primaryOffset)
	return cbnsg
}
...
func (cbnsg *CNNBatchNormalizationStatisticsGradient) WithSecondaryOffset(secondaryOffset mpscore.MPSOffset) *CNNBatchNormalizationStatisticsGradient {
	objc.Send[objc.ID](objref.IDOf(cbnsg), objc.RegisterName("setSecondaryOffset:"), secondaryOffset)
	return cbnsg
}
...
func (cbnsg *CNNBatchNormalizationStatisticsGradient) WithClipRect(clipRect metal.MTLRegion) *CNNBatchNormalizationStatisticsGradient {
	objc.Send[objc.ID](objref.IDOf(cbnsg), objc.RegisterName("setClipRect:"), clipRect)
	return cbnsg
}
...
func (cbnsg *CNNBatchNormalizationStatisticsGradient) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNBatchNormalizationStatisticsGradient {
	objc.Send[objc.ID](objref.IDOf(cbnsg), objc.RegisterName("setDestinationFeatureChannelOffset:"), destinationFeatureChannelOffset)
	return cbnsg
}
...
func (cbnsg *CNNBatchNormalizationStatisticsGradient) WithPrimarySourceFeatureChannelOffset(primarySourceFeatureChannelOffset int) *CNNBatchNormalizationStatisticsGradient {
	objc.Send[objc.ID](objref.IDOf(cbnsg), objc.RegisterName("setPrimarySourceFeatureChannelOffset:"), primarySourceFeatureChannelOffset)
	return cbnsg
}
...
func (cbnsg *CNNBatchNormalizationStatisticsGradient) WithSecondarySourceFeatureChannelOffset(secondarySourceFeatureChannelOffset int) *CNNBatchNormalizationStatisticsGradient {
	objc.Send[objc.ID](objref.IDOf(cbnsg), objc.RegisterName("setSecondarySourceFeatureChannelOffset:"), secondarySourceFeatureChannelOffset)
	return cbnsg
}
...
func (cbnsg *CNNBatchNormalizationStatisticsGradient) WithPrimarySourceFeatureChannelMaxCount(primarySourceFeatureChannelMaxCount int) *CNNBatchNormalizationStatisticsGradient {
	objc.Send[objc.ID](objref.IDOf(cbnsg), objc.RegisterName("setPrimarySourceFeatureChannelMaxCount:"), primarySourceFeatureChannelMaxCount)
	return cbnsg
}
...
func (cbnsg *CNNBatchNormalizationStatisticsGradient) WithSecondarySourceFeatureChannelMaxCount(secondarySourceFeatureChannelMaxCount int) *CNNBatchNormalizationStatisticsGradient {
	objc.Send[objc.ID](objref.IDOf(cbnsg), objc.RegisterName("setSecondarySourceFeatureChannelMaxCount:"), secondarySourceFeatureChannelMaxCount)
	return cbnsg
}
...
func (cbnsg *CNNBatchNormalizationStatisticsGradient) WithPrimaryStrideInPixelsX(primaryStrideInPixelsX int) *CNNBatchNormalizationStatisticsGradient {
	objc.Send[objc.ID](objref.IDOf(cbnsg), objc.RegisterName("setPrimaryStrideInPixelsX:"), primaryStrideInPixelsX)
	return cbnsg
}
...
func (cbnsg *CNNBatchNormalizationStatisticsGradient) WithPrimaryStrideInPixelsY(primaryStrideInPixelsY int) *CNNBatchNormalizationStatisticsGradient {
	objc.Send[objc.ID](objref.IDOf(cbnsg), objc.RegisterName("setPrimaryStrideInPixelsY:"), primaryStrideInPixelsY)
	return cbnsg
}
...
func (cbnsg *CNNBatchNormalizationStatisticsGradient) WithSecondaryStrideInPixelsX(secondaryStrideInPixelsX int) *CNNBatchNormalizationStatisticsGradient {
	objc.Send[objc.ID](objref.IDOf(cbnsg), objc.RegisterName("setSecondaryStrideInPixelsX:"), secondaryStrideInPixelsX)
	return cbnsg
}
...
func (cbnsg *CNNBatchNormalizationStatisticsGradient) WithSecondaryStrideInPixelsY(secondaryStrideInPixelsY int) *CNNBatchNormalizationStatisticsGradient {
	objc.Send[objc.ID](objref.IDOf(cbnsg), objc.RegisterName("setSecondaryStrideInPixelsY:"), secondaryStrideInPixelsY)
	return cbnsg
}

// WithLabel sets the string that identifies the kernel.
func (cbnsg *CNNBatchNormalizationStatisticsGradient) WithLabel(label string) *CNNBatchNormalizationStatisticsGradient {
	objc.Send[objc.ID](objref.IDOf(cbnsg), objc.RegisterName("setLabel:"), purego.NSString(label))
	return cbnsg
}

var _ CNNGradientKernelProvider = (*CNNBatchNormalizationStatisticsGradient)(nil)

var _ CNNBinaryKernelProvider = (*CNNBatchNormalizationStatisticsGradient)(nil)

var _ KernelProvider = (*CNNBatchNormalizationStatisticsGradient)(nil)
