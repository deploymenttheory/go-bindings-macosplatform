...
func (mlsmg *MatrixLogSoftMaxGradient) WithLabel(label string) *MatrixLogSoftMaxGradient {
	objc.Send[objc.ID](objref.IDOf(mlsmg), objc.RegisterName("setLabel:"), purego.NSString(label))
	return mlsmg
}
...
var _ KernelProvider = (*MatrixLogSoftMaxGradient)(nil)
