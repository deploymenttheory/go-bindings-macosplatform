...
func CNNPoolingFromID(id objc.ID) *CNNPooling {
	...
	x := &CNNPooling{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func cNNPoolingAdopt(id objc.ID) *CNNPooling {
	...
	x := &CNNPooling{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}

// Description returns the object's -description text.
func (x *CNNPooling) Description() string {
	return rt.Description(objref.IDOf(x))
}

// IsEqual reports Objective-C equality (isEqual:) with another object.
func (x *CNNPooling) IsEqual(other obj.Object) bool {
	return rt.IsEqual(objref.IDOf(x), objref.IDOf(other))
}

// IsKind reports whether the object is an instance of the named class or a subclass.
func (x *CNNPooling) IsKind(className string) bool {
	return rt.IsKind(objref.IDOf(x), className)
}

// NewCNNPooling creates a new CNNPooling.
func NewCNNPooling() *CNNPooling {
	_id := objc.Send[objc.ID](objc.ID(_class("MPSCNNPooling")), objc.RegisterName("new"))
	return cNNPoolingAdopt(_id)
}
