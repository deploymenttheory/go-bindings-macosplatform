...
func (x *CNNPooling) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNPooling {
...
func (x *CNNPooling) WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *CNNPooling {
...
func (x *CNNPooling) WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *CNNPooling {
...
type CNNPoolingable interface {
	...
	WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNPooling
	WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *CNNPooling
	WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *CNNPooling
...
func (x *CNNPooling) isCNNPooling() {}
