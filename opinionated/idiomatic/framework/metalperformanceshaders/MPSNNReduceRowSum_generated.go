...
func (nrrs *NNReduceRowSum) WithLabel(label string) *NNReduceRowSum {
	objc.Send[objc.ID](objref.IDOf(nrrs), objc.RegisterName("setLabel:"), purego.NSString(label))
	return nrrs
}
...
var _ KernelProvider = (*NNReduceRowSum)(nil)
