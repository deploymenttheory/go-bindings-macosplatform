...
func (csng *CNNSpatialNormalizationGradient) WithLabel(label string) *CNNSpatialNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(csng), objc.RegisterName("setLabel:"), purego.NSString(label))
	return csng
}
...
var _ KernelProvider = (*CNNSpatialNormalizationGradient)(nil)
