...
func (x *NNLossGradient) WithPadding(padding mpsneuralnetwork.MPSNNPadding) *NNLossGradient {
...
type NNLossGradientable interface {
	...
	WithPadding(padding mpsneuralnetwork.MPSNNPadding) *NNLossGradient
	WithDestinationImageAllocator(destinationImageAllocator mpscore.MPSImageAllocator) *NNLossGradient
	WithOptions(options mpscore.MPSKernelOptions) *NNLossGradient
