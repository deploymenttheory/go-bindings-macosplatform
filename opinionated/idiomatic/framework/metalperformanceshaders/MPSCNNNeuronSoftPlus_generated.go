...
func (cnsp *CNNNeuronSoftPlus) WithOffset(offset mpscore.MPSOffset) *CNNNeuronSoftPlus {
	objc.Send[objc.ID](objref.IDOf(cnsp), objc.RegisterName("setOffset:"), offset)
	return cnsp
}
...
func (cnsp *CNNNeuronSoftPlus) WithClipRect(clipRect metal.MTLRegion) *CNNNeuronSoftPlus {
	objc.Send[objc.ID](objref.IDOf(cnsp), objc.RegisterName("setClipRect:"), clipRect)
	return cnsp
}
...
func (cnsp *CNNNeuronSoftPlus) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNNeuronSoftPlus {
	objc.Send[objc.ID](objref.IDOf(cnsp), objc.RegisterName("setDestinationFeatureChannelOffset:"), destinationFeatureChannelOffset)
	return cnsp
}
...
func (cnsp *CNNNeuronSoftPlus) WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *CNNNeuronSoftPlus {
	objc.Send[objc.ID](objref.IDOf(cnsp), objc.RegisterName("setSourceFeatureChannelOffset:"), sourceFeatureChannelOffset)
	return cnsp
}
...
func (cnsp *CNNNeuronSoftPlus) WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *CNNNeuronSoftPlus {
	objc.Send[objc.ID](objref.IDOf(cnsp), objc.RegisterName("setSourceFeatureChannelMaxCount:"), sourceFeatureChannelMaxCount)
	return cnsp
}

// WithLabel sets the string that identifies the kernel.
func (cnsp *CNNNeuronSoftPlus) WithLabel(label string) *CNNNeuronSoftPlus {
	objc.Send[objc.ID](objref.IDOf(cnsp), objc.RegisterName("setLabel:"), purego.NSString(label))
	return cnsp
}

var _ CNNNeuronProvider = (*CNNNeuronSoftPlus)(nil)

var _ CNNKernelProvider = (*CNNNeuronSoftPlus)(nil)

var _ KernelProvider = (*CNNNeuronSoftPlus)(nil)
