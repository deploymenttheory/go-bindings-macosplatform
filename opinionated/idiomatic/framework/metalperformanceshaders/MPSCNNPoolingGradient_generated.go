...
func CNNPoolingGradientFromID(id objc.ID) *CNNPoolingGradient {
	...
	x := &CNNPoolingGradient{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func cNNPoolingGradientAdopt(id objc.ID) *CNNPoolingGradient {
	...
	x := &CNNPoolingGradient{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}

// Description returns the object's -description text.
func (x *CNNPoolingGradient) Description() string {
	return rt.Description(objref.IDOf(x))
}

// IsEqual reports Objective-C equality (isEqual:) with another object.
func (x *CNNPoolingGradient) IsEqual(other obj.Object) bool {
	return rt.IsEqual(objref.IDOf(x), objref.IDOf(other))
}

// IsKind reports whether the object is an instance of the named class or a subclass.
func (x *CNNPoolingGradient) IsKind(className string) bool {
	return rt.IsKind(objref.IDOf(x), className)
}

// NewCNNPoolingGradient creates a new CNNPoolingGradient.
func NewCNNPoolingGradient() *CNNPoolingGradient {
	_id := objc.Send[objc.ID](objc.ID(_class("MPSCNNPoolingGradient")), objc.RegisterName("new"))
	return cNNPoolingGradientAdopt(_id)
}
