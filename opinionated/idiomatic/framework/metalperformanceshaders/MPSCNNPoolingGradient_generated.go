...
func (cpg *CNNPoolingGradient) WithLabel(label string) *CNNPoolingGradient {
	objc.Send[objc.ID](objref.IDOf(cpg), objc.RegisterName("setLabel:"), purego.NSString(label))
	return cpg
}
...
var _ KernelProvider = (*CNNPoolingGradient)(nil)
