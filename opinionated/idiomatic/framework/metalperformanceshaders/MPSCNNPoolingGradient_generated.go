...
func (x *CNNPoolingGradient) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNPoolingGradient {
...
func (x *CNNPoolingGradient) WithPrimarySourceFeatureChannelOffset(primarySourceFeatureChannelOffset int) *CNNPoolingGradient {
...
func (x *CNNPoolingGradient) WithSecondarySourceFeatureChannelOffset(secondarySourceFeatureChannelOffset int) *CNNPoolingGradient {
...
func (x *CNNPoolingGradient) WithPrimarySourceFeatureChannelMaxCount(primarySourceFeatureChannelMaxCount int) *CNNPoolingGradient {
...
func (x *CNNPoolingGradient) WithSecondarySourceFeatureChannelMaxCount(secondarySourceFeatureChannelMaxCount int) *CNNPoolingGradient {
...
func (x *CNNPoolingGradient) WithPrimaryStrideInPixelsX(primaryStrideInPixelsX int) *CNNPoolingGradient {
...
func (x *CNNPoolingGradient) WithPrimaryStrideInPixelsY(primaryStrideInPixelsY int) *CNNPoolingGradient {
...
func (x *CNNPoolingGradient) WithSecondaryStrideInPixelsX(secondaryStrideInPixelsX int) *CNNPoolingGradient {
...
func (x *CNNPoolingGradient) WithSecondaryStrideInPixelsY(secondaryStrideInPixelsY int) *CNNPoolingGradient {
...
// SourceSize an optional source size which defines together with primaryOffset, the set of input gradient pixels to take into account in the gradient computations. A MTLSize that together with primaryOffset indicates which part of the source gradient to consider. If the area does not lie completely within the primary source image, the intersection between source area rectangle and primary source bounds is used. Default: A size where every component is NSUIntegerMax indicating the entire rest of the image, starting from an offset (see primaryOffset).
func (x *CNNPoolingGradient) SourceSize() metal.MTLSize {
	_r := objc.Send[metal.MTLSize](objref.IDOf(x), objc.RegisterName("sourceSize"))
	return _r
}

// SetSourceSize wraps the corresponding Objective-C method.
...
type CNNPoolingGradientable interface {
	...
	WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNPoolingGradient
	WithPrimarySourceFeatureChannelOffset(primarySourceFeatureChannelOffset int) *CNNPoolingGradient
	WithSecondarySourceFeatureChannelOffset(secondarySourceFeatureChannelOffset int) *CNNPoolingGradient
	WithPrimarySourceFeatureChannelMaxCount(primarySourceFeatureChannelMaxCount int) *CNNPoolingGradient
	WithSecondarySourceFeatureChannelMaxCount(secondarySourceFeatureChannelMaxCount int) *CNNPoolingGradient
	WithPrimaryStrideInPixelsX(primaryStrideInPixelsX int) *CNNPoolingGradient
	WithPrimaryStrideInPixelsY(primaryStrideInPixelsY int) *CNNPoolingGradient
	WithSecondaryStrideInPixelsX(secondaryStrideInPixelsX int) *CNNPoolingGradient
	WithSecondaryStrideInPixelsY(secondaryStrideInPixelsY int) *CNNPoolingGradient
...
func (x *CNNPoolingGradient) isCNNPoolingGradient() {}
