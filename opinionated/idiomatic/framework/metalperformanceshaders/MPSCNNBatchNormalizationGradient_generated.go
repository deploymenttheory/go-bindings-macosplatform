...
func (cbng *CNNBatchNormalizationGradient) WithLabel(label string) *CNNBatchNormalizationGradient {
	objc.Send[objc.ID](objref.IDOf(cbng), objc.RegisterName("setLabel:"), purego.NSString(label))
	return cbng
}
...
var _ KernelProvider = (*CNNBatchNormalizationGradient)(nil)
