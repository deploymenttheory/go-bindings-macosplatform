...
// String returns the OSActivityFlag constant's name, or its numeric form when the
// value is not a known constant.
func (e OSActivityFlag) String() string {
	...
	default:
		return fmt.Sprintf("OSActivityFlag(%d)", int64(e))
	}
}
...
// String returns the OSSignpostType constant's name, or its numeric form when the
// value is not a known constant.
func (e OSSignpostType) String() string {
	switch e {
	case OSSignpostTypeEvent:
		return "OSSignpostTypeEvent"
	case OSSignpostTypeIntervalBegin:
		return "OSSignpostTypeIntervalBegin"
	case OSSignpostTypeIntervalEnd:
		return "OSSignpostTypeIntervalEnd"
	default:
		return fmt.Sprintf("OSSignpostType(%d)", int64(e))
	}
}
