...
func (x *NNPadGradientNode) WithPaddingPolicy(paddingPolicy raw.MPSNNPadding) *NNPadGradientNode {
...
type NNPadGradientNodeable interface {
	...
	WithPaddingPolicy(paddingPolicy raw.MPSNNPadding) *NNPadGradientNode
