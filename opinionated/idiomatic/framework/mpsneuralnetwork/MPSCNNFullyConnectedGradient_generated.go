...
func (cfcg *CNNFullyConnectedGradient) WithGradientOption(gradientOption CNNConvolutionGradientOption) *CNNFullyConnectedGradient {
	objc.Send[objc.ID](objref.IDOf(cfcg), objc.RegisterName("setGradientOption:"), gradientOption)
	return cfcg
}
