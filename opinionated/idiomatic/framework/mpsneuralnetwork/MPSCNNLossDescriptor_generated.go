...
// WithLossType the type of a loss filter. This parameter specifies the type of a loss filter.
...
// WithReductionType the type of a reduction operation performed in the loss filter. This parameter specifies the type of a reduction operation performed in the loss filter.
...
// LossType the type of a loss filter. This parameter specifies the type of a loss filter.
func (x *CNNLossDescriptor) LossType() CNNLossType {
	_r := objc.Send[CNNLossType](objref.IDOf(x), objc.RegisterName("lossType"))
	return _r
}

// SetLossType wraps the corresponding Objective-C method.
func (x *CNNLossDescriptor) SetLossType(lossType CNNLossType) {
	objc.Send[objc.ID](objref.IDOf(x), objc.RegisterName("setLossType:"), lossType)
}

// ReductionType the type of a reduction operation performed in the loss filter. This parameter specifies the type of a reduction operation performed in the loss filter.
