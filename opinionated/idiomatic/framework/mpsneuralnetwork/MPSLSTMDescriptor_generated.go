...
type LSTMDescriptorable interface {
	...
	WithCellToOutputNeuronType(cellToOutputNeuronType CNNNeuronType) *LSTMDescriptor
	...
	WithLayerSequenceDirection(layerSequenceDirection RNNSequenceDirection) *LSTMDescriptor
	...
	SetCellToOutputNeuronType(cellToOutputNeuronType CNNNeuronType)
