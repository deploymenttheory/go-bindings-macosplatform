...
func (x *CNNConvolutionDescriptor) SetNeuronTypeParameterAParameterB(neuronType CNNNeuronType, parameterA float32, parameterB float32) {
	objc.Send[objc.ID](objref.IDOf(x), objc.RegisterName("setNeuronType:parameterA:parameterB:"), neuronType, parameterA, parameterB)
}

// NeuronType getter funtion for neuronType set using setNeuronType:parameterA:parameterB method
func (x *CNNConvolutionDescriptor) NeuronType() CNNNeuronType {
...
func (x *CNNConvolutionDescriptor) SetFusedNeuronDescriptor(fusedNeuronDescriptor *NNNeuronDescriptor) {
	objc.Send[objc.ID](objref.IDOf(x), objc.RegisterName("setFusedNeuronDescriptor:"), objref.IDOf(fusedNeuronDescriptor))
}
...
type CNNConvolutionDescriptorable interface {
	...
	SetNeuronTypeParameterAParameterB(neuronType CNNNeuronType, parameterA float32, parameterB float32)
	...
	SetFusedNeuronDescriptor(fusedNeuronDescriptor *NNNeuronDescriptor)
}
