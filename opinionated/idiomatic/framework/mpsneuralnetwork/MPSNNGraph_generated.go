...
func NewNNGraphWithDeviceResultImageResultImageIsNeeded(device metal.MTLDevice, resultImage *raw.MPSNNImageNode, resultIsNeeded bool) *NNGraph {
...
func NewNNGraphWithDeviceResultImagesResultsAreNeeded(device metal.MTLDevice, resultImages *foundation.NSArray[*raw.MPSNNImageNode], areResultsNeeded *bool) *NNGraph {
	_alloc := objc.Send[objc.ID](objc.ID(objc.GetClass("MPSNNGraph")), objc.RegisterName("alloc"))
...
func NewNNGraphWithDeviceResultImage(device metal.MTLDevice, resultImage *raw.MPSNNImageNode) *NNGraph {
	_alloc := objc.Send[objc.ID](objc.ID(objc.GetClass("MPSNNGraph")), objc.RegisterName("alloc"))
