...
func (x *CNNUpsamplingNearestGradientNode) asNNGradientFilterNode() *raw.MPSNNGradientFilterNode {
	return &x.inner.MPSNNGradientFilterNode
}

func (x *CNNUpsamplingNearestGradientNode) asNNFilterNode() *raw.MPSNNFilterNode {
