...
func CNNNeuronFromID(id objc.ID) *CNNNeuron {
	...
	x := &CNNNeuron{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func cNNNeuronAdopt(id objc.ID) *CNNNeuron {
	...
	x := &CNNNeuron{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}

// Description returns the object's -description text.
func (x *CNNNeuron) Description() string {
	return rt.Description(objref.IDOf(x))
}

// IsEqual reports Objective-C equality (isEqual:) with another object.
func (x *CNNNeuron) IsEqual(other obj.Object) bool {
	return rt.IsEqual(objref.IDOf(x), objref.IDOf(other))
}

// IsKind reports whether the object is an instance of the named class or a subclass.
func (x *CNNNeuron) IsKind(className string) bool {
	return rt.IsKind(objref.IDOf(x), className)
}

// NewCNNNeuron creates a new CNNNeuron.
func NewCNNNeuron() *CNNNeuron {
	_id := objc.Send[objc.ID](objc.ID(_class("MPSCNNNeuron")), objc.RegisterName("new"))
	return cNNNeuronAdopt(_id)
}
