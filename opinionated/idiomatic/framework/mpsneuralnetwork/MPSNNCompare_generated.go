...
// WithComparisonType sets the comparison type to use
func (nc *NNCompare) WithComparisonType(comparisonType NNComparisonType) *NNCompare {
	objc.Send[objc.ID](objref.IDOf(nc), objc.RegisterName("setComparisonType:"), comparisonType)
	return nc
}
...
// ComparisonType returns the comparison type to use
func (nc *NNCompare) ComparisonType() NNComparisonType {
	_r := objc.Send[NNComparisonType](objref.IDOf(nc), objc.RegisterName("comparisonType"))
	return _r
}
