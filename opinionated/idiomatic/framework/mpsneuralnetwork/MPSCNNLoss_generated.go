...
func (cl *CNNLoss) WithOffset(offset mpscore.MPSOffset) *CNNLoss {
...
func (cl *CNNLoss) WithClipRect(clipRect metal.MTLRegion) *CNNLoss {
...
func (cl *CNNLoss) WithDestinationFeatureChannelOffset(destinationFeatureChannelOffset int) *CNNLoss {
...
func (cl *CNNLoss) WithSourceFeatureChannelOffset(sourceFeatureChannelOffset int) *CNNLoss {
...
func (cl *CNNLoss) WithSourceFeatureChannelMaxCount(sourceFeatureChannelMaxCount int) *CNNLoss {
...
func (cl *CNNLoss) LossType() CNNLossType {
	_r := objc.Send[CNNLossType](objref.IDOf(cl), objc.RegisterName("lossType"))
	return _r
}
