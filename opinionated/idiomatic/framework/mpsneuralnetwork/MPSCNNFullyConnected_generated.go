...
func CNNFullyConnectedFromID(id objc.ID) *CNNFullyConnected {
	...
	x := &CNNFullyConnected{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func cNNFullyConnectedAdopt(id objc.ID) *CNNFullyConnected {
	...
	x := &CNNFullyConnected{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}

// Description returns the object's -description text.
func (x *CNNFullyConnected) Description() string {
	return rt.Description(objref.IDOf(x))
}

// IsEqual reports Objective-C equality (isEqual:) with another object.
func (x *CNNFullyConnected) IsEqual(other obj.Object) bool {
	return rt.IsEqual(objref.IDOf(x), objref.IDOf(other))
}

// IsKind reports whether the object is an instance of the named class or a subclass.
func (x *CNNFullyConnected) IsKind(className string) bool {
...
func (x *CNNFullyConnected) WithAccumulatorPrecisionOption(accumulatorPrecisionOption NNConvolutionAccumulatorPrecisionOption) *CNNFullyConnected {
...
type CNNFullyConnectedable interface {
	obj.Object
	WithAccumulatorPrecisionOption(accumulatorPrecisionOption NNConvolutionAccumulatorPrecisionOption) *CNNFullyConnected
