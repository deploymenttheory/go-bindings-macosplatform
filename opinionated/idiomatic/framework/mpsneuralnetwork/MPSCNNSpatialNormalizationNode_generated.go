...
func (x *CNNSpatialNormalizationNode) asCNNNormalizationNode() *raw.MPSCNNNormalizationNode {
	return &x.inner.MPSCNNNormalizationNode
}

func (x *CNNSpatialNormalizationNode) asNNFilterNode() *raw.MPSNNFilterNode {
