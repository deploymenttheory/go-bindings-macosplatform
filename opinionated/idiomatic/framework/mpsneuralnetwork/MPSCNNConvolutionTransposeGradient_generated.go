...
// WithGradientOption sets option to control which gradient to compute. Default is MPSCNNConvolutionGradientOptionAll which means both gradient with respect to data and gradient with respect to weight and bias are computed.
func (cctg *CNNConvolutionTransposeGradient) WithGradientOption(gradientOption CNNConvolutionGradientOption) *CNNConvolutionTransposeGradient {
	objc.Send[objc.ID](objref.IDOf(cctg), objc.RegisterName("setGradientOption:"), gradientOption)
	return cctg
}
...
// GradientOption returns option to control which gradient to compute. Default is MPSCNNConvolutionGradientOptionAll which means both gradient with respect to data and gradient with respect to weight and bias are computed.
func (cctg *CNNConvolutionTransposeGradient) GradientOption() CNNConvolutionGradientOption {
	_r := objc.Send[CNNConvolutionGradientOption](objref.IDOf(cctg), objc.RegisterName("gradientOption"))
	return _r
}
