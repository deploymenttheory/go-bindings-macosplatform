...
func MTRBooleanStateConfigurationClusterEnableDisableAlarmParamsFromID(id objc.ID) *MTRBooleanStateConfigurationClusterEnableDisableAlarmParams {
	...
	x := &MTRBooleanStateConfigurationClusterEnableDisableAlarmParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRBooleanStateConfigurationClusterEnableDisableAlarmParamsAdopt(id objc.ID) *MTRBooleanStateConfigurationClusterEnableDisableAlarmParams {
	...
	x := &MTRBooleanStateConfigurationClusterEnableDisableAlarmParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
...
// WithAlarmsToEnableDisable sets alarmsToEnableDisable and returns the receiver so calls can be chained.
