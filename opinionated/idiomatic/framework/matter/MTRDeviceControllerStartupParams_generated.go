...
func MTRDeviceControllerStartupParamsFromID(id objc.ID) *MTRDeviceControllerStartupParams {
	...
	x := &MTRDeviceControllerStartupParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRDeviceControllerStartupParamsAdopt(id objc.ID) *MTRDeviceControllerStartupParams {
	...
	x := &MTRDeviceControllerStartupParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
...
// WithCaseAuthenticatedTags sets caseAuthenticatedTags and returns the receiver so calls can be chained.
...
// WithOperationalCertificateIssuerQueue sets operationalCertificateIssuerQueue and returns the receiver so calls can be chained.
