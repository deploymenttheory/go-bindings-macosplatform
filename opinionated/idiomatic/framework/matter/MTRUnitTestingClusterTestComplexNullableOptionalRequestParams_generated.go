...
func (x *MTRUnitTestingClusterTestComplexNullableOptionalRequestParams) ID() objc.ID { return x.inner.Ptr() }

// MTRUnitTestingClusterTestComplexNullableOptionalRequestParamsFromID adopts an existing toll-free-bridged object id as a MTRUnitTestingClusterTestComplexNullableOptionalRequestParams (nil for 0).
