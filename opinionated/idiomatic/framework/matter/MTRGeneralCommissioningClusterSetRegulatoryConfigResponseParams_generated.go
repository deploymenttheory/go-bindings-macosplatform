...
func MTRGeneralCommissioningClusterSetRegulatoryConfigResponseParamsFromID(id objc.ID) *MTRGeneralCommissioningClusterSetRegulatoryConfigResponseParams {
	...
	x := &MTRGeneralCommissioningClusterSetRegulatoryConfigResponseParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRGeneralCommissioningClusterSetRegulatoryConfigResponseParamsAdopt(id objc.ID) *MTRGeneralCommissioningClusterSetRegulatoryConfigResponseParams {
	...
	x := &MTRGeneralCommissioningClusterSetRegulatoryConfigResponseParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
...
func NewMTRGeneralCommissioningClusterSetRegulatoryConfigResponseParamsWithResponseValueError(responseValue obj.Object) (*MTRGeneralCommissioningClusterSetRegulatoryConfigResponseParams, error) {
