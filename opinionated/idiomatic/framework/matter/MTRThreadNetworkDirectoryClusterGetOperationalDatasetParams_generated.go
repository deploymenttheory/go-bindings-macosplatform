...
func (x *MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams) ID() objc.ID { return x.inner.Ptr() }

// MTRThreadNetworkDirectoryClusterGetOperationalDatasetParamsFromID adopts an existing toll-free-bridged object id as a MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams (nil for 0).
