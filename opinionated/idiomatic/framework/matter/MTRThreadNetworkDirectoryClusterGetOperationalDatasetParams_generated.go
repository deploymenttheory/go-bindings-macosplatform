...
func (mtndcgodp *MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams) Description() string {
	defer runtime.KeepAlive(mtndcgodp)
...
func (mtndcgodp *MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams) WithExtendedPanID(extendedPanID []byte) *MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams {
	objc.Send[objc.ID](objref.IDOf(mtndcgodp), objc.RegisterName("setExtendedPanID:"), rt.BytesToNSData(extendedPanID))
	return mtndcgodp
}
...
func (mtndcgodp *MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams) ExtendedPanID() []byte {
	defer runtime.KeepAlive(mtndcgodp)
...
func (mtndcgodp *MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams) TimedInvokeTimeoutMs() *foundation.Number {
	defer runtime.KeepAlive(mtndcgodp)
...
func (mtndcgodp *MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams) ServerSideProcessingTimeout() *foundation.Number {
	defer runtime.KeepAlive(mtndcgodp)
