...
func MTRThreadNetworkDirectoryClusterGetOperationalDatasetParamsFromID(id objc.ID) *MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams {
	...
	x := &MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRThreadNetworkDirectoryClusterGetOperationalDatasetParamsAdopt(id objc.ID) *MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams {
	...
	x := &MTRThreadNetworkDirectoryClusterGetOperationalDatasetParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
