...
func MTRAccountLoginClusterGetSetupPINResponseParamsFromID(id objc.ID) *MTRAccountLoginClusterGetSetupPINResponseParams {
	...
	x := &MTRAccountLoginClusterGetSetupPINResponseParams{}
...
func (malcgsprp *MTRAccountLoginClusterGetSetupPINResponseParams) Description() string {
	defer runtime.KeepAlive(malcgsprp)
...
// NewMTRAccountLoginClusterGetSetupPINResponseParamsWithResponseValue initialize an MTRAccountLoginClusterGetSetupPINResponseParams with a response-value dictionary of the sort that MTRDeviceResponseHandler would receive. Will return nil and hand out an error if the response-value dictionary is not a command data response or is not the right command response. Will return nil and hand out an error if the data response does not match the known schema for this command.
func NewMTRAccountLoginClusterGetSetupPINResponseParamsWithResponseValue(responseValue map[string]obj.Object) (result *MTRAccountLoginClusterGetSetupPINResponseParams, err error) {
...
func (malcgsprp *MTRAccountLoginClusterGetSetupPINResponseParams) TimedInvokeTimeoutMs() *foundation.Number {
	defer runtime.KeepAlive(malcgsprp)
