...
func (x *MTRClusterActivatedCarbonFilterMonitoring) ID() objc.ID { return x.inner.Ptr() }

// MTRClusterActivatedCarbonFilterMonitoringFromID adopts an existing toll-free-bridged object id as a MTRClusterActivatedCarbonFilterMonitoring (nil for 0).
