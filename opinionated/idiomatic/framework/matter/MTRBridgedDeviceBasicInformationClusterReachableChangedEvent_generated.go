...
func (x *MTRBridgedDeviceBasicInformationClusterReachableChangedEvent) ID() objc.ID { return x.inner.Ptr() }

// MTRBridgedDeviceBasicInformationClusterReachableChangedEventFromID adopts an existing toll-free-bridged object id as a MTRBridgedDeviceBasicInformationClusterReachableChangedEvent (nil for 0).
