...
func (mmpcsp *MTRMediaPlaybackClusterStopParams) TimedInvokeTimeoutMs() *foundation.Number {
	defer runtime.KeepAlive(mmpcsp)
...
func (mmpcsp *MTRMediaPlaybackClusterStopParams) ServerSideProcessingTimeout() *foundation.Number {
	defer runtime.KeepAlive(mmpcsp)
