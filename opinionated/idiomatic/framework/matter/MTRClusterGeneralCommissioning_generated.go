...
func (x *MTRClusterGeneralCommissioning) ID() objc.ID { return x.inner.Ptr() }

// MTRClusterGeneralCommissioningFromID adopts an existing toll-free-bridged object id as a MTRClusterGeneralCommissioning (nil for 0).
