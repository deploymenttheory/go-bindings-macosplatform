...
func MTRDishwasherAlarmClusterResetParamsFromID(id objc.ID) *MTRDishwasherAlarmClusterResetParams {
	...
	x := &MTRDishwasherAlarmClusterResetParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRDishwasherAlarmClusterResetParamsAdopt(id objc.ID) *MTRDishwasherAlarmClusterResetParams {
	...
	x := &MTRDishwasherAlarmClusterResetParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
...
// WithAlarms sets alarms and returns the receiver so calls can be chained.
