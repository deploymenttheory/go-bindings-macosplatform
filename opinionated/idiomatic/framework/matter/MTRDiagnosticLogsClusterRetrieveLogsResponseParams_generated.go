...
func MTRDiagnosticLogsClusterRetrieveLogsResponseParamsFromID(id objc.ID) *MTRDiagnosticLogsClusterRetrieveLogsResponseParams {
	...
	x := &MTRDiagnosticLogsClusterRetrieveLogsResponseParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRDiagnosticLogsClusterRetrieveLogsResponseParamsAdopt(id objc.ID) *MTRDiagnosticLogsClusterRetrieveLogsResponseParams {
	...
	x := &MTRDiagnosticLogsClusterRetrieveLogsResponseParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
...
func NewMTRDiagnosticLogsClusterRetrieveLogsResponseParamsWithResponseValueError(responseValue obj.Object) (*MTRDiagnosticLogsClusterRetrieveLogsResponseParams, error) {
...
// WithLogContent sets logContent and returns the receiver so calls can be chained.
...
// WithUtcTimeStamp sets utcTimeStamp and returns the receiver so calls can be chained.
...
// WithTimeSinceBoot sets timeSinceBoot and returns the receiver so calls can be chained.
