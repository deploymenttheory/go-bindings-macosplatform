...
// MTRICDManagementClusterRegisterClientResponseParamsFromID adopts an existing toll-free-bridged object id as a MTRICDManagementClusterRegisterClientResponseParams (nil for 0).
...
func NewMTRICDManagementClusterRegisterClientResponseParamsWithResponseValueError(responseValue *foundation.NSDictionary[*foundation.NSString, objc.ID]) (*MTRICDManagementClusterRegisterClientResponseParams, error) {
