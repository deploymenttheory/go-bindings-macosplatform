...
func (mgdctsp *MTRGeneralDiagnosticsClusterTimeSnapshotParams) Description() string {
	defer runtime.KeepAlive(mgdctsp)
...
func (mgdctsp *MTRGeneralDiagnosticsClusterTimeSnapshotParams) TimedInvokeTimeoutMs() *foundation.Number {
	defer runtime.KeepAlive(mgdctsp)
...
func (mgdctsp *MTRGeneralDiagnosticsClusterTimeSnapshotParams) ServerSideProcessingTimeout() *foundation.Number {
	defer runtime.KeepAlive(mgdctsp)
