...
func MTROperationalCredentialsClusterCertificateChainResponseParamsFromID(id objc.ID) *MTROperationalCredentialsClusterCertificateChainResponseParams {
	...
	x := &MTROperationalCredentialsClusterCertificateChainResponseParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTROperationalCredentialsClusterCertificateChainResponseParamsAdopt(id objc.ID) *MTROperationalCredentialsClusterCertificateChainResponseParams {
	...
	x := &MTROperationalCredentialsClusterCertificateChainResponseParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
...
func NewMTROperationalCredentialsClusterCertificateChainResponseParamsWithResponseValueError(responseValue obj.Object) (*MTROperationalCredentialsClusterCertificateChainResponseParams, error) {
...
// WithCertificate sets certificate and returns the receiver so calls can be chained.
