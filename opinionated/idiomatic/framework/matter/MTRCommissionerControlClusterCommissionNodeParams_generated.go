...
func MTRCommissionerControlClusterCommissionNodeParamsFromID(id objc.ID) *MTRCommissionerControlClusterCommissionNodeParams {
	...
	x := &MTRCommissionerControlClusterCommissionNodeParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRCommissionerControlClusterCommissionNodeParamsAdopt(id objc.ID) *MTRCommissionerControlClusterCommissionNodeParams {
	...
	x := &MTRCommissionerControlClusterCommissionNodeParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
...
// WithResponseTimeoutSeconds sets responseTimeoutSeconds and returns the receiver so calls can be chained.
