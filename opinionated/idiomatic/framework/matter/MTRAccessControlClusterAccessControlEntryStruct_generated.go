...
func (maccaces *MTRAccessControlClusterAccessControlEntryStruct) Privilege() *foundation.Number {
	defer runtime.KeepAlive(maccaces)
...
func (maccaces *MTRAccessControlClusterAccessControlEntryStruct) AuthMode() *foundation.Number {
	defer runtime.KeepAlive(maccaces)
...
func (maccaces *MTRAccessControlClusterAccessControlEntryStruct) SetSubjects(subjects obj.Object) {
	defer runtime.KeepAlive(maccaces)
	defer runtime.KeepAlive(subjects)
...
func (maccaces *MTRAccessControlClusterAccessControlEntryStruct) FabricIndex() *foundation.Number {
	defer runtime.KeepAlive(maccaces)
