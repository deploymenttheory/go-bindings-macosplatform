...
func MTRMediaPlaybackClusterActivateTextTrackParamsFromID(id objc.ID) *MTRMediaPlaybackClusterActivateTextTrackParams {
	...
	x := &MTRMediaPlaybackClusterActivateTextTrackParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRMediaPlaybackClusterActivateTextTrackParamsAdopt(id objc.ID) *MTRMediaPlaybackClusterActivateTextTrackParams {
	...
	x := &MTRMediaPlaybackClusterActivateTextTrackParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
