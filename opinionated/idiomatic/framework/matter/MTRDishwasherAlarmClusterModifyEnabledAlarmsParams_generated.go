...
func MTRDishwasherAlarmClusterModifyEnabledAlarmsParamsFromID(id objc.ID) *MTRDishwasherAlarmClusterModifyEnabledAlarmsParams {
	...
	x := &MTRDishwasherAlarmClusterModifyEnabledAlarmsParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRDishwasherAlarmClusterModifyEnabledAlarmsParamsAdopt(id objc.ID) *MTRDishwasherAlarmClusterModifyEnabledAlarmsParams {
	...
	x := &MTRDishwasherAlarmClusterModifyEnabledAlarmsParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
