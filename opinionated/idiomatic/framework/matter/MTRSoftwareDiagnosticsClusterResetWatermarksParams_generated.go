...
func MTRSoftwareDiagnosticsClusterResetWatermarksParamsFromID(id objc.ID) *MTRSoftwareDiagnosticsClusterResetWatermarksParams {
	...
	x := &MTRSoftwareDiagnosticsClusterResetWatermarksParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRSoftwareDiagnosticsClusterResetWatermarksParamsAdopt(id objc.ID) *MTRSoftwareDiagnosticsClusterResetWatermarksParams {
	...
	x := &MTRSoftwareDiagnosticsClusterResetWatermarksParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
