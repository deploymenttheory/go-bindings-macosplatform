...
func MTRTimeSynchronizationClusterSetDSTOffsetParamsFromID(id objc.ID) *MTRTimeSynchronizationClusterSetDSTOffsetParams {
	...
	x := &MTRTimeSynchronizationClusterSetDSTOffsetParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRTimeSynchronizationClusterSetDSTOffsetParamsAdopt(id objc.ID) *MTRTimeSynchronizationClusterSetDSTOffsetParams {
	...
	x := &MTRTimeSynchronizationClusterSetDSTOffsetParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
