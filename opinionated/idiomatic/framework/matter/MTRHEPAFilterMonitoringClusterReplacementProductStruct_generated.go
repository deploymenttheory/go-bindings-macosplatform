...
// MTRHEPAFilterMonitoringClusterReplacementProductStructFromID adopts an existing object pointer as a MTRHEPAFilterMonitoringClusterReplacementProductStruct (nil for 0).
