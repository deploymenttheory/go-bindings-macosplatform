...
func (x *MTRBaseClusterGroups) ID() objc.ID { return x.inner.Ptr() }

// MTRBaseClusterGroupsFromID adopts an existing toll-free-bridged object id as a MTRBaseClusterGroups (nil for 0).
