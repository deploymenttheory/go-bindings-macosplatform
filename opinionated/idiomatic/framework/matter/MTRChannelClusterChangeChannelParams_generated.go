...
func (mccccp *MTRChannelClusterChangeChannelParams) Description() string {
	defer runtime.KeepAlive(mccccp)
...
func (mccccp *MTRChannelClusterChangeChannelParams) TimedInvokeTimeoutMs() *foundation.Number {
	defer runtime.KeepAlive(mccccp)
...
func (mccccp *MTRChannelClusterChangeChannelParams) ServerSideProcessingTimeout() *foundation.Number {
	defer runtime.KeepAlive(mccccp)
