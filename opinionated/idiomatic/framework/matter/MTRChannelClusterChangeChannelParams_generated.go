...
func MTRChannelClusterChangeChannelParamsFromID(id objc.ID) *MTRChannelClusterChangeChannelParams {
	...
	x := &MTRChannelClusterChangeChannelParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRChannelClusterChangeChannelParamsAdopt(id objc.ID) *MTRChannelClusterChangeChannelParams {
	...
	x := &MTRChannelClusterChangeChannelParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
...
// WithMatch sets match and returns the receiver so calls can be chained.
