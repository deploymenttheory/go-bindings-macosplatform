...
// MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParamsFromID adopts an existing toll-free-bridged object id as a MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams (nil for 0).
func MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParamsFromID(id objc.ID) *MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams {
	...
	return &MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams{inner: raw.MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParamsFromID(id)}
}
