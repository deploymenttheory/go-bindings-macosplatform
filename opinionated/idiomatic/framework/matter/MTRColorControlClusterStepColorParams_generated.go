...
func (x *MTRColorControlClusterStepColorParams) ID() objc.ID { return x.inner.Ptr() }

// MTRColorControlClusterStepColorParamsFromID adopts an existing toll-free-bridged object id as a MTRColorControlClusterStepColorParams (nil for 0).
func MTRColorControlClusterStepColorParamsFromID(id objc.ID) *MTRColorControlClusterStepColorParams {
	if id == 0 {
		return nil
	}
	return &MTRColorControlClusterStepColorParams{inner: raw.MTRColorControlClusterStepColorParamsFromID(id)}
}
