...
func (x *MTRRVCCleanModeClusterModeTagStruct) ID() objc.ID { return x.inner.Ptr() }

// MTRRVCCleanModeClusterModeTagStructFromID adopts an existing toll-free-bridged object id as a MTRRVCCleanModeClusterModeTagStruct (nil for 0).
func MTRRVCCleanModeClusterModeTagStructFromID(id objc.ID) *MTRRVCCleanModeClusterModeTagStruct {
	if id == 0 {
		return nil
	}
	return &MTRRVCCleanModeClusterModeTagStruct{inner: raw.MTRRVCCleanModeClusterModeTagStructFromID(id)}
}
