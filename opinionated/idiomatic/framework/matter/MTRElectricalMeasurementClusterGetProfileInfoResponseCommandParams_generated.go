...
func (x *MTRElectricalMeasurementClusterGetProfileInfoResponseCommandParams) ID() objc.ID { return x.inner.Ptr() }

// MTRElectricalMeasurementClusterGetProfileInfoResponseCommandParamsFromID adopts an existing toll-free-bridged object id as a MTRElectricalMeasurementClusterGetProfileInfoResponseCommandParams (nil for 0).
