...
// MTRBridgedDeviceBasicClusterReachableChangedEventFromID adopts an existing object pointer as a MTRBridgedDeviceBasicClusterReachableChangedEvent (nil for 0).
