...
func MTRAccessControlClusterReviewFabricRestrictionsParamsFromID(id objc.ID) *MTRAccessControlClusterReviewFabricRestrictionsParams {
	...
	x := &MTRAccessControlClusterReviewFabricRestrictionsParams{}
...
func (maccrfrp *MTRAccessControlClusterReviewFabricRestrictionsParams) ServerSideProcessingTimeout() *foundation.Number {
	defer runtime.KeepAlive(maccrfrp)
