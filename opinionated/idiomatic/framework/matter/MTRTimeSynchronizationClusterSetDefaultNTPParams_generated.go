...
func MTRTimeSynchronizationClusterSetDefaultNTPParamsFromID(id objc.ID) *MTRTimeSynchronizationClusterSetDefaultNTPParams {
	...
	x := &MTRTimeSynchronizationClusterSetDefaultNTPParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRTimeSynchronizationClusterSetDefaultNTPParamsAdopt(id objc.ID) *MTRTimeSynchronizationClusterSetDefaultNTPParams {
	...
	x := &MTRTimeSynchronizationClusterSetDefaultNTPParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
...
// WithDefaultNTP sets defaultNTP and returns the receiver so calls can be chained.
