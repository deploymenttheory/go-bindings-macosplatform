...
func (x *MTRWindowCoveringClusterGoToLiftPercentageParams) ID() objc.ID { return x.inner.Ptr() }

// MTRWindowCoveringClusterGoToLiftPercentageParamsFromID adopts an existing toll-free-bridged object id as a MTRWindowCoveringClusterGoToLiftPercentageParams (nil for 0).
func MTRWindowCoveringClusterGoToLiftPercentageParamsFromID(id objc.ID) *MTRWindowCoveringClusterGoToLiftPercentageParams {
	if id == 0 {
		return nil
	}
	return &MTRWindowCoveringClusterGoToLiftPercentageParams{inner: raw.MTRWindowCoveringClusterGoToLiftPercentageParamsFromID(id)}
}
