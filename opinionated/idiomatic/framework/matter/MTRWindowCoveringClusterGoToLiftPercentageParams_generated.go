...
func MTRWindowCoveringClusterGoToLiftPercentageParamsFromID(id objc.ID) *MTRWindowCoveringClusterGoToLiftPercentageParams {
	...
	x := &MTRWindowCoveringClusterGoToLiftPercentageParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRWindowCoveringClusterGoToLiftPercentageParamsAdopt(id objc.ID) *MTRWindowCoveringClusterGoToLiftPercentageParams {
	...
	x := &MTRWindowCoveringClusterGoToLiftPercentageParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
...
// WithLiftPercent100thsValue sets liftPercent100thsValue and returns the receiver so calls can be chained.
