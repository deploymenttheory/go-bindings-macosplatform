...
func MTRBarrierControlClusterBarrierControlGoToPercentParamsFromID(id objc.ID) *MTRBarrierControlClusterBarrierControlGoToPercentParams {
	...
	x := &MTRBarrierControlClusterBarrierControlGoToPercentParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRBarrierControlClusterBarrierControlGoToPercentParamsAdopt(id objc.ID) *MTRBarrierControlClusterBarrierControlGoToPercentParams {
	...
	x := &MTRBarrierControlClusterBarrierControlGoToPercentParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
...
// WithPercentOpen sets percentOpen and returns the receiver so calls can be chained.
