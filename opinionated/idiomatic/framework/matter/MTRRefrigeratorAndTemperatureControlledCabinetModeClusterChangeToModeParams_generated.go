...
func MTRRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParamsFromID(id objc.ID) *MTRRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParams {
	...
	x := &MTRRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParamsAdopt(id objc.ID) *MTRRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParams {
	...
	x := &MTRRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
