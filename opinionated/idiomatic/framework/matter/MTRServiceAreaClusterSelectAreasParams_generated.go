...
func (msacsap *MTRServiceAreaClusterSelectAreasParams) SetNewAreas(newAreas obj.Object) {
	defer runtime.KeepAlive(msacsap)
	defer runtime.KeepAlive(newAreas)
...
func (msacsap *MTRServiceAreaClusterSelectAreasParams) TimedInvokeTimeoutMs() *foundation.Number {
	defer runtime.KeepAlive(msacsap)
...
func (msacsap *MTRServiceAreaClusterSelectAreasParams) ServerSideProcessingTimeout() *foundation.Number {
	defer runtime.KeepAlive(msacsap)
