...
func MTRValveConfigurationAndControlClusterOpenParamsFromID(id objc.ID) *MTRValveConfigurationAndControlClusterOpenParams {
	...
	x := &MTRValveConfigurationAndControlClusterOpenParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRValveConfigurationAndControlClusterOpenParamsAdopt(id objc.ID) *MTRValveConfigurationAndControlClusterOpenParams {
	...
	x := &MTRValveConfigurationAndControlClusterOpenParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
...
// WithOpenDuration sets openDuration and returns the receiver so calls can be chained.
...
// WithTargetLevel sets targetLevel and returns the receiver so calls can be chained.
