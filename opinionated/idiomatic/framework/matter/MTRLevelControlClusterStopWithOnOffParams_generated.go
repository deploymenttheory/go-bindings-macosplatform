...
func MTRLevelControlClusterStopWithOnOffParamsFromID(id objc.ID) *MTRLevelControlClusterStopWithOnOffParams {
	...
	x := &MTRLevelControlClusterStopWithOnOffParams{}
...
func (mlccswoop *MTRLevelControlClusterStopWithOnOffParams) OptionsMask() *foundation.Number {
	defer runtime.KeepAlive(mlccswoop)
...
func (mlccswoop *MTRLevelControlClusterStopWithOnOffParams) OptionsOverride() *foundation.Number {
	defer runtime.KeepAlive(mlccswoop)
...
func (mlccswoop *MTRLevelControlClusterStopWithOnOffParams) TimedInvokeTimeoutMs() *foundation.Number {
	defer runtime.KeepAlive(mlccswoop)
...
func (mlccswoop *MTRLevelControlClusterStopWithOnOffParams) ServerSideProcessingTimeout() *foundation.Number {
	defer runtime.KeepAlive(mlccswoop)
