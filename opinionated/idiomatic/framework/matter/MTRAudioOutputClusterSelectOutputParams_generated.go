...
func (maocsop *MTRAudioOutputClusterSelectOutputParams) Description() string {
	defer runtime.KeepAlive(maocsop)
...
func (maocsop *MTRAudioOutputClusterSelectOutputParams) Index() *foundation.Number {
	defer runtime.KeepAlive(maocsop)
...
func (maocsop *MTRAudioOutputClusterSelectOutputParams) TimedInvokeTimeoutMs() *foundation.Number {
	defer runtime.KeepAlive(maocsop)
...
func (maocsop *MTRAudioOutputClusterSelectOutputParams) ServerSideProcessingTimeout() *foundation.Number {
	defer runtime.KeepAlive(maocsop)
