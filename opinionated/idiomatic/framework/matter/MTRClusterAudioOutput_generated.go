...
func (x *MTRClusterAudioOutput) ID() objc.ID { return x.inner.Ptr() }

// MTRClusterAudioOutputFromID adopts an existing toll-free-bridged object id as a MTRClusterAudioOutput (nil for 0).
