...
func (moccarp *MTROperationalCredentialsClusterAttestationRequestParams) WithAttestationNonce(attestationNonce []byte) *MTROperationalCredentialsClusterAttestationRequestParams {
	objc.Send[objc.ID](objref.IDOf(moccarp), objc.RegisterName("setAttestationNonce:"), rt.BytesToNSData(attestationNonce))
	return moccarp
}
...
func (moccarp *MTROperationalCredentialsClusterAttestationRequestParams) AttestationNonce() []byte {
	defer runtime.KeepAlive(moccarp)
...
func (moccarp *MTROperationalCredentialsClusterAttestationRequestParams) TimedInvokeTimeoutMs() *foundation.Number {
	defer runtime.KeepAlive(moccarp)
...
func (moccarp *MTROperationalCredentialsClusterAttestationRequestParams) ServerSideProcessingTimeout() *foundation.Number {
	defer runtime.KeepAlive(moccarp)
