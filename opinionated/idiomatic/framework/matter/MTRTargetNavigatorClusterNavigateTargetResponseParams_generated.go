...
func (mtncntrp *MTRTargetNavigatorClusterNavigateTargetResponseParams) Description() string {
	defer runtime.KeepAlive(mtncntrp)
...
// NewMTRTargetNavigatorClusterNavigateTargetResponseParamsWithResponseValue initialize an MTRTargetNavigatorClusterNavigateTargetResponseParams with a response-value dictionary of the sort that MTRDeviceResponseHandler would receive. Will return nil and hand out an error if the response-value dictionary is not a command data response or is not the right command response. Will return nil and hand out an error if the data response does not match the known schema for this command.
func NewMTRTargetNavigatorClusterNavigateTargetResponseParamsWithResponseValue(responseValue map[string]obj.Object) (result *MTRTargetNavigatorClusterNavigateTargetResponseParams, err error) {
...
func (mtncntrp *MTRTargetNavigatorClusterNavigateTargetResponseParams) Status() *foundation.Number {
	defer runtime.KeepAlive(mtncntrp)
...
func (mtncntrp *MTRTargetNavigatorClusterNavigateTargetResponseParams) TimedInvokeTimeoutMs() *foundation.Number {
	defer runtime.KeepAlive(mtncntrp)
