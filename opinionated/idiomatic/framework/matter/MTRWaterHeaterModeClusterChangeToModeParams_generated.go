...
func (mwhmcctmp *MTRWaterHeaterModeClusterChangeToModeParams) Description() string {
	defer runtime.KeepAlive(mwhmcctmp)
...
func (mwhmcctmp *MTRWaterHeaterModeClusterChangeToModeParams) NewMode() *foundation.Number {
	defer runtime.KeepAlive(mwhmcctmp)
...
func (mwhmcctmp *MTRWaterHeaterModeClusterChangeToModeParams) TimedInvokeTimeoutMs() *foundation.Number {
	defer runtime.KeepAlive(mwhmcctmp)
...
func (mwhmcctmp *MTRWaterHeaterModeClusterChangeToModeParams) ServerSideProcessingTimeout() *foundation.Number {
	defer runtime.KeepAlive(mwhmcctmp)
