...
func (x *MTRWiFiNetworkManagementClusterNetworkPassphraseResponseParams) ID() objc.ID { return x.inner.Ptr() }

// MTRWiFiNetworkManagementClusterNetworkPassphraseResponseParamsFromID adopts an existing toll-free-bridged object id as a MTRWiFiNetworkManagementClusterNetworkPassphraseResponseParams (nil for 0).
