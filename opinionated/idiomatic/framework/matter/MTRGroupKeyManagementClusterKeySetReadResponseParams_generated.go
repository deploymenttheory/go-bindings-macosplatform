...
func MTRGroupKeyManagementClusterKeySetReadResponseParamsFromID(id objc.ID) *MTRGroupKeyManagementClusterKeySetReadResponseParams {
	...
	x := &MTRGroupKeyManagementClusterKeySetReadResponseParams{Handle: objref.Wrap(purego.Retain(id))}
	objref.Track(x)
	return x
}
...
func mTRGroupKeyManagementClusterKeySetReadResponseParamsAdopt(id objc.ID) *MTRGroupKeyManagementClusterKeySetReadResponseParams {
	...
	x := &MTRGroupKeyManagementClusterKeySetReadResponseParams{Handle: objref.Wrap(id)}
	objref.Track(x)
	return x
}
...
func NewMTRGroupKeyManagementClusterKeySetReadResponseParamsWithResponseValueError(responseValue obj.Object) (*MTRGroupKeyManagementClusterKeySetReadResponseParams, error) {
