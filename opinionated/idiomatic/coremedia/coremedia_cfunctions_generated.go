...
// CMMetadataCreateIdentifierForKeyAndKeySpace calls [raw.CMMetadataCreateIdentifierForKeyAndKeySpace] (C function CMMetadataCreateIdentifierForKeyAndKeySpace).
func CMMetadataCreateIdentifierForKeyAndKeySpace(allocator unsafe.Pointer, key unsafe.Pointer, keySpace unsafe.Pointer, identifierOut unsafe.Pointer) int {
	return raw.CMMetadataCreateIdentifierForKeyAndKeySpace(allocator, key, keySpace, identifierOut)
}

// CMMetadataCreateKeyFromIdentifier calls [raw.CMMetadataCreateKeyFromIdentifier] (C function CMMetadataCreateKeyFromIdentifier).
func CMMetadataCreateKeyFromIdentifier(allocator unsafe.Pointer, identifier unsafe.Pointer, keyOut unsafe.Pointer) int {
	return raw.CMMetadataCreateKeyFromIdentifier(allocator, identifier, keyOut)
}

// CMMetadataCreateKeyFromIdentifierAsCFData calls [raw.CMMetadataCreateKeyFromIdentifierAsCFData] (C function CMMetadataCreateKeyFromIdentifierAsCFData).
func CMMetadataCreateKeyFromIdentifierAsCFData(allocator unsafe.Pointer, identifier unsafe.Pointer, keyOut unsafe.Pointer) int {
	return raw.CMMetadataCreateKeyFromIdentifierAsCFData(allocator, identifier, keyOut)
}

// CMMetadataCreateKeySpaceFromIdentifier calls [raw.CMMetadataCreateKeySpaceFromIdentifier] (C function CMMetadataCreateKeySpaceFromIdentifier).
func CMMetadataCreateKeySpaceFromIdentifier(allocator unsafe.Pointer, identifier unsafe.Pointer, keySpaceOut unsafe.Pointer) int {
	return raw.CMMetadataCreateKeySpaceFromIdentifier(allocator, identifier, keySpaceOut)
}
...
// CMMetadataDataTypeRegistryRegisterDataType calls [raw.CMMetadataDataTypeRegistryRegisterDataType] (C function CMMetadataDataTypeRegistryRegisterDataType).
func CMMetadataDataTypeRegistryRegisterDataType(dataType unsafe.Pointer, description unsafe.Pointer, conformingDataTypes unsafe.Pointer) int {
	return raw.CMMetadataDataTypeRegistryRegisterDataType(dataType, description, conformingDataTypes)
}
...
// CMSwapBigEndianClosedCaptionDescriptionToHost calls [raw.CMSwapBigEndianClosedCaptionDescriptionToHost] (C function CMSwapBigEndianClosedCaptionDescriptionToHost).
func CMSwapBigEndianClosedCaptionDescriptionToHost(closedCaptionDescriptionData *uint8, closedCaptionDescriptionSize uint) int {
	return raw.CMSwapBigEndianClosedCaptionDescriptionToHost(closedCaptionDescriptionData, closedCaptionDescriptionSize)
}

// CMSwapBigEndianImageDescriptionToHost calls [raw.CMSwapBigEndianImageDescriptionToHost] (C function CMSwapBigEndianImageDescriptionToHost).
func CMSwapBigEndianImageDescriptionToHost(imageDescriptionData *uint8, imageDescriptionSize uint) int {
	return raw.CMSwapBigEndianImageDescriptionToHost(imageDescriptionData, imageDescriptionSize)
}

// CMSwapBigEndianMetadataDescriptionToHost calls [raw.CMSwapBigEndianMetadataDescriptionToHost] (C function CMSwapBigEndianMetadataDescriptionToHost).
func CMSwapBigEndianMetadataDescriptionToHost(metadataDescriptionData *uint8, metadataDescriptionSize uint) int {
	return raw.CMSwapBigEndianMetadataDescriptionToHost(metadataDescriptionData, metadataDescriptionSize)
}

// CMSwapBigEndianSoundDescriptionToHost calls [raw.CMSwapBigEndianSoundDescriptionToHost] (C function CMSwapBigEndianSoundDescriptionToHost).
func CMSwapBigEndianSoundDescriptionToHost(soundDescriptionData *uint8, soundDescriptionSize uint) int {
	return raw.CMSwapBigEndianSoundDescriptionToHost(soundDescriptionData, soundDescriptionSize)
}

// CMSwapBigEndianTextDescriptionToHost calls [raw.CMSwapBigEndianTextDescriptionToHost] (C function CMSwapBigEndianTextDescriptionToHost).
func CMSwapBigEndianTextDescriptionToHost(textDescriptionData *uint8, textDescriptionSize uint) int {
	return raw.CMSwapBigEndianTextDescriptionToHost(textDescriptionData, textDescriptionSize)
}

// CMSwapBigEndianTimeCodeDescriptionToHost calls [raw.CMSwapBigEndianTimeCodeDescriptionToHost] (C function CMSwapBigEndianTimeCodeDescriptionToHost).
func CMSwapBigEndianTimeCodeDescriptionToHost(timeCodeDescriptionData *uint8, timeCodeDescriptionSize uint) int {
	return raw.CMSwapBigEndianTimeCodeDescriptionToHost(timeCodeDescriptionData, timeCodeDescriptionSize)
}

// CMSwapHostEndianClosedCaptionDescriptionToBig calls [raw.CMSwapHostEndianClosedCaptionDescriptionToBig] (C function CMSwapHostEndianClosedCaptionDescriptionToBig).
func CMSwapHostEndianClosedCaptionDescriptionToBig(closedCaptionDescriptionData *uint8, closedCaptionDescriptionSize uint) int {
	return raw.CMSwapHostEndianClosedCaptionDescriptionToBig(closedCaptionDescriptionData, closedCaptionDescriptionSize)
}

// CMSwapHostEndianImageDescriptionToBig calls [raw.CMSwapHostEndianImageDescriptionToBig] (C function CMSwapHostEndianImageDescriptionToBig).
func CMSwapHostEndianImageDescriptionToBig(imageDescriptionData *uint8, imageDescriptionSize uint) int {
	return raw.CMSwapHostEndianImageDescriptionToBig(imageDescriptionData, imageDescriptionSize)
}

// CMSwapHostEndianMetadataDescriptionToBig calls [raw.CMSwapHostEndianMetadataDescriptionToBig] (C function CMSwapHostEndianMetadataDescriptionToBig).
func CMSwapHostEndianMetadataDescriptionToBig(metadataDescriptionData *uint8, metadataDescriptionSize uint) int {
	return raw.CMSwapHostEndianMetadataDescriptionToBig(metadataDescriptionData, metadataDescriptionSize)
}

// CMSwapHostEndianSoundDescriptionToBig calls [raw.CMSwapHostEndianSoundDescriptionToBig] (C function CMSwapHostEndianSoundDescriptionToBig).
func CMSwapHostEndianSoundDescriptionToBig(soundDescriptionData *uint8, soundDescriptionSize uint) int {
	return raw.CMSwapHostEndianSoundDescriptionToBig(soundDescriptionData, soundDescriptionSize)
}

// CMSwapHostEndianTextDescriptionToBig calls [raw.CMSwapHostEndianTextDescriptionToBig] (C function CMSwapHostEndianTextDescriptionToBig).
func CMSwapHostEndianTextDescriptionToBig(textDescriptionData *uint8, textDescriptionSize uint) int {
	return raw.CMSwapHostEndianTextDescriptionToBig(textDescriptionData, textDescriptionSize)
}

// CMSwapHostEndianTimeCodeDescriptionToBig calls [raw.CMSwapHostEndianTimeCodeDescriptionToBig] (C function CMSwapHostEndianTimeCodeDescriptionToBig).
func CMSwapHostEndianTimeCodeDescriptionToBig(timeCodeDescriptionData *uint8, timeCodeDescriptionSize uint) int {
	return raw.CMSwapHostEndianTimeCodeDescriptionToBig(timeCodeDescriptionData, timeCodeDescriptionSize)
}
