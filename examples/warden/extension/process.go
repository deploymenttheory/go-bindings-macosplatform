...
// Package extension implements Warden's network-extension side: the
// NEFilterDataProvider subclass that judges every new flow, process attribution
// via libproc, and the XPC daemon the app talks to. Mirrors Warden's Extension/.
package extension
...
// or "" when it cannot be determined. This is the Go equivalent of Warden's
